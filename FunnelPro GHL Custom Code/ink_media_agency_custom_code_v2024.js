...
(function() {
    ...
    setInterval(async () => {
        ...
        if(hrCompany.relationshipNumber === '0-013-420' && hrCurrentLocation && hrCurrentLocation.id === 'Rfghqe9JReCqHvTnYSdK') { 
            hrInitApplication() 
        }
...
(function() {
    ...
    function pinontop() {
      ...
      if(!location.href.includes('Rfghqe9JReCqHvTnYSdK')){
        return;
      }
...
let myElement = document.querySelector("link[rel=icon]");

myElement.href = "https://firebasestorage.googleapis.com/v0/b/highlevel-backend.appspot.com/o/location%2FP4ZTl2z2DWWCAsxFNyKI%2Fimages%2F10c8ba67-7d4b-4d0e-83a9-79d6fab4fa8e.png?alt=media";
...
(function () {
  ...
  task_link.className = `w-full group px-3 flex items-center md:justify-center lg:justify-start xl:justify-start text-sm font-medium rounded-md cursor-pointer font-medium opacity-70 hover:opacity-100 py-2 md:py-2`;
  ...
  task_link.addEventListener("click", (e) => {
    ...
    app.__vue__.$router.push(taskPath);
  });
