---
title: "MetaobjectThumbnail"
description: "Shopify GraphQL Admin API documentation for metaobjectthumbnail"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectthumbnail"
...
Title: MetaobjectThumbnail - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectthumbnail

Markdown Content:
MetaobjectThumbnail - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectthumbnail#main-content)
...
[Anchor to MetaobjectThumbnail](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectthumbnail#top)
Metaobject Thumbnail
====================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectthumbnail#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to file](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectthumbnail#field-MetaobjectThumbnail.fields.file)file
...
[Anchor to hex](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectthumbnail#field-MetaobjectThumbnail.fields.hex)hex
...
*   {}[MetaobjectField.thumbnail](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetaobjectField#field-thumbnail)
