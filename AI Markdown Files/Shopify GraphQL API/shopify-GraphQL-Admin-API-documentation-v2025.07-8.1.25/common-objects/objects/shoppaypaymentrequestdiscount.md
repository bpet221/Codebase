---
title: "ShopPayPaymentRequestDiscount"
description: "Shopify GraphQL Admin API documentation for shoppaypaymentrequestdiscount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestdiscount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestdiscount

Markdown Content:
ShopPayPaymentRequestDiscount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestdiscount#main-content)
...
[Anchor to ShopPayPaymentRequestDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestdiscount#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestdiscount#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestdiscount#field-ShopPayPaymentRequestDiscount.fields.amount)amount
...
[Anchor to label](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestdiscount#field-ShopPayPaymentRequestDiscount.fields.label)label
...
*   {}[ShopPayPaymentRequest.discounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequest#field-discounts)
*   {}[ShopPayPaymentRequestLineItem.itemDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequestLineItem#field-itemDiscounts)
*   {}[ShopPayPaymentRequestLineItem.lineDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequestLineItem#field-lineDiscounts)
*   {}[ShopPayPaymentRequestTotalShippingPrice.discounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequestTotalShippingPrice#field-discounts)
