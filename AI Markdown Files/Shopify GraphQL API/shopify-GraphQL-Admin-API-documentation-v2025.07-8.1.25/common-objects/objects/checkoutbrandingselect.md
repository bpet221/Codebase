---
title: "CheckoutBrandingSelect"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingselect"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingselect"
...
Title: CheckoutBrandingSelect - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingselect

Markdown Content:
CheckoutBrandingSelect - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingselect#main-content)
...
[Anchor to CheckoutBrandingSelect](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingselect#top)
Checkout Branding Select
========================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingselect#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to border](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingselect#field-CheckoutBrandingSelect.fields.border)border
...
[Anchor to typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingselect#field-CheckoutBrandingSelect.fields.typography)typography
...
*   {}[CheckoutBrandingCustomizations.select](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-select)
