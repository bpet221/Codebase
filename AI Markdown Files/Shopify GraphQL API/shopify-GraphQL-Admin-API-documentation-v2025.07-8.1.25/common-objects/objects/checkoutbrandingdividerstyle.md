---
title: "CheckoutBrandingDividerStyle"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingdividerstyle"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingdividerstyle"
...
Title: CheckoutBrandingDividerStyle - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingdividerstyle

Markdown Content:
CheckoutBrandingDividerStyle - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingdividerstyle#main-content)
...
[Anchor to CheckoutBrandingDividerStyle](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingdividerstyle#top)
Checkout Branding Divider Style
===============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingdividerstyle#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to borderStyle](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingdividerstyle#field-CheckoutBrandingDividerStyle.fields.borderStyle)border Style
...
[Anchor to borderWidth](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingdividerstyle#field-CheckoutBrandingDividerStyle.fields.borderWidth)border Width
...
*   {}[CheckoutBrandingCustomizations.divider](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-divider)
