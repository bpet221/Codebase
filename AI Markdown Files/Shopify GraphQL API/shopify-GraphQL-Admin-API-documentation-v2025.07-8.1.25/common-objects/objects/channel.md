---
title: "Channel"
description: "Shopify GraphQL Admin API documentation for channel"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/channel"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/channel

Markdown Content:
Channel - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#queries)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#interfaces)
...
[Anchor to Channel](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#top)
Channel
=======
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#fields)Fields
--------------------------------------------------------------------------------------------------

[Anchor to app](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.app)app
...
[Anchor to collectionPublicationsV3](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.collectionPublicationsV3)collection Publications V3
...
[Anchor to collections](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.collections)collections
...
[Anchor to hasCollection](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.hasCollection)has Collection
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.hasCollection.arguments.id)id
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.name)name
...
[Anchor to productPublicationsV3](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.productPublicationsV3)product Publications V3
...
[Anchor to products](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.products)products
...
[Anchor to productsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.productsCount)products Count
...
[Anchor to supportsFuturePublishing](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.supportsFuturePublishing)supports Future Publishing
...
[Anchor to handle](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.handle)handle

•[String!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

non-null Deprecated

[Anchor to navigationItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.navigationItems)navigation Items
...
[Anchor to overviewPath](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.overviewPath)overview Path

•[URL](https://shopify.dev/docs/api/admin-graphql/latest/scalars/URL)

Deprecated

[Anchor to productPublications](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#field-Channel.fields.productPublications)product Publications
...
*   <->[ChannelConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ChannelConnection#field-nodes)
*   {}[ChannelEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ChannelEdge#field-node)
*   {}[ProductPublication.channel](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductPublication#field-channel)

Show deprecations

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#queries)Queries
-----------------------------------------------------------------------------------------------------

### Deprecated queries

[Anchor to channel](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#query-channel)[channel](https://shopify.dev/docs/api/admin-graphql/latest/queries/channel)
...
[Anchor to channels](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#query-channels)[channels](https://shopify.dev/docs/api/admin-graphql/latest/queries/channels)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/channel#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
