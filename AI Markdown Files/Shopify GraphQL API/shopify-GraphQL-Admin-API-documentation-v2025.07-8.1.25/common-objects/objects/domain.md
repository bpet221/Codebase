...
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/domain"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/domain

Markdown Content:
Domain - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#queries)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#interfaces)
...
[Anchor to Domain](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#top)
Domain
======
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#fields)Fields
-------------------------------------------------------------------------------------------------

[Anchor to host](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#field-Domain.fields.host)host
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#field-Domain.fields.id)id
...
[Anchor to localization](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#field-Domain.fields.localization)localization
...
[Anchor to marketWebPresence](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#field-Domain.fields.marketWebPresence)market Web Presence
...
[Anchor to sslEnabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#field-Domain.fields.sslEnabled)ssl Enabled
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#field-Domain.fields.url)url
...
*   {}[MarketWebPresence.domain](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketWebPresence#field-domain)
*   {}[Shop.primaryDomain](https://shopify.dev/docs/api/admin-graphql/latest/objects/Shop#field-primaryDomain)

Show deprecations

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#queries)Queries
----------------------------------------------------------------------------------------------------

[Anchor to domain](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#query-domain)[domain](https://shopify.dev/docs/api/admin-graphql/latest/queries/domain)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/domain#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
