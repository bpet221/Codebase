---
title: "CheckoutBrandingMainSection"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingmainsection"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection"
...
Title: CheckoutBrandingMainSection - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection

Markdown Content:
CheckoutBrandingMainSection - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#main-content)
...
[Anchor to CheckoutBrandingMainSection](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#top)
Checkout Branding Main Section
==============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to background](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#field-CheckoutBrandingMainSection.fields.background)background
...
[Anchor to border](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#field-CheckoutBrandingMainSection.fields.border)border
...
[Anchor to borderStyle](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#field-CheckoutBrandingMainSection.fields.borderStyle)border Style
...
[Anchor to borderWidth](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#field-CheckoutBrandingMainSection.fields.borderWidth)border Width
...
[Anchor to colorScheme](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#field-CheckoutBrandingMainSection.fields.colorScheme)color Scheme
...
[Anchor to cornerRadius](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#field-CheckoutBrandingMainSection.fields.cornerRadius)corner Radius
...
[Anchor to padding](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#field-CheckoutBrandingMainSection.fields.padding)padding
...
[Anchor to shadow](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmainsection#field-CheckoutBrandingMainSection.fields.shadow)shadow
...
*   {}[CheckoutBrandingMain.section](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingMain#field-section)
