---
title: "MetafieldDefinitionIdentifier"
description: "Shopify GraphQL Admin API documentation for metafielddefinitionidentifier"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier

Markdown Content:
MetafieldDefinitionIdentifier - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#mutations)
...
[Anchor to MetafieldDefinitionIdentifier](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to key](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#field-MetafieldDefinitionIdentifier.fields.key)key
...
[Anchor to namespace](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#field-MetafieldDefinitionIdentifier.fields.namespace)namespace
...
[Anchor to ownerType](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#field-MetafieldDefinitionIdentifier.fields.ownerType)owner Type
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to metafieldDefinitionDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionidentifier#mutation-metafieldDefinitionDelete)[metafield Definition Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafieldDefinitionDelete)
