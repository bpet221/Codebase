---
title: "StoreCreditAccountDebitRevertTransaction"
description: "Shopify GraphQL Admin API documentation for storecreditaccountdebitreverttransaction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction

Markdown Content:
StoreCreditAccountDebitRevertTransaction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#interfaces)
...
[Anchor to StoreCreditAccountDebitRevertTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to account](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#field-StoreCreditAccountDebitRevertTransaction.fields.account)account
...
[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#field-StoreCreditAccountDebitRevertTransaction.fields.amount)amount
...
[Anchor to balanceAfterTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#field-StoreCreditAccountDebitRevertTransaction.fields.balanceAfterTransaction)balance After Transaction
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#field-StoreCreditAccountDebitRevertTransaction.fields.createdAt)created At
...
[Anchor to debitTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#field-StoreCreditAccountDebitRevertTransaction.fields.debitTransaction)debit Transaction
...
[Anchor to event](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#field-StoreCreditAccountDebitRevertTransaction.fields.event)event
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#field-StoreCreditAccountDebitRevertTransaction.fields.id)id
...
[Anchor to origin](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#field-StoreCreditAccountDebitRevertTransaction.fields.origin)origin
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to StoreCreditAccountTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebitreverttransaction#interface-StoreCreditAccountTransaction)[Store Credit Account Transaction](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/StoreCreditAccountTransaction)
