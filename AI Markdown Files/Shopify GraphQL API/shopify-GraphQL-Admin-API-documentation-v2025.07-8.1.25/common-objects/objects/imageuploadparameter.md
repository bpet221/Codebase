---
title: "ImageUploadParameter"
description: "Shopify GraphQL Admin API documentation for imageuploadparameter"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/imageuploadparameter"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/imageuploadparameter

Markdown Content:
ImageUploadParameter - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageuploadparameter#main-content)
...
[Anchor to ImageUploadParameter](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageuploadparameter#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageuploadparameter#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageuploadparameter#field-ImageUploadParameter.fields.name)name
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageuploadparameter#field-ImageUploadParameter.fields.value)value
...
*   {}[StagedUploadTarget.parameters](https://shopify.dev/docs/api/admin-graphql/latest/objects/StagedUploadTarget#field-parameters)
