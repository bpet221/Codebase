---
title: "ShopPayPaymentRequestShippingLine"
description: "Shopify GraphQL Admin API documentation for shoppaypaymentrequestshippingline"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestshippingline"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestshippingline

Markdown Content:
ShopPayPaymentRequestShippingLine - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestshippingline#main-content)
...
[Anchor to ShopPayPaymentRequestShippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestshippingline#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestshippingline#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestshippingline#field-ShopPayPaymentRequestShippingLine.fields.amount)amount
...
[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestshippingline#field-ShopPayPaymentRequestShippingLine.fields.code)code
...
[Anchor to label](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestshippingline#field-ShopPayPaymentRequestShippingLine.fields.label)label
...
*   {}[ShopPayPaymentRequest.shippingLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequest#field-shippingLines)
