---
title: "CustomerPaymentInstrumentBillingAddress"
description: "Shopify GraphQL Admin API documentation for customerpaymentinstrumentbillingaddress"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress

Markdown Content:
CustomerPaymentInstrumentBillingAddress - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#main-content)
...
[Anchor to CustomerPaymentInstrumentBillingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#fields)Fields
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to address1](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#field-CustomerPaymentInstrumentBillingAddress.fields.address1)address1

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The first line of the address. Typically the street address or PO Box number.

[Anchor to city](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#field-CustomerPaymentInstrumentBillingAddress.fields.city)city

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The name of the city, district, village, or town.

[Anchor to country](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#field-CustomerPaymentInstrumentBillingAddress.fields.country)country

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The name of the country.

[Anchor to countryCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#field-CustomerPaymentInstrumentBillingAddress.fields.countryCode)country Code
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#field-CustomerPaymentInstrumentBillingAddress.fields.name)name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The name of the buyer of the address.

[Anchor to province](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#field-CustomerPaymentInstrumentBillingAddress.fields.province)province

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The region of the address, such as the province, state, or district.

[Anchor to provinceCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#field-CustomerPaymentInstrumentBillingAddress.fields.provinceCode)province Code

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The alphanumeric code for the region. For example, ON.

[Anchor to zip](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentinstrumentbillingaddress#field-CustomerPaymentInstrumentBillingAddress.fields.zip)zip
...
*   {}[CustomerPaypalBillingAgreement.billingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerPaypalBillingAgreement#field-billingAddress)
