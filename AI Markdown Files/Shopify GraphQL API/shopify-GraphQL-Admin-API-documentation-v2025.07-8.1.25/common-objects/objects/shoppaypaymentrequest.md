---
title: "ShopPayPaymentRequest"
description: "Shopify GraphQL Admin API documentation for shoppaypaymentrequest"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest

Markdown Content:
ShopPayPaymentRequest - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#main-content)
...
[Anchor to ShopPayPaymentRequest](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to discounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.discounts)discounts
...
[Anchor to lineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.lineItems)line Items
...
[Anchor to presentmentCurrency](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.presentmentCurrency)presentment Currency
...
[Anchor to selectedDeliveryMethodType](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.selectedDeliveryMethodType)selected Delivery Method Type
...
[Anchor to shippingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.shippingAddress)shipping Address
...
[Anchor to shippingLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.shippingLines)shipping Lines
...
[Anchor to subtotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.subtotal)subtotal
...
[Anchor to total](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.total)total
...
[Anchor to totalShippingPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.totalShippingPrice)total Shipping Price
...
[Anchor to totalTax](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequest#field-ShopPayPaymentRequest.fields.totalTax)total Tax
...
*   {}[ShopPayPaymentRequestReceipt.paymentRequest](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequestReceipt#field-paymentRequest)
