---
title: "AbandonedCheckoutLineItemComponent"
description: "Shopify GraphQL Admin API documentation for abandonedcheckoutlineitemcomponent"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent

Markdown Content:
AbandonedCheckoutLineItemComponent - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent#main-content)
...
[Anchor to AbandonedCheckoutLineItemComponent](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent#field-AbandonedCheckoutLineItemComponent.fields.id)id
...
[Anchor to image](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent#field-AbandonedCheckoutLineItemComponent.fields.image)image
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent#field-AbandonedCheckoutLineItemComponent.fields.quantity)quantity
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent#field-AbandonedCheckoutLineItemComponent.fields.title)title
...
[Anchor to variantTitle](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemcomponent#field-AbandonedCheckoutLineItemComponent.fields.variantTitle)variant Title
...
*   {}[AbandonedCheckoutLineItem.components](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckoutLineItem#field-components)
