---
title: "MetafieldRelation"
description: "Shopify GraphQL Admin API documentation for metafieldrelation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation

Markdown Content:
MetafieldRelation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation#main-content)
...
[Anchor to MetafieldRelation](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation#top)
Metafield Relation
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to key](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation#field-MetafieldRelation.fields.key)key
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation#field-MetafieldRelation.fields.name)name
...
[Anchor to namespace](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation#field-MetafieldRelation.fields.namespace)namespace
...
[Anchor to referencer](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation#field-MetafieldRelation.fields.referencer)referencer
...
[Anchor to target](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelation#field-MetafieldRelation.fields.target)target
...
*   <->[MetafieldRelationConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/MetafieldRelationConnection#field-nodes)
*   {}[MetafieldRelationEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetafieldRelationEdge#field-node)
*   {}[Metaobject.referencedBy](https://shopify.dev/docs/api/admin-graphql/latest/objects/Metaobject#field-referencedBy)
