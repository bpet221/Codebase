---
title: "GiftCardDebitTransaction"
description: "Shopify GraphQL Admin API documentation for giftcarddebittransaction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction

Markdown Content:
GiftCardDebitTransaction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#interfaces)
...
[Anchor to GiftCardDebitTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#field-GiftCardDebitTransaction.fields.amount)amount
...
[Anchor to giftCard](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#field-GiftCardDebitTransaction.fields.giftCard)gift Card
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#field-GiftCardDebitTransaction.fields.id)id
...
[Anchor to metafield](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#field-GiftCardDebitTransaction.fields.metafield)metafield
...
[Anchor to metafields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#field-GiftCardDebitTransaction.fields.metafields)metafields
...
[Anchor to note](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#field-GiftCardDebitTransaction.fields.note)note

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A note about the transaction.

[Anchor to processedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#field-GiftCardDebitTransaction.fields.processedAt)processed At
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------

[Anchor to giftCardDebit](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#mutation-giftCardDebit)[gift Card Debit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftCardDebit)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to GiftCardTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#interface-GiftCardTransaction)[Gift Card Transaction](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/GiftCardTransaction)

•interface

[Anchor to HasMetafields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#interface-HasMetafields)[Has Metafields](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/HasMetafields)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddebittransaction#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
