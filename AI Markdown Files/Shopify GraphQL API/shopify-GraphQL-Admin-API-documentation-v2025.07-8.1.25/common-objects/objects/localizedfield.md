...
description: "Shopify GraphQL Admin API documentation for localizedfield"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield

Markdown Content:
LocalizedField - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield#main-content)
...
[Anchor to LocalizedField](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield#top)
Localized Field
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to countryCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield#field-LocalizedField.fields.countryCode)country Code
...
[Anchor to key](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield#field-LocalizedField.fields.key)key
...
[Anchor to purpose](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield#field-LocalizedField.fields.purpose)purpose
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield#field-LocalizedField.fields.title)title
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfield#field-LocalizedField.fields.value)value
...
*   {}[DraftOrder.localizedFields](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrder#field-localizedFields)
*   ||-[HasLocalizedFields.localizedFields](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/HasLocalizedFields#field-localizedFields)
*   <->[LocalizedFieldConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/LocalizedFieldConnection#field-nodes)
*   {}[LocalizedFieldEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/LocalizedFieldEdge#field-node)
*   {}[Order.localizedFields](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-localizedFields)
