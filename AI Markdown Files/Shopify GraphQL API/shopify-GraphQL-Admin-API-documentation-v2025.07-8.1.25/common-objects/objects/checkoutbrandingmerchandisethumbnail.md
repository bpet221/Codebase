---
title: "CheckoutBrandingMerchandiseThumbnail"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingmerchandisethumbnail"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnail"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnail

Markdown Content:
CheckoutBrandingMerchandiseThumbnail - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnail#main-content)
...
[Anchor to CheckoutBrandingMerchandiseThumbnail](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnail#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnail#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to badge](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnail#field-CheckoutBrandingMerchandiseThumbnail.fields.badge)badge
...
[Anchor to border](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnail#field-CheckoutBrandingMerchandiseThumbnail.fields.border)border
...
[Anchor to cornerRadius](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnail#field-CheckoutBrandingMerchandiseThumbnail.fields.cornerRadius)corner Radius
...
[Anchor to fit](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnail#field-CheckoutBrandingMerchandiseThumbnail.fields.fit)fit
...
*   {}[CheckoutBrandingCustomizations.merchandiseThumbnail](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-merchandiseThumbnail)
