...
description: "Shopify GraphQL Admin API documentation for stageduploadparameter"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadparameter"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadparameter

Markdown Content:
StagedUploadParameter - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadparameter#main-content)
...
[Anchor to StagedUploadParameter](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadparameter#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadparameter#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadparameter#field-StagedUploadParameter.fields.name)name
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadparameter#field-StagedUploadParameter.fields.value)value
...
*   {}[StagedMediaUploadTarget.parameters](https://shopify.dev/docs/api/admin-graphql/latest/objects/StagedMediaUploadTarget#field-parameters)
