---
title: "ApiVersion"
description: "Shopify GraphQL Admin API documentation for apiversion"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion

Markdown Content:
ApiVersion - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#queries)
...
[Anchor to ApiVersion](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#top)
Api Version
===========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#fields)Fields
-----------------------------------------------------------------------------------------------------

[Anchor to displayName](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#field-ApiVersion.fields.displayName)display Name
...
[Anchor to handle](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#field-ApiVersion.fields.handle)handle
...
[Anchor to supported](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#field-ApiVersion.fields.supported)supported
...
*   {}[WebhookSubscription.apiVersion](https://shopify.dev/docs/api/admin-graphql/latest/objects/WebhookSubscription#field-apiVersion)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#queries)Queries
--------------------------------------------------------------------------------------------------------

[Anchor to publicApiVersions](https://shopify.dev/docs/api/admin-graphql/latest/objects/apiversion#query-publicApiVersions)[public Api Versions](https://shopify.dev/docs/api/admin-graphql/latest/queries/publicApiVersions)
...
*   <?>[public Api Versions](https://shopify.dev/docs/api/admin-graphql/latest/queries/ApiVersion)
