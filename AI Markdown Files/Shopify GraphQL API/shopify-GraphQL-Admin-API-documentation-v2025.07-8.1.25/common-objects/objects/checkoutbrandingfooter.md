---
title: "CheckoutBrandingFooter"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingfooter"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter

Markdown Content:
CheckoutBrandingFooter - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter#main-content)
...
[Anchor to CheckoutBrandingFooter](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to alignment](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter#field-CheckoutBrandingFooter.fields.alignment)alignment
...
[Anchor to colorScheme](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter#field-CheckoutBrandingFooter.fields.colorScheme)color Scheme
...
[Anchor to content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter#field-CheckoutBrandingFooter.fields.content)content
...
[Anchor to divided](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter#field-CheckoutBrandingFooter.fields.divided)divided

•[Boolean](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Boolean)

The divided setting.

[Anchor to padding](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter#field-CheckoutBrandingFooter.fields.padding)padding
...
[Anchor to position](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfooter#field-CheckoutBrandingFooter.fields.position)position
...
*   {}[CheckoutBrandingCustomizations.footer](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-footer)
