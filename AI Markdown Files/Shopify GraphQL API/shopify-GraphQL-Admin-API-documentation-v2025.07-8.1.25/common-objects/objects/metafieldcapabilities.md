---
title: "MetafieldCapabilities"
description: "Shopify GraphQL Admin API documentation for metafieldcapabilities"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilities"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilities

Markdown Content:
MetafieldCapabilities - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilities#main-content)
...
[Anchor to MetafieldCapabilities](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilities#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilities#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to adminFilterable](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilities#field-MetafieldCapabilities.fields.adminFilterable)admin Filterable
...
[Anchor to smartCollectionCondition](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilities#field-MetafieldCapabilities.fields.smartCollectionCondition)smart Collection Condition
...
[Anchor to uniqueValues](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilities#field-MetafieldCapabilities.fields.uniqueValues)unique Values
...
*   {}[MetafieldDefinition.capabilities](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetafieldDefinition#field-capabilities)
