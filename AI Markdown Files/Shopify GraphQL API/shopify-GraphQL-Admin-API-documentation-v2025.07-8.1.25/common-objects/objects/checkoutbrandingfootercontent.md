---
title: "CheckoutBrandingFooterContent"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingfootercontent"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfootercontent"
...
Title: CheckoutBrandingFooterContent - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfootercontent

Markdown Content:
CheckoutBrandingFooterContent - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfootercontent#main-content)
...
[Anchor to CheckoutBrandingFooterContent](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfootercontent#top)
Checkout Branding Footer Content
================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfootercontent#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to visibility](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingfootercontent#field-CheckoutBrandingFooterContent.fields.visibility)visibility
...
*   {}[CheckoutBrandingFooter.content](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingFooter#field-content)
