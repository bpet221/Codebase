---
title: "FinanceAppAccessPolicy"
description: "Shopify GraphQL Admin API documentation for financeappaccesspolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy

Markdown Content:
FinanceAppAccessPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy#queries)
...
[Anchor to FinanceAppAccessPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to access](https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy#field-FinanceAppAccessPolicy.fields.access)access
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy#queries)Queries
--------------------------------------------------------------------------------------------------------------------

[Anchor to financeAppAccessPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/financeappaccesspolicy#query-financeAppAccessPolicy)[finance App Access Policy](https://shopify.dev/docs/api/admin-graphql/latest/queries/financeAppAccessPolicy)
