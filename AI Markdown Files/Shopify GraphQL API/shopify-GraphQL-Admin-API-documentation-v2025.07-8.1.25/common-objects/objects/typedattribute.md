---
title: "TypedAttribute"
description: "Shopify GraphQL Admin API documentation for typedattribute"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/typedattribute"
...
Title: TypedAttribute - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/typedattribute

Markdown Content:
TypedAttribute - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/typedattribute#main-content)
...
[Anchor to TypedAttribute](https://shopify.dev/docs/api/admin-graphql/latest/objects/typedattribute#top)
Typed Attribute
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/typedattribute#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to key](https://shopify.dev/docs/api/admin-graphql/latest/objects/typedattribute#field-TypedAttribute.fields.key)key
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/typedattribute#field-TypedAttribute.fields.value)value
...
*   {}[CalculatedDraftOrderLineItem.customAttributesV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-customAttributesV2)
*   {}[DraftOrderLineItem.customAttributesV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrderLineItem#field-customAttributesV2)
