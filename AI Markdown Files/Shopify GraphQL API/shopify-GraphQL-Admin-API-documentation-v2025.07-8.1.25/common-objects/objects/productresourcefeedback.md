...
description: "Shopify GraphQL Admin API documentation for productresourcefeedback"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback

Markdown Content:
ProductResourceFeedback - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#queries)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#mutations)
...
[Anchor to ProductResourceFeedback](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to feedbackGeneratedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#field-ProductResourceFeedback.fields.feedbackGeneratedAt)feedback Generated At
...
[Anchor to messages](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#field-ProductResourceFeedback.fields.messages)messages
...
[Anchor to productId](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#field-ProductResourceFeedback.fields.productId)product Id
...
[Anchor to productUpdatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#field-ProductResourceFeedback.fields.productUpdatedAt)product Updated At
...
[Anchor to state](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#field-ProductResourceFeedback.fields.state)state
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#queries)Queries
---------------------------------------------------------------------------------------------------------------------

[Anchor to productResourceFeedback](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#query-productResourceFeedback)[product Resource Feedback](https://shopify.dev/docs/api/admin-graphql/latest/queries/productResourceFeedback)
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------

[Anchor to bulkProductResourceFeedbackCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/productresourcefeedback#mutation-bulkProductResourceFeedbackCreate)[bulk Product Resource Feedback Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/bulkProductResourceFeedbackCreate)
