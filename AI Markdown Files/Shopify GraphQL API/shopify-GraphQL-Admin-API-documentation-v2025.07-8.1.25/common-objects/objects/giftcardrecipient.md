---
title: "GiftCardRecipient"
description: "Shopify GraphQL Admin API documentation for giftcardrecipient"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardrecipient"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardrecipient

Markdown Content:
GiftCardRecipient - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardrecipient#main-content)
...
[Anchor to GiftCardRecipient](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardrecipient#top)
Gift Card Recipient
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardrecipient#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardrecipient#field-GiftCardRecipient.fields.message)message

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The message sent with the gift card.

[Anchor to preferredName](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardrecipient#field-GiftCardRecipient.fields.preferredName)preferred Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The preferred name of the recipient who will receive the gift card.

[Anchor to recipient](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardrecipient#field-GiftCardRecipient.fields.recipient)recipient
...
[Anchor to sendNotificationAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardrecipient#field-GiftCardRecipient.fields.sendNotificationAt)send Notification At
...
*   {}[GiftCard.recipientAttributes](https://shopify.dev/docs/api/admin-graphql/latest/objects/GiftCard#field-recipientAttributes)
