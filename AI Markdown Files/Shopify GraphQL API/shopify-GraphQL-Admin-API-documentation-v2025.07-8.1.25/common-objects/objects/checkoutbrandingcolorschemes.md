---
title: "CheckoutBrandingColorSchemes"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcolorschemes"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorschemes"
...
Title: CheckoutBrandingColorSchemes - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorschemes

Markdown Content:
CheckoutBrandingColorSchemes - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorschemes#main-content)
...
[Anchor to CheckoutBrandingColorSchemes](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorschemes#top)
Checkout Branding Color Schemes
===============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorschemes#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to scheme1](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorschemes#field-CheckoutBrandingColorSchemes.fields.scheme1)scheme1
...
[Anchor to scheme2](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorschemes#field-CheckoutBrandingColorSchemes.fields.scheme2)scheme2
...
[Anchor to scheme3](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorschemes#field-CheckoutBrandingColorSchemes.fields.scheme3)scheme3
...
[Anchor to scheme4](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorschemes#field-CheckoutBrandingColorSchemes.fields.scheme4)scheme4
...
*   {}[CheckoutBrandingColors.schemes](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColors#field-schemes)
