---
title: "PaymentTerms"
description: "Shopify GraphQL Admin API documentation for paymentterms"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms

Markdown Content:
PaymentTerms - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#interfaces)
...
[Anchor to PaymentTerms](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#top)
Payment Terms
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to draftOrder](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#field-PaymentTerms.fields.draftOrder)draft Order
...
[Anchor to dueInDays](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#field-PaymentTerms.fields.dueInDays)due In Days

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

Duration of payment terms in days based on the payment terms template used to create the payment terms.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#field-PaymentTerms.fields.id)id
...
[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#field-PaymentTerms.fields.order)order
...
[Anchor to overdue](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#field-PaymentTerms.fields.overdue)overdue
...
[Anchor to paymentSchedules](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#field-PaymentTerms.fields.paymentSchedules)payment Schedules
...
[Anchor to paymentTermsName](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#field-PaymentTerms.fields.paymentTermsName)payment Terms Name
...
[Anchor to paymentTermsType](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#field-PaymentTerms.fields.paymentTermsType)payment Terms Type
...
[Anchor to translatedName](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#field-PaymentTerms.fields.translatedName)translated Name
...
*   {}[DraftOrder.paymentTerms](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrder#field-paymentTerms)
*   {}[Order.paymentTerms](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-paymentTerms)
*   {}[PaymentSchedule.paymentTerms](https://shopify.dev/docs/api/admin-graphql/latest/objects/PaymentSchedule#field-paymentTerms)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#mutations)Mutations
----------------------------------------------------------------------------------------------------------------

[Anchor to paymentTermsCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#mutation-paymentTermsCreate)[payment Terms Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/paymentTermsCreate)
...
[Anchor to paymentTermsUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#mutation-paymentTermsUpdate)[payment Terms Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/paymentTermsUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentterms#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
