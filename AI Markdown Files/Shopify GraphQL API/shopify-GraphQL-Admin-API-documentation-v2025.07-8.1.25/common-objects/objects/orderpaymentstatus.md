...
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus

Markdown Content:
OrderPaymentStatus - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#queries)
...
[Anchor to OrderPaymentStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to errorMessage](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#field-OrderPaymentStatus.fields.errorMessage)error Message

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A message describing an error during the asynchronous processing of a payment.

[Anchor to paymentReferenceId](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#field-OrderPaymentStatus.fields.paymentReferenceId)payment Reference Id
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#field-OrderPaymentStatus.fields.status)status
...
[Anchor to transactions](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#field-OrderPaymentStatus.fields.transactions)transactions
...
[Anchor to translatedErrorMessage](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#field-OrderPaymentStatus.fields.translatedErrorMessage)translated Error Message
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#queries)Queries
----------------------------------------------------------------------------------------------------------------

[Anchor to orderPaymentStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentstatus#query-orderPaymentStatus)[order Payment Status](https://shopify.dev/docs/api/admin-graphql/latest/queries/orderPaymentStatus)
