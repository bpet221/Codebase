---
title: "MoneyV2"
description: "Shopify GraphQL Admin API documentation for moneyv2"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/moneyv2

Markdown Content:
MoneyV2 - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneyv2#main-content)
...
[Anchor to MoneyV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneyv2#top)
Money V2
========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneyv2#fields)Fields
--------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneyv2#field-MoneyV2.fields.amount)amount
...
[Anchor to currencyCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneyv2#field-MoneyV2.fields.currencyCode)currency Code
...
*   {}[AppCredit.amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppCredit#field-amount)
*   ||-[AppPurchase.price](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/AppPurchase#field-price)
*   {}[AppPurchaseOneTime.price](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppPurchaseOneTime#field-price)
*   {}[AppRecurringPricing.price](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppRecurringPricing#field-price)
*   {}[AppRevenueAttributionRecord.amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppRevenueAttributionRecord#field-amount)
*   {}[AppSubscriptionDiscount.priceAfterDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppSubscriptionDiscount#field-priceAfterDiscount)
*   {}[AppSubscriptionDiscountAmount.amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppSubscriptionDiscountAmount#field-amount)
*   {}[AppUsagePricing.balanceUsed](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppUsagePricing#field-balanceUsed)
*   {}[AppUsagePricing.cappedAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppUsagePricing#field-cappedAmount)
*   {}[AppUsageRecord.price](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppUsageRecord#field-price)
*   {}[CalculatedDraftOrderLineItem.discountedTotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-discountedTotal)
*   {}[CalculatedDraftOrderLineItem.originalTotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-originalTotal)
*   {}[CalculatedDraftOrderLineItem.originalUnitPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-originalUnitPrice)
*   {}[CalculatedDraftOrderLineItem.originalUnitPriceWithCurrency](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-originalUnitPriceWithCurrency)
*   {}[CalculatedDraftOrderLineItem.priceOverride](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-priceOverride)
*   {}[CalculatedDraftOrderLineItem.totalDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-totalDiscount)
*   {}[CashTrackingAdjustment.cash](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingAdjustment#field-cash)
*   {}[CashTrackingSession.closingBalance](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-closingBalance)
*   {}[CashTrackingSession.expectedBalance](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-expectedBalance)
*   {}[CashTrackingSession.expectedClosingBalance](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-expectedClosingBalance)
*   {}[CashTrackingSession.expectedOpeningBalance](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-expectedOpeningBalance)
*   {}[CashTrackingSession.netCashSales](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-netCashSales)
*   {}[CashTrackingSession.openingBalance](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-openingBalance)
*   {}[CashTrackingSession.totalAdjustments](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-totalAdjustments)
*   {}[CashTrackingSession.totalCashRefunds](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-totalCashRefunds)
*   {}[CashTrackingSession.totalCashSales](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-totalCashSales)
*   {}[CashTrackingSession.totalDiscrepancy](https://shopify.dev/docs/api/admin-graphql/latest/objects/CashTrackingSession#field-totalDiscrepancy)
*   {}[Company.totalSpent](https://shopify.dev/docs/api/admin-graphql/latest/objects/Company#field-totalSpent)
*   {}[CompanyLocation.totalSpent](https://shopify.dev/docs/api/admin-graphql/latest/objects/CompanyLocation#field-totalSpent)
*   {}[CurrencyExchangeAdjustment.adjustment](https://shopify.dev/docs/api/admin-graphql/latest/objects/CurrencyExchangeAdjustment#field-adjustment)
