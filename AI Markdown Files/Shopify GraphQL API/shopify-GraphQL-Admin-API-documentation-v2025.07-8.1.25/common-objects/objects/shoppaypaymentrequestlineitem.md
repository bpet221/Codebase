---
title: "ShopPayPaymentRequestLineItem"
description: "Shopify GraphQL Admin API documentation for shoppaypaymentrequestlineitem"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem

Markdown Content:
ShopPayPaymentRequestLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#main-content)
...
[Anchor to ShopPayPaymentRequestLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to finalItemPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.finalItemPrice)final Item Price
...
[Anchor to finalLinePrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.finalLinePrice)final Line Price
...
[Anchor to image](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.image)image
...
[Anchor to itemDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.itemDiscounts)item Discounts
...
[Anchor to label](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.label)label
...
[Anchor to lineDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.lineDiscounts)line Discounts
...
[Anchor to originalItemPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.originalItemPrice)original Item Price
...
[Anchor to originalLinePrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.originalLinePrice)original Line Price
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.quantity)quantity
...
[Anchor to requiresShipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.requiresShipping)requires Shipping

•[Boolean](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Boolean)

Whether the line item requires shipping.

[Anchor to sku](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestlineitem#field-ShopPayPaymentRequestLineItem.fields.sku)sku
...
*   {}[ShopPayPaymentRequest.lineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequest#field-lineItems)
