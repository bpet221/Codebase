---
title: "ShopPayPaymentRequestReceiptProcessingStatus"
description: "Shopify GraphQL Admin API documentation for shoppaypaymentrequestreceiptprocessingstatus"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptprocessingstatus"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptprocessingstatus

Markdown Content:
ShopPayPaymentRequestReceiptProcessingStatus - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptprocessingstatus#main-content)
...
[Anchor to ShopPayPaymentRequestReceiptProcessingStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptprocessingstatus#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptprocessingstatus#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to errorCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptprocessingstatus#field-ShopPayPaymentRequestReceiptProcessingStatus.fields.errorCode)error Code
...
[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptprocessingstatus#field-ShopPayPaymentRequestReceiptProcessingStatus.fields.message)message

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The message of the payment request receipt.

[Anchor to state](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptprocessingstatus#field-ShopPayPaymentRequestReceiptProcessingStatus.fields.state)state
...
*   {}[ShopPayPaymentRequestReceipt.processingStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequestReceipt#field-processingStatus)
