---
title: "VaultCreditCard"
description: "Shopify GraphQL Admin API documentation for vaultcreditcard"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard

Markdown Content:
VaultCreditCard - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#main-content)
...
[Anchor to VaultCreditCard](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#top)
Vault Credit Card
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to billingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#field-VaultCreditCard.fields.billingAddress)billing Address
...
[Anchor to brand](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#field-VaultCreditCard.fields.brand)brand
...
[Anchor to expired](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#field-VaultCreditCard.fields.expired)expired
...
[Anchor to expiryMonth](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#field-VaultCreditCard.fields.expiryMonth)expiry Month
...
[Anchor to expiryYear](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#field-VaultCreditCard.fields.expiryYear)expiry Year
...
[Anchor to lastDigits](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#field-VaultCreditCard.fields.lastDigits)last Digits
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultcreditcard#field-VaultCreditCard.fields.name)name
