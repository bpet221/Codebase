---
title: "SearchResult"
description: "Shopify GraphQL Admin API documentation for searchresult"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult

Markdown Content:
SearchResult - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult#main-content)
...
[Anchor to SearchResult](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult#top)
Search Result
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult#field-SearchResult.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

Returns the search result description text.

[Anchor to image](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult#field-SearchResult.fields.image)image
...
[Anchor to reference](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult#field-SearchResult.fields.reference)reference
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult#field-SearchResult.fields.title)title
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresult#field-SearchResult.fields.url)url
...
*   {}[SearchResultEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/SearchResultEdge#field-node)
*   {}[Shop.search](https://shopify.dev/docs/api/admin-graphql/latest/objects/Shop#field-search)
