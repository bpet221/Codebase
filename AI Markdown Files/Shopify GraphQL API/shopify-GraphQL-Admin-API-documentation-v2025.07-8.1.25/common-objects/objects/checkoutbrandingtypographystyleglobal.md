---
title: "CheckoutBrandingTypographyStyleGlobal"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingtypographystyleglobal"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyleglobal"
...
Title: CheckoutBrandingTypographyStyleGlobal - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyleglobal

Markdown Content:
CheckoutBrandingTypographyStyleGlobal - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyleglobal#main-content)
...
[Anchor to CheckoutBrandingTypographyStyleGlobal](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyleglobal#top)
Checkout Branding Typography Style Global
=========================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyleglobal#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to kerning](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyleglobal#field-CheckoutBrandingTypographyStyleGlobal.fields.kerning)kerning
...
[Anchor to letterCase](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyleglobal#field-CheckoutBrandingTypographyStyleGlobal.fields.letterCase)letter Case
...
*   {}[CheckoutBrandingGlobal.typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingGlobal#field-typography)
