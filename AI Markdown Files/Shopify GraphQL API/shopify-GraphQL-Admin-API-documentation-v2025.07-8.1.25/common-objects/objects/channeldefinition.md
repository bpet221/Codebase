...
description: "Shopify GraphQL Admin API documentation for channeldefinition"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition

Markdown Content:
ChannelDefinition - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#interfaces)
...
[Anchor to ChannelDefinition](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#top)
Channel Definition
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to channelName](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#field-ChannelDefinition.fields.channelName)channel Name
...
[Anchor to handle](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#field-ChannelDefinition.fields.handle)handle
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#field-ChannelDefinition.fields.id)id
...
[Anchor to isMarketplace](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#field-ChannelDefinition.fields.isMarketplace)is Marketplace
...
[Anchor to subChannelName](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#field-ChannelDefinition.fields.subChannelName)sub Channel Name
...
[Anchor to svgIcon](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#field-ChannelDefinition.fields.svgIcon)svg Icon
...
*   {}[AvailableChannelDefinitionsByChannel.channelDefinitions](https://shopify.dev/docs/api/admin-graphql/latest/objects/AvailableChannelDefinitionsByChannel#field-channelDefinitions)
*   {}[ChannelInformation.channelDefinition](https://shopify.dev/docs/api/admin-graphql/latest/objects/ChannelInformation#field-channelDefinition)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeldefinition#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
