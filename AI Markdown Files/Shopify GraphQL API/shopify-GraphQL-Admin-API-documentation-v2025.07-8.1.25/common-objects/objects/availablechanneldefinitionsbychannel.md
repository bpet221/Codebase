---
title: "AvailableChannelDefinitionsByChannel"
description: "Shopify GraphQL Admin API documentation for availablechanneldefinitionsbychannel"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/availablechanneldefinitionsbychannel"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/availablechanneldefinitionsbychannel

Markdown Content:
AvailableChannelDefinitionsByChannel - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/availablechanneldefinitionsbychannel#main-content)
...
[Anchor to AvailableChannelDefinitionsByChannel](https://shopify.dev/docs/api/admin-graphql/latest/objects/availablechanneldefinitionsbychannel#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/availablechanneldefinitionsbychannel#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to channelDefinitions](https://shopify.dev/docs/api/admin-graphql/latest/objects/availablechanneldefinitionsbychannel#field-AvailableChannelDefinitionsByChannel.fields.channelDefinitions)channel Definitions
...
[Anchor to channelName](https://shopify.dev/docs/api/admin-graphql/latest/objects/availablechanneldefinitionsbychannel#field-AvailableChannelDefinitionsByChannel.fields.channelName)channel Name
...
*   {}[Shop.channelDefinitionsForInstalledChannels](https://shopify.dev/docs/api/admin-graphql/latest/objects/Shop#field-channelDefinitionsForInstalledChannels)
