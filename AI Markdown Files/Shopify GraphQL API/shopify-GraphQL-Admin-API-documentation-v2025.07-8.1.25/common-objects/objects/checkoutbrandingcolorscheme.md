---
title: "CheckoutBrandingColorScheme"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcolorscheme"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorscheme"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorscheme

Markdown Content:
CheckoutBrandingColorScheme - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorscheme#main-content)
...
[Anchor to CheckoutBrandingColorScheme](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorscheme#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorscheme#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to base](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorscheme#field-CheckoutBrandingColorScheme.fields.base)base
...
[Anchor to control](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorscheme#field-CheckoutBrandingColorScheme.fields.control)control
...
[Anchor to primaryButton](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorscheme#field-CheckoutBrandingColorScheme.fields.primaryButton)primary Button
...
[Anchor to secondaryButton](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorscheme#field-CheckoutBrandingColorScheme.fields.secondaryButton)secondary Button
...
*   {}[CheckoutBrandingColorSchemes.scheme1](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColorSchemes#field-scheme1)
*   {}[CheckoutBrandingColorSchemes.scheme2](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColorSchemes#field-scheme2)
*   {}[CheckoutBrandingColorSchemes.scheme3](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColorSchemes#field-scheme3)
*   {}[CheckoutBrandingColorSchemes.scheme4](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColorSchemes#field-scheme4)
