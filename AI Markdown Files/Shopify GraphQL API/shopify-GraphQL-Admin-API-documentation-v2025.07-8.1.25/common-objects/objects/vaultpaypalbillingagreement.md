---
title: "VaultPaypalBillingAgreement"
description: "Shopify GraphQL Admin API documentation for vaultpaypalbillingagreement"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultpaypalbillingagreement"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultpaypalbillingagreement

Markdown Content:
VaultPaypalBillingAgreement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultpaypalbillingagreement#main-content)
...
[Anchor to VaultPaypalBillingAgreement](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultpaypalbillingagreement#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultpaypalbillingagreement#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to inactive](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultpaypalbillingagreement#field-VaultPaypalBillingAgreement.fields.inactive)inactive
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultpaypalbillingagreement#field-VaultPaypalBillingAgreement.fields.name)name
...
[Anchor to paypalAccountEmail](https://shopify.dev/docs/api/admin-graphql/latest/objects/vaultpaypalbillingagreement#field-VaultPaypalBillingAgreement.fields.paypalAccountEmail)paypal Account Email
