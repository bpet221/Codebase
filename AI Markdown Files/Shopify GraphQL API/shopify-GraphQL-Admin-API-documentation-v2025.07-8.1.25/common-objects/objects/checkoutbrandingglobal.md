---
title: "CheckoutBrandingGlobal"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingglobal"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingglobal"
...
Title: CheckoutBrandingGlobal - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingglobal

Markdown Content:
CheckoutBrandingGlobal - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingglobal#main-content)
...
[Anchor to CheckoutBrandingGlobal](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingglobal#top)
Checkout Branding Global
========================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingglobal#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cornerRadius](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingglobal#field-CheckoutBrandingGlobal.fields.cornerRadius)corner Radius

•[Checkout Branding Global Corner Radius](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingGlobalCornerRadius)

The global corner radius setting that overrides all other [corner radius](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingCornerRadius) customizations.

Show enum values

[Anchor to typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingglobal#field-CheckoutBrandingGlobal.fields.typography)typography
...
*   {}[CheckoutBrandingCustomizations.global](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-global)
