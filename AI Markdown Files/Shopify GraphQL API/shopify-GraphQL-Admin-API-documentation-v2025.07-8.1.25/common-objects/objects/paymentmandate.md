...
description: "Shopify GraphQL Admin API documentation for paymentmandate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate

Markdown Content:
PaymentMandate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate#interfaces)
...
[Anchor to PaymentMandate](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate#top)
Payment Mandate
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate#field-PaymentMandate.fields.id)id
...
[Anchor to paymentInstrument](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate#field-PaymentMandate.fields.paymentInstrument)payment Instrument
...
*   {}[OrderPaymentCollectionDetails.vaultedPaymentMethods](https://shopify.dev/docs/api/admin-graphql/latest/objects/OrderPaymentCollectionDetails#field-vaultedPaymentMethods)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentmandate#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
