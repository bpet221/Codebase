...
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt

Markdown Content:
ShopPayPaymentRequestReceipt - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#queries)
...
[Anchor to ShopPayPaymentRequestReceipt](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#field-ShopPayPaymentRequestReceipt.fields.createdAt)created At
...
[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#field-ShopPayPaymentRequestReceipt.fields.order)order
...
[Anchor to paymentRequest](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#field-ShopPayPaymentRequestReceipt.fields.paymentRequest)payment Request
...
[Anchor to processingStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#field-ShopPayPaymentRequestReceipt.fields.processingStatus)processing Status
...
[Anchor to sourceIdentifier](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#field-ShopPayPaymentRequestReceipt.fields.sourceIdentifier)source Identifier
...
[Anchor to token](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#field-ShopPayPaymentRequestReceipt.fields.token)token
...
*   <->[ShopPayPaymentRequestReceiptConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ShopPayPaymentRequestReceiptConnection#field-nodes)
*   {}[ShopPayPaymentRequestReceiptEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequestReceiptEdge#field-node)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#queries)Queries
--------------------------------------------------------------------------------------------------------------------------

[Anchor to shopPayPaymentRequestReceipt](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#query-shopPayPaymentRequestReceipt)[shop Pay Payment Request Receipt](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopPayPaymentRequestReceipt)
...
[Anchor to shopPayPaymentRequestReceipts](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceipt#query-shopPayPaymentRequestReceipts)[shop Pay Payment Request Receipts](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopPayPaymentRequestReceipts)
...
*   <?>[shop Pay Payment Request Receipts](https://shopify.dev/docs/api/admin-graphql/latest/queries/ShopPayPaymentRequestReceiptConnection)
