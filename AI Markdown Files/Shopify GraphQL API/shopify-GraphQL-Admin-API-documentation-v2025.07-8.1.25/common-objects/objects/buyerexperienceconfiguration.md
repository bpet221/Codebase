---
title: "BuyerExperienceConfiguration"
description: "Shopify GraphQL Admin API documentation for buyerexperienceconfiguration"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration

Markdown Content:
BuyerExperienceConfiguration - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration#main-content)
...
[Anchor to BuyerExperienceConfiguration](https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to checkoutToDraft](https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration#field-BuyerExperienceConfiguration.fields.checkoutToDraft)checkout To Draft
...
[Anchor to deposit](https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration#field-BuyerExperienceConfiguration.fields.deposit)deposit
...
[Anchor to editableShippingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration#field-BuyerExperienceConfiguration.fields.editableShippingAddress)editable Shipping Address
...
[Anchor to paymentTermsTemplate](https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration#field-BuyerExperienceConfiguration.fields.paymentTermsTemplate)payment Terms Template
...
[Anchor to payNowOnly](https://shopify.dev/docs/api/admin-graphql/latest/objects/buyerexperienceconfiguration#field-BuyerExperienceConfiguration.fields.payNowOnly)pay Now Only
...
*   {}[CompanyLocation.buyerExperienceConfiguration](https://shopify.dev/docs/api/admin-graphql/latest/objects/CompanyLocation#field-buyerExperienceConfiguration)
