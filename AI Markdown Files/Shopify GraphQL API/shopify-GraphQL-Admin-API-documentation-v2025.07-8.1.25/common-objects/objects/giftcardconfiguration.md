...
description: "Shopify GraphQL Admin API documentation for giftcardconfiguration"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration

Markdown Content:
GiftCardConfiguration - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration#queries)
...
[Anchor to GiftCardConfiguration](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to issueLimit](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration#field-GiftCardConfiguration.fields.issueLimit)issue Limit
...
[Anchor to purchaseLimit](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration#field-GiftCardConfiguration.fields.purchaseLimit)purchase Limit
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration#queries)Queries
-------------------------------------------------------------------------------------------------------------------

[Anchor to giftCardConfiguration](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardconfiguration#query-giftCardConfiguration)[gift Card Configuration](https://shopify.dev/docs/api/admin-graphql/latest/queries/giftCardConfiguration)
