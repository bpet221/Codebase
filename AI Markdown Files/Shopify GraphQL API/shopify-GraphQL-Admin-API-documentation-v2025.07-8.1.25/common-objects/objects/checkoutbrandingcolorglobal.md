---
title: "CheckoutBrandingColorGlobal"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcolorglobal"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal

Markdown Content:
CheckoutBrandingColorGlobal - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#main-content)
...
[Anchor to CheckoutBrandingColorGlobal](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to accent](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#field-CheckoutBrandingColorGlobal.fields.accent)accent

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A color used for interaction, like links and focus states.

[Anchor to brand](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#field-CheckoutBrandingColorGlobal.fields.brand)brand
...
[Anchor to critical](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#field-CheckoutBrandingColorGlobal.fields.critical)critical
...
[Anchor to decorative](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#field-CheckoutBrandingColorGlobal.fields.decorative)decorative
...
[Anchor to info](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#field-CheckoutBrandingColorGlobal.fields.info)info

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A semantic color used for components that communicate general, informative content.

[Anchor to success](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#field-CheckoutBrandingColorGlobal.fields.success)success

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A semantic color used for components that communicate successful actions or a positive state.

[Anchor to warning](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorglobal#field-CheckoutBrandingColorGlobal.fields.warning)warning
...
*   {}[CheckoutBrandingColors.global](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColors#field-global)
