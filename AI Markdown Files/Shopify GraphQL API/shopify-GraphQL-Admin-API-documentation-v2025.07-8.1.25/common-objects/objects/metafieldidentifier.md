---
title: "MetafieldIdentifier"
description: "Shopify GraphQL Admin API documentation for metafieldidentifier"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier

Markdown Content:
MetafieldIdentifier - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#mutations)
...
[Anchor to MetafieldIdentifier](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to key](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#field-MetafieldIdentifier.fields.key)key
...
[Anchor to namespace](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#field-MetafieldIdentifier.fields.namespace)namespace
...
[Anchor to ownerId](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#field-MetafieldIdentifier.fields.ownerId)owner Id
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------

[Anchor to metafieldsDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldidentifier#mutation-metafieldsDelete)[metafields Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafieldsDelete)
