...
description: "Shopify GraphQL Admin API documentation for customercreditcard"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard

Markdown Content:
CustomerCreditCard - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#main-content)
...
[Anchor to CustomerCreditCard](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to billingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.billingAddress)billing Address
...
[Anchor to brand](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.brand)brand
...
[Anchor to expiresSoon](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.expiresSoon)expires Soon
...
[Anchor to expiryMonth](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.expiryMonth)expiry Month
...
[Anchor to expiryYear](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.expiryYear)expiry Year
...
[Anchor to firstDigits](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.firstDigits)first Digits

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The card's BIN number.

[Anchor to isRevocable](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.isRevocable)is Revocable
...
[Anchor to lastDigits](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.lastDigits)last Digits
...
[Anchor to maskedNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.maskedNumber)masked Number
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.name)name
...
[Anchor to source](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.source)source

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The source of the card if coming from a wallet such as Apple Pay.

[Anchor to virtualLastDigits](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercreditcard#field-CustomerCreditCard.fields.virtualLastDigits)virtual Last Digits
