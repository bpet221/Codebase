---
title: "StandardMetaobjectCapabilityTemplate"
description: "Shopify GraphQL Admin API documentation for standardmetaobjectcapabilitytemplate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectcapabilitytemplate"
...
Title: StandardMetaobjectCapabilityTemplate - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectcapabilitytemplate

Markdown Content:
StandardMetaobjectCapabilityTemplate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectcapabilitytemplate#main-content)
...
[Anchor to StandardMetaobjectCapabilityTemplate](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectcapabilitytemplate#top)
Standard Metaobject Capability Template
=======================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectcapabilitytemplate#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to capabilityType](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectcapabilitytemplate#field-StandardMetaobjectCapabilityTemplate.fields.capabilityType)capability Type

•[Metaobject Capability Type!](https://shopify.dev/docs/api/admin-graphql/latest/enums/MetaobjectCapabilityType)
...
*   {}[StandardMetaobjectDefinitionTemplate.enabledCapabilities](https://shopify.dev/docs/api/admin-graphql/latest/objects/StandardMetaobjectDefinitionTemplate#field-enabledCapabilities)
