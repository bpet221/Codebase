---
title: "ShopifyFunction"
description: "Shopify GraphQL Admin API documentation for shopifyfunction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction

Markdown Content:
ShopifyFunction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#queries)
...
[Anchor to ShopifyFunction](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#top)
Shopify Function
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to apiType](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.apiType)api Type
...
[Anchor to apiVersion](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.apiVersion)api Version
...
[Anchor to app](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.app)app
...
[Anchor to appBridge](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.appBridge)app Bridge
...
[Anchor to appKey](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.appKey)app Key
...
[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The description of the Shopify Function.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.id)id
...
[Anchor to inputQuery](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.inputQuery)input Query

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The input query of the Shopify Function.

[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.title)title
...
[Anchor to useCreationUi](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#field-ShopifyFunction.fields.useCreationUi)use Creation Ui
...
*   {}[DeliveryCustomization.shopifyFunction](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryCustomization#field-shopifyFunction)
*   {}[FulfillmentConstraintRule.function](https://shopify.dev/docs/api/admin-graphql/latest/objects/FulfillmentConstraintRule#field-function)
*   {}[PaymentCustomization.shopifyFunction](https://shopify.dev/docs/api/admin-graphql/latest/objects/PaymentCustomization#field-shopifyFunction)
*   <->[ShopifyFunctionConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ShopifyFunctionConnection#field-nodes)
*   {}[ShopifyFunctionEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopifyFunctionEdge#field-node)
*   {}[Validation.shopifyFunction](https://shopify.dev/docs/api/admin-graphql/latest/objects/Validation#field-shopifyFunction)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#queries)Queries
-------------------------------------------------------------------------------------------------------------

[Anchor to shopifyFunction](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#query-shopifyFunction)[shopify Function](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyFunction)
...
[Anchor to shopifyFunctions](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunction#query-shopifyFunctions)[shopify Functions](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyFunctions)
...
*   <?>[shopify Functions](https://shopify.dev/docs/api/admin-graphql/latest/queries/ShopifyFunctionConnection)
