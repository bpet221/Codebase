---
title: "SearchFilterOptions"
description: "Shopify GraphQL Admin API documentation for searchfilteroptions"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/searchfilteroptions"
...
Title: SearchFilterOptions - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/searchfilteroptions

Markdown Content:
SearchFilterOptions - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchfilteroptions#main-content)
...
[Anchor to SearchFilterOptions](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchfilteroptions#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchfilteroptions#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to productAvailability](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchfilteroptions#field-SearchFilterOptions.fields.productAvailability)product Availability
...
*   {}[Shop.searchFilters](https://shopify.dev/docs/api/admin-graphql/latest/objects/Shop#field-searchFilters)
