...
description: "Shopify GraphQL Admin API documentation for storecreditaccountdebittransaction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction

Markdown Content:
StoreCreditAccountDebitTransaction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#interfaces)
...
[Anchor to StoreCreditAccountDebitTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to account](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#field-StoreCreditAccountDebitTransaction.fields.account)account
...
[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#field-StoreCreditAccountDebitTransaction.fields.amount)amount
...
[Anchor to balanceAfterTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#field-StoreCreditAccountDebitTransaction.fields.balanceAfterTransaction)balance After Transaction
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#field-StoreCreditAccountDebitTransaction.fields.createdAt)created At
...
[Anchor to event](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#field-StoreCreditAccountDebitTransaction.fields.event)event
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#field-StoreCreditAccountDebitTransaction.fields.id)id
...
[Anchor to origin](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#field-StoreCreditAccountDebitTransaction.fields.origin)origin
...
*   {}[StoreCreditAccountDebitRevertTransaction.debitTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/StoreCreditAccountDebitRevertTransaction#field-debitTransaction)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to storeCreditAccountDebit](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#mutation-storeCreditAccountDebit)[store Credit Account Debit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/storeCreditAccountDebit)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to StoreCreditAccountTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountdebittransaction#interface-StoreCreditAccountTransaction)[Store Credit Account Transaction](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/StoreCreditAccountTransaction)
