---
title: "FunctionsErrorHistory"
description: "Shopify GraphQL Admin API documentation for functionserrorhistory"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/functionserrorhistory"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/functionserrorhistory

Markdown Content:
FunctionsErrorHistory - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionserrorhistory#main-content)
...
[Anchor to FunctionsErrorHistory](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionserrorhistory#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionserrorhistory#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to errorsFirstOccurredAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionserrorhistory#field-FunctionsErrorHistory.fields.errorsFirstOccurredAt)errors First Occurred At
...
[Anchor to firstOccurredAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionserrorhistory#field-FunctionsErrorHistory.fields.firstOccurredAt)first Occurred At
...
[Anchor to hasBeenSharedSinceLastError](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionserrorhistory#field-FunctionsErrorHistory.fields.hasBeenSharedSinceLastError)has Been Shared Since Last Error
...
[Anchor to hasSharedRecentErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionserrorhistory#field-FunctionsErrorHistory.fields.hasSharedRecentErrors)has Shared Recent Errors
...
*   {}[DeliveryCustomization.errorHistory](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryCustomization#field-errorHistory)
*   {}[DiscountAutomaticApp.errorHistory](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountAutomaticApp#field-errorHistory)
*   {}[DiscountCodeApp.errorHistory](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountCodeApp#field-errorHistory)
*   {}[PaymentCustomization.errorHistory](https://shopify.dev/docs/api/admin-graphql/latest/objects/PaymentCustomization#field-errorHistory)
*   {}[Validation.errorHistory](https://shopify.dev/docs/api/admin-graphql/latest/objects/Validation#field-errorHistory)
