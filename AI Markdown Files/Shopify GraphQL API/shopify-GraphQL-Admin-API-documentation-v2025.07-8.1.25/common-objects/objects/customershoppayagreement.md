---
title: "CustomerShopPayAgreement"
description: "Shopify GraphQL Admin API documentation for customershoppayagreement"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement

Markdown Content:
CustomerShopPayAgreement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#main-content)
...
[Anchor to CustomerShopPayAgreement](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to billingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#field-CustomerShopPayAgreement.fields.billingAddress)billing Address
...
[Anchor to expiresSoon](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#field-CustomerShopPayAgreement.fields.expiresSoon)expires Soon
...
[Anchor to expiryMonth](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#field-CustomerShopPayAgreement.fields.expiryMonth)expiry Month
...
[Anchor to expiryYear](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#field-CustomerShopPayAgreement.fields.expiryYear)expiry Year
...
[Anchor to inactive](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#field-CustomerShopPayAgreement.fields.inactive)inactive
...
[Anchor to isRevocable](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#field-CustomerShopPayAgreement.fields.isRevocable)is Revocable
...
[Anchor to lastDigits](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#field-CustomerShopPayAgreement.fields.lastDigits)last Digits
...
[Anchor to maskedNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#field-CustomerShopPayAgreement.fields.maskedNumber)masked Number
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/customershoppayagreement#field-CustomerShopPayAgreement.fields.name)name
