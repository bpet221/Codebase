---
title: "StoreCreditAccountCreditTransaction"
description: "Shopify GraphQL Admin API documentation for storecreditaccountcredittransaction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction

Markdown Content:
StoreCreditAccountCreditTransaction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#interfaces)
...
[Anchor to StoreCreditAccountCreditTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to account](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#field-StoreCreditAccountCreditTransaction.fields.account)account
...
[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#field-StoreCreditAccountCreditTransaction.fields.amount)amount
...
[Anchor to balanceAfterTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#field-StoreCreditAccountCreditTransaction.fields.balanceAfterTransaction)balance After Transaction
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#field-StoreCreditAccountCreditTransaction.fields.createdAt)created At
...
[Anchor to event](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#field-StoreCreditAccountCreditTransaction.fields.event)event
...
[Anchor to expiresAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#field-StoreCreditAccountCreditTransaction.fields.expiresAt)expires At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

The time at which the transaction expires. Debit transactions will always spend the soonest expiring credit first.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#field-StoreCreditAccountCreditTransaction.fields.id)id
...
[Anchor to origin](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#field-StoreCreditAccountCreditTransaction.fields.origin)origin
...
[Anchor to remainingAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#field-StoreCreditAccountCreditTransaction.fields.remainingAmount)remaining Amount
...
*   {}[StoreCreditAccountExpirationTransaction.creditTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/StoreCreditAccountExpirationTransaction#field-creditTransaction)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to storeCreditAccountCredit](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#mutation-storeCreditAccountCredit)[store Credit Account Credit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/storeCreditAccountCredit)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to StoreCreditAccountTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcredittransaction#interface-StoreCreditAccountTransaction)[Store Credit Account Transaction](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/StoreCreditAccountTransaction)
