---
title: "CheckoutBrandingTextField"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingtextfield"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtextfield"
...
Title: CheckoutBrandingTextField - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtextfield

Markdown Content:
CheckoutBrandingTextField - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtextfield#main-content)
...
[Anchor to CheckoutBrandingTextField](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtextfield#top)
Checkout Branding Text Field
============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtextfield#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to border](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtextfield#field-CheckoutBrandingTextField.fields.border)border

•[Checkout Branding Border](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingBorder)

The border used for text fields.

Show enum values

[Anchor to typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtextfield#field-CheckoutBrandingTextField.fields.typography)typography
...
*   {}[CheckoutBrandingCustomizations.textField](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-textField)
