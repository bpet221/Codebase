---
title: "DepositPercentage"
description: "Shopify GraphQL Admin API documentation for depositpercentage"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/depositpercentage"
...
Title: DepositPercentage - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/depositpercentage

Markdown Content:
DepositPercentage - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/depositpercentage#main-content)
...
[Anchor to DepositPercentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/depositpercentage#top)
Deposit Percentage
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/depositpercentage#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to percentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/depositpercentage#field-DepositPercentage.fields.percentage)percentage
