---
title: "ShopPayPaymentRequestTotalShippingPrice"
description: "Shopify GraphQL Admin API documentation for shoppaypaymentrequesttotalshippingprice"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequesttotalshippingprice"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequesttotalshippingprice

Markdown Content:
ShopPayPaymentRequestTotalShippingPrice - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequesttotalshippingprice#main-content)
...
[Anchor to ShopPayPaymentRequestTotalShippingPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequesttotalshippingprice#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequesttotalshippingprice#fields)Fields
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to discounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequesttotalshippingprice#field-ShopPayPaymentRequestTotalShippingPrice.fields.discounts)discounts
...
[Anchor to finalTotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequesttotalshippingprice#field-ShopPayPaymentRequestTotalShippingPrice.fields.finalTotal)final Total
...
[Anchor to originalTotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequesttotalshippingprice#field-ShopPayPaymentRequestTotalShippingPrice.fields.originalTotal)original Total
...
*   {}[ShopPayPaymentRequest.totalShippingPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequest#field-totalShippingPrice)
