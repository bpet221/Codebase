---
title: "DomainLocalization"
description: "Shopify GraphQL Admin API documentation for domainlocalization"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/domainlocalization"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/domainlocalization

Markdown Content:
DomainLocalization - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/domainlocalization#main-content)
...
[Anchor to DomainLocalization](https://shopify.dev/docs/api/admin-graphql/latest/objects/domainlocalization#top)
Domain Localization
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/domainlocalization#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to alternateLocales](https://shopify.dev/docs/api/admin-graphql/latest/objects/domainlocalization#field-DomainLocalization.fields.alternateLocales)alternate Locales
...
[Anchor to country](https://shopify.dev/docs/api/admin-graphql/latest/objects/domainlocalization#field-DomainLocalization.fields.country)country

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The ISO code for the country assigned to the domain. For example, `"CA"` or "*" for a domain set to "Rest of world".

[Anchor to defaultLocale](https://shopify.dev/docs/api/admin-graphql/latest/objects/domainlocalization#field-DomainLocalization.fields.defaultLocale)default Locale
...
*   {}[Domain.localization](https://shopify.dev/docs/api/admin-graphql/latest/objects/Domain#field-localization)
