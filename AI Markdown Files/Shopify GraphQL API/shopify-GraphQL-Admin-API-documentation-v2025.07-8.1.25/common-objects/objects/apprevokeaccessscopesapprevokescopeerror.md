...
description: "Shopify GraphQL Admin API documentation for apprevokeaccessscopesapprevokescopeerror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror

Markdown Content:
AppRevokeAccessScopesAppRevokeScopeError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#interfaces)
...
[Anchor to AppRevokeAccessScopesAppRevokeScopeError](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#field-AppRevokeAccessScopesAppRevokeScopeError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#field-AppRevokeAccessScopesAppRevokeScopeError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#field-AppRevokeAccessScopesAppRevokeScopeError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to appRevokeAccessScopes](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#mutation-appRevokeAccessScopes)[app Revoke Access Scopes](https://shopify.dev/docs/api/admin-graphql/latest/mutations/appRevokeAccessScopes)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevokeaccessscopesapprevokescopeerror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
