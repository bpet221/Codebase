---
title: "CheckoutBrandingCornerRadiusVariables"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcornerradiusvariables"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcornerradiusvariables"
...
Title: CheckoutBrandingCornerRadiusVariables - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcornerradiusvariables

Markdown Content:
CheckoutBrandingCornerRadiusVariables - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcornerradiusvariables#main-content)
...
[Anchor to CheckoutBrandingCornerRadiusVariables](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcornerradiusvariables#top)
Checkout Branding Corner Radius Variables
=========================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcornerradiusvariables#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to base](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcornerradiusvariables#field-CheckoutBrandingCornerRadiusVariables.fields.base)base

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The value in pixels for base corner radii. Example: 5.

[Anchor to large](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcornerradiusvariables#field-CheckoutBrandingCornerRadiusVariables.fields.large)large

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The value in pixels for large corner radii. Example: 10.

[Anchor to small](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcornerradiusvariables#field-CheckoutBrandingCornerRadiusVariables.fields.small)small
...
*   {}[CheckoutBrandingDesignSystem.cornerRadius](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingDesignSystem#field-cornerRadius)
