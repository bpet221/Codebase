---
title: "CheckoutBrandingShopifyFont"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingshopifyfont"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont"
...
Title: CheckoutBrandingShopifyFont - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont

Markdown Content:
CheckoutBrandingShopifyFont - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont#interfaces)
...
[Anchor to CheckoutBrandingShopifyFont](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont#top)
Checkout Branding Shopify Font
==============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to sources](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont#field-CheckoutBrandingShopifyFont.fields.sources)sources

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The font sources.

[Anchor to weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont#field-CheckoutBrandingShopifyFont.fields.weight)weight
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to CheckoutBrandingFont](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingshopifyfont#interface-CheckoutBrandingFont)[Checkout Branding Font](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/CheckoutBrandingFont)
...
||-CheckoutBrandingShopifyFont Implements
-----------------------------------------
