---
title: "MutationsStagedUploadTargetGenerateUploadParameter"
description: "Shopify GraphQL Admin API documentation for mutationsstageduploadtargetgenerateuploadparameter"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter

Markdown Content:
MutationsStagedUploadTargetGenerateUploadParameter - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter#mutations)
...
[Anchor to MutationsStagedUploadTargetGenerateUploadParameter](https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter#field-MutationsStagedUploadTargetGenerateUploadParameter.fields.name)name
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter#field-MutationsStagedUploadTargetGenerateUploadParameter.fields.value)value
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to stagedUploadTargetGenerate](https://shopify.dev/docs/api/admin-graphql/latest/objects/mutationsstageduploadtargetgenerateuploadparameter#mutation-stagedUploadTargetGenerate)[staged Upload Target Generate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stagedUploadTargetGenerate)
