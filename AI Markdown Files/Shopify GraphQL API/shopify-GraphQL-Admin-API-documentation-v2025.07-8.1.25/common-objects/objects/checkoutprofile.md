...
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile

Markdown Content:
CheckoutProfile - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#queries)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#interfaces)
...
[Anchor to CheckoutProfile](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#top)
Checkout Profile
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#field-CheckoutProfile.fields.createdAt)created At
...
[Anchor to editedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#field-CheckoutProfile.fields.editedAt)edited At
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#field-CheckoutProfile.fields.id)id
...
[Anchor to isPublished](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#field-CheckoutProfile.fields.isPublished)is Published
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#field-CheckoutProfile.fields.name)name
...
[Anchor to typOspPagesActive](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#field-CheckoutProfile.fields.typOspPagesActive)typ Osp Pages Active
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#field-CheckoutProfile.fields.updatedAt)updated At
...
*   <->[CheckoutProfileConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/CheckoutProfileConnection#field-nodes)
*   {}[CheckoutProfileEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutProfileEdge#field-node)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#queries)Queries
-------------------------------------------------------------------------------------------------------------

[Anchor to checkoutProfile](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#query-checkoutProfile)[checkout Profile](https://shopify.dev/docs/api/admin-graphql/latest/queries/checkoutProfile)
...
[Anchor to checkoutProfiles](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#query-checkoutProfiles)[checkout Profiles](https://shopify.dev/docs/api/admin-graphql/latest/queries/checkoutProfiles)
...
*   <?>[checkout Profiles](https://shopify.dev/docs/api/admin-graphql/latest/queries/CheckoutProfileConnection)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofile#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
