---
title: "CheckoutBrandingExpressCheckout"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingexpresscheckout"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckout"
...
Title: CheckoutBrandingExpressCheckout - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckout

Markdown Content:
CheckoutBrandingExpressCheckout - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckout#main-content)
...
[Anchor to CheckoutBrandingExpressCheckout](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckout#top)
Checkout Branding Express Checkout
==================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckout#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to button](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckout#field-CheckoutBrandingExpressCheckout.fields.button)button
...
*   {}[CheckoutBrandingCustomizations.expressCheckout](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-expressCheckout)
