---
title: "GiftCardCreditTransaction"
description: "Shopify GraphQL Admin API documentation for giftcardcredittransaction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction

Markdown Content:
GiftCardCreditTransaction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#interfaces)
...
[Anchor to GiftCardCreditTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#field-GiftCardCreditTransaction.fields.amount)amount
...
[Anchor to giftCard](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#field-GiftCardCreditTransaction.fields.giftCard)gift Card
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#field-GiftCardCreditTransaction.fields.id)id
...
[Anchor to metafield](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#field-GiftCardCreditTransaction.fields.metafield)metafield
...
[Anchor to metafields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#field-GiftCardCreditTransaction.fields.metafields)metafields
...
[Anchor to note](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#field-GiftCardCreditTransaction.fields.note)note

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A note about the transaction.

[Anchor to processedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#field-GiftCardCreditTransaction.fields.processedAt)processed At
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to giftCardCredit](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#mutation-giftCardCredit)[gift Card Credit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftCardCredit)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to GiftCardTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#interface-GiftCardTransaction)[Gift Card Transaction](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/GiftCardTransaction)

•interface

[Anchor to HasMetafields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#interface-HasMetafields)[Has Metafields](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/HasMetafields)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardcredittransaction#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
