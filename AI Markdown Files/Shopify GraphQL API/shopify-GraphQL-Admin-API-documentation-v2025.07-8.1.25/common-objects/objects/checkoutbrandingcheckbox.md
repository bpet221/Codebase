---
title: "CheckoutBrandingCheckbox"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcheckbox"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcheckbox"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcheckbox

Markdown Content:
CheckoutBrandingCheckbox - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcheckbox#main-content)
...
[Anchor to CheckoutBrandingCheckbox](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcheckbox#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcheckbox#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to cornerRadius](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcheckbox#field-CheckoutBrandingCheckbox.fields.cornerRadius)corner Radius
...
*   {}[CheckoutBrandingCustomizations.checkbox](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-checkbox)
