...
description: "Shopify GraphQL Admin API documentation for shoppaypaymentrequestimage"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestimage"
...
Title: ShopPayPaymentRequestImage - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestimage

Markdown Content:
ShopPayPaymentRequestImage - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestimage#main-content)
...
[Anchor to ShopPayPaymentRequestImage](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestimage#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestimage#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to alt](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestimage#field-ShopPayPaymentRequestImage.fields.alt)alt

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The alt text of the image.

[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestimage#field-ShopPayPaymentRequestImage.fields.url)url
...
*   {}[ShopPayPaymentRequestLineItem.image](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequestLineItem#field-image)
