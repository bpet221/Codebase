---
title: "CheckoutBrandingExpressCheckoutButton"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingexpresscheckoutbutton"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckoutbutton"
...
Title: CheckoutBrandingExpressCheckoutButton - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckoutbutton

Markdown Content:
CheckoutBrandingExpressCheckoutButton - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckoutbutton#main-content)
...
[Anchor to CheckoutBrandingExpressCheckoutButton](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckoutbutton#top)
Checkout Branding Express Checkout Button
=========================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckoutbutton#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to cornerRadius](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingexpresscheckoutbutton#field-CheckoutBrandingExpressCheckoutButton.fields.cornerRadius)corner Radius
...
*   {}[CheckoutBrandingExpressCheckout.button](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingExpressCheckout#field-button)
