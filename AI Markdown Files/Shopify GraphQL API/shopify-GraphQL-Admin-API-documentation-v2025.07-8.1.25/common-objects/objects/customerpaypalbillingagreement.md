---
title: "CustomerPaypalBillingAgreement"
description: "Shopify GraphQL Admin API documentation for customerpaypalbillingagreement"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaypalbillingagreement"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaypalbillingagreement

Markdown Content:
CustomerPaypalBillingAgreement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaypalbillingagreement#main-content)
...
[Anchor to CustomerPaypalBillingAgreement](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaypalbillingagreement#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaypalbillingagreement#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to billingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaypalbillingagreement#field-CustomerPaypalBillingAgreement.fields.billingAddress)billing Address
...
[Anchor to inactive](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaypalbillingagreement#field-CustomerPaypalBillingAgreement.fields.inactive)inactive
...
[Anchor to isRevocable](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaypalbillingagreement#field-CustomerPaypalBillingAgreement.fields.isRevocable)is Revocable
...
[Anchor to paypalAccountEmail](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaypalbillingagreement#field-CustomerPaypalBillingAgreement.fields.paypalAccountEmail)paypal Account Email
