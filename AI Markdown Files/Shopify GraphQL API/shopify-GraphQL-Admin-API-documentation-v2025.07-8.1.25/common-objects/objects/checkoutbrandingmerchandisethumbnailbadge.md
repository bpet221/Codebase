---
title: "CheckoutBrandingMerchandiseThumbnailBadge"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingmerchandisethumbnailbadge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnailbadge"
...
Title: CheckoutBrandingMerchandiseThumbnailBadge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnailbadge

Markdown Content:
CheckoutBrandingMerchandiseThumbnailBadge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnailbadge#main-content)
...
[Anchor to CheckoutBrandingMerchandiseThumbnailBadge](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnailbadge#top)
Checkout Branding Merchandise Thumbnail Badge
=============================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnailbadge#fields)Fields
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to background](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingmerchandisethumbnailbadge#field-CheckoutBrandingMerchandiseThumbnailBadge.fields.background)background

•[Checkout Branding Merchandise Thumbnail Badge Background](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingMerchandiseThumbnailBadgeBackground)
...
*   {}[CheckoutBrandingMerchandiseThumbnail.badge](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingMerchandiseThumbnail#field-badge)
