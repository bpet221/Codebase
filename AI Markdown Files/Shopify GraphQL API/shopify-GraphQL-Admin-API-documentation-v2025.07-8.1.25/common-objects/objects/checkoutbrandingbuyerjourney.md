---
title: "CheckoutBrandingBuyerJourney"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingbuyerjourney"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuyerjourney"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuyerjourney

Markdown Content:
CheckoutBrandingBuyerJourney - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuyerjourney#main-content)
...
[Anchor to CheckoutBrandingBuyerJourney](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuyerjourney#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuyerjourney#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to visibility](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuyerjourney#field-CheckoutBrandingBuyerJourney.fields.visibility)visibility
...
*   {}[CheckoutBrandingCustomizations.buyerJourney](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-buyerJourney)
