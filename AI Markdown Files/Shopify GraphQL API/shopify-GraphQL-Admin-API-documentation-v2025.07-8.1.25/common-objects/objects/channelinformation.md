...
description: "Shopify GraphQL Admin API documentation for channelinformation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation

Markdown Content:
ChannelInformation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#interfaces)
...
[Anchor to ChannelInformation](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#top)
Channel Information
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to app](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#field-ChannelInformation.fields.app)app
...
[Anchor to channelDefinition](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#field-ChannelInformation.fields.channelDefinition)channel Definition
...
[Anchor to channelId](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#field-ChannelInformation.fields.channelId)channel Id
...
[Anchor to displayName](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#field-ChannelInformation.fields.displayName)display Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The publishing destination display name or channel name.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#field-ChannelInformation.fields.id)id
...
*   {}[Order.channelInformation](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-channelInformation)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/channelinformation#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
