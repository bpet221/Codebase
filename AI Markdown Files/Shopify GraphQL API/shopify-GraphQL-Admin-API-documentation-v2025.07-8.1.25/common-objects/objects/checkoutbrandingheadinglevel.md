---
title: "CheckoutBrandingHeadingLevel"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingheadinglevel"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadinglevel"
...
Title: CheckoutBrandingHeadingLevel - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadinglevel

Markdown Content:
CheckoutBrandingHeadingLevel - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadinglevel#main-content)
...
[Anchor to CheckoutBrandingHeadingLevel](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadinglevel#top)
Checkout Branding Heading Level
===============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadinglevel#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadinglevel#field-CheckoutBrandingHeadingLevel.fields.typography)typography
...
*   {}[CheckoutBrandingCustomizations.headingLevel1](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-headingLevel1)
*   {}[CheckoutBrandingCustomizations.headingLevel2](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-headingLevel2)
*   {}[CheckoutBrandingCustomizations.headingLevel3](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-headingLevel3)
