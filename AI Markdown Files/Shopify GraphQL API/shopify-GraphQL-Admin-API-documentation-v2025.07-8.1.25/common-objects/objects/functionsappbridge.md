---
title: "FunctionsAppBridge"
description: "Shopify GraphQL Admin API documentation for functionsappbridge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/functionsappbridge"
...
Title: FunctionsAppBridge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/functionsappbridge

Markdown Content:
FunctionsAppBridge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionsappbridge#main-content)
...
[Anchor to FunctionsAppBridge](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionsappbridge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionsappbridge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to createPath](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionsappbridge#field-FunctionsAppBridge.fields.createPath)create Path
...
[Anchor to detailsPath](https://shopify.dev/docs/api/admin-graphql/latest/objects/functionsappbridge#field-FunctionsAppBridge.fields.detailsPath)details Path
...
*   {}[AppDiscountType.appBridge](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppDiscountType#field-appBridge)
*   {}[ShopifyFunction.appBridge](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopifyFunction#field-appBridge)
