---
title: "MetafieldAccess"
description: "Shopify GraphQL Admin API documentation for metafieldaccess"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldaccess"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldaccess

Markdown Content:
MetafieldAccess - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldaccess#main-content)
...
[Anchor to MetafieldAccess](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldaccess#top)
Metafield Access
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldaccess#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to admin](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldaccess#field-MetafieldAccess.fields.admin)admin
...
[Anchor to customerAccount](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldaccess#field-MetafieldAccess.fields.customerAccount)customer Account
...
[Anchor to storefront](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldaccess#field-MetafieldAccess.fields.storefront)storefront
...
*   {}[MetafieldDefinition.access](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetafieldDefinition#field-access)
