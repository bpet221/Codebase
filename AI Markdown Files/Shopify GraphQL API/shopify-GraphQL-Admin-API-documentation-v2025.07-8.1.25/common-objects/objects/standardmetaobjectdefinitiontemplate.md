---
title: "StandardMetaobjectDefinitionTemplate"
description: "Shopify GraphQL Admin API documentation for standardmetaobjectdefinitiontemplate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate

Markdown Content:
StandardMetaobjectDefinitionTemplate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate#main-content)
...
[Anchor to StandardMetaobjectDefinitionTemplate](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate#field-StandardMetaobjectDefinitionTemplate.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The administrative description.

[Anchor to displayNameKey](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate#field-StandardMetaobjectDefinitionTemplate.fields.displayNameKey)display Name Key

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The key of a field to reference as the display name for each object.

[Anchor to enabledCapabilities](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate#field-StandardMetaobjectDefinitionTemplate.fields.enabledCapabilities)enabled Capabilities
...
[Anchor to fieldDefinitions](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate#field-StandardMetaobjectDefinitionTemplate.fields.fieldDefinitions)field Definitions
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate#field-StandardMetaobjectDefinitionTemplate.fields.name)name
...
[Anchor to type](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetaobjectdefinitiontemplate#field-StandardMetaobjectDefinitionTemplate.fields.type)type
...
*   {}[MetaobjectDefinition.standardTemplate](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetaobjectDefinition#field-standardTemplate)
