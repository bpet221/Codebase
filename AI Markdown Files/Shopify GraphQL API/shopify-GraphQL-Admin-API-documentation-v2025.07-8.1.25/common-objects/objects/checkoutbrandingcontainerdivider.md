...
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcontainerdivider"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontainerdivider"
...
Title: CheckoutBrandingContainerDivider - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontainerdivider

Markdown Content:
CheckoutBrandingContainerDivider - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontainerdivider#main-content)
...
[Anchor to CheckoutBrandingContainerDivider](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontainerdivider#top)
Checkout Branding Container Divider
===================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontainerdivider#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to borderStyle](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontainerdivider#field-CheckoutBrandingContainerDivider.fields.borderStyle)border Style
...
[Anchor to borderWidth](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontainerdivider#field-CheckoutBrandingContainerDivider.fields.borderWidth)border Width
...
[Anchor to visibility](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontainerdivider#field-CheckoutBrandingContainerDivider.fields.visibility)visibility
...
*   {}[CheckoutBrandingContent.divider](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingContent#field-divider)
*   {}[CheckoutBrandingMain.divider](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingMain#field-divider)
*   {}[CheckoutBrandingOrderSummary.divider](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingOrderSummary#field-divider)
