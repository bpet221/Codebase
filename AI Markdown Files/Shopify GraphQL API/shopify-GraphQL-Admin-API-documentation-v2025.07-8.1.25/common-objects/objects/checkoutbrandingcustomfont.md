---
title: "CheckoutBrandingCustomFont"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcustomfont"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont"
...
Title: CheckoutBrandingCustomFont - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont

Markdown Content:
CheckoutBrandingCustomFont - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#interfaces)
...
[Anchor to CheckoutBrandingCustomFont](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#top)
Checkout Branding Custom Font
=============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to genericFileId](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#field-CheckoutBrandingCustomFont.fields.genericFileId)generic File Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

Globally unique ID reference to the custom font file.

[Anchor to sources](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#field-CheckoutBrandingCustomFont.fields.sources)sources

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The font sources.

[Anchor to weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#field-CheckoutBrandingCustomFont.fields.weight)weight
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to CheckoutBrandingFont](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcustomfont#interface-CheckoutBrandingFont)[Checkout Branding Font](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/CheckoutBrandingFont)
...
||-CheckoutBrandingCustomFont Implements
----------------------------------------
