---
title: "CheckoutBrandingContent"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcontent"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontent"
...
Title: CheckoutBrandingContent - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontent

Markdown Content:
CheckoutBrandingContent - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontent#main-content)
...
[Anchor to CheckoutBrandingContent](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontent#top)
Checkout Branding Content
=========================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontent#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to divider](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontent#field-CheckoutBrandingContent.fields.divider)divider
...
*   {}[CheckoutBrandingCustomizations.content](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-content)
