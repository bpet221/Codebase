---
title: "Distance"
description: "Shopify GraphQL Admin API documentation for distance"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/distance"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/distance

Markdown Content:
Distance - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/distance#main-content)
...
[Anchor to Distance](https://shopify.dev/docs/api/admin-graphql/latest/objects/distance#top)
Distance
========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/distance#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to unit](https://shopify.dev/docs/api/admin-graphql/latest/objects/distance#field-Distance.fields.unit)unit
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/distance#field-Distance.fields.value)value
...
*   {}[PickupInStoreLocation.distanceFromBuyer](https://shopify.dev/docs/api/admin-graphql/latest/objects/PickupInStoreLocation#field-distanceFromBuyer)
