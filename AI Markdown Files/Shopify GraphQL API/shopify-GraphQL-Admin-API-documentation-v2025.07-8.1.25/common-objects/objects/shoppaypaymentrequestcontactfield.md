---
title: "ShopPayPaymentRequestContactField"
description: "Shopify GraphQL Admin API documentation for shoppaypaymentrequestcontactfield"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield

Markdown Content:
ShopPayPaymentRequestContactField - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#main-content)
...
[Anchor to ShopPayPaymentRequestContactField](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to address1](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.address1)address1
...
[Anchor to address2](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.address2)address2

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The second address line of the contact field.

[Anchor to city](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.city)city
...
[Anchor to companyName](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.companyName)company Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The company name of the contact field.

[Anchor to countryCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.countryCode)country Code
...
[Anchor to email](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.email)email

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The email of the contact field.

[Anchor to firstName](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.firstName)first Name
...
[Anchor to lastName](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.lastName)last Name
...
[Anchor to phone](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.phone)phone

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The phone number of the contact field.

[Anchor to postalCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.postalCode)postal Code

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The postal code of the contact field.

[Anchor to provinceCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestcontactfield#field-ShopPayPaymentRequestContactField.fields.provinceCode)province Code
...
*   {}[ShopPayPaymentRequest.shippingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopPayPaymentRequest#field-shippingAddress)
