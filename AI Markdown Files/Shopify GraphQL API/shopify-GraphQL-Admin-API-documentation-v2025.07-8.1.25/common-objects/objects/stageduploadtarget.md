---
title: "StagedUploadTarget"
description: "Shopify GraphQL Admin API documentation for stageduploadtarget"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget

Markdown Content:
StagedUploadTarget - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget#mutations)
...
[Anchor to StagedUploadTarget](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to parameters](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget#field-StagedUploadTarget.fields.parameters)parameters
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget#field-StagedUploadTarget.fields.url)url
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------

[Anchor to stagedUploadTargetsGenerate](https://shopify.dev/docs/api/admin-graphql/latest/objects/stageduploadtarget#mutation-stagedUploadTargetsGenerate)[staged Upload Targets Generate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stagedUploadTargetsGenerate)
