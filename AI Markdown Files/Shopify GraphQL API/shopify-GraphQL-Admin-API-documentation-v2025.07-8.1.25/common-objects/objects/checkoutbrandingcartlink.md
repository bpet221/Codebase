---
title: "CheckoutBrandingCartLink"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcartlink"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcartlink"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcartlink

Markdown Content:
CheckoutBrandingCartLink - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcartlink#main-content)
...
[Anchor to CheckoutBrandingCartLink](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcartlink#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcartlink#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to visibility](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcartlink#field-CheckoutBrandingCartLink.fields.visibility)visibility
...
*   {}[CheckoutBrandingCustomizations.cartLink](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-cartLink)
