---
title: "SavedSearch"
description: "Shopify GraphQL Admin API documentation for savedsearch"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch

Markdown Content:
SavedSearch - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#queries)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#interfaces)
...
[Anchor to SavedSearch](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#top)
Saved Search
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to filters](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#field-SavedSearch.fields.filters)filters
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#field-SavedSearch.fields.id)id
...
[Anchor to legacyResourceId](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#field-SavedSearch.fields.legacyResourceId)legacy Resource Id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#field-SavedSearch.fields.name)name
...
[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#field-SavedSearch.fields.query)query
...
[Anchor to resourceType](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#field-SavedSearch.fields.resourceType)resource Type
...
[Anchor to searchTerms](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#field-SavedSearch.fields.searchTerms)search Terms
...
*   <->[SavedSearchConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/SavedSearchConnection#field-nodes)
*   {}[SavedSearchEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/SavedSearchEdge#field-node)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#queries)Queries
---------------------------------------------------------------------------------------------------------

[Anchor to automaticDiscountSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-automaticDiscountSavedSearches)[automatic Discount Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticDiscountSavedSearches)
...
[Anchor to codeDiscountSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-codeDiscountSavedSearches)[code Discount Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/codeDiscountSavedSearches)
...
[Anchor to collectionSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-collectionSavedSearches)[collection Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/collectionSavedSearches)
...
[Anchor to customerSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-customerSavedSearches)[customer Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/customerSavedSearches)
...
[Anchor to discountRedeemCodeSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-discountRedeemCodeSavedSearches)[discount Redeem Code Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/discountRedeemCodeSavedSearches)
...
[Anchor to draftOrderSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-draftOrderSavedSearches)[draft Order Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/draftOrderSavedSearches)
...
[Anchor to fileSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-fileSavedSearches)[file Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/fileSavedSearches)
...
[Anchor to orderSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-orderSavedSearches)[order Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/orderSavedSearches)
...
[Anchor to productSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-productSavedSearches)[product Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/productSavedSearches)
...
[Anchor to urlRedirectSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#query-urlRedirectSavedSearches)[url Redirect Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/urlRedirectSavedSearches)
...
*   <?>[automatic Discount Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)
*   <?>[code Discount Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)
*   <?>[collection Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)
*   <?>[customer Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)
*   <?>[discount Redeem Code Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)
*   <?>[draft Order Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)
*   <?>[file Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)
*   <?>[order Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)
*   <?>[product Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)
*   <?>[url Redirect Saved Searches](https://shopify.dev/docs/api/admin-graphql/latest/queries/SavedSearchConnection)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#mutations)Mutations
---------------------------------------------------------------------------------------------------------------

[Anchor to savedSearchCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#mutation-savedSearchCreate)[saved Search Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedSearchCreate)
...
[Anchor to savedSearchUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#mutation-savedSearchUpdate)[saved Search Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedSearchUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------

[Anchor to LegacyInteroperability](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#interface-LegacyInteroperability)[Legacy Interoperability](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/LegacyInteroperability)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearch#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
