---
title: "WebhookSubscriptionMetafieldIdentifier"
description: "Shopify GraphQL Admin API documentation for webhooksubscriptionmetafieldidentifier"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionmetafieldidentifier"
...
Title: WebhookSubscriptionMetafieldIdentifier - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionmetafieldidentifier

Markdown Content:
WebhookSubscriptionMetafieldIdentifier - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionmetafieldidentifier#main-content)
...
[Anchor to WebhookSubscriptionMetafieldIdentifier](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionmetafieldidentifier#top)
Webhook Subscription Metafield Identifier
=========================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionmetafieldidentifier#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to key](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionmetafieldidentifier#field-WebhookSubscriptionMetafieldIdentifier.fields.key)key
...
[Anchor to namespace](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionmetafieldidentifier#field-WebhookSubscriptionMetafieldIdentifier.fields.namespace)namespace
...
*   {}[WebhookSubscription.metafields](https://shopify.dev/docs/api/admin-graphql/latest/objects/WebhookSubscription#field-metafields)
