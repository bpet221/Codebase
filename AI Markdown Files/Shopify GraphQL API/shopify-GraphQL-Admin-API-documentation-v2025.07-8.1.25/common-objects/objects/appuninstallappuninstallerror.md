---
title: "AppUninstallAppUninstallError"
description: "Shopify GraphQL Admin API documentation for appuninstallappuninstallerror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror

Markdown Content:
AppUninstallAppUninstallError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#interfaces)
...
[Anchor to AppUninstallAppUninstallError](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#field-AppUninstallAppUninstallError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#field-AppUninstallAppUninstallError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#field-AppUninstallAppUninstallError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to appUninstall](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#mutation-appUninstall)[app Uninstall](https://shopify.dev/docs/api/admin-graphql/latest/mutations/appUninstall)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/appuninstallappuninstallerror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
