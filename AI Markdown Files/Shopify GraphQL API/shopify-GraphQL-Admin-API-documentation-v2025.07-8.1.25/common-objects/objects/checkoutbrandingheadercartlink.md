---
title: "CheckoutBrandingHeaderCartLink"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingheadercartlink"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadercartlink"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadercartlink

Markdown Content:
CheckoutBrandingHeaderCartLink - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadercartlink#main-content)
...
[Anchor to CheckoutBrandingHeaderCartLink](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadercartlink#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadercartlink#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to contentType](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadercartlink#field-CheckoutBrandingHeaderCartLink.fields.contentType)content Type
...
[Anchor to image](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingheadercartlink#field-CheckoutBrandingHeaderCartLink.fields.image)image
...
*   {}[CheckoutBrandingHeader.cartLink](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingHeader#field-cartLink)
