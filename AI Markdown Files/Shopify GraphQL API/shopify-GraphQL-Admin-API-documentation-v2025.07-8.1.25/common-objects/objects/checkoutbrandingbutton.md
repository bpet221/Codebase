---
title: "CheckoutBrandingButton"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingbutton"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton

Markdown Content:
CheckoutBrandingButton - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton#main-content)
...
[Anchor to CheckoutBrandingButton](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to background](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton#field-CheckoutBrandingButton.fields.background)background
...
[Anchor to blockPadding](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton#field-CheckoutBrandingButton.fields.blockPadding)block Padding
...
[Anchor to border](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton#field-CheckoutBrandingButton.fields.border)border
...
[Anchor to cornerRadius](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton#field-CheckoutBrandingButton.fields.cornerRadius)corner Radius
...
[Anchor to inlinePadding](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton#field-CheckoutBrandingButton.fields.inlinePadding)inline Padding
...
[Anchor to typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbutton#field-CheckoutBrandingButton.fields.typography)typography
...
*   {}[CheckoutBrandingCustomizations.primaryButton](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-primaryButton)
*   {}[CheckoutBrandingCustomizations.secondaryButton](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingCustomizations#field-secondaryButton)
