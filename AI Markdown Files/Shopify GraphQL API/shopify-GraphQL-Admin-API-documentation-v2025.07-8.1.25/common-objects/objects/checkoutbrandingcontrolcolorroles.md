---
title: "CheckoutBrandingControlColorRoles"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcontrolcolorroles"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles

Markdown Content:
CheckoutBrandingControlColorRoles - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#main-content)
...
[Anchor to CheckoutBrandingControlColorRoles](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to accent](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#field-CheckoutBrandingControlColorRoles.fields.accent)accent

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of accented objects (links and focused state).

[Anchor to background](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#field-CheckoutBrandingControlColorRoles.fields.background)background

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of the background.

[Anchor to border](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#field-CheckoutBrandingControlColorRoles.fields.border)border

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of borders.

[Anchor to decorative](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#field-CheckoutBrandingControlColorRoles.fields.decorative)decorative

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The decorative color for highlighting specific parts of the user interface.

[Anchor to icon](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#field-CheckoutBrandingControlColorRoles.fields.icon)icon

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of icons.

[Anchor to selected](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#field-CheckoutBrandingControlColorRoles.fields.selected)selected
...
[Anchor to text](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcontrolcolorroles#field-CheckoutBrandingControlColorRoles.fields.text)text
...
*   {}[CheckoutBrandingColorScheme.control](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColorScheme#field-control)
