...
description: "Shopify GraphQL Admin API documentation for checkoutbrandingtypographystyle"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle"
...
Title: CheckoutBrandingTypographyStyle - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle

Markdown Content:
CheckoutBrandingTypographyStyle - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle#main-content)
...
[Anchor to CheckoutBrandingTypographyStyle](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle#top)
Checkout Branding Typography Style
==================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to font](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle#field-CheckoutBrandingTypographyStyle.fields.font)font

•[Checkout Branding Typography Font](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingTypographyFont)

The font.

Show enum values

[Anchor to kerning](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle#field-CheckoutBrandingTypographyStyle.fields.kerning)kerning

•[Checkout Branding Typography Kerning](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingTypographyKerning)

The kerning.

Show enum values

[Anchor to letterCase](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle#field-CheckoutBrandingTypographyStyle.fields.letterCase)letter Case

•[Checkout Branding Typography Letter Case](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingTypographyLetterCase)

The letter case.

Show enum values

[Anchor to size](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle#field-CheckoutBrandingTypographyStyle.fields.size)size

•[Checkout Branding Typography Size](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingTypographySize)

The font size.

Show enum values

[Anchor to weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingtypographystyle#field-CheckoutBrandingTypographyStyle.fields.weight)weight

•[Checkout Branding Typography Weight](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingTypographyWeight)
...
*   {}[CheckoutBrandingButton.typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingButton#field-typography)
*   {}[CheckoutBrandingHeadingLevel.typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingHeadingLevel#field-typography)
*   {}[CheckoutBrandingSelect.typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingSelect#field-typography)
*   {}[CheckoutBrandingTextField.typography](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingTextField#field-typography)
