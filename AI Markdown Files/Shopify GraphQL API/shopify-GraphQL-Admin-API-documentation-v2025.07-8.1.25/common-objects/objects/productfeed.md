---
title: "ProductFeed"
description: "Shopify GraphQL Admin API documentation for productfeed"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed

Markdown Content:
ProductFeed - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#queries)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#interfaces)
...
[Anchor to ProductFeed](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#top)
Product Feed
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to country](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#field-ProductFeed.fields.country)country
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#field-ProductFeed.fields.id)id
...
[Anchor to language](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#field-ProductFeed.fields.language)language
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#field-ProductFeed.fields.status)status
...
*   <->[ProductFeedConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductFeedConnection#field-nodes)
*   {}[ProductFeedEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductFeedEdge#field-node)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#queries)Queries
---------------------------------------------------------------------------------------------------------

[Anchor to productFeed](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#query-productFeed)[product Feed](https://shopify.dev/docs/api/admin-graphql/latest/queries/productFeed)
...
[Anchor to productFeeds](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#query-productFeeds)[product Feeds](https://shopify.dev/docs/api/admin-graphql/latest/queries/productFeeds)
...
*   <?>[product Feeds](https://shopify.dev/docs/api/admin-graphql/latest/queries/ProductFeedConnection)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#mutations)Mutations
---------------------------------------------------------------------------------------------------------------

[Anchor to productFeedCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#mutation-productFeedCreate)[product Feed Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productFeedCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeed#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
