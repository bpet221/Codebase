---
title: "MerchantApprovalSignals"
description: "Shopify GraphQL Admin API documentation for merchantapprovalsignals"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/merchantapprovalsignals"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/merchantapprovalsignals

Markdown Content:
MerchantApprovalSignals - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/merchantapprovalsignals#main-content)
...
[Anchor to MerchantApprovalSignals](https://shopify.dev/docs/api/admin-graphql/latest/objects/merchantapprovalsignals#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/merchantapprovalsignals#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to identityVerified](https://shopify.dev/docs/api/admin-graphql/latest/objects/merchantapprovalsignals#field-MerchantApprovalSignals.fields.identityVerified)identity Verified
...
[Anchor to verifiedByShopify](https://shopify.dev/docs/api/admin-graphql/latest/objects/merchantapprovalsignals#field-MerchantApprovalSignals.fields.verifiedByShopify)verified By Shopify
...
[Anchor to verifiedByShopifyTier](https://shopify.dev/docs/api/admin-graphql/latest/objects/merchantapprovalsignals#field-MerchantApprovalSignals.fields.verifiedByShopifyTier)verified By Shopify Tier
...
*   {}[Shop.merchantApprovalSignals](https://shopify.dev/docs/api/admin-graphql/latest/objects/Shop#field-merchantApprovalSignals)
