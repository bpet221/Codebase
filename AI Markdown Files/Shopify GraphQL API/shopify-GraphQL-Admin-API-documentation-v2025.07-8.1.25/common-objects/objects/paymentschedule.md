...
description: "Shopify GraphQL Admin API documentation for paymentschedule"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule

Markdown Content:
PaymentSchedule - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#interfaces)
...
[Anchor to PaymentSchedule](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#top)
Payment Schedule
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to completedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#field-PaymentSchedule.fields.completedAt)completed At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

Date and time when the payment schedule is paid or fulfilled.

[Anchor to dueAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#field-PaymentSchedule.fields.dueAt)due At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

Date and time when the payment schedule is due.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#field-PaymentSchedule.fields.id)id
...
[Anchor to issuedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#field-PaymentSchedule.fields.issuedAt)issued At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

Date and time when the invoice is sent.

[Anchor to paymentTerms](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#field-PaymentSchedule.fields.paymentTerms)payment Terms
...
[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#field-PaymentSchedule.fields.amount)amount
...
*   <->[PaymentScheduleConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/PaymentScheduleConnection#field-nodes)
*   {}[PaymentScheduleEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/PaymentScheduleEdge#field-node)
*   {}[PaymentTerms.paymentSchedules](https://shopify.dev/docs/api/admin-graphql/latest/objects/PaymentTerms#field-paymentSchedules)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentschedule#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
