---
title: "PaymentTermsTemplate"
description: "Shopify GraphQL Admin API documentation for paymenttermstemplate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate

Markdown Content:
PaymentTermsTemplate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#queries)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#interfaces)
...
[Anchor to PaymentTermsTemplate](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#field-PaymentTermsTemplate.fields.description)description
...
[Anchor to dueInDays](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#field-PaymentTermsTemplate.fields.dueInDays)due In Days

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The number of days between the issued date and due date if this is the net type of payment terms.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#field-PaymentTermsTemplate.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#field-PaymentTermsTemplate.fields.name)name
...
[Anchor to paymentTermsType](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#field-PaymentTermsTemplate.fields.paymentTermsType)payment Terms Type
...
[Anchor to translatedName](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#field-PaymentTermsTemplate.fields.translatedName)translated Name
...
*   {}[BuyerExperienceConfiguration.paymentTermsTemplate](https://shopify.dev/docs/api/admin-graphql/latest/objects/BuyerExperienceConfiguration#field-paymentTermsTemplate)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#queries)Queries
------------------------------------------------------------------------------------------------------------------

[Anchor to paymentTermsTemplates](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#query-paymentTermsTemplates)[payment Terms Templates](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentTermsTemplates)
...
*   <?>[payment Terms Templates](https://shopify.dev/docs/api/admin-graphql/latest/queries/PaymentTermsTemplate)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermstemplate#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
