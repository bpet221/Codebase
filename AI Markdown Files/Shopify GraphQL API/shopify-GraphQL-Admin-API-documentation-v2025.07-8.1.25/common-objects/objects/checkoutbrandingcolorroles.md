---
title: "CheckoutBrandingColorRoles"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingcolorroles"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles"
...
Title: CheckoutBrandingColorRoles - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles

Markdown Content:
CheckoutBrandingColorRoles - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles#main-content)
...
[Anchor to CheckoutBrandingColorRoles](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles#top)
Checkout Branding Color Roles
=============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to accent](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles#field-CheckoutBrandingColorRoles.fields.accent)accent

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of accented objects (links and focused state).

[Anchor to background](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles#field-CheckoutBrandingColorRoles.fields.background)background

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of the background.

[Anchor to border](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles#field-CheckoutBrandingColorRoles.fields.border)border

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of borders.

[Anchor to decorative](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles#field-CheckoutBrandingColorRoles.fields.decorative)decorative

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The decorative color for highlighting specific parts of the user interface.

[Anchor to icon](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles#field-CheckoutBrandingColorRoles.fields.icon)icon

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of icons.

[Anchor to text](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingcolorroles#field-CheckoutBrandingColorRoles.fields.text)text
...
*   {}[CheckoutBrandingButtonColorRoles.hover](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingButtonColorRoles#field-hover)
*   {}[CheckoutBrandingColorScheme.base](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColorScheme#field-base)
*   {}[CheckoutBrandingControlColorRoles.selected](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingControlColorRoles#field-selected)
