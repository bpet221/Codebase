---
title: "MetafieldCapabilityAdminFilterable"
description: "Shopify GraphQL Admin API documentation for metafieldcapabilityadminfilterable"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilityadminfilterable"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilityadminfilterable

Markdown Content:
MetafieldCapabilityAdminFilterable - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilityadminfilterable#main-content)
...
[Anchor to MetafieldCapabilityAdminFilterable](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilityadminfilterable#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilityadminfilterable#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to eligible](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilityadminfilterable#field-MetafieldCapabilityAdminFilterable.fields.eligible)eligible
...
[Anchor to enabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilityadminfilterable#field-MetafieldCapabilityAdminFilterable.fields.enabled)enabled
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilityadminfilterable#field-MetafieldCapabilityAdminFilterable.fields.status)status
...
*   {}[MetafieldCapabilities.adminFilterable](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetafieldCapabilities#field-adminFilterable)
