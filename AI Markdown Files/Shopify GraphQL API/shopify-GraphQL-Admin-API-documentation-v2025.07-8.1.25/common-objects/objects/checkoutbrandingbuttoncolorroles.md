---
title: "CheckoutBrandingButtonColorRoles"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingbuttoncolorroles"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles

Markdown Content:
CheckoutBrandingButtonColorRoles - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#main-content)
...
[Anchor to CheckoutBrandingButtonColorRoles](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to accent](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#field-CheckoutBrandingButtonColorRoles.fields.accent)accent

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of accented objects (links and focused state).

[Anchor to background](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#field-CheckoutBrandingButtonColorRoles.fields.background)background

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of the background.

[Anchor to border](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#field-CheckoutBrandingButtonColorRoles.fields.border)border

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of borders.

[Anchor to decorative](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#field-CheckoutBrandingButtonColorRoles.fields.decorative)decorative

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The decorative color for highlighting specific parts of the user interface.

[Anchor to hover](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#field-CheckoutBrandingButtonColorRoles.fields.hover)hover
...
[Anchor to icon](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#field-CheckoutBrandingButtonColorRoles.fields.icon)icon

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The color of icons.

[Anchor to text](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingbuttoncolorroles#field-CheckoutBrandingButtonColorRoles.fields.text)text
...
*   {}[CheckoutBrandingColorScheme.primaryButton](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColorScheme#field-primaryButton)
*   {}[CheckoutBrandingColorScheme.secondaryButton](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingColorScheme#field-secondaryButton)
