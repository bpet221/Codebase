---
title: "CheckoutBrandingOrderSummarySection"
description: "Shopify GraphQL Admin API documentation for checkoutbrandingordersummarysection"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection"
...
Title: CheckoutBrandingOrderSummarySection - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection

Markdown Content:
CheckoutBrandingOrderSummarySection - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#main-content)
...
[Anchor to CheckoutBrandingOrderSummarySection](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#top)
Checkout Branding Order Summary Section
=======================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to background](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#field-CheckoutBrandingOrderSummarySection.fields.background)background

•[Checkout Branding Background](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingBackground)

The background style of the order summary sections.

Show enum values

[Anchor to border](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#field-CheckoutBrandingOrderSummarySection.fields.border)border
...
[Anchor to borderStyle](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#field-CheckoutBrandingOrderSummarySection.fields.borderStyle)border Style

•[Checkout Branding Border Style](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingBorderStyle)

The border style of the order summary sections.

Show enum values

[Anchor to borderWidth](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#field-CheckoutBrandingOrderSummarySection.fields.borderWidth)border Width

•[Checkout Branding Border Width](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingBorderWidth)

The border width of the order summary sections.

Show enum values

[Anchor to colorScheme](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#field-CheckoutBrandingOrderSummarySection.fields.colorScheme)color Scheme
...
[Anchor to cornerRadius](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#field-CheckoutBrandingOrderSummarySection.fields.cornerRadius)corner Radius
...
[Anchor to padding](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#field-CheckoutBrandingOrderSummarySection.fields.padding)padding
...
[Anchor to shadow](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutbrandingordersummarysection#field-CheckoutBrandingOrderSummarySection.fields.shadow)shadow

•[Checkout Branding Shadow](https://shopify.dev/docs/api/admin-graphql/latest/enums/CheckoutBrandingShadow)
...
*   {}[CheckoutBrandingOrderSummary.section](https://shopify.dev/docs/api/admin-graphql/latest/objects/CheckoutBrandingOrderSummary#field-section)
