---
title: "StoreCreditAccountExpirationTransaction"
description: "Shopify GraphQL Admin API documentation for storecreditaccountexpirationtransaction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction

Markdown Content:
StoreCreditAccountExpirationTransaction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#interfaces)
...
[Anchor to StoreCreditAccountExpirationTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#fields)Fields
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to account](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#field-StoreCreditAccountExpirationTransaction.fields.account)account
...
[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#field-StoreCreditAccountExpirationTransaction.fields.amount)amount
...
[Anchor to balanceAfterTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#field-StoreCreditAccountExpirationTransaction.fields.balanceAfterTransaction)balance After Transaction
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#field-StoreCreditAccountExpirationTransaction.fields.createdAt)created At
...
[Anchor to creditTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#field-StoreCreditAccountExpirationTransaction.fields.creditTransaction)credit Transaction
...
[Anchor to event](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#field-StoreCreditAccountExpirationTransaction.fields.event)event
...
[Anchor to origin](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#field-StoreCreditAccountExpirationTransaction.fields.origin)origin
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to StoreCreditAccountTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountexpirationtransaction#interface-StoreCreditAccountTransaction)[Store Credit Account Transaction](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/StoreCreditAccountTransaction)
