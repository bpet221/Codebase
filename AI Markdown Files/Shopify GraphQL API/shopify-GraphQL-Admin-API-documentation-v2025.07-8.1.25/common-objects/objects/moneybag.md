---
title: "MoneyBag"
description: "Shopify GraphQL Admin API documentation for moneybag"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/moneybag

Markdown Content:
MoneyBag - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneybag#main-content)
...
[Anchor to MoneyBag](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneybag#top)
Money Bag
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneybag#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to presentmentMoney](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneybag#field-MoneyBag.fields.presentmentMoney)presentment Money
...
[Anchor to shopMoney](https://shopify.dev/docs/api/admin-graphql/latest/objects/moneybag#field-MoneyBag.fields.shopMoney)shop Money
...
*   {}[AbandonedCheckout.subtotalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckout#field-subtotalPriceSet)
*   {}[AbandonedCheckout.totalDiscountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckout#field-totalDiscountSet)
*   {}[AbandonedCheckout.totalDutiesSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckout#field-totalDutiesSet)
*   {}[AbandonedCheckout.totalLineItemsPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckout#field-totalLineItemsPriceSet)
*   {}[AbandonedCheckout.totalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckout#field-totalPriceSet)
*   {}[AbandonedCheckout.totalTaxSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckout#field-totalTaxSet)
*   {}[AbandonedCheckoutLineItem.discountedTotalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckoutLineItem#field-discountedTotalPriceSet)
*   {}[AbandonedCheckoutLineItem.discountedTotalPriceWithCodeDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckoutLineItem#field-discountedTotalPriceWithCodeDiscount)
*   {}[AbandonedCheckoutLineItem.discountedUnitPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckoutLineItem#field-discountedUnitPriceSet)
*   {}[AbandonedCheckoutLineItem.discountedUnitPriceWithCodeDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckoutLineItem#field-discountedUnitPriceWithCodeDiscount)
*   {}[AbandonedCheckoutLineItem.originalTotalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckoutLineItem#field-originalTotalPriceSet)
*   {}[AbandonedCheckoutLineItem.originalUnitPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckoutLineItem#field-originalUnitPriceSet)
*   {}[AdditionalFee.price](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdditionalFee#field-price)
*   {}[AdditionalFeeSale.totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdditionalFeeSale#field-totalAmount)
*   {}[AdditionalFeeSale.totalDiscountAmountAfterTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdditionalFeeSale#field-totalDiscountAmountAfterTaxes)
*   {}[AdditionalFeeSale.totalDiscountAmountBeforeTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdditionalFeeSale#field-totalDiscountAmountBeforeTaxes)
*   {}[AdditionalFeeSale.totalTaxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdditionalFeeSale#field-totalTaxAmount)
*   {}[AdjustmentSale.totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdjustmentSale#field-totalAmount)
*   {}[AdjustmentSale.totalDiscountAmountAfterTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdjustmentSale#field-totalDiscountAmountAfterTaxes)
*   {}[AdjustmentSale.totalDiscountAmountBeforeTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdjustmentSale#field-totalDiscountAmountBeforeTaxes)
*   {}[AdjustmentSale.totalTaxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdjustmentSale#field-totalTaxAmount)
*   {}[CalculatedDiscountAllocation.allocatedAmountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDiscountAllocation#field-allocatedAmountSet)
*   {}[CalculatedDraftOrder.lineItemsSubtotalPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-lineItemsSubtotalPrice)
*   {}[CalculatedDraftOrder.subtotalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-subtotalPriceSet)
*   {}[CalculatedDraftOrder.totalDiscountsSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-totalDiscountsSet)
*   {}[CalculatedDraftOrder.totalLineItemsPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-totalLineItemsPriceSet)
*   {}[CalculatedDraftOrder.totalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-totalPriceSet)
*   {}[CalculatedDraftOrder.totalShippingPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-totalShippingPriceSet)
*   {}[CalculatedDraftOrder.totalTaxSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-totalTaxSet)
*   {}[CalculatedDraftOrderLineItem.approximateDiscountedUnitPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-approximateDiscountedUnitPriceSet)
