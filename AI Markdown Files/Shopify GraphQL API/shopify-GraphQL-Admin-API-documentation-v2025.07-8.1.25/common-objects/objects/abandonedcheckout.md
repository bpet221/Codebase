---
title: "AbandonedCheckout"
description: "Shopify GraphQL Admin API documentation for abandonedcheckout"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout

Markdown Content:
AbandonedCheckout - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#queries)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#interfaces)
...
[Anchor to AbandonedCheckout](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#top)
Abandoned Checkout
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to abandonedCheckoutUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.abandonedCheckoutUrl)abandoned Checkout Url
...
[Anchor to billingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.billingAddress)billing Address
...
[Anchor to completedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.completedAt)completed At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

The date and time when the buyer completed the checkout. Null if the checkout has not been completed.

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.createdAt)created At
...
[Anchor to customAttributes](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.customAttributes)custom Attributes
...
[Anchor to customer](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.customer)customer
...
[Anchor to defaultCursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.defaultCursor)default Cursor
...
[Anchor to discountCodes](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.discountCodes)discount Codes
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.id)id
...
[Anchor to lineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.lineItems)line Items
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.name)name
...
[Anchor to note](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.note)note
...
[Anchor to shippingAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.shippingAddress)shipping Address
...
[Anchor to subtotalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.subtotalPriceSet)subtotal Price Set
...
[Anchor to taxesIncluded](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.taxesIncluded)taxes Included
...
[Anchor to taxLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.taxLines)tax Lines
...
[Anchor to totalDiscountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.totalDiscountSet)total Discount Set
...
[Anchor to totalDutiesSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.totalDutiesSet)total Duties Set
...
[Anchor to totalLineItemsPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.totalLineItemsPriceSet)total Line Items Price Set
...
[Anchor to totalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.totalPriceSet)total Price Set
...
[Anchor to totalTaxSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.totalTaxSet)total Tax Set
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.updatedAt)updated At
...
[Anchor to lineItemsQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#field-AbandonedCheckout.fields.lineItemsQuantity)line Items Quantity
...
*   <->[AbandonedCheckoutConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/AbandonedCheckoutConnection#field-nodes)
*   {}[AbandonedCheckoutEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckoutEdge#field-node)
*   {}[Abandonment.abandonedCheckoutPayload](https://shopify.dev/docs/api/admin-graphql/latest/objects/Abandonment#field-abandonedCheckoutPayload)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#queries)Queries
---------------------------------------------------------------------------------------------------------------

[Anchor to abandonedCheckouts](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#query-abandonedCheckouts)[abandoned Checkouts](https://shopify.dev/docs/api/admin-graphql/latest/queries/abandonedCheckouts)
...
*   <?>[abandoned Checkouts](https://shopify.dev/docs/api/admin-graphql/latest/queries/AbandonedCheckoutConnection)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to Navigable](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#interface-Navigable)[Navigable](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Navigable)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckout#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
