---
title: "currentStaffMember"
description: "Shopify GraphQL Admin API documentation for currentstaffmember"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/currentstaffmember"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/currentstaffmember

Markdown Content:
currentStaffMember - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/currentstaffmember#main-content)
...
[Anchor to currentStaffMember](https://shopify.dev/docs/api/admin-graphql/latest/queries/currentstaffmember#top)
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/currentstaffmember#possible-returns)Possible returns
-------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to StaffMember](https://shopify.dev/docs/api/admin-graphql/latest/queries/currentstaffmember#returns-StaffMember)Staff Member
