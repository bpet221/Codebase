---
title: "staffMembers"
description: "Shopify GraphQL Admin API documentation for staffmembers"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers

Markdown Content:
staffMembers - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#main-content)
...
[Anchor to staffMembers](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#top)
staff Members
=============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#arguments)
...
[Anchor to after](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#arguments-after)after

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come after the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to before](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#arguments-before)before

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come before the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to first](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#arguments-first)first

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to last](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#arguments-last)last

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#arguments-query)query
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#argument-query-filter-account_type)account_type
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#argument-query-filter-email)email

•string

Filter by email.

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#argument-query-filter-first_name)first_name

•string

Filter by first name.

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#argument-query-filter-id)id
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#argument-query-filter-last_name)last_name

•string

Filter by last name.

[Anchor to reverse](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#arguments-reverse)reverse
...
[Anchor to sortKey](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#arguments-sortKey)sort Key
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#possible-returns)Possible returns
-------------------------------------------------------------------------------------------------------------------------------------

[Anchor to edges](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#returns-edges)edges
...
[Anchor to nodes](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#returns-nodes)nodes
...
[Anchor to pageInfo](https://shopify.dev/docs/api/admin-graphql/latest/queries/staffmembers#returns-pageInfo)page Info
