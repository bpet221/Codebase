...
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/productfeed"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/productfeed

Markdown Content:
productFeed - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/productfeed#main-content)
...
[Anchor to productFeed](https://shopify.dev/docs/api/admin-graphql/latest/queries/productfeed#top)
product Feed
============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/productfeed#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/queries/productfeed#arguments-id)id
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/productfeed#possible-returns)Possible returns
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to ProductFeed](https://shopify.dev/docs/api/admin-graphql/latest/queries/productfeed#returns-ProductFeed)Product Feed
