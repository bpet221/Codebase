---
title: "paymentCustomizations"
description: "Shopify GraphQL Admin API documentation for paymentcustomizations"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations

Markdown Content:
paymentCustomizations - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#main-content)
...
[Anchor to paymentCustomizations](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#arguments)
...
[Anchor to after](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#arguments-after)after

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come after the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to before](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#arguments-before)before

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come before the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to first](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#arguments-first)first

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to last](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#arguments-last)last

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#arguments-query)query
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#argument-query-filter-enabled)enabled

•boolean

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#argument-query-filter-function_id)function_id

•string

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#argument-query-filter-id)id
...
[Anchor to reverse](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#arguments-reverse)reverse
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#possible-returns)Possible returns
----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to edges](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#returns-edges)edges
...
[Anchor to nodes](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#returns-nodes)nodes
...
[Anchor to pageInfo](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomizations#returns-pageInfo)page Info
