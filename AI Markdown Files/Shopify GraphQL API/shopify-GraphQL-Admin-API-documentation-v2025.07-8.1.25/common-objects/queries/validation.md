---
title: "validation"
description: "Shopify GraphQL Admin API documentation for validation"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/validation

Markdown Content:
validation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/validation#main-content)
...
[Anchor to validation](https://shopify.dev/docs/api/admin-graphql/latest/queries/validation#top)
validation
==========
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/validation#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/queries/validation#arguments-id)id
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/validation#possible-returns)Possible returns
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to Validation](https://shopify.dev/docs/api/admin-graphql/latest/queries/validation#returns-Validation)Validation
