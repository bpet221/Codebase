...
description: "Shopify GraphQL Admin API documentation for paymentcustomization"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomization"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomization

Markdown Content:
paymentCustomization - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomization#main-content)
...
[Anchor to paymentCustomization](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomization#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomization#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomization#arguments-id)id
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomization#possible-returns)Possible returns
---------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to PaymentCustomization](https://shopify.dev/docs/api/admin-graphql/latest/queries/paymentcustomization#returns-PaymentCustomization)Payment Customization
...
*   ### paymentCustomization reference
