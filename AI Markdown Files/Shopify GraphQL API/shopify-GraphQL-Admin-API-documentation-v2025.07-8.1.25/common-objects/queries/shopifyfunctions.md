---
title: "shopifyFunctions"
description: "Shopify GraphQL Admin API documentation for shopifyfunctions"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions

Markdown Content:
shopifyFunctions - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#main-content)
...
[Anchor to shopifyFunctions](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#top)
shopify Functions
=================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#arguments)
...
[Anchor to after](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#arguments-after)after

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come after the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to apiType](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#arguments-apiType)api Type

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

Filter the functions by the API type.

[Anchor to before](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#arguments-before)before

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come before the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to first](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#arguments-first)first

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to last](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#arguments-last)last

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to reverse](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#arguments-reverse)reverse
...
[Anchor to useCreationUi](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#arguments-useCreationUi)use Creation Ui
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#possible-returns)Possible returns
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to edges](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#returns-edges)edges
...
[Anchor to nodes](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#returns-nodes)nodes
...
[Anchor to pageInfo](https://shopify.dev/docs/api/admin-graphql/latest/queries/shopifyfunctions#returns-pageInfo)page Info
