---
title: "job"
description: "Shopify GraphQL Admin API documentation for job"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/job"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/job

Markdown Content:
job - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/job#main-content)
...
[Anchor to job](https://shopify.dev/docs/api/admin-graphql/latest/queries/job#top)
job
===
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/job#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/queries/job#arguments-id)id
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/job#possible-returns)Possible returns
----------------------------------------------------------------------------------------------------------------------------

[Anchor to Job](https://shopify.dev/docs/api/admin-graphql/latest/queries/job#returns-Job)Job
...
Show description[Open in GraphiQL](http://localhost:3457/graphiql?query=query%20%7B%0A%20%20job(id%3A%20%22gid%3A%2F%2Fshopify%2FJob%2Fdc9b2604-c73b-45c6-8942-e235bac987e8%22)%20%7B%0A%20%20%20%20id%0A%20%20%20%20done%0A%20%20%7D%0A%7D)Copy
