---
title: "customerPaymentMethodRevoke"
description: "Shopify GraphQL Admin API documentation for customerpaymentmethodrevoke"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodrevoke"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodrevoke

Markdown Content:
customerPaymentMethodRevoke - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodrevoke#main-content)
...
[Anchor to customerPaymentMethodRevoke](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodrevoke#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodrevoke#arguments)
Arguments
---------

[Anchor to customerPaymentMethodId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodrevoke#arguments-customerPaymentMethodId)customer Payment Method Id
...
[Anchor to CustomerPaymentMethodRevokePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodrevoke#returns)Customer Payment Method Revoke Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to revokedCustomerPaymentMethodId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodrevoke#returns-revokedCustomerPaymentMethodId)revoked Customer Payment Method Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the revoked customer payment method.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodrevoke#returns-userErrors)user Errors
