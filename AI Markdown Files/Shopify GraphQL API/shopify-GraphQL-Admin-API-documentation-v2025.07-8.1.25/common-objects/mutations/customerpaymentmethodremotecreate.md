---
title: "customerPaymentMethodRemoteCreate"
description: "Shopify GraphQL Admin API documentation for customerpaymentmethodremotecreate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate

Markdown Content:
customerPaymentMethodRemoteCreate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate#main-content)
...
[Anchor to customerPaymentMethodRemoteCreate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate#arguments)
Arguments
---------

[Anchor to customerId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate#arguments-customerId)customer Id
...
[Anchor to remoteReference](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate#arguments-remoteReference)remote Reference
...
[Anchor to CustomerPaymentMethodRemoteCreatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate#returns)Customer Payment Method Remote Create Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to customerPaymentMethod](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate#returns-customerPaymentMethod)customer Payment Method
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodremotecreate#returns-userErrors)user Errors
