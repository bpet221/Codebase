---
title: "savedSearchUpdate"
description: "Shopify GraphQL Admin API documentation for savedsearchupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedsearchupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedsearchupdate

Markdown Content:
savedSearchUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedsearchupdate#main-content)
...
[Anchor to savedSearchUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedsearchupdate#top)
saved Search Update
===================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedsearchupdate#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedsearchupdate#arguments-input)input
...
[Anchor to SavedSearchUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedsearchupdate#returns)Saved Search Update Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to savedSearch](https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedsearchupdate#returns-savedSearch)saved Search
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/savedsearchupdate#returns-userErrors)user Errors
