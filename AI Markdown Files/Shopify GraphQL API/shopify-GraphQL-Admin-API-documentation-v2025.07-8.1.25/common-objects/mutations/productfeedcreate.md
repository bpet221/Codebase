---
title: "productFeedCreate"
description: "Shopify GraphQL Admin API documentation for productfeedcreate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeedcreate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeedcreate

Markdown Content:
productFeedCreate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeedcreate#main-content)
...
[Anchor to productFeedCreate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeedcreate#top)
product Feed Create
===================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeedcreate#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeedcreate#arguments-input)input
...
[Anchor to ProductFeedCreatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeedcreate#returns)Product Feed Create Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to productFeed](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeedcreate#returns-productFeed)product Feed
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeedcreate#returns-userErrors)user Errors
