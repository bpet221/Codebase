---
title: "giftCardCredit"
description: "Shopify GraphQL Admin API documentation for giftcardcredit"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit

Markdown Content:
giftCardCredit - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit#main-content)
...
[Anchor to giftCardCredit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit#top)
gift Card Credit
================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit#arguments)
Arguments
---------

[Anchor to creditInput](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit#arguments-creditInput)credit Input
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit#arguments-id)id
...
[Anchor to GiftCardCreditPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit#returns)Gift Card Credit Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to giftCardCreditTransaction](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit#returns-giftCardCreditTransaction)gift Card Credit Transaction
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardcredit#returns-userErrors)user Errors
