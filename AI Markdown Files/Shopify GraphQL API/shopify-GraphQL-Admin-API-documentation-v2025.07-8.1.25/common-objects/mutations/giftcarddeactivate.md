...
description: "Shopify GraphQL Admin API documentation for giftcarddeactivate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcarddeactivate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcarddeactivate

Markdown Content:
giftCardDeactivate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcarddeactivate#main-content)
...
[Anchor to giftCardDeactivate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcarddeactivate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcarddeactivate#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcarddeactivate#arguments-id)id
...
[Anchor to GiftCardDeactivatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcarddeactivate#returns)Gift Card Deactivate Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to giftCard](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcarddeactivate#returns-giftCard)gift Card
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcarddeactivate#returns-userErrors)user Errors
...
[Open in GraphiQL](http://localhost:3457/graphiql?query=mutation%20giftCardDeactivate(%24id%3A%20ID!)%20%7B%0A%20%20giftCardDeactivate(id%3A%20%24id)%20%7B%0A%20%20%20%20giftCard%20%7B%0A%20%20%20%20%20%20id%0A%20%20%20%20%20%20deactivatedAt%0A%20%20%20%20%7D%0A%20%20%20%20userErrors%20%7B%0A%20%20%20%20%20%20message%0A%20%20%20%20%20%20field%0A%20%20%20%20%20%20code%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D&variables=%7B%0A%20%20%22id%22%3A%20%22gid%3A%2F%2Fshopify%2FGiftCard%2F411106674%22%0A%7D)Copy
