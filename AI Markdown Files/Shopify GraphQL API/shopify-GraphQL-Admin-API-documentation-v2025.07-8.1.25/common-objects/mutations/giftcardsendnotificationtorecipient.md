---
title: "giftCardSendNotificationToRecipient"
description: "Shopify GraphQL Admin API documentation for giftcardsendnotificationtorecipient"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardsendnotificationtorecipient"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardsendnotificationtorecipient

Markdown Content:
giftCardSendNotificationToRecipient - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardsendnotificationtorecipient#main-content)
...
[Anchor to giftCardSendNotificationToRecipient](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardsendnotificationtorecipient#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardsendnotificationtorecipient#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardsendnotificationtorecipient#arguments-id)id
...
[Anchor to GiftCardSendNotificationToRecipientPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardsendnotificationtorecipient#returns)Gift Card Send Notification To Recipient Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to giftCard](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardsendnotificationtorecipient#returns-giftCard)gift Card
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftcardsendnotificationtorecipient#returns-userErrors)user Errors
...
[Open in GraphiQL](http://localhost:3457/graphiql?query=mutation%20giftCardSendNotificationToRecipient(%24id%3A%20ID!)%20%7B%0A%20%20giftCardSendNotificationToRecipient(id%3A%20%24id)%20%7B%0A%20%20%20%20giftCard%20%7B%0A%20%20%20%20%20%20id%0A%20%20%20%20%20%20recipientAttributes%20%7B%0A%20%20%20%20%20%20%20%20recipient%20%7B%0A%20%20%20%20%20%20%20%20%20%20id%0A%20%20%20%20%20%20%20%20%7D%0A%20%20%20%20%20%20%7D%0A%20%20%20%20%7D%0A%20%20%20%20userErrors%20%7B%0A%20%20%20%20%20%20message%0A%20%20%20%20%20%20field%0A%20%20%20%20%20%20code%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D&variables=%7B%0A%20%20%22id%22%3A%20%22gid%3A%2F%2Fshopify%2FGiftCard%2F698360200%22%0A%7D)Copy
