---
title: "marketRegionsDelete"
description: "Shopify GraphQL Admin API documentation for marketregionsdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketregionsdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketregionsdelete

Markdown Content:
marketRegionsDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketregionsdelete#main-content)
...
[Anchor to marketRegionsDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketregionsdelete#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketregionsdelete#arguments)
Arguments
---------

[Anchor to ids](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketregionsdelete#arguments-ids)ids
...
[Anchor to MarketRegionsDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketregionsdelete#returns)Market Regions Delete Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketregionsdelete#returns-deletedIds)deleted Ids

•[[ID!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the deleted market region.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketregionsdelete#returns-userErrors)user Errors
