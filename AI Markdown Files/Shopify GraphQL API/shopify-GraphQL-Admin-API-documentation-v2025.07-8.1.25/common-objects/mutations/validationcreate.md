...
description: "Shopify GraphQL Admin API documentation for validationcreate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationcreate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationcreate

Markdown Content:
validationCreate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationcreate#main-content)
...
[Anchor to validationCreate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationcreate#top)
validation Create
=================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationcreate#arguments)
Arguments
---------

[Anchor to validation](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationcreate#arguments-validation)validation
...
[Anchor to ValidationCreatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationcreate#returns)Validation Create Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationcreate#returns-userErrors)user Errors
...
[Anchor to validation](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationcreate#returns-validation)validation
