---
title: "stagedUploadTargetGenerate"
description: "Shopify GraphQL Admin API documentation for stageduploadtargetgenerate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate

Markdown Content:
stagedUploadTargetGenerate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate#main-content)
...
[Anchor to stagedUploadTargetGenerate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate#arguments-input)input
...
[Anchor to StagedUploadTargetGeneratePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate#returns)Staged Upload Target Generate Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to parameters](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate#returns-parameters)parameters
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate#returns-url)url
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/stageduploadtargetgenerate#returns-userErrors)user Errors
