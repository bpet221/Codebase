---
title: "webPresenceDelete"
description: "Shopify GraphQL Admin API documentation for webpresencedelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpresencedelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpresencedelete

Markdown Content:
webPresenceDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpresencedelete#main-content)
...
[Anchor to webPresenceDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpresencedelete#top)
web Presence Delete
===================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpresencedelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpresencedelete#arguments-id)id
...
[Anchor to WebPresenceDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpresencedelete#returns)Web Presence Delete Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpresencedelete#returns-deletedId)deleted Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the deleted web presence.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpresencedelete#returns-userErrors)user Errors
