---
title: "customerPaymentMethodPaypalBillingAgreementCreate"
description: "Shopify GraphQL Admin API documentation for customerpaymentmethodpaypalbillingagreementcreate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate

Markdown Content:
customerPaymentMethodPaypalBillingAgreementCreate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#main-content)
...
[Anchor to customerPaymentMethodPaypalBillingAgreementCreate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#arguments)
Arguments
---------

[Anchor to billingAddress](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#arguments-billingAddress)billing Address
...
[Anchor to billingAgreementId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#arguments-billingAgreementId)billing Agreement Id
...
[Anchor to customerId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#arguments-customerId)customer Id
...
[Anchor to inactive](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#arguments-inactive)inactive
...
[Anchor to CustomerPaymentMethodPaypalBillingAgreementCreatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#returns)Customer Payment Method Paypal Billing Agreement Create Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to customerPaymentMethod](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#returns-customerPaymentMethod)customer Payment Method
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodpaypalbillingagreementcreate#returns-userErrors)user Errors
