---
title: "customerPaymentMethodGetUpdateUrl"
description: "Shopify GraphQL Admin API documentation for customerpaymentmethodgetupdateurl"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodgetupdateurl"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodgetupdateurl

Markdown Content:
customerPaymentMethodGetUpdateUrl - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodgetupdateurl#main-content)
...
[Anchor to customerPaymentMethodGetUpdateUrl](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodgetupdateurl#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodgetupdateurl#arguments)
Arguments
---------

[Anchor to customerPaymentMethodId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodgetupdateurl#arguments-customerPaymentMethodId)customer Payment Method Id
...
[Anchor to CustomerPaymentMethodGetUpdateUrlPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodgetupdateurl#returns)Customer Payment Method Get Update Url Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to updatePaymentMethodUrl](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodgetupdateurl#returns-updatePaymentMethodUrl)update Payment Method Url

•[URL](https://shopify.dev/docs/api/admin-graphql/latest/scalars/URL)

The URL to redirect the customer to update the payment method.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerpaymentmethodgetupdateurl#returns-userErrors)user Errors
