---
title: "productFeedDelete"
description: "Shopify GraphQL Admin API documentation for productfeeddelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeeddelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeeddelete

Markdown Content:
productFeedDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeeddelete#main-content)
...
[Anchor to productFeedDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeeddelete#top)
product Feed Delete
===================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeeddelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeeddelete#arguments-id)id
...
[Anchor to ProductFeedDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeeddelete#returns)Product Feed Delete Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeeddelete#returns-deletedId)deleted Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the product feed that was deleted.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productfeeddelete#returns-userErrors)user Errors
