---
title: "fulfillmentConstraintRuleDelete"
description: "Shopify GraphQL Admin API documentation for fulfillmentconstraintruledelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentconstraintruledelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentconstraintruledelete

Markdown Content:
fulfillmentConstraintRuleDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentconstraintruledelete#main-content)
...
[Anchor to fulfillmentConstraintRuleDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentconstraintruledelete#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentconstraintruledelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentconstraintruledelete#arguments-id)id
...
[Anchor to FulfillmentConstraintRuleDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentconstraintruledelete#returns)Fulfillment Constraint Rule Delete Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to success](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentconstraintruledelete#returns-success)success

•[Boolean](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Boolean)

Whether or not the fulfillment constraint rule was successfully deleted.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentconstraintruledelete#returns-userErrors)user Errors
