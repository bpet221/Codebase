---
title: "validationDelete"
description: "Shopify GraphQL Admin API documentation for validationdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationdelete

Markdown Content:
validationDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationdelete#main-content)
...
[Anchor to validationDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationdelete#top)
validation Delete
=================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationdelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationdelete#arguments-id)id
...
[Anchor to ValidationDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationdelete#returns)Validation Delete Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationdelete#returns-deletedId)deleted Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

Returns the deleted validation ID.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/validationdelete#returns-userErrors)user Errors
