...
description: "Shopify GraphQL Admin API documentation for ordercancelusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror"
...
Title: OrderCancelUserError - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror

Markdown Content:
OrderCancelUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#interfaces)
...
[Anchor to OrderCancelUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#top)
Order Cancel User Error
=======================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#field-OrderCancelUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#field-OrderCancelUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#field-OrderCancelUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------

[Anchor to orderCancel](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#mutation-orderCancel)[order Cancel](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderCancel)
...
<~>OrderCancelUserError Mutations
---------------------------------
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancelusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
...
||-OrderCancelUserError Implements
----------------------------------
