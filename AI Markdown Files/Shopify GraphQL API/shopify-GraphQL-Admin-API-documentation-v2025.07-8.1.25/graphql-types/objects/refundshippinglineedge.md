---
title: "RefundShippingLineEdge"
description: "Shopify GraphQL Admin API documentation for refundshippinglineedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippinglineedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippinglineedge

Markdown Content:
RefundShippingLineEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippinglineedge#main-content)
...
[Anchor to RefundShippingLineEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippinglineedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippinglineedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippinglineedge#field-RefundShippingLineEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippinglineedge#field-RefundShippingLineEdge.fields.node)node
...
*   <->[RefundShippingLineConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/RefundShippingLineConnection#field-edges)
