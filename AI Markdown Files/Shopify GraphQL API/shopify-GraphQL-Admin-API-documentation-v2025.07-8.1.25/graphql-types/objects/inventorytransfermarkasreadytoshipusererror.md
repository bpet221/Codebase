---
title: "InventoryTransferMarkAsReadyToShipUserError"
description: "Shopify GraphQL Admin API documentation for inventorytransfermarkasreadytoshipusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror

Markdown Content:
InventoryTransferMarkAsReadyToShipUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#interfaces)
...
[Anchor to InventoryTransferMarkAsReadyToShipUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#field-InventoryTransferMarkAsReadyToShipUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#field-InventoryTransferMarkAsReadyToShipUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#field-InventoryTransferMarkAsReadyToShipUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to inventoryTransferMarkAsReadyToShip](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#mutation-inventoryTransferMarkAsReadyToShip)[inventory Transfer Mark As Ready To Ship](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryTransferMarkAsReadyToShip)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfermarkasreadytoshipusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
