---
title: "TaxonomyCategoryEdge"
description: "Shopify GraphQL Admin API documentation for taxonomycategoryedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryedge"
...
Title: TaxonomyCategoryEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryedge

Markdown Content:
TaxonomyCategoryEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryedge#main-content)
...
[Anchor to TaxonomyCategoryEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryedge#top)
Taxonomy Category Edge
======================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryedge#field-TaxonomyCategoryEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryedge#field-TaxonomyCategoryEdge.fields.node)node
...
*   <->[TaxonomyCategoryConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/TaxonomyCategoryConnection#field-edges)
