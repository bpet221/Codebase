...
description: "Shopify GraphQL Admin API documentation for appinstallationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appinstallationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appinstallationedge

Markdown Content:
AppInstallationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appinstallationedge#main-content)
...
[Anchor to AppInstallationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/appinstallationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appinstallationedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/appinstallationedge#field-AppInstallationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/appinstallationedge#field-AppInstallationEdge.fields.node)node
...
*   <->[AppInstallationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/AppInstallationConnection#field-edges)
