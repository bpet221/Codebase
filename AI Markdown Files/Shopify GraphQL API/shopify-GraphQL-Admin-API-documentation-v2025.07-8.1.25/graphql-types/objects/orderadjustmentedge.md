---
title: "OrderAdjustmentEdge"
description: "Shopify GraphQL Admin API documentation for orderadjustmentedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustmentedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustmentedge

Markdown Content:
OrderAdjustmentEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustmentedge#main-content)
...
[Anchor to OrderAdjustmentEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustmentedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustmentedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustmentedge#field-OrderAdjustmentEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustmentedge#field-OrderAdjustmentEdge.fields.node)node
...
*   <->[OrderAdjustmentConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/OrderAdjustmentConnection#field-edges)
