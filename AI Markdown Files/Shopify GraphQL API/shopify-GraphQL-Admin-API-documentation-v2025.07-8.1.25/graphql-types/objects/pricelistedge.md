---
title: "PriceListEdge"
description: "Shopify GraphQL Admin API documentation for pricelistedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistedge"
...
Title: PriceListEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistedge

Markdown Content:
PriceListEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistedge#main-content)
...
[Anchor to PriceListEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistedge#top)
Price List Edge
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistedge#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistedge#field-PriceListEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistedge#field-PriceListEdge.fields.node)node
...
*   <->[PriceListConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/PriceListConnection#field-edges)
