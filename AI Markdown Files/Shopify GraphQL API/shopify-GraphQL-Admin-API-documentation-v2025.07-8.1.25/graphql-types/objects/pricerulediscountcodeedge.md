---
title: "PriceRuleDiscountCodeEdge"
description: "Shopify GraphQL Admin API documentation for pricerulediscountcodeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulediscountcodeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulediscountcodeedge

Markdown Content:
PriceRuleDiscountCodeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulediscountcodeedge#main-content)
...
[Anchor to PriceRuleDiscountCodeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulediscountcodeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulediscountcodeedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulediscountcodeedge#field-PriceRuleDiscountCodeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulediscountcodeedge#field-PriceRuleDiscountCodeEdge.fields.node)node
...
*   <->[PriceRuleDiscountCodeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/PriceRuleDiscountCodeConnection#field-edges)
