---
title: "BlogEdge"
description: "Shopify GraphQL Admin API documentation for blogedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/blogedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/blogedge

Markdown Content:
BlogEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogedge#main-content)
...
[Anchor to BlogEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogedge#top)
Blog Edge
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogedge#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogedge#field-BlogEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogedge#field-BlogEdge.fields.node)node
...
*   <->[BlogConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/BlogConnection#field-edges)
