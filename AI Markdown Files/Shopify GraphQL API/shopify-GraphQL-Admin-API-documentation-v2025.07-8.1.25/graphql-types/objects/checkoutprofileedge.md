---
title: "CheckoutProfileEdge"
description: "Shopify GraphQL Admin API documentation for checkoutprofileedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofileedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofileedge

Markdown Content:
CheckoutProfileEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofileedge#main-content)
...
[Anchor to CheckoutProfileEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofileedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofileedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofileedge#field-CheckoutProfileEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/checkoutprofileedge#field-CheckoutProfileEdge.fields.node)node
...
*   <->[CheckoutProfileConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CheckoutProfileConnection#field-edges)
