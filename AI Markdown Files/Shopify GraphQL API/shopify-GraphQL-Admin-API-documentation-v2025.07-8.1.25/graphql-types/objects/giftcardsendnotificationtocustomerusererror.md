---
title: "GiftCardSendNotificationToCustomerUserError"
description: "Shopify GraphQL Admin API documentation for giftcardsendnotificationtocustomerusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror

Markdown Content:
GiftCardSendNotificationToCustomerUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#interfaces)
...
[Anchor to GiftCardSendNotificationToCustomerUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#field-GiftCardSendNotificationToCustomerUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#field-GiftCardSendNotificationToCustomerUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#field-GiftCardSendNotificationToCustomerUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to giftCardSendNotificationToCustomer](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#mutation-giftCardSendNotificationToCustomer)[gift Card Send Notification To Customer](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftCardSendNotificationToCustomer)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtocustomerusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
