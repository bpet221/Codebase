---
title: "DeliveryLocationGroupZoneEdge"
description: "Shopify GraphQL Admin API documentation for deliverylocationgroupzoneedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzoneedge"
...
Title: DeliveryLocationGroupZoneEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzoneedge

Markdown Content:
DeliveryLocationGroupZoneEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzoneedge#main-content)
...
[Anchor to DeliveryLocationGroupZoneEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzoneedge#top)
Delivery Location Group Zone Edge
=================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzoneedge#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzoneedge#field-DeliveryLocationGroupZoneEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzoneedge#field-DeliveryLocationGroupZoneEdge.fields.node)node
...
*   <->[DeliveryLocationGroupZoneConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryLocationGroupZoneConnection#field-edges)
