---
title: "OrderEditRemoveDiscountUserError"
description: "Shopify GraphQL Admin API documentation for ordereditremovediscountusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror

Markdown Content:
OrderEditRemoveDiscountUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#interfaces)
...
[Anchor to OrderEditRemoveDiscountUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#field-OrderEditRemoveDiscountUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#field-OrderEditRemoveDiscountUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#field-OrderEditRemoveDiscountUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to orderEditRemoveDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#mutation-orderEditRemoveDiscount)[order Edit Remove Discount](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderEditRemoveDiscount)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditremovediscountusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
