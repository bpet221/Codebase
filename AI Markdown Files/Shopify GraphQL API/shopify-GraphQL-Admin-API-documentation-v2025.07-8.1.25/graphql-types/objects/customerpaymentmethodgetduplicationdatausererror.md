---
title: "CustomerPaymentMethodGetDuplicationDataUserError"
description: "Shopify GraphQL Admin API documentation for customerpaymentmethodgetduplicationdatausererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror

Markdown Content:
CustomerPaymentMethodGetDuplicationDataUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#interfaces)
...
[Anchor to CustomerPaymentMethodGetDuplicationDataUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#field-CustomerPaymentMethodGetDuplicationDataUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#field-CustomerPaymentMethodGetDuplicationDataUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#field-CustomerPaymentMethodGetDuplicationDataUserError.fields.message)message
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodgetduplicationdatausererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
