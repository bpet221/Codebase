---
title: "MetaobjectDefinitionEdge"
description: "Shopify GraphQL Admin API documentation for metaobjectdefinitionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectdefinitionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectdefinitionedge

Markdown Content:
MetaobjectDefinitionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectdefinitionedge#main-content)
...
[Anchor to MetaobjectDefinitionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectdefinitionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectdefinitionedge#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectdefinitionedge#field-MetaobjectDefinitionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectdefinitionedge#field-MetaobjectDefinitionEdge.fields.node)node
...
*   <->[MetaobjectDefinitionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MetaobjectDefinitionConnection#field-edges)
