---
title: "DiscountAutomaticNodeEdge"
description: "Shopify GraphQL Admin API documentation for discountautomaticnodeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticnodeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticnodeedge

Markdown Content:
DiscountAutomaticNodeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticnodeedge#main-content)
...
[Anchor to DiscountAutomaticNodeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticnodeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticnodeedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticnodeedge#field-DiscountAutomaticNodeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticnodeedge#field-DiscountAutomaticNodeEdge.fields.node)node
...
*   <->[DiscountAutomaticNodeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DiscountAutomaticNodeConnection#field-edges)
