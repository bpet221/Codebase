---
title: "AbandonedCheckoutLineItemEdge"
description: "Shopify GraphQL Admin API documentation for abandonedcheckoutlineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemedge

Markdown Content:
AbandonedCheckoutLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemedge#main-content)
...
[Anchor to AbandonedCheckoutLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemedge#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemedge#field-AbandonedCheckoutLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutlineitemedge#field-AbandonedCheckoutLineItemEdge.fields.node)node
...
*   <->[AbandonedCheckoutLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/AbandonedCheckoutLineItemConnection#field-edges)
