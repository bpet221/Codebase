---
title: "DiscountCodeNodeEdge"
description: "Shopify GraphQL Admin API documentation for discountcodenodeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodenodeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodenodeedge

Markdown Content:
DiscountCodeNodeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodenodeedge#main-content)
...
[Anchor to DiscountCodeNodeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodenodeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodenodeedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodenodeedge#field-DiscountCodeNodeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodenodeedge#field-DiscountCodeNodeEdge.fields.node)node
...
*   <->[DiscountCodeNodeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DiscountCodeNodeConnection#field-edges)
