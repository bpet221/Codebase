---
title: "BlogUpdateUserError"
description: "Shopify GraphQL Admin API documentation for blogupdateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror

Markdown Content:
BlogUpdateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#interfaces)
...
[Anchor to BlogUpdateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#field-BlogUpdateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#field-BlogUpdateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#field-BlogUpdateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------

[Anchor to blogUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#mutation-blogUpdate)[blog Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/blogUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogupdateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
