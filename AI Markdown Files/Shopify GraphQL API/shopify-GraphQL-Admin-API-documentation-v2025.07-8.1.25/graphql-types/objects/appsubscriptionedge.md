---
title: "AppSubscriptionEdge"
description: "Shopify GraphQL Admin API documentation for appsubscriptionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptionedge

Markdown Content:
AppSubscriptionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptionedge#main-content)
...
[Anchor to AppSubscriptionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptionedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptionedge#field-AppSubscriptionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptionedge#field-AppSubscriptionEdge.fields.node)node
...
*   <->[AppSubscriptionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/AppSubscriptionConnection#field-edges)
