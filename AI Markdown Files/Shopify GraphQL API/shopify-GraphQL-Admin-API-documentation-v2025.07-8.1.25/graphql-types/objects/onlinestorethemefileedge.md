---
title: "OnlineStoreThemeFileEdge"
description: "Shopify GraphQL Admin API documentation for onlinestorethemefileedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefileedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefileedge

Markdown Content:
OnlineStoreThemeFileEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefileedge#main-content)
...
[Anchor to OnlineStoreThemeFileEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefileedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefileedge#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefileedge#field-OnlineStoreThemeFileEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefileedge#field-OnlineStoreThemeFileEdge.fields.node)node
...
*   <->[OnlineStoreThemeFileConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/OnlineStoreThemeFileConnection#field-edges)
