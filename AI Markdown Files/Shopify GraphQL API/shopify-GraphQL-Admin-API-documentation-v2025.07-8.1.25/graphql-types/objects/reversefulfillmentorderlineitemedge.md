---
title: "ReverseFulfillmentOrderLineItemEdge"
description: "Shopify GraphQL Admin API documentation for reversefulfillmentorderlineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitemedge

Markdown Content:
ReverseFulfillmentOrderLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitemedge#main-content)
...
[Anchor to ReverseFulfillmentOrderLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitemedge#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitemedge#field-ReverseFulfillmentOrderLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitemedge#field-ReverseFulfillmentOrderLineItemEdge.fields.node)node
...
*   <->[ReverseFulfillmentOrderLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReverseFulfillmentOrderLineItemConnection#field-edges)
