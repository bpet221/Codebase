---
title: "PubSubWebhookSubscriptionCreateUserError"
description: "Shopify GraphQL Admin API documentation for pubsubwebhooksubscriptioncreateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror

Markdown Content:
PubSubWebhookSubscriptionCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#interfaces)
...
[Anchor to PubSubWebhookSubscriptionCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#field-PubSubWebhookSubscriptionCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#field-PubSubWebhookSubscriptionCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#field-PubSubWebhookSubscriptionCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to pubSubWebhookSubscriptionCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#mutation-pubSubWebhookSubscriptionCreate)[pub Sub Webhook Subscription Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pubSubWebhookSubscriptionCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptioncreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
