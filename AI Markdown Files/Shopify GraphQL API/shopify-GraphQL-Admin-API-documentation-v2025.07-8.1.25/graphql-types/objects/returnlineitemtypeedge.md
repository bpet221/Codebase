---
title: "ReturnLineItemTypeEdge"
description: "Shopify GraphQL Admin API documentation for returnlineitemtypeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitemtypeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitemtypeedge

Markdown Content:
ReturnLineItemTypeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitemtypeedge#main-content)
...
[Anchor to ReturnLineItemTypeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitemtypeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitemtypeedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitemtypeedge#field-ReturnLineItemTypeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitemtypeedge#field-ReturnLineItemTypeEdge.fields.node)node
...
*   <->[ReturnLineItemTypeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReturnLineItemTypeConnection#field-edges)
