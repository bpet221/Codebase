...
description: "Shopify GraphQL Admin API documentation for ordertransactionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/ordertransactionedge"
...
Title: OrderTransactionEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/ordertransactionedge

Markdown Content:
OrderTransactionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordertransactionedge#main-content)
...
[Anchor to OrderTransactionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordertransactionedge#top)
Order Transaction Edge
======================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordertransactionedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordertransactionedge#field-OrderTransactionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordertransactionedge#field-OrderTransactionEdge.fields.node)node
...
*   <->[OrderTransactionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/OrderTransactionConnection#field-edges)
