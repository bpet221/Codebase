---
title: "InventoryShipmentUpdateItemQuantitiesUserError"
description: "Shopify GraphQL Admin API documentation for inventoryshipmentupdateitemquantitiesusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror

Markdown Content:
InventoryShipmentUpdateItemQuantitiesUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#interfaces)
...
[Anchor to InventoryShipmentUpdateItemQuantitiesUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#field-InventoryShipmentUpdateItemQuantitiesUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#field-InventoryShipmentUpdateItemQuantitiesUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#field-InventoryShipmentUpdateItemQuantitiesUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to inventoryShipmentUpdateItemQuantities](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#mutation-inventoryShipmentUpdateItemQuantities)[inventory Shipment Update Item Quantities](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryShipmentUpdateItemQuantities)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryshipmentupdateitemquantitiesusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
