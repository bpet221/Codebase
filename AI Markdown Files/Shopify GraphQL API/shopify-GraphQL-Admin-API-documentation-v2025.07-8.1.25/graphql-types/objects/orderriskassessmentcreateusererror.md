---
title: "OrderRiskAssessmentCreateUserError"
description: "Shopify GraphQL Admin API documentation for orderriskassessmentcreateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror

Markdown Content:
OrderRiskAssessmentCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#interfaces)
...
[Anchor to OrderRiskAssessmentCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#field-OrderRiskAssessmentCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#field-OrderRiskAssessmentCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#field-OrderRiskAssessmentCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to orderRiskAssessmentCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#mutation-orderRiskAssessmentCreate)[order Risk Assessment Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderRiskAssessmentCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessmentcreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
