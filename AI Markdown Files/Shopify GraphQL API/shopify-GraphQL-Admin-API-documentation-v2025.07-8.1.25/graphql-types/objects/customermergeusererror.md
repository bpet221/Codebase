---
title: "CustomerMergeUserError"
description: "Shopify GraphQL Admin API documentation for customermergeusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror

Markdown Content:
CustomerMergeUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#interfaces)
...
[Anchor to CustomerMergeUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#field-CustomerMergeUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#field-CustomerMergeUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#field-CustomerMergeUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------

[Anchor to customerMerge](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#mutation-customerMerge)[customer Merge](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerMerge)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
