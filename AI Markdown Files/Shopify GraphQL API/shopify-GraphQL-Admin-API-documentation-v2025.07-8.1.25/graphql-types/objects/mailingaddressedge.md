---
title: "MailingAddressEdge"
description: "Shopify GraphQL Admin API documentation for mailingaddressedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/mailingaddressedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mailingaddressedge

Markdown Content:
MailingAddressEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mailingaddressedge#main-content)
...
[Anchor to MailingAddressEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/mailingaddressedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mailingaddressedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/mailingaddressedge#field-MailingAddressEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/mailingaddressedge#field-MailingAddressEdge.fields.node)node
...
*   <->[MailingAddressConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MailingAddressConnection#field-edges)
