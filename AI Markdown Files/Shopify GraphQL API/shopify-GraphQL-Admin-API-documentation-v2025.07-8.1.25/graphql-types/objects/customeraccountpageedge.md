---
title: "CustomerAccountPageEdge"
description: "Shopify GraphQL Admin API documentation for customeraccountpageedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountpageedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountpageedge

Markdown Content:
CustomerAccountPageEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountpageedge#main-content)
...
[Anchor to CustomerAccountPageEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountpageedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountpageedge#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountpageedge#field-CustomerAccountPageEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountpageedge#field-CustomerAccountPageEdge.fields.node)node
...
*   <->[CustomerAccountPageConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CustomerAccountPageConnection#field-edges)
