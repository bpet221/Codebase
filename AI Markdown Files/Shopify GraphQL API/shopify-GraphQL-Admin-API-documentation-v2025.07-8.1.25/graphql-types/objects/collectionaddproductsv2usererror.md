---
title: "CollectionAddProductsV2UserError"
description: "Shopify GraphQL Admin API documentation for collectionaddproductsv2usererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror

Markdown Content:
CollectionAddProductsV2UserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#interfaces)
...
[Anchor to CollectionAddProductsV2UserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#field-CollectionAddProductsV2UserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#field-CollectionAddProductsV2UserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#field-CollectionAddProductsV2UserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to collectionAddProductsV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#mutation-collectionAddProductsV2)[collection Add Products V2](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionAddProductsV2)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionaddproductsv2usererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
