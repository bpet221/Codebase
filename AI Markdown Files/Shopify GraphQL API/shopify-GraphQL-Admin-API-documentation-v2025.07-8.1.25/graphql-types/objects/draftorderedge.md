---
title: "DraftOrderEdge"
description: "Shopify GraphQL Admin API documentation for draftorderedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderedge

Markdown Content:
DraftOrderEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderedge#main-content)
...
[Anchor to DraftOrderEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderedge#top)
Draft Order Edge
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderedge#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderedge#field-DraftOrderEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderedge#field-DraftOrderEdge.fields.node)node
...
*   <->[DraftOrderConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DraftOrderConnection#field-edges)
