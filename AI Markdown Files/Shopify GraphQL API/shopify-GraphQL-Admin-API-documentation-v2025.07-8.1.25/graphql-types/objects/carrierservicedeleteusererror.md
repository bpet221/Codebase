---
title: "CarrierServiceDeleteUserError"
description: "Shopify GraphQL Admin API documentation for carrierservicedeleteusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror

Markdown Content:
CarrierServiceDeleteUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#interfaces)
...
[Anchor to CarrierServiceDeleteUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#field-CarrierServiceDeleteUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#field-CarrierServiceDeleteUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#field-CarrierServiceDeleteUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to carrierServiceDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#mutation-carrierServiceDelete)[carrier Service Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/carrierServiceDelete)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicedeleteusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
