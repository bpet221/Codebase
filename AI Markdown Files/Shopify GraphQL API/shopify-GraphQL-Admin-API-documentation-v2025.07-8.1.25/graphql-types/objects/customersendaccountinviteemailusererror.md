---
title: "CustomerSendAccountInviteEmailUserError"
description: "Shopify GraphQL Admin API documentation for customersendaccountinviteemailusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror

Markdown Content:
CustomerSendAccountInviteEmailUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#interfaces)
...
[Anchor to CustomerSendAccountInviteEmailUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#fields)Fields
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#field-CustomerSendAccountInviteEmailUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#field-CustomerSendAccountInviteEmailUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#field-CustomerSendAccountInviteEmailUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to customerSendAccountInviteEmail](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#mutation-customerSendAccountInviteEmail)[customer Send Account Invite Email](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerSendAccountInviteEmail)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersendaccountinviteemailusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
