---
title: "ImageEdge"
description: "Shopify GraphQL Admin API documentation for imageedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/imageedge"
...
Title: ImageEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/imageedge

Markdown Content:
ImageEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageedge#main-content)
...
[Anchor to ImageEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageedge#top)
Image Edge
==========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageedge#fields)Fields
----------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageedge#field-ImageEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/imageedge#field-ImageEdge.fields.node)node
...
*   <->[ImageConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ImageConnection#field-edges)
