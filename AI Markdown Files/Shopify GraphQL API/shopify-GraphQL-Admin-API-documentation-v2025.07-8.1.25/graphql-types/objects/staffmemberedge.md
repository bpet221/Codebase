---
title: "StaffMemberEdge"
description: "Shopify GraphQL Admin API documentation for staffmemberedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/staffmemberedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/staffmemberedge

Markdown Content:
StaffMemberEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/staffmemberedge#main-content)
...
[Anchor to StaffMemberEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/staffmemberedge#top)
Staff Member Edge
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/staffmemberedge#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/staffmemberedge#field-StaffMemberEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/staffmemberedge#field-StaffMemberEdge.fields.node)node
...
*   <->[StaffMemberConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/StaffMemberConnection#field-edges)
