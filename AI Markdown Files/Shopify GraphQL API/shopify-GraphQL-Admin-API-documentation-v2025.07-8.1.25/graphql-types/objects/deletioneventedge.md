---
title: "DeletionEventEdge"
description: "Shopify GraphQL Admin API documentation for deletioneventedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deletioneventedge"
...
Title: DeletionEventEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deletioneventedge

Markdown Content:
DeletionEventEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deletioneventedge#main-content)
...
[Anchor to DeletionEventEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/deletioneventedge#top)
Deletion Event Edge
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deletioneventedge#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/deletioneventedge#field-DeletionEventEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deletioneventedge#field-DeletionEventEdge.fields.node)node
...
*   <->[DeletionEventConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeletionEventConnection#field-edges)
