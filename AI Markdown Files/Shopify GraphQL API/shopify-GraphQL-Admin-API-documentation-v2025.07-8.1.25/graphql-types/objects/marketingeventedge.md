---
title: "MarketingEventEdge"
description: "Shopify GraphQL Admin API documentation for marketingeventedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingeventedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingeventedge

Markdown Content:
MarketingEventEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingeventedge#main-content)
...
[Anchor to MarketingEventEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingeventedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingeventedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingeventedge#field-MarketingEventEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingeventedge#field-MarketingEventEdge.fields.node)node
...
*   <->[MarketingEventConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MarketingEventConnection#field-edges)
