---
title: "AppRevenueAttributionRecordEdge"
description: "Shopify GraphQL Admin API documentation for apprevenueattributionrecordedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevenueattributionrecordedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevenueattributionrecordedge

Markdown Content:
AppRevenueAttributionRecordEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevenueattributionrecordedge#main-content)
...
[Anchor to AppRevenueAttributionRecordEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevenueattributionrecordedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevenueattributionrecordedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevenueattributionrecordedge#field-AppRevenueAttributionRecordEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/apprevenueattributionrecordedge#field-AppRevenueAttributionRecordEdge.fields.node)node
...
*   <->[AppRevenueAttributionRecordConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/AppRevenueAttributionRecordConnection#field-edges)
