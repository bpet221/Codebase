---
title: "FileEdge"
description: "Shopify GraphQL Admin API documentation for fileedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fileedge"
...
Title: FileEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fileedge

Markdown Content:
FileEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileedge#main-content)
...
[Anchor to FileEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileedge#top)
File Edge
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileedge#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileedge#field-FileEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileedge#field-FileEdge.fields.node)node
...
*   <->[FileConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/FileConnection#field-edges)
