---
title: "CompanyContactRoleEdge"
description: "Shopify GraphQL Admin API documentation for companycontactroleedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactroleedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactroleedge

Markdown Content:
CompanyContactRoleEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactroleedge#main-content)
...
[Anchor to CompanyContactRoleEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactroleedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactroleedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactroleedge#field-CompanyContactRoleEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactroleedge#field-CompanyContactRoleEdge.fields.node)node
...
*   <->[CompanyContactRoleConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CompanyContactRoleConnection#field-edges)
