---
title: "ValidationEdge"
description: "Shopify GraphQL Admin API documentation for validationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/validationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/validationedge

Markdown Content:
ValidationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/validationedge#main-content)
...
[Anchor to ValidationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/validationedge#top)
Validation Edge
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/validationedge#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/validationedge#field-ValidationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/validationedge#field-ValidationEdge.fields.node)node
...
*   <->[ValidationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ValidationConnection#field-edges)
