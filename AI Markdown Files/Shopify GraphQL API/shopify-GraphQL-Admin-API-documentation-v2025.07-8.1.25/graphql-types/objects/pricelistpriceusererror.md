---
title: "PriceListPriceUserError"
description: "Shopify GraphQL Admin API documentation for pricelistpriceusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror

Markdown Content:
PriceListPriceUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#interfaces)
...
[Anchor to PriceListPriceUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#field-PriceListPriceUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#field-PriceListPriceUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#field-PriceListPriceUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------

[Anchor to priceListFixedPricesAdd](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#mutation-priceListFixedPricesAdd)[price List Fixed Prices Add](https://shopify.dev/docs/api/admin-graphql/latest/mutations/priceListFixedPricesAdd)
...
[Anchor to priceListFixedPricesDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#mutation-priceListFixedPricesDelete)[price List Fixed Prices Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/priceListFixedPricesDelete)
...
[Anchor to priceListFixedPricesUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#mutation-priceListFixedPricesUpdate)[price List Fixed Prices Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/priceListFixedPricesUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
