---
title: "AppUsageRecordEdge"
description: "Shopify GraphQL Admin API documentation for appusagerecordedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appusagerecordedge"
...
Title: AppUsageRecordEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appusagerecordedge

Markdown Content:
AppUsageRecordEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appusagerecordedge#main-content)
...
[Anchor to AppUsageRecordEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/appusagerecordedge#top)
App Usage Record Edge
=====================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appusagerecordedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/appusagerecordedge#field-AppUsageRecordEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/appusagerecordedge#field-AppUsageRecordEdge.fields.node)node
...
*   <->[AppUsageRecordConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/AppUsageRecordConnection#field-edges)
