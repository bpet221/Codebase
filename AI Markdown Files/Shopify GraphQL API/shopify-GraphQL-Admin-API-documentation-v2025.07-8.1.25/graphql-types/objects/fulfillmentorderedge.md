---
title: "FulfillmentOrderEdge"
description: "Shopify GraphQL Admin API documentation for fulfillmentorderedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderedge

Markdown Content:
FulfillmentOrderEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderedge#main-content)
...
[Anchor to FulfillmentOrderEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderedge#field-FulfillmentOrderEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderedge#field-FulfillmentOrderEdge.fields.node)node
...
*   <->[FulfillmentOrderConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/FulfillmentOrderConnection#field-edges)
