---
title: "SellingPlanGroupUserError"
description: "Shopify GraphQL Admin API documentation for sellingplangroupusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror

Markdown Content:
SellingPlanGroupUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#interfaces)
...
[Anchor to SellingPlanGroupUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#field-SellingPlanGroupUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#field-SellingPlanGroupUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#field-SellingPlanGroupUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to productJoinSellingPlanGroups](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-productJoinSellingPlanGroups)[product Join Selling Plan Groups](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productJoinSellingPlanGroups)
...
[Anchor to productLeaveSellingPlanGroups](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-productLeaveSellingPlanGroups)[product Leave Selling Plan Groups](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productLeaveSellingPlanGroups)
...
[Anchor to productVariantLeaveSellingPlanGroups](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-productVariantLeaveSellingPlanGroups)[product Variant Leave Selling Plan Groups](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productVariantLeaveSellingPlanGroups)
...
[Anchor to sellingPlanGroupAddProducts](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-sellingPlanGroupAddProducts)[selling Plan Group Add Products](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingPlanGroupAddProducts)
...
[Anchor to sellingPlanGroupAddProductVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-sellingPlanGroupAddProductVariants)[selling Plan Group Add Product Variants](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingPlanGroupAddProductVariants)
...
[Anchor to sellingPlanGroupCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-sellingPlanGroupCreate)[selling Plan Group Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingPlanGroupCreate)
...
[Anchor to sellingPlanGroupDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-sellingPlanGroupDelete)[selling Plan Group Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingPlanGroupDelete)
...
[Anchor to sellingPlanGroupRemoveProducts](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-sellingPlanGroupRemoveProducts)[selling Plan Group Remove Products](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingPlanGroupRemoveProducts)
...
[Anchor to sellingPlanGroupRemoveProductVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-sellingPlanGroupRemoveProductVariants)[selling Plan Group Remove Product Variants](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingPlanGroupRemoveProductVariants)
...
[Anchor to sellingPlanGroupUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#mutation-sellingPlanGroupUpdate)[selling Plan Group Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingPlanGroupUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
