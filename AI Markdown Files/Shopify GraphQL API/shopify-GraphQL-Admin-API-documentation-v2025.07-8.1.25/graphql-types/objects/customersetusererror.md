---
title: "CustomerSetUserError"
description: "Shopify GraphQL Admin API documentation for customersetusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror"
...
Title: CustomerSetUserError - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror

Markdown Content:
CustomerSetUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#interfaces)
...
[Anchor to CustomerSetUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#field-CustomerSetUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#field-CustomerSetUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#field-CustomerSetUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------

[Anchor to customerSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#mutation-customerSet)[customer Set](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerSet)
...
<~>CustomerSetUserError Mutations
---------------------------------
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersetusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
...
||-CustomerSetUserError Implements
----------------------------------
