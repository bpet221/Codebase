---
title: "MediaEdge"
description: "Shopify GraphQL Admin API documentation for mediaedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaedge"
...
Title: MediaEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaedge

Markdown Content:
MediaEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaedge#main-content)
...
[Anchor to MediaEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaedge#top)
Media Edge
==========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaedge#fields)Fields
----------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaedge#field-MediaEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaedge#field-MediaEdge.fields.node)node
...
*   <->[MediaConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MediaConnection#field-edges)
