---
title: "LineItemEdge"
description: "Shopify GraphQL Admin API documentation for lineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemedge

Markdown Content:
LineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemedge#main-content)
...
[Anchor to LineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemedge#top)
Line Item Edge
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemedge#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemedge#field-LineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemedge#field-LineItemEdge.fields.node)node
...
*   <->[LineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/LineItemConnection#field-edges)
