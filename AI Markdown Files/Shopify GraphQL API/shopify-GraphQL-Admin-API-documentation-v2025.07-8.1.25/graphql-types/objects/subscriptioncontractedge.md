---
title: "SubscriptionContractEdge"
description: "Shopify GraphQL Admin API documentation for subscriptioncontractedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractedge

Markdown Content:
SubscriptionContractEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractedge#main-content)
...
[Anchor to SubscriptionContractEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractedge#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractedge#field-SubscriptionContractEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractedge#field-SubscriptionContractEdge.fields.node)node
...
*   <->[SubscriptionContractConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SubscriptionContractConnection#field-edges)
