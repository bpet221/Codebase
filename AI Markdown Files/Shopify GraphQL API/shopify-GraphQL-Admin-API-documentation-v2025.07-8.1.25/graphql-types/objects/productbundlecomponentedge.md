---
title: "ProductBundleComponentEdge"
description: "Shopify GraphQL Admin API documentation for productbundlecomponentedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentedge

Markdown Content:
ProductBundleComponentEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentedge#main-content)
...
[Anchor to ProductBundleComponentEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentedge#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentedge#field-ProductBundleComponentEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentedge#field-ProductBundleComponentEdge.fields.node)node
...
*   <->[ProductBundleComponentConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductBundleComponentConnection#field-edges)
