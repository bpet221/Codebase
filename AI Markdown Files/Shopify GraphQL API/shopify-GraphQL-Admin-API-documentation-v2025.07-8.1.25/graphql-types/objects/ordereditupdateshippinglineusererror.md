---
title: "OrderEditUpdateShippingLineUserError"
description: "Shopify GraphQL Admin API documentation for ordereditupdateshippinglineusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror

Markdown Content:
OrderEditUpdateShippingLineUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#interfaces)
...
[Anchor to OrderEditUpdateShippingLineUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#field-OrderEditUpdateShippingLineUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#field-OrderEditUpdateShippingLineUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#field-OrderEditUpdateShippingLineUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to orderEditUpdateShippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#mutation-orderEditUpdateShippingLine)[order Edit Update Shipping Line](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderEditUpdateShippingLine)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdateshippinglineusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
