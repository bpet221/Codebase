---
title: "CartTransformDeleteUserError"
description: "Shopify GraphQL Admin API documentation for carttransformdeleteusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror

Markdown Content:
CartTransformDeleteUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#interfaces)
...
[Anchor to CartTransformDeleteUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#field-CartTransformDeleteUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#field-CartTransformDeleteUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#field-CartTransformDeleteUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to cartTransformDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#mutation-cartTransformDelete)[cart Transform Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/cartTransformDelete)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformdeleteusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
