---
title: "CartTransformEdge"
description: "Shopify GraphQL Admin API documentation for carttransformedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformedge

Markdown Content:
CartTransformEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformedge#main-content)
...
[Anchor to CartTransformEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformedge#top)
Cart Transform Edge
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformedge#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformedge#field-CartTransformEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformedge#field-CartTransformEdge.fields.node)node
...
*   <->[CartTransformConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CartTransformConnection#field-edges)
