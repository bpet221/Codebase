---
title: "InventoryTransferEdge"
description: "Shopify GraphQL Admin API documentation for inventorytransferedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferedge"
...
Title: InventoryTransferEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferedge

Markdown Content:
InventoryTransferEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferedge#main-content)
...
[Anchor to InventoryTransferEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferedge#top)
Inventory Transfer Edge
=======================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferedge#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferedge#field-InventoryTransferEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferedge#field-InventoryTransferEdge.fields.node)node
...
*   <->[InventoryTransferConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/InventoryTransferConnection#field-edges)
