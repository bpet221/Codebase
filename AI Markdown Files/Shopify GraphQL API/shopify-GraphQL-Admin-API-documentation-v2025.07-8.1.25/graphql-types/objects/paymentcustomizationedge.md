---
title: "PaymentCustomizationEdge"
description: "Shopify GraphQL Admin API documentation for paymentcustomizationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentcustomizationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentcustomizationedge

Markdown Content:
PaymentCustomizationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentcustomizationedge#main-content)
...
[Anchor to PaymentCustomizationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentcustomizationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentcustomizationedge#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentcustomizationedge#field-PaymentCustomizationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentcustomizationedge#field-PaymentCustomizationEdge.fields.node)node
...
*   <->[PaymentCustomizationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/PaymentCustomizationConnection#field-edges)
