---
title: "DisputeEvidenceUpdateUserError"
description: "Shopify GraphQL Admin API documentation for disputeevidenceupdateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror

Markdown Content:
DisputeEvidenceUpdateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#interfaces)
...
[Anchor to DisputeEvidenceUpdateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#field-DisputeEvidenceUpdateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#field-DisputeEvidenceUpdateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#field-DisputeEvidenceUpdateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to disputeEvidenceUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#mutation-disputeEvidenceUpdate)[dispute Evidence Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/disputeEvidenceUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/disputeevidenceupdateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
