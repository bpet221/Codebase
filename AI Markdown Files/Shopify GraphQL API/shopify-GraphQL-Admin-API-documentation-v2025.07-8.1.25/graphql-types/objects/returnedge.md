---
title: "ReturnEdge"
description: "Shopify GraphQL Admin API documentation for returnedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnedge"
...
Title: ReturnEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnedge

Markdown Content:
ReturnEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnedge#main-content)
...
[Anchor to ReturnEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnedge#top)
Return Edge
===========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnedge#fields)Fields
-----------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnedge#field-ReturnEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnedge#field-ReturnEdge.fields.node)node
...
*   <->[ReturnConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReturnConnection#field-edges)
