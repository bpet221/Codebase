---
title: "CollectionPublicationEdge"
description: "Shopify GraphQL Admin API documentation for collectionpublicationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublicationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublicationedge

Markdown Content:
CollectionPublicationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublicationedge#main-content)
...
[Anchor to CollectionPublicationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublicationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublicationedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublicationedge#field-CollectionPublicationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublicationedge#field-CollectionPublicationEdge.fields.node)node
...
*   <->[CollectionPublicationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CollectionPublicationConnection#field-edges)
