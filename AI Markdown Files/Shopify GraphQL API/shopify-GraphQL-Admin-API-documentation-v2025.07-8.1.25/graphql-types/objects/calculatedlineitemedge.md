---
title: "CalculatedLineItemEdge"
description: "Shopify GraphQL Admin API documentation for calculatedlineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedlineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedlineitemedge

Markdown Content:
CalculatedLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedlineitemedge#main-content)
...
[Anchor to CalculatedLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedlineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedlineitemedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedlineitemedge#field-CalculatedLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedlineitemedge#field-CalculatedLineItemEdge.fields.node)node
...
*   <->[CalculatedLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CalculatedLineItemConnection#field-edges)
