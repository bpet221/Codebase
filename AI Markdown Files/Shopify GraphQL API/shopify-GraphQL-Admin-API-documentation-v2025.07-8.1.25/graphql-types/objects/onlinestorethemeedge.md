---
title: "OnlineStoreThemeEdge"
description: "Shopify GraphQL Admin API documentation for onlinestorethemeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemeedge

Markdown Content:
OnlineStoreThemeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemeedge#main-content)
...
[Anchor to OnlineStoreThemeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemeedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemeedge#field-OnlineStoreThemeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemeedge#field-OnlineStoreThemeEdge.fields.node)node
...
*   <->[OnlineStoreThemeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/OnlineStoreThemeConnection#field-edges)
