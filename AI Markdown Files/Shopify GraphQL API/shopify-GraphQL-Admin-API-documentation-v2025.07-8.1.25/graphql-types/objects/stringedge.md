---
title: "StringEdge"
description: "Shopify GraphQL Admin API documentation for stringedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/stringedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/stringedge

Markdown Content:
StringEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/stringedge#main-content)
...
[Anchor to StringEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/stringedge#top)
String Edge
===========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/stringedge#fields)Fields
-----------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/stringedge#field-StringEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/stringedge#field-StringEdge.fields.node)node
...
*   <->[StringConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/StringConnection#field-edges)
