---
title: "MediaUserError"
description: "Shopify GraphQL Admin API documentation for mediausererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror

Markdown Content:
MediaUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#interfaces)
...
[Anchor to MediaUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#top)
Media User Error
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#field-MediaUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#field-MediaUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#field-MediaUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------

[Anchor to productReorderMedia](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#mutation-productReorderMedia)[product Reorder Media](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productReorderMedia)
...
[Anchor to productVariantAppendMedia](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#mutation-productVariantAppendMedia)[product Variant Append Media](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productVariantAppendMedia)
...
[Anchor to productVariantDetachMedia](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#mutation-productVariantDetachMedia)[product Variant Detach Media](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productVariantDetachMedia)
...
[Anchor to productCreateMedia](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#mutation-productCreateMedia)[product Create Media](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productCreateMedia)
...
[Anchor to productDeleteMedia](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#mutation-productDeleteMedia)[product Delete Media](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productDeleteMedia)
...
[Anchor to productUpdateMedia](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#mutation-productUpdateMedia)[product Update Media](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productUpdateMedia)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediausererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
