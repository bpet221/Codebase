---
title: "MarketRegionEdge"
description: "Shopify GraphQL Admin API documentation for marketregionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketregionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketregionedge

Markdown Content:
MarketRegionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketregionedge#main-content)
...
[Anchor to MarketRegionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketregionedge#top)
Market Region Edge
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketregionedge#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketregionedge#field-MarketRegionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketregionedge#field-MarketRegionEdge.fields.node)node
...
*   <->[MarketRegionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MarketRegionConnection#field-edges)
