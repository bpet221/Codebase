---
title: "TransactionVoidUserError"
description: "Shopify GraphQL Admin API documentation for transactionvoidusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror

Markdown Content:
TransactionVoidUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#interfaces)
...
[Anchor to TransactionVoidUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#field-TransactionVoidUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#field-TransactionVoidUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#field-TransactionVoidUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------

[Anchor to transactionVoid](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#mutation-transactionVoid)[transaction Void](https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionVoid)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionvoidusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
