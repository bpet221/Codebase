---
title: "GiftCardEdge"
description: "Shopify GraphQL Admin API documentation for giftcardedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardedge

Markdown Content:
GiftCardEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardedge#main-content)
...
[Anchor to GiftCardEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardedge#top)
Gift Card Edge
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardedge#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardedge#field-GiftCardEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardedge#field-GiftCardEdge.fields.node)node
...
*   <->[GiftCardConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/GiftCardConnection#field-edges)
