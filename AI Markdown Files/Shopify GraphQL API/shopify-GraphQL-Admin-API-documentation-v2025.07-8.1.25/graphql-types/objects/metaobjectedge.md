---
title: "MetaobjectEdge"
description: "Shopify GraphQL Admin API documentation for metaobjectedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectedge

Markdown Content:
MetaobjectEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectedge#main-content)
...
[Anchor to MetaobjectEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectedge#top)
Metaobject Edge
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectedge#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectedge#field-MetaobjectEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectedge#field-MetaobjectEdge.fields.node)node
...
*   <->[MetaobjectConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MetaobjectConnection#field-edges)
