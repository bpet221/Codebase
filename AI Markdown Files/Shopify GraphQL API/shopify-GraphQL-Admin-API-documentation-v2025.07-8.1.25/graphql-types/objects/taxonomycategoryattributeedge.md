---
title: "TaxonomyCategoryAttributeEdge"
description: "Shopify GraphQL Admin API documentation for taxonomycategoryattributeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryattributeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryattributeedge

Markdown Content:
TaxonomyCategoryAttributeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryattributeedge#main-content)
...
[Anchor to TaxonomyCategoryAttributeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryattributeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryattributeedge#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryattributeedge#field-TaxonomyCategoryAttributeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomycategoryattributeedge#field-TaxonomyCategoryAttributeEdge.fields.node)node
...
*   <->[TaxonomyCategoryAttributeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/TaxonomyCategoryAttributeConnection#field-edges)
