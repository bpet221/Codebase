---
title: "QuantityRuleEdge"
description: "Shopify GraphQL Admin API documentation for quantityruleedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleedge

Markdown Content:
QuantityRuleEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleedge#main-content)
...
[Anchor to QuantityRuleEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleedge#top)
Quantity Rule Edge
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleedge#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleedge#field-QuantityRuleEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleedge#field-QuantityRuleEdge.fields.node)node
...
*   <->[QuantityRuleConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/QuantityRuleConnection#field-edges)
