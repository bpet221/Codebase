---
title: "UrlRedirectBulkDeleteBySearchUserError"
description: "Shopify GraphQL Admin API documentation for urlredirectbulkdeletebysearchusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror

Markdown Content:
UrlRedirectBulkDeleteBySearchUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#interfaces)
...
[Anchor to UrlRedirectBulkDeleteBySearchUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#field-UrlRedirectBulkDeleteBySearchUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#field-UrlRedirectBulkDeleteBySearchUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#field-UrlRedirectBulkDeleteBySearchUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to urlRedirectBulkDeleteBySearch](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#mutation-urlRedirectBulkDeleteBySearch)[url Redirect Bulk Delete By Search](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlRedirectBulkDeleteBySearch)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectbulkdeletebysearchusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
