...
description: "Shopify GraphQL Admin API documentation for resourcepublicationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationedge

Markdown Content:
ResourcePublicationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationedge#main-content)
...
[Anchor to ResourcePublicationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationedge#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationedge#field-ResourcePublicationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationedge#field-ResourcePublicationEdge.fields.node)node
...
*   <->[ResourcePublicationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ResourcePublicationConnection#field-edges)
