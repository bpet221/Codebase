...
description: "Shopify GraphQL Admin API documentation for fulfillmentedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentedge"
...
Title: FulfillmentEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentedge

Markdown Content:
FulfillmentEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentedge#main-content)
...
[Anchor to FulfillmentEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentedge#top)
Fulfillment Edge
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentedge#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentedge#field-FulfillmentEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentedge#field-FulfillmentEdge.fields.node)node
...
*   <->[FulfillmentConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/FulfillmentConnection#field-edges)
