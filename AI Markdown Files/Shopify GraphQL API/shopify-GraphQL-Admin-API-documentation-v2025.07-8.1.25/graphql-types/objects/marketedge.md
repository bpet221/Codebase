---
title: "MarketEdge"
description: "Shopify GraphQL Admin API documentation for marketedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketedge

Markdown Content:
MarketEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketedge#main-content)
...
[Anchor to MarketEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketedge#top)
Market Edge
===========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketedge#fields)Fields
-----------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketedge#field-MarketEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketedge#field-MarketEdge.fields.node)node
...
*   <->[MarketConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MarketConnection#field-edges)
