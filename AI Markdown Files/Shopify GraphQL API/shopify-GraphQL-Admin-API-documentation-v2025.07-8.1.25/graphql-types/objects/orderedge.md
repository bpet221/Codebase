---
title: "OrderEdge"
description: "Shopify GraphQL Admin API documentation for orderedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderedge"
...
Title: OrderEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderedge

Markdown Content:
OrderEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderedge#main-content)
...
[Anchor to OrderEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderedge#top)
Order Edge
==========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderedge#fields)Fields
----------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderedge#field-OrderEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderedge#field-OrderEdge.fields.node)node
...
*   <->[OrderConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/OrderConnection#field-edges)
