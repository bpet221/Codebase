---
title: "ResourcePublicationV2Edge"
description: "Shopify GraphQL Admin API documentation for resourcepublicationv2edge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2edge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2edge

Markdown Content:
ResourcePublicationV2Edge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2edge#main-content)
...
[Anchor to ResourcePublicationV2Edge](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2edge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2edge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2edge#field-ResourcePublicationV2Edge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2edge#field-ResourcePublicationV2Edge.fields.node)node
...
*   <->[ResourcePublicationV2Connection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ResourcePublicationV2Connection#field-edges)
