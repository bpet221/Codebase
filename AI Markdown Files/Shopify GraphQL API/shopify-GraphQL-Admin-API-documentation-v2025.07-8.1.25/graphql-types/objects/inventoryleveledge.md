---
title: "InventoryLevelEdge"
description: "Shopify GraphQL Admin API documentation for inventoryleveledge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryleveledge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryleveledge

Markdown Content:
InventoryLevelEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryleveledge#main-content)
...
[Anchor to InventoryLevelEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryleveledge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryleveledge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryleveledge#field-InventoryLevelEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryleveledge#field-InventoryLevelEdge.fields.node)node
...
*   <->[InventoryLevelConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/InventoryLevelConnection#field-edges)
