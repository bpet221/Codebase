---
title: "ExchangeLineItemEdge"
description: "Shopify GraphQL Admin API documentation for exchangelineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitemedge

Markdown Content:
ExchangeLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitemedge#main-content)
...
[Anchor to ExchangeLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitemedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitemedge#field-ExchangeLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitemedge#field-ExchangeLineItemEdge.fields.node)node
...
*   <->[ExchangeLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ExchangeLineItemConnection#field-edges)
