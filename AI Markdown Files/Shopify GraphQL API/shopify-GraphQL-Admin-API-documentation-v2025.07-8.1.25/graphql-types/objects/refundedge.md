---
title: "RefundEdge"
description: "Shopify GraphQL Admin API documentation for refundedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/refundedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/refundedge

Markdown Content:
RefundEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundedge#main-content)
...
[Anchor to RefundEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundedge#top)
Refund Edge
===========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundedge#fields)Fields
-----------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundedge#field-RefundEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundedge#field-RefundEdge.fields.node)node
...
*   <->[RefundConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/RefundConnection#field-edges)
