---
title: "CombinedListingChildEdge"
description: "Shopify GraphQL Admin API documentation for combinedlistingchildedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchildedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchildedge

Markdown Content:
CombinedListingChildEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchildedge#main-content)
...
[Anchor to CombinedListingChildEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchildedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchildedge#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchildedge#field-CombinedListingChildEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchildedge#field-CombinedListingChildEdge.fields.node)node
...
*   <->[CombinedListingChildConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CombinedListingChildConnection#field-edges)
