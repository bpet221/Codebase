---
title: "CalculatedDiscountApplicationEdge"
description: "Shopify GraphQL Admin API documentation for calculateddiscountapplicationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountapplicationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountapplicationedge

Markdown Content:
CalculatedDiscountApplicationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountapplicationedge#main-content)
...
[Anchor to CalculatedDiscountApplicationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountapplicationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountapplicationedge#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountapplicationedge#field-CalculatedDiscountApplicationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountapplicationedge#field-CalculatedDiscountApplicationEdge.fields.node)node
...
*   <->[CalculatedDiscountApplicationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CalculatedDiscountApplicationConnection#field-edges)
