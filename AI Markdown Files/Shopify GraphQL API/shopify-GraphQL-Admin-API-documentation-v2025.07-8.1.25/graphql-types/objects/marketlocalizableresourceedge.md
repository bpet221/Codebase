---
title: "MarketLocalizableResourceEdge"
description: "Shopify GraphQL Admin API documentation for marketlocalizableresourceedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketlocalizableresourceedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketlocalizableresourceedge

Markdown Content:
MarketLocalizableResourceEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketlocalizableresourceedge#main-content)
...
[Anchor to MarketLocalizableResourceEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketlocalizableresourceedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketlocalizableresourceedge#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketlocalizableresourceedge#field-MarketLocalizableResourceEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketlocalizableresourceedge#field-MarketLocalizableResourceEdge.fields.node)node
...
*   <->[MarketLocalizableResourceConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MarketLocalizableResourceConnection#field-edges)
