---
title: "DiscountRedeemCodeEdge"
description: "Shopify GraphQL Admin API documentation for discountredeemcodeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodeedge

Markdown Content:
DiscountRedeemCodeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodeedge#main-content)
...
[Anchor to DiscountRedeemCodeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodeedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodeedge#field-DiscountRedeemCodeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodeedge#field-DiscountRedeemCodeEdge.fields.node)node
...
*   <->[DiscountRedeemCodeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DiscountRedeemCodeConnection#field-edges)
