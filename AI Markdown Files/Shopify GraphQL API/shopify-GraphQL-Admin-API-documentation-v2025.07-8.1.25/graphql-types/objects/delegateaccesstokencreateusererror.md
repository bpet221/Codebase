---
title: "DelegateAccessTokenCreateUserError"
description: "Shopify GraphQL Admin API documentation for delegateaccesstokencreateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror

Markdown Content:
DelegateAccessTokenCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#interfaces)
...
[Anchor to DelegateAccessTokenCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#field-DelegateAccessTokenCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#field-DelegateAccessTokenCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#field-DelegateAccessTokenCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to delegateAccessTokenCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#mutation-delegateAccessTokenCreate)[delegate Access Token Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateAccessTokenCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokencreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
