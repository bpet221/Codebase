---
title: "DraftOrderLineItemEdge"
description: "Shopify GraphQL Admin API documentation for draftorderlineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitemedge

Markdown Content:
DraftOrderLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitemedge#main-content)
...
[Anchor to DraftOrderLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitemedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitemedge#field-DraftOrderLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitemedge#field-DraftOrderLineItemEdge.fields.node)node
...
*   <->[DraftOrderLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DraftOrderLineItemConnection#field-edges)
