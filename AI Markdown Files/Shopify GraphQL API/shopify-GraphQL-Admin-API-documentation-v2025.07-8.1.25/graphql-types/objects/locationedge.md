---
title: "LocationEdge"
description: "Shopify GraphQL Admin API documentation for locationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/locationedge"
...
Title: LocationEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/locationedge

Markdown Content:
LocationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/locationedge#main-content)
...
[Anchor to LocationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/locationedge#top)
Location Edge
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/locationedge#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/locationedge#field-LocationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/locationedge#field-LocationEdge.fields.node)node
...
*   <->[LocationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/LocationConnection#field-edges)
