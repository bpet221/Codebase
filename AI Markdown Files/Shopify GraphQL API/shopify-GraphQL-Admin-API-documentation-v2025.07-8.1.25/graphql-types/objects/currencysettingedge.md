---
title: "CurrencySettingEdge"
description: "Shopify GraphQL Admin API documentation for currencysettingedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysettingedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysettingedge

Markdown Content:
CurrencySettingEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysettingedge#main-content)
...
[Anchor to CurrencySettingEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysettingedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysettingedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysettingedge#field-CurrencySettingEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysettingedge#field-CurrencySettingEdge.fields.node)node
...
*   <->[CurrencySettingConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CurrencySettingConnection#field-edges)
