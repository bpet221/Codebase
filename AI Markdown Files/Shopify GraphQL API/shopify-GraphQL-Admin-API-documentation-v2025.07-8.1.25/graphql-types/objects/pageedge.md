---
title: "PageEdge"
description: "Shopify GraphQL Admin API documentation for pageedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pageedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pageedge

Markdown Content:
PageEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pageedge#main-content)
...
[Anchor to PageEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/pageedge#top)
Page Edge
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pageedge#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/pageedge#field-PageEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/pageedge#field-PageEdge.fields.node)node
...
*   <->[PageConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/PageConnection#field-edges)
