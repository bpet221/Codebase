---
title: "MarketingActivityEdge"
description: "Shopify GraphQL Admin API documentation for marketingactivityedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityedge

Markdown Content:
MarketingActivityEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityedge#main-content)
...
[Anchor to MarketingActivityEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityedge#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityedge#field-MarketingActivityEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityedge#field-MarketingActivityEdge.fields.node)node
...
*   <->[MarketingActivityConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MarketingActivityConnection#field-edges)
