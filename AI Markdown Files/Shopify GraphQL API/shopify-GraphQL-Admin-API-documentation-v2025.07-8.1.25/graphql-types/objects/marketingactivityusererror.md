---
title: "MarketingActivityUserError"
description: "Shopify GraphQL Admin API documentation for marketingactivityusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror

Markdown Content:
MarketingActivityUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#interfaces)
...
[Anchor to MarketingActivityUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#field-MarketingActivityUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#field-MarketingActivityUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#field-MarketingActivityUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------

[Anchor to marketingActivitiesDeleteAllExternal](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#mutation-marketingActivitiesDeleteAllExternal)[marketing Activities Delete All External](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketingActivitiesDeleteAllExternal)
...
[Anchor to marketingActivityCreateExternal](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#mutation-marketingActivityCreateExternal)[marketing Activity Create External](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketingActivityCreateExternal)
...
[Anchor to marketingActivityDeleteExternal](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#mutation-marketingActivityDeleteExternal)[marketing Activity Delete External](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketingActivityDeleteExternal)
...
[Anchor to marketingActivityUpdateExternal](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#mutation-marketingActivityUpdateExternal)[marketing Activity Update External](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketingActivityUpdateExternal)
...
[Anchor to marketingActivityUpsertExternal](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#mutation-marketingActivityUpsertExternal)[marketing Activity Upsert External](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketingActivityUpsertExternal)
...
[Anchor to marketingEngagementCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#mutation-marketingEngagementCreate)[marketing Engagement Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketingEngagementCreate)
...
[Anchor to marketingEngagementsDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#mutation-marketingEngagementsDelete)[marketing Engagements Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketingEngagementsDelete)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
