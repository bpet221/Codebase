---
title: "AppEdge"
description: "Shopify GraphQL Admin API documentation for appedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appedge

Markdown Content:
AppEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appedge#main-content)
...
[Anchor to AppEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/appedge#top)
App Edge
========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appedge#fields)Fields
--------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/appedge#field-AppEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/appedge#field-AppEdge.fields.node)node
...
*   <->[AppConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/AppConnection#field-edges)
