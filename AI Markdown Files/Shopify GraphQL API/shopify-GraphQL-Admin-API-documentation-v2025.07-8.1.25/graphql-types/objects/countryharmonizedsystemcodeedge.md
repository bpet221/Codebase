---
title: "CountryHarmonizedSystemCodeEdge"
description: "Shopify GraphQL Admin API documentation for countryharmonizedsystemcodeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/countryharmonizedsystemcodeedge"
...
Title: CountryHarmonizedSystemCodeEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/countryharmonizedsystemcodeedge

Markdown Content:
CountryHarmonizedSystemCodeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/countryharmonizedsystemcodeedge#main-content)
...
[Anchor to CountryHarmonizedSystemCodeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/countryharmonizedsystemcodeedge#top)
Country Harmonized System Code Edge
===================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/countryharmonizedsystemcodeedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/countryharmonizedsystemcodeedge#field-CountryHarmonizedSystemCodeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/countryharmonizedsystemcodeedge#field-CountryHarmonizedSystemCodeEdge.fields.node)node
...
*   <->[CountryHarmonizedSystemCodeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CountryHarmonizedSystemCodeConnection#field-edges)
