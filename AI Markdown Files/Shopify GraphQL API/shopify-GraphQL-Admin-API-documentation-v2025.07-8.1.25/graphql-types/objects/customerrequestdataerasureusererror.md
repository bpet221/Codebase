---
title: "CustomerRequestDataErasureUserError"
description: "Shopify GraphQL Admin API documentation for customerrequestdataerasureusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror

Markdown Content:
CustomerRequestDataErasureUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#interfaces)
...
[Anchor to CustomerRequestDataErasureUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#field-CustomerRequestDataErasureUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#field-CustomerRequestDataErasureUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#field-CustomerRequestDataErasureUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to customerRequestDataErasure](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#mutation-customerRequestDataErasure)[customer Request Data Erasure](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerRequestDataErasure)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerrequestdataerasureusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
