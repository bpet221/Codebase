---
title: "DeliveryProfileItemEdge"
description: "Shopify GraphQL Admin API documentation for deliveryprofileitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitemedge"
...
Title: DeliveryProfileItemEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitemedge

Markdown Content:
DeliveryProfileItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitemedge#main-content)
...
[Anchor to DeliveryProfileItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitemedge#top)
Delivery Profile Item Edge
==========================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitemedge#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitemedge#field-DeliveryProfileItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitemedge#field-DeliveryProfileItemEdge.fields.node)node
...
*   <->[DeliveryProfileItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryProfileItemConnection#field-edges)
