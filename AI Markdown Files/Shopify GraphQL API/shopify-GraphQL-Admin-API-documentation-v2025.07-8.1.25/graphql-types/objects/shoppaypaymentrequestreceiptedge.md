---
title: "ShopPayPaymentRequestReceiptEdge"
description: "Shopify GraphQL Admin API documentation for shoppaypaymentrequestreceiptedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptedge

Markdown Content:
ShopPayPaymentRequestReceiptEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptedge#main-content)
...
[Anchor to ShopPayPaymentRequestReceiptEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptedge#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptedge#field-ShopPayPaymentRequestReceiptEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppaypaymentrequestreceiptedge#field-ShopPayPaymentRequestReceiptEdge.fields.node)node
...
*   <->[ShopPayPaymentRequestReceiptConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ShopPayPaymentRequestReceiptConnection#field-edges)
