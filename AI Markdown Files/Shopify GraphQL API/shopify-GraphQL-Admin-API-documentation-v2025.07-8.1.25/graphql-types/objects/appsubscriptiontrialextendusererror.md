---
title: "AppSubscriptionTrialExtendUserError"
description: "Shopify GraphQL Admin API documentation for appsubscriptiontrialextendusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror

Markdown Content:
AppSubscriptionTrialExtendUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#interfaces)
...
[Anchor to AppSubscriptionTrialExtendUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#field-AppSubscriptionTrialExtendUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#field-AppSubscriptionTrialExtendUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#field-AppSubscriptionTrialExtendUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to appSubscriptionTrialExtend](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#mutation-appSubscriptionTrialExtend)[app Subscription Trial Extend](https://shopify.dev/docs/api/admin-graphql/latest/mutations/appSubscriptionTrialExtend)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiontrialextendusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
