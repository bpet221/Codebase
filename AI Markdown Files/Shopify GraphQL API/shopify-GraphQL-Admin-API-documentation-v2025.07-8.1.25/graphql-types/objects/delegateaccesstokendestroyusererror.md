---
title: "DelegateAccessTokenDestroyUserError"
description: "Shopify GraphQL Admin API documentation for delegateaccesstokendestroyusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror

Markdown Content:
DelegateAccessTokenDestroyUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#interfaces)
...
[Anchor to DelegateAccessTokenDestroyUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#field-DelegateAccessTokenDestroyUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#field-DelegateAccessTokenDestroyUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#field-DelegateAccessTokenDestroyUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to delegateAccessTokenDestroy](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#mutation-delegateAccessTokenDestroy)[delegate Access Token Destroy](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateAccessTokenDestroy)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/delegateaccesstokendestroyusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
