---
title: "SegmentValueEdge"
description: "Shopify GraphQL Admin API documentation for segmentvalueedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalueedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalueedge

Markdown Content:
SegmentValueEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalueedge#main-content)
...
[Anchor to SegmentValueEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalueedge#top)
Segment Value Edge
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalueedge#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalueedge#field-SegmentValueEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalueedge#field-SegmentValueEdge.fields.node)node
...
*   <->[SegmentValueConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SegmentValueConnection#field-edges)
