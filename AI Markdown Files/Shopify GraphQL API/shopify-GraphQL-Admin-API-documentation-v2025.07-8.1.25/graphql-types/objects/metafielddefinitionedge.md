---
title: "MetafieldDefinitionEdge"
description: "Shopify GraphQL Admin API documentation for metafielddefinitionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionedge"
...
Title: MetafieldDefinitionEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionedge

Markdown Content:
MetafieldDefinitionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionedge#main-content)
...
[Anchor to MetafieldDefinitionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionedge#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionedge#field-MetafieldDefinitionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionedge#field-MetafieldDefinitionEdge.fields.node)node
...
*   <->[MetafieldDefinitionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MetafieldDefinitionConnection#field-edges)
