---
title: "StoreCreditAccountEdge"
description: "Shopify GraphQL Admin API documentation for storecreditaccountedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountedge

Markdown Content:
StoreCreditAccountEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountedge#main-content)
...
[Anchor to StoreCreditAccountEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountedge#field-StoreCreditAccountEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountedge#field-StoreCreditAccountEdge.fields.node)node
...
*   <->[StoreCreditAccountConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/StoreCreditAccountConnection#field-edges)
