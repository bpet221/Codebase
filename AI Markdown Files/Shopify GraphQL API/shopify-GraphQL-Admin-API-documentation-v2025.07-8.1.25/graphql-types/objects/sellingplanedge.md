---
title: "SellingPlanEdge"
description: "Shopify GraphQL Admin API documentation for sellingplanedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanedge

Markdown Content:
SellingPlanEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanedge#main-content)
...
[Anchor to SellingPlanEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanedge#top)
Selling Plan Edge
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanedge#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanedge#field-SellingPlanEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanedge#field-SellingPlanEdge.fields.node)node
...
*   <->[SellingPlanConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SellingPlanConnection#field-edges)
