---
title: "UrlRedirectEdge"
description: "Shopify GraphQL Admin API documentation for urlredirectedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectedge

Markdown Content:
UrlRedirectEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectedge#main-content)
...
[Anchor to UrlRedirectEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectedge#top)
Url Redirect Edge
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectedge#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectedge#field-UrlRedirectEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectedge#field-UrlRedirectEdge.fields.node)node
...
*   <->[UrlRedirectConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/UrlRedirectConnection#field-edges)
