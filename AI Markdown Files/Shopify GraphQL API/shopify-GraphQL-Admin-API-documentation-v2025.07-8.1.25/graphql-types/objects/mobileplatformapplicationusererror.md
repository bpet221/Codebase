...
description: "Shopify GraphQL Admin API documentation for mobileplatformapplicationusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror

Markdown Content:
MobilePlatformApplicationUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#interfaces)
...
[Anchor to MobilePlatformApplicationUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#field-MobilePlatformApplicationUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#field-MobilePlatformApplicationUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#field-MobilePlatformApplicationUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to mobilePlatformApplicationCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#mutation-mobilePlatformApplicationCreate)[mobile Platform Application Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/mobilePlatformApplicationCreate)
...
[Anchor to mobilePlatformApplicationDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#mutation-mobilePlatformApplicationDelete)[mobile Platform Application Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/mobilePlatformApplicationDelete)
...
[Anchor to mobilePlatformApplicationUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#mutation-mobilePlatformApplicationUpdate)[mobile Platform Application Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/mobilePlatformApplicationUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
