---
title: "SubscriptionLineEdge"
description: "Shopify GraphQL Admin API documentation for subscriptionlineedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlineedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlineedge

Markdown Content:
SubscriptionLineEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlineedge#main-content)
...
[Anchor to SubscriptionLineEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlineedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlineedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlineedge#field-SubscriptionLineEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlineedge#field-SubscriptionLineEdge.fields.node)node
...
*   <->[SubscriptionLineConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SubscriptionLineConnection#field-edges)
