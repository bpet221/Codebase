---
title: "EventEdge"
description: "Shopify GraphQL Admin API documentation for eventedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/eventedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/eventedge

Markdown Content:
EventEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/eventedge#main-content)
...
[Anchor to EventEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/eventedge#top)
Event Edge
==========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/eventedge#fields)Fields
----------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/eventedge#field-EventEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/eventedge#field-EventEdge.fields.node)node
...
*   <->[EventConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/EventConnection#field-edges)
