---
title: "PriceListPriceEdge"
description: "Shopify GraphQL Admin API documentation for pricelistpriceedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceedge

Markdown Content:
PriceListPriceEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceedge#main-content)
...
[Anchor to PriceListPriceEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceedge#field-PriceListPriceEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistpriceedge#field-PriceListPriceEdge.fields.node)node
...
*   <->[PriceListPriceConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/PriceListPriceConnection#field-edges)
