...
description: "Shopify GraphQL Admin API documentation for subscriptioncontractstatusupdateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror

Markdown Content:
SubscriptionContractStatusUpdateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#interfaces)
...
[Anchor to SubscriptionContractStatusUpdateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#field-SubscriptionContractStatusUpdateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#field-SubscriptionContractStatusUpdateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#field-SubscriptionContractStatusUpdateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to subscriptionContractActivate](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#mutation-subscriptionContractActivate)[subscription Contract Activate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionContractActivate)
...
[Anchor to subscriptionContractCancel](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#mutation-subscriptionContractCancel)[subscription Contract Cancel](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionContractCancel)
...
[Anchor to subscriptionContractExpire](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#mutation-subscriptionContractExpire)[subscription Contract Expire](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionContractExpire)
...
[Anchor to subscriptionContractFail](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#mutation-subscriptionContractFail)[subscription Contract Fail](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionContractFail)
...
[Anchor to subscriptionContractPause](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#mutation-subscriptionContractPause)[subscription Contract Pause](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionContractPause)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncontractstatusupdateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
