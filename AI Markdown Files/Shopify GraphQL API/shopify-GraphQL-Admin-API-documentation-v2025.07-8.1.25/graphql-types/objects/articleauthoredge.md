---
title: "ArticleAuthorEdge"
description: "Shopify GraphQL Admin API documentation for articleauthoredge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/articleauthoredge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/articleauthoredge

Markdown Content:
ArticleAuthorEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleauthoredge#main-content)
...
[Anchor to ArticleAuthorEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleauthoredge#top)
Article Author Edge
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleauthoredge#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleauthoredge#field-ArticleAuthorEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleauthoredge#field-ArticleAuthorEdge.fields.node)node
...
*   <->[ArticleAuthorConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ArticleAuthorConnection#field-edges)
