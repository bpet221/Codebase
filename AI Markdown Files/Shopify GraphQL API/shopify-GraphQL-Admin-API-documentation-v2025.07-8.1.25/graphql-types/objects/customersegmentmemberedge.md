---
title: "CustomerSegmentMemberEdge"
description: "Shopify GraphQL Admin API documentation for customersegmentmemberedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customersegmentmemberedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customersegmentmemberedge

Markdown Content:
CustomerSegmentMemberEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersegmentmemberedge#main-content)
...
[Anchor to CustomerSegmentMemberEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersegmentmemberedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersegmentmemberedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersegmentmemberedge#field-CustomerSegmentMemberEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/customersegmentmemberedge#field-CustomerSegmentMemberEdge.fields.node)node
...
*   <->[CustomerSegmentMemberConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CustomerSegmentMemberConnection#field-edges)
