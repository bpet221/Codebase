---
title: "SearchResultEdge"
description: "Shopify GraphQL Admin API documentation for searchresultedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresultedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresultedge

Markdown Content:
SearchResultEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresultedge#main-content)
...
[Anchor to SearchResultEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresultedge#top)
Search Result Edge
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresultedge#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresultedge#field-SearchResultEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/searchresultedge#field-SearchResultEdge.fields.node)node
...
*   <->[SearchResultConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SearchResultConnection#field-edges)
