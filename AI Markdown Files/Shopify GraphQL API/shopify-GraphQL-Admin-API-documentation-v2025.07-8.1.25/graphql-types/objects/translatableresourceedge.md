---
title: "TranslatableResourceEdge"
description: "Shopify GraphQL Admin API documentation for translatableresourceedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/translatableresourceedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/translatableresourceedge

Markdown Content:
TranslatableResourceEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/translatableresourceedge#main-content)
...
[Anchor to TranslatableResourceEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/translatableresourceedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/translatableresourceedge#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/translatableresourceedge#field-TranslatableResourceEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/translatableresourceedge#field-TranslatableResourceEdge.fields.node)node
...
*   <->[TranslatableResourceConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/TranslatableResourceConnection#field-edges)
