---
title: "CommentEdge"
description: "Shopify GraphQL Admin API documentation for commentedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/commentedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/commentedge

Markdown Content:
CommentEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentedge#main-content)
...
[Anchor to CommentEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentedge#top)
Comment Edge
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentedge#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentedge#field-CommentEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentedge#field-CommentEdge.fields.node)node
...
*   <->[CommentConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CommentConnection#field-edges)
