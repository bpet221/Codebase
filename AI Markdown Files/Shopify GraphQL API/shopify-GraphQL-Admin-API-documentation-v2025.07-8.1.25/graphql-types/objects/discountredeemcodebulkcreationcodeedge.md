---
title: "DiscountRedeemCodeBulkCreationCodeEdge"
description: "Shopify GraphQL Admin API documentation for discountredeemcodebulkcreationcodeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodebulkcreationcodeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodebulkcreationcodeedge

Markdown Content:
DiscountRedeemCodeBulkCreationCodeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodebulkcreationcodeedge#main-content)
...
[Anchor to DiscountRedeemCodeBulkCreationCodeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodebulkcreationcodeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodebulkcreationcodeedge#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodebulkcreationcodeedge#field-DiscountRedeemCodeBulkCreationCodeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountredeemcodebulkcreationcodeedge#field-DiscountRedeemCodeBulkCreationCodeEdge.fields.node)node
...
*   <->[DiscountRedeemCodeBulkCreationCodeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DiscountRedeemCodeBulkCreationCodeConnection#field-edges)
