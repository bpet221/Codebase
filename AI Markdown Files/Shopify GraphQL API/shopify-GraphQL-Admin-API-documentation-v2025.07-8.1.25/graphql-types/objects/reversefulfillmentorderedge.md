---
title: "ReverseFulfillmentOrderEdge"
description: "Shopify GraphQL Admin API documentation for reversefulfillmentorderedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderedge

Markdown Content:
ReverseFulfillmentOrderEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderedge#main-content)
...
[Anchor to ReverseFulfillmentOrderEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderedge#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderedge#field-ReverseFulfillmentOrderEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderedge#field-ReverseFulfillmentOrderEdge.fields.node)node
...
*   <->[ReverseFulfillmentOrderConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReverseFulfillmentOrderConnection#field-edges)
