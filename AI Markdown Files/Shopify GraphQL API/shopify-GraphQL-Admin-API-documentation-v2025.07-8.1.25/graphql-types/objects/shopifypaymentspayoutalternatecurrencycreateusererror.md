---
title: "ShopifyPaymentsPayoutAlternateCurrencyCreateUserError"
description: "Shopify GraphQL Admin API documentation for shopifypaymentspayoutalternatecurrencycreateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror

Markdown Content:
ShopifyPaymentsPayoutAlternateCurrencyCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#interfaces)
...
[Anchor to ShopifyPaymentsPayoutAlternateCurrencyCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#field-ShopifyPaymentsPayoutAlternateCurrencyCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#field-ShopifyPaymentsPayoutAlternateCurrencyCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#field-ShopifyPaymentsPayoutAlternateCurrencyCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to shopifyPaymentsPayoutAlternateCurrencyCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#mutation-shopifyPaymentsPayoutAlternateCurrencyCreate)[shopify Payments Payout Alternate Currency Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shopifyPaymentsPayoutAlternateCurrencyCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutalternatecurrencycreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
