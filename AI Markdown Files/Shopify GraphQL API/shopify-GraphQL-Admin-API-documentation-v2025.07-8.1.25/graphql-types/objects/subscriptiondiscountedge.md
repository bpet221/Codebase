---
title: "SubscriptionDiscountEdge"
description: "Shopify GraphQL Admin API documentation for subscriptiondiscountedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountedge"
...
Title: SubscriptionDiscountEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountedge

Markdown Content:
SubscriptionDiscountEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountedge#main-content)
...
[Anchor to SubscriptionDiscountEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountedge#top)
Subscription Discount Edge
==========================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountedge#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountedge#field-SubscriptionDiscountEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountedge#field-SubscriptionDiscountEdge.fields.node)node
...
*   <->[SubscriptionDiscountConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SubscriptionDiscountConnection#field-edges)
