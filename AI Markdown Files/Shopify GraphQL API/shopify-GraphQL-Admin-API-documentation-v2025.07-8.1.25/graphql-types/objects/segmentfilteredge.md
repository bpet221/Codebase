---
title: "SegmentFilterEdge"
description: "Shopify GraphQL Admin API documentation for segmentfilteredge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentfilteredge"
...
Title: SegmentFilterEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentfilteredge

Markdown Content:
SegmentFilterEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentfilteredge#main-content)
...
[Anchor to SegmentFilterEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentfilteredge#top)
Segment Filter Edge
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentfilteredge#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentfilteredge#field-SegmentFilterEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentfilteredge#field-SegmentFilterEdge.fields.node)node
...
*   <->[SegmentFilterConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SegmentFilterConnection#field-edges)
