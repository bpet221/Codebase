---
title: "PriceListFixedPricesByProductBulkUpdateUserError"
description: "Shopify GraphQL Admin API documentation for pricelistfixedpricesbyproductbulkupdateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror

Markdown Content:
PriceListFixedPricesByProductBulkUpdateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#interfaces)
...
[Anchor to PriceListFixedPricesByProductBulkUpdateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#field-PriceListFixedPricesByProductBulkUpdateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#field-PriceListFixedPricesByProductBulkUpdateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#field-PriceListFixedPricesByProductBulkUpdateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to priceListFixedPricesByProductUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#mutation-priceListFixedPricesByProductUpdate)[price List Fixed Prices By Product Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/priceListFixedPricesByProductUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistfixedpricesbyproductbulkupdateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
