---
title: "DeliveryCarrierServiceEdge"
description: "Shopify GraphQL Admin API documentation for deliverycarrierserviceedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycarrierserviceedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycarrierserviceedge

Markdown Content:
DeliveryCarrierServiceEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycarrierserviceedge#main-content)
...
[Anchor to DeliveryCarrierServiceEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycarrierserviceedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycarrierserviceedge#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycarrierserviceedge#field-DeliveryCarrierServiceEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycarrierserviceedge#field-DeliveryCarrierServiceEdge.fields.node)node
...
*   <->[DeliveryCarrierServiceConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryCarrierServiceConnection#field-edges)
