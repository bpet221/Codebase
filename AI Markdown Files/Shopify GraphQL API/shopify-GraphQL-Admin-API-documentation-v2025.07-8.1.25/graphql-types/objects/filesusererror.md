---
title: "FilesUserError"
description: "Shopify GraphQL Admin API documentation for filesusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror

Markdown Content:
FilesUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#interfaces)
...
[Anchor to FilesUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#top)
Files User Error
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#field-FilesUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#field-FilesUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#field-FilesUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------

[Anchor to fileAcknowledgeUpdateFailed](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#mutation-fileAcknowledgeUpdateFailed)[file Acknowledge Update Failed](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileAcknowledgeUpdateFailed)
...
[Anchor to fileCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#mutation-fileCreate)[file Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileCreate)
...
[Anchor to fileDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#mutation-fileDelete)[file Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileDelete)
...
[Anchor to fileUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#mutation-fileUpdate)[file Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/filesusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
