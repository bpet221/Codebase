---
title: "CarrierServiceCreateUserError"
description: "Shopify GraphQL Admin API documentation for carrierservicecreateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror

Markdown Content:
CarrierServiceCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#interfaces)
...
[Anchor to CarrierServiceCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#field-CarrierServiceCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#field-CarrierServiceCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#field-CarrierServiceCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to carrierServiceCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#mutation-carrierServiceCreate)[carrier Service Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/carrierServiceCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/carrierservicecreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
