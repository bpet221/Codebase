---
title: "MetafieldDefinitionDeleteUserError"
description: "Shopify GraphQL Admin API documentation for metafielddefinitiondeleteusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror

Markdown Content:
MetafieldDefinitionDeleteUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#interfaces)
...
[Anchor to MetafieldDefinitionDeleteUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#field-MetafieldDefinitionDeleteUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#field-MetafieldDefinitionDeleteUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#field-MetafieldDefinitionDeleteUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to metafieldDefinitionDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#mutation-metafieldDefinitionDelete)[metafield Definition Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafieldDefinitionDelete)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitiondeleteusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
