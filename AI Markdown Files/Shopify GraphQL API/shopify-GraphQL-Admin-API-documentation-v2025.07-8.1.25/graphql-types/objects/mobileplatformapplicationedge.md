---
title: "MobilePlatformApplicationEdge"
description: "Shopify GraphQL Admin API documentation for mobileplatformapplicationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationedge

Markdown Content:
MobilePlatformApplicationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationedge#main-content)
...
[Anchor to MobilePlatformApplicationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationedge#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationedge#field-MobilePlatformApplicationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/mobileplatformapplicationedge#field-MobilePlatformApplicationEdge.fields.node)node
...
*   <->[MobilePlatformApplicationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MobilePlatformApplicationConnection#field-edges)
