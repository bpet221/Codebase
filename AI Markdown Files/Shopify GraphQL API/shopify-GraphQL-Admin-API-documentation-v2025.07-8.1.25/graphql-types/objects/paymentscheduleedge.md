---
title: "PaymentScheduleEdge"
description: "Shopify GraphQL Admin API documentation for paymentscheduleedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentscheduleedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentscheduleedge

Markdown Content:
PaymentScheduleEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentscheduleedge#main-content)
...
[Anchor to PaymentScheduleEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentscheduleedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentscheduleedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentscheduleedge#field-PaymentScheduleEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentscheduleedge#field-PaymentScheduleEdge.fields.node)node
...
*   <->[PaymentScheduleConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/PaymentScheduleConnection#field-edges)
