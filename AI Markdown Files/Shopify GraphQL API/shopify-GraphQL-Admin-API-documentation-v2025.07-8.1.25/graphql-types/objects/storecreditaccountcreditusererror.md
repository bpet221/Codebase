---
title: "StoreCreditAccountCreditUserError"
description: "Shopify GraphQL Admin API documentation for storecreditaccountcreditusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror

Markdown Content:
StoreCreditAccountCreditUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#interfaces)
...
[Anchor to StoreCreditAccountCreditUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#field-StoreCreditAccountCreditUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#field-StoreCreditAccountCreditUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#field-StoreCreditAccountCreditUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------------------

[Anchor to storeCreditAccountCredit](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#mutation-storeCreditAccountCredit)[store Credit Account Credit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/storeCreditAccountCredit)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccountcreditusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
