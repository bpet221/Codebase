---
title: "ProductBundleMutationUserError"
description: "Shopify GraphQL Admin API documentation for productbundlemutationusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror

Markdown Content:
ProductBundleMutationUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#interfaces)
...
[Anchor to ProductBundleMutationUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#field-ProductBundleMutationUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#field-ProductBundleMutationUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#field-ProductBundleMutationUserError.fields.message)message
...
*   {}[ProductBundleOperation.userErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductBundleOperation#field-userErrors)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlemutationusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
