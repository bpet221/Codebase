---
title: "GiftCardDeactivateUserError"
description: "Shopify GraphQL Admin API documentation for giftcarddeactivateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror

Markdown Content:
GiftCardDeactivateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#interfaces)
...
[Anchor to GiftCardDeactivateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#field-GiftCardDeactivateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#field-GiftCardDeactivateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#field-GiftCardDeactivateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to giftCardDeactivate](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#mutation-giftCardDeactivate)[gift Card Deactivate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftCardDeactivate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcarddeactivateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
