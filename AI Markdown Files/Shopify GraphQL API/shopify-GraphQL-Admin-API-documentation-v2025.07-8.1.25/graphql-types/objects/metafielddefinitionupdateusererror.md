---
title: "MetafieldDefinitionUpdateUserError"
description: "Shopify GraphQL Admin API documentation for metafielddefinitionupdateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror

Markdown Content:
MetafieldDefinitionUpdateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#interfaces)
...
[Anchor to MetafieldDefinitionUpdateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#field-MetafieldDefinitionUpdateUserError.fields.code)code
...
[Anchor to elementIndex](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#field-MetafieldDefinitionUpdateUserError.fields.elementIndex)element Index

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The index of the array element that's causing the error.

[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#field-MetafieldDefinitionUpdateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#field-MetafieldDefinitionUpdateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to metafieldDefinitionUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#mutation-metafieldDefinitionUpdate)[metafield Definition Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafieldDefinitionUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionupdateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
