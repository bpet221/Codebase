---
title: "ShopifyPaymentsBalanceTransactionEdge"
description: "Shopify GraphQL Admin API documentation for shopifypaymentsbalancetransactionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionedge

Markdown Content:
ShopifyPaymentsBalanceTransactionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionedge#main-content)
...
[Anchor to ShopifyPaymentsBalanceTransactionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionedge#field-ShopifyPaymentsBalanceTransactionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionedge#field-ShopifyPaymentsBalanceTransactionEdge.fields.node)node
...
*   <->[ShopifyPaymentsBalanceTransactionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ShopifyPaymentsBalanceTransactionConnection#field-edges)
