---
title: "CatalogUserError"
description: "Shopify GraphQL Admin API documentation for catalogusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror

Markdown Content:
CatalogUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#interfaces)
...
[Anchor to CatalogUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#top)
Catalog User Error
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#field-CatalogUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#field-CatalogUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#field-CatalogUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------

[Anchor to catalogContextUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#mutation-catalogContextUpdate)[catalog Context Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogContextUpdate)
...
[Anchor to catalogCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#mutation-catalogCreate)[catalog Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogCreate)
...
[Anchor to catalogDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#mutation-catalogDelete)[catalog Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogDelete)
...
[Anchor to catalogUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#mutation-catalogUpdate)[catalog Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
