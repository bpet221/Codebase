---
title: "ShopifyFunctionEdge"
description: "Shopify GraphQL Admin API documentation for shopifyfunctionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunctionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunctionedge

Markdown Content:
ShopifyFunctionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunctionedge#main-content)
...
[Anchor to ShopifyFunctionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunctionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunctionedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunctionedge#field-ShopifyFunctionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyfunctionedge#field-ShopifyFunctionEdge.fields.node)node
...
*   <->[ShopifyFunctionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ShopifyFunctionConnection#field-edges)
