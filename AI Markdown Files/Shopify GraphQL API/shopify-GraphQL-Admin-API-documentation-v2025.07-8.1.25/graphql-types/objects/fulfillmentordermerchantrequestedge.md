---
title: "FulfillmentOrderMerchantRequestEdge"
description: "Shopify GraphQL Admin API documentation for fulfillmentordermerchantrequestedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordermerchantrequestedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordermerchantrequestedge

Markdown Content:
FulfillmentOrderMerchantRequestEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordermerchantrequestedge#main-content)
...
[Anchor to FulfillmentOrderMerchantRequestEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordermerchantrequestedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordermerchantrequestedge#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordermerchantrequestedge#field-FulfillmentOrderMerchantRequestEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordermerchantrequestedge#field-FulfillmentOrderMerchantRequestEdge.fields.node)node
...
*   <->[FulfillmentOrderMerchantRequestConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/FulfillmentOrderMerchantRequestConnection#field-edges)
