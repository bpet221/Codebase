---
title: "LocalizedFieldEdge"
description: "Shopify GraphQL Admin API documentation for localizedfieldedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfieldedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfieldedge

Markdown Content:
LocalizedFieldEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfieldedge#main-content)
...
[Anchor to LocalizedFieldEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfieldedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfieldedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfieldedge#field-LocalizedFieldEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizedfieldedge#field-LocalizedFieldEdge.fields.node)node
...
*   <->[LocalizedFieldConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/LocalizedFieldConnection#field-edges)
