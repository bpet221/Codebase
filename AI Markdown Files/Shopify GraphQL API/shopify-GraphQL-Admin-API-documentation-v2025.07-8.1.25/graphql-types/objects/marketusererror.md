---
title: "MarketUserError"
description: "Shopify GraphQL Admin API documentation for marketusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror

Markdown Content:
MarketUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#interfaces)
...
[Anchor to MarketUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#top)
Market User Error
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#field-MarketUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#field-MarketUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#field-MarketUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------

[Anchor to backupRegionUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-backupRegionUpdate)[backup Region Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/backupRegionUpdate)
...
[Anchor to marketCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-marketCreate)[market Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketCreate)
...
[Anchor to marketDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-marketDelete)[market Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketDelete)
...
[Anchor to marketUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-marketUpdate)[market Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketUpdate)
...
[Anchor to webPresenceCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-webPresenceCreate)[web Presence Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webPresenceCreate)
...
[Anchor to webPresenceDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-webPresenceDelete)[web Presence Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webPresenceDelete)
...
[Anchor to webPresenceUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-webPresenceUpdate)[web Presence Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webPresenceUpdate)
...
[Anchor to marketRegionDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-marketRegionDelete)[market Region Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketRegionDelete)
...
[Anchor to marketRegionsCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-marketRegionsCreate)[market Regions Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketRegionsCreate)
...
[Anchor to marketRegionsDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-marketRegionsDelete)[market Regions Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketRegionsDelete)
...
[Anchor to marketWebPresenceCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-marketWebPresenceCreate)[market Web Presence Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketWebPresenceCreate)
...
[Anchor to marketWebPresenceDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-marketWebPresenceDelete)[market Web Presence Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketWebPresenceDelete)
...
[Anchor to marketWebPresenceUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#mutation-marketWebPresenceUpdate)[market Web Presence Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketWebPresenceUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
