---
title: "DeliveryCustomizationEdge"
description: "Shopify GraphQL Admin API documentation for deliverycustomizationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycustomizationedge"
...
Title: DeliveryCustomizationEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycustomizationedge

Markdown Content:
DeliveryCustomizationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycustomizationedge#main-content)
...
[Anchor to DeliveryCustomizationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycustomizationedge#top)
Delivery Customization Edge
===========================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycustomizationedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycustomizationedge#field-DeliveryCustomizationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycustomizationedge#field-DeliveryCustomizationEdge.fields.node)node
...
*   <->[DeliveryCustomizationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryCustomizationConnection#field-edges)
