---
title: "DiscountAutomaticEdge"
description: "Shopify GraphQL Admin API documentation for discountautomaticedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticedge

Markdown Content:
DiscountAutomaticEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticedge#main-content)
...
[Anchor to DiscountAutomaticEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticedge#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticedge#field-DiscountAutomaticEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticedge#field-DiscountAutomaticEdge.fields.node)node
...
*   <->[DiscountAutomaticConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DiscountAutomaticConnection#field-edges)
