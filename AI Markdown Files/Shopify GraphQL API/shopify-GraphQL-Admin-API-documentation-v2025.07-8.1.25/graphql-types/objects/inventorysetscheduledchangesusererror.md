---
title: "InventorySetScheduledChangesUserError"
description: "Shopify GraphQL Admin API documentation for inventorysetscheduledchangesusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror

Markdown Content:
InventorySetScheduledChangesUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#interfaces)
...
[Anchor to InventorySetScheduledChangesUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#field-InventorySetScheduledChangesUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#field-InventorySetScheduledChangesUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#field-InventorySetScheduledChangesUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to inventorySetScheduledChanges](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#mutation-inventorySetScheduledChanges)[inventory Set Scheduled Changes](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorySetScheduledChanges)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetscheduledchangesusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
