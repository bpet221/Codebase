---
title: "FulfillmentEventEdge"
description: "Shopify GraphQL Admin API documentation for fulfillmenteventedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmenteventedge"
...
Title: FulfillmentEventEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmenteventedge

Markdown Content:
FulfillmentEventEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmenteventedge#main-content)
...
[Anchor to FulfillmentEventEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmenteventedge#top)
Fulfillment Event Edge
======================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmenteventedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmenteventedge#field-FulfillmentEventEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmenteventedge#field-FulfillmentEventEdge.fields.node)node
...
*   <->[FulfillmentEventConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/FulfillmentEventConnection#field-edges)
