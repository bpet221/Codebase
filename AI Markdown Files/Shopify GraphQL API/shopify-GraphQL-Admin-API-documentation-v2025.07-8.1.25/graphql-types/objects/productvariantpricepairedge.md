---
title: "ProductVariantPricePairEdge"
description: "Shopify GraphQL Admin API documentation for productvariantpricepairedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepairedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepairedge

Markdown Content:
ProductVariantPricePairEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepairedge#main-content)
...
[Anchor to ProductVariantPricePairEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepairedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepairedge#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepairedge#field-ProductVariantPricePairEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepairedge#field-ProductVariantPricePairEdge.fields.node)node
...
*   <->[ProductVariantPricePairConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductVariantPricePairConnection#field-edges)
