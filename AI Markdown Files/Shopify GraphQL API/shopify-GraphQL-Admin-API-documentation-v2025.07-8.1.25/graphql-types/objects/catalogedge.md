---
title: "CatalogEdge"
description: "Shopify GraphQL Admin API documentation for catalogedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogedge

Markdown Content:
CatalogEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogedge#main-content)
...
[Anchor to CatalogEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogedge#top)
Catalog Edge
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogedge#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogedge#field-CatalogEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogedge#field-CatalogEdge.fields.node)node
...
*   <->[CatalogConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CatalogConnection#field-edges)
