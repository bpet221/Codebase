---
title: "DiscountAllocationEdge"
description: "Shopify GraphQL Admin API documentation for discountallocationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocationedge

Markdown Content:
DiscountAllocationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocationedge#main-content)
...
[Anchor to DiscountAllocationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocationedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocationedge#field-DiscountAllocationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocationedge#field-DiscountAllocationEdge.fields.node)node
...
*   <->[DiscountAllocationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DiscountAllocationConnection#field-edges)
