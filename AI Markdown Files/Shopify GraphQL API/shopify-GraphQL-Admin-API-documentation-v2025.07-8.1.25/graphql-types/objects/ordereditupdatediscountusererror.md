---
title: "OrderEditUpdateDiscountUserError"
description: "Shopify GraphQL Admin API documentation for ordereditupdatediscountusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror

Markdown Content:
OrderEditUpdateDiscountUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#interfaces)
...
[Anchor to OrderEditUpdateDiscountUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#field-OrderEditUpdateDiscountUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#field-OrderEditUpdateDiscountUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#field-OrderEditUpdateDiscountUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to orderEditUpdateDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#mutation-orderEditUpdateDiscount)[order Edit Update Discount](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderEditUpdateDiscount)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditupdatediscountusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
