---
title: "ReverseDeliveryEdge"
description: "Shopify GraphQL Admin API documentation for reversedeliveryedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliveryedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliveryedge

Markdown Content:
ReverseDeliveryEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliveryedge#main-content)
...
[Anchor to ReverseDeliveryEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliveryedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliveryedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliveryedge#field-ReverseDeliveryEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliveryedge#field-ReverseDeliveryEdge.fields.node)node
...
*   <->[ReverseDeliveryConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReverseDeliveryConnection#field-edges)
