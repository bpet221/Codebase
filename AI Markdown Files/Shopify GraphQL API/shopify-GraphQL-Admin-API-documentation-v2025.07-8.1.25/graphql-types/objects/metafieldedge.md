---
title: "MetafieldEdge"
description: "Shopify GraphQL Admin API documentation for metafieldedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldedge

Markdown Content:
MetafieldEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldedge#main-content)
...
[Anchor to MetafieldEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldedge#top)
Metafield Edge
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldedge#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldedge#field-MetafieldEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldedge#field-MetafieldEdge.fields.node)node
...
*   <->[MetafieldConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MetafieldConnection#field-edges)
