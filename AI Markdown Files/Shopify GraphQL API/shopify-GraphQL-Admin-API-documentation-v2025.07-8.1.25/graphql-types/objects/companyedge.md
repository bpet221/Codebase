---
title: "CompanyEdge"
description: "Shopify GraphQL Admin API documentation for companyedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/companyedge"
...
Title: CompanyEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/companyedge

Markdown Content:
CompanyEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/companyedge#main-content)
...
[Anchor to CompanyEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/companyedge#top)
Company Edge
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/companyedge#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/companyedge#field-CompanyEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/companyedge#field-CompanyEdge.fields.node)node
...
*   <->[CompanyConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CompanyConnection#field-edges)
