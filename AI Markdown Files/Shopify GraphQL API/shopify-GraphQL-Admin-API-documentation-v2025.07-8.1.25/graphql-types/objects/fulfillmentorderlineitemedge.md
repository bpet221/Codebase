---
title: "FulfillmentOrderLineItemEdge"
description: "Shopify GraphQL Admin API documentation for fulfillmentorderlineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlineitemedge

Markdown Content:
FulfillmentOrderLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlineitemedge#main-content)
...
[Anchor to FulfillmentOrderLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlineitemedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlineitemedge#field-FulfillmentOrderLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlineitemedge#field-FulfillmentOrderLineItemEdge.fields.node)node
...
*   <->[FulfillmentOrderLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/FulfillmentOrderLineItemConnection#field-edges)
