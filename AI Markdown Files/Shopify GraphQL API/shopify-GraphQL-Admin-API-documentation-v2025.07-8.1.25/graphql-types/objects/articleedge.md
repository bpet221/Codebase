---
title: "ArticleEdge"
description: "Shopify GraphQL Admin API documentation for articleedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/articleedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/articleedge

Markdown Content:
ArticleEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleedge#main-content)
...
[Anchor to ArticleEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleedge#top)
Article Edge
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleedge#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleedge#field-ArticleEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/articleedge#field-ArticleEdge.fields.node)node
...
*   <->[ArticleConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ArticleConnection#field-edges)
