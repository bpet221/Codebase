---
title: "TenderTransactionEdge"
description: "Shopify GraphQL Admin API documentation for tendertransactionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactionedge

Markdown Content:
TenderTransactionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactionedge#main-content)
...
[Anchor to TenderTransactionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactionedge#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactionedge#field-TenderTransactionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactionedge#field-TenderTransactionEdge.fields.node)node
...
*   <->[TenderTransactionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/TenderTransactionConnection#field-edges)
