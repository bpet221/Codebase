---
title: "QuantityPriceBreakEdge"
description: "Shopify GraphQL Admin API documentation for quantitypricebreakedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreakedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreakedge

Markdown Content:
QuantityPriceBreakEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreakedge#main-content)
...
[Anchor to QuantityPriceBreakEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreakedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreakedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreakedge#field-QuantityPriceBreakEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreakedge#field-QuantityPriceBreakEdge.fields.node)node
...
*   <->[QuantityPriceBreakConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/QuantityPriceBreakConnection#field-edges)
