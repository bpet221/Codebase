---
title: "AbandonmentEmailStateUpdateUserError"
description: "Shopify GraphQL Admin API documentation for abandonmentemailstateupdateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror

Markdown Content:
AbandonmentEmailStateUpdateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#interfaces)
...
[Anchor to AbandonmentEmailStateUpdateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#field-AbandonmentEmailStateUpdateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#field-AbandonmentEmailStateUpdateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#field-AbandonmentEmailStateUpdateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to abandonmentEmailStateUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#mutation-abandonmentEmailStateUpdate)[abandonment Email State Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentEmailStateUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentemailstateupdateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
