---
title: "InventoryTransferLineItemEdge"
description: "Shopify GraphQL Admin API documentation for inventorytransferlineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferlineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferlineitemedge

Markdown Content:
InventoryTransferLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferlineitemedge#main-content)
...
[Anchor to InventoryTransferLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferlineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferlineitemedge#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferlineitemedge#field-InventoryTransferLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransferlineitemedge#field-InventoryTransferLineItemEdge.fields.node)node
...
*   <->[InventoryTransferLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/InventoryTransferLineItemConnection#field-edges)
