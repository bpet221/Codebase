---
title: "StandardMetafieldDefinitionTemplateEdge"
description: "Shopify GraphQL Admin API documentation for standardmetafielddefinitiontemplateedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitiontemplateedge"
...
Title: StandardMetafieldDefinitionTemplateEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitiontemplateedge

Markdown Content:
StandardMetafieldDefinitionTemplateEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitiontemplateedge#main-content)
...
[Anchor to StandardMetafieldDefinitionTemplateEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitiontemplateedge#top)
Standard Metafield Definition Template Edge
===========================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitiontemplateedge#fields)Fields
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitiontemplateedge#field-StandardMetafieldDefinitionTemplateEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitiontemplateedge#field-StandardMetafieldDefinitionTemplateEdge.fields.node)node
...
*   <->[StandardMetafieldDefinitionTemplateConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/StandardMetafieldDefinitionTemplateConnection#field-edges)
