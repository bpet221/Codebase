---
title: "ShopResourceFeedbackCreateUserError"
description: "Shopify GraphQL Admin API documentation for shopresourcefeedbackcreateusererror"
date: "2025-08-01"
...
Title: ShopResourceFeedbackCreateUserError - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror

Markdown Content:
ShopResourceFeedbackCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#interfaces)
...
[Anchor to ShopResourceFeedbackCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#top)
Shop Resource Feedback Create User Error
========================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#field-ShopResourceFeedbackCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#field-ShopResourceFeedbackCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#field-ShopResourceFeedbackCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to shopResourceFeedbackCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#mutation-shopResourceFeedbackCreate)[shop Resource Feedback Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shopResourceFeedbackCreate)
...
<~>ShopResourceFeedbackCreateUserError Mutations
------------------------------------------------
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopresourcefeedbackcreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
...
||-ShopResourceFeedbackCreateUserError Implements
-------------------------------------------------
