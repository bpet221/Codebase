---
title: "AbandonmentUpdateActivitiesDeliveryStatusesUserError"
description: "Shopify GraphQL Admin API documentation for abandonmentupdateactivitiesdeliverystatusesusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror

Markdown Content:
AbandonmentUpdateActivitiesDeliveryStatusesUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#interfaces)
...
[Anchor to AbandonmentUpdateActivitiesDeliveryStatusesUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#field-AbandonmentUpdateActivitiesDeliveryStatusesUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#field-AbandonmentUpdateActivitiesDeliveryStatusesUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#field-AbandonmentUpdateActivitiesDeliveryStatusesUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to abandonmentUpdateActivitiesDeliveryStatuses](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#mutation-abandonmentUpdateActivitiesDeliveryStatuses)[abandonment Update Activities Delivery Statuses](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentUpdateActivitiesDeliveryStatuses)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonmentupdateactivitiesdeliverystatusesusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
