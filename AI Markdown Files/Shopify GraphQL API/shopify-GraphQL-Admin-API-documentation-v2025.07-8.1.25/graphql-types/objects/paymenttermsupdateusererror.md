---
title: "PaymentTermsUpdateUserError"
description: "Shopify GraphQL Admin API documentation for paymenttermsupdateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror

Markdown Content:
PaymentTermsUpdateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#interfaces)
...
[Anchor to PaymentTermsUpdateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#field-PaymentTermsUpdateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#field-PaymentTermsUpdateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#field-PaymentTermsUpdateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to paymentTermsUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#mutation-paymentTermsUpdate)[payment Terms Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/paymentTermsUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsupdateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
