---
title: "SubscriptionDraftUserError"
description: "Shopify GraphQL Admin API documentation for subscriptiondraftusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror

Markdown Content:
SubscriptionDraftUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#interfaces)
...
[Anchor to SubscriptionDraftUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#field-SubscriptionDraftUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#field-SubscriptionDraftUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#field-SubscriptionDraftUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------

[Anchor to subscriptionBillingCycleContractDraftCommit](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionBillingCycleContractDraftCommit)[subscription Billing Cycle Contract Draft Commit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionBillingCycleContractDraftCommit)
...
[Anchor to subscriptionContractAtomicCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionContractAtomicCreate)[subscription Contract Atomic Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionContractAtomicCreate)
...
[Anchor to subscriptionContractCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionContractCreate)[subscription Contract Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionContractCreate)
...
[Anchor to subscriptionContractProductChange](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionContractProductChange)[subscription Contract Product Change](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionContractProductChange)
...
[Anchor to subscriptionContractUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionContractUpdate)[subscription Contract Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionContractUpdate)
...
[Anchor to subscriptionDraftCommit](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionDraftCommit)[subscription Draft Commit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftCommit)
...
[Anchor to subscriptionDraftDiscountAdd](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionDraftDiscountAdd)[subscription Draft Discount Add](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftDiscountAdd)
...
[Anchor to subscriptionDraftDiscountCodeApply](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionDraftDiscountCodeApply)[subscription Draft Discount Code Apply](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftDiscountCodeApply)
...
[Anchor to subscriptionDraftDiscountRemove](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionDraftDiscountRemove)[subscription Draft Discount Remove](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftDiscountRemove)
...
[Anchor to subscriptionDraftDiscountUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionDraftDiscountUpdate)[subscription Draft Discount Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftDiscountUpdate)
...
[Anchor to subscriptionDraftLineAdd](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionDraftLineAdd)[subscription Draft Line Add](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftLineAdd)
...
[Anchor to subscriptionDraftLineRemove](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionDraftLineRemove)[subscription Draft Line Remove](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftLineRemove)
...
[Anchor to subscriptionDraftLineUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionDraftLineUpdate)[subscription Draft Line Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftLineUpdate)
...
[Anchor to subscriptionDraftUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#mutation-subscriptionDraftUpdate)[subscription Draft Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondraftusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
