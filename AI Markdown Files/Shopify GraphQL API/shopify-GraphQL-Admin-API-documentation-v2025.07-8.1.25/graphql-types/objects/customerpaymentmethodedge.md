...
description: "Shopify GraphQL Admin API documentation for customerpaymentmethodedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodedge

Markdown Content:
CustomerPaymentMethodEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodedge#main-content)
...
[Anchor to CustomerPaymentMethodEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodedge#field-CustomerPaymentMethodEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodedge#field-CustomerPaymentMethodEdge.fields.node)node
...
*   <->[CustomerPaymentMethodConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CustomerPaymentMethodConnection#field-edges)
