---
title: "TaxonomyValueEdge"
description: "Shopify GraphQL Admin API documentation for taxonomyvalueedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalueedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalueedge

Markdown Content:
TaxonomyValueEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalueedge#main-content)
...
[Anchor to TaxonomyValueEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalueedge#top)
Taxonomy Value Edge
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalueedge#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalueedge#field-TaxonomyValueEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalueedge#field-TaxonomyValueEdge.fields.node)node
...
*   <->[TaxonomyValueConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/TaxonomyValueConnection#field-edges)
