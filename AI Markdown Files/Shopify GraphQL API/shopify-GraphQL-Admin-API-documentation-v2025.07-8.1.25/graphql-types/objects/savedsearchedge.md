---
title: "SavedSearchEdge"
description: "Shopify GraphQL Admin API documentation for savedsearchedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearchedge"
...
Title: SavedSearchEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearchedge

Markdown Content:
SavedSearchEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearchedge#main-content)
...
[Anchor to SavedSearchEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearchedge#top)
Saved Search Edge
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearchedge#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearchedge#field-SavedSearchEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/savedsearchedge#field-SavedSearchEdge.fields.node)node
...
*   <->[SavedSearchConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SavedSearchConnection#field-edges)
