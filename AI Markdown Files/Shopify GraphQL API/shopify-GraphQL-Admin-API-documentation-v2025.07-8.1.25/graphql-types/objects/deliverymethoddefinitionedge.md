---
title: "DeliveryMethodDefinitionEdge"
description: "Shopify GraphQL Admin API documentation for deliverymethoddefinitionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitionedge

Markdown Content:
DeliveryMethodDefinitionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitionedge#main-content)
...
[Anchor to DeliveryMethodDefinitionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitionedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitionedge#field-DeliveryMethodDefinitionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitionedge#field-DeliveryMethodDefinitionEdge.fields.node)node
...
*   <->[DeliveryMethodDefinitionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryMethodDefinitionConnection#field-edges)
