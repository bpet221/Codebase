---
title: "GiftCardSendNotificationToRecipientUserError"
description: "Shopify GraphQL Admin API documentation for giftcardsendnotificationtorecipientusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror

Markdown Content:
GiftCardSendNotificationToRecipientUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#interfaces)
...
[Anchor to GiftCardSendNotificationToRecipientUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#field-GiftCardSendNotificationToRecipientUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#field-GiftCardSendNotificationToRecipientUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#field-GiftCardSendNotificationToRecipientUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to giftCardSendNotificationToRecipient](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#mutation-giftCardSendNotificationToRecipient)[gift Card Send Notification To Recipient](https://shopify.dev/docs/api/admin-graphql/latest/mutations/giftCardSendNotificationToRecipient)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsendnotificationtorecipientusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
