---
title: "FulfillmentOrderLocationForMoveEdge"
description: "Shopify GraphQL Admin API documentation for fulfillmentorderlocationformoveedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformoveedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformoveedge

Markdown Content:
FulfillmentOrderLocationForMoveEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformoveedge#main-content)
...
[Anchor to FulfillmentOrderLocationForMoveEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformoveedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformoveedge#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformoveedge#field-FulfillmentOrderLocationForMoveEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformoveedge#field-FulfillmentOrderLocationForMoveEdge.fields.node)node
...
*   <->[FulfillmentOrderLocationForMoveConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/FulfillmentOrderLocationForMoveConnection#field-edges)
