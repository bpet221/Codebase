...
description: "Shopify GraphQL Admin API documentation for urlredirectusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror

Markdown Content:
UrlRedirectUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#interfaces)
...
[Anchor to UrlRedirectUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#field-UrlRedirectUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#field-UrlRedirectUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#field-UrlRedirectUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------

[Anchor to urlRedirectCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#mutation-urlRedirectCreate)[url Redirect Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlRedirectCreate)
...
[Anchor to urlRedirectDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#mutation-urlRedirectDelete)[url Redirect Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlRedirectDelete)
...
[Anchor to urlRedirectUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#mutation-urlRedirectUpdate)[url Redirect Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlRedirectUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
