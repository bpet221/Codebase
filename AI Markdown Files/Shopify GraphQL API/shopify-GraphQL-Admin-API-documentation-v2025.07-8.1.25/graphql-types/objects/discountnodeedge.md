---
title: "DiscountNodeEdge"
description: "Shopify GraphQL Admin API documentation for discountnodeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountnodeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountnodeedge

Markdown Content:
DiscountNodeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountnodeedge#main-content)
...
[Anchor to DiscountNodeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountnodeedge#top)
Discount Node Edge
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountnodeedge#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountnodeedge#field-DiscountNodeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountnodeedge#field-DiscountNodeEdge.fields.node)node
...
*   <->[DiscountNodeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DiscountNodeConnection#field-edges)
