...
description: "Shopify GraphQL Admin API documentation for fulfillmentlineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentlineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentlineitemedge

Markdown Content:
FulfillmentLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentlineitemedge#main-content)
...
[Anchor to FulfillmentLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentlineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentlineitemedge#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentlineitemedge#field-FulfillmentLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentlineitemedge#field-FulfillmentLineItemEdge.fields.node)node
...
*   <->[FulfillmentLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/FulfillmentLineItemConnection#field-edges)
