---
title: "FulfillmentOrdersSetFulfillmentDeadlineUserError"
description: "Shopify GraphQL Admin API documentation for fulfillmentorderssetfulfillmentdeadlineusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror

Markdown Content:
FulfillmentOrdersSetFulfillmentDeadlineUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#interfaces)
...
[Anchor to FulfillmentOrdersSetFulfillmentDeadlineUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#field-FulfillmentOrdersSetFulfillmentDeadlineUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#field-FulfillmentOrdersSetFulfillmentDeadlineUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#field-FulfillmentOrdersSetFulfillmentDeadlineUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to fulfillmentOrdersSetFulfillmentDeadline](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#mutation-fulfillmentOrdersSetFulfillmentDeadline)[fulfillment Orders Set Fulfillment Deadline](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentOrdersSetFulfillmentDeadline)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderssetfulfillmentdeadlineusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
