---
title: "ShopifyPaymentsBankAccountEdge"
description: "Shopify GraphQL Admin API documentation for shopifypaymentsbankaccountedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbankaccountedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbankaccountedge

Markdown Content:
ShopifyPaymentsBankAccountEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbankaccountedge#main-content)
...
[Anchor to ShopifyPaymentsBankAccountEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbankaccountedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbankaccountedge#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbankaccountedge#field-ShopifyPaymentsBankAccountEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbankaccountedge#field-ShopifyPaymentsBankAccountEdge.fields.node)node
...
*   <->[ShopifyPaymentsBankAccountConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ShopifyPaymentsBankAccountConnection#field-edges)
