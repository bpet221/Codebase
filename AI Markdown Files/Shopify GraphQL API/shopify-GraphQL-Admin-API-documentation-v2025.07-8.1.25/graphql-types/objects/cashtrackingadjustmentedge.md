---
title: "CashTrackingAdjustmentEdge"
description: "Shopify GraphQL Admin API documentation for cashtrackingadjustmentedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/cashtrackingadjustmentedge"
...
Title: CashTrackingAdjustmentEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/cashtrackingadjustmentedge

Markdown Content:
CashTrackingAdjustmentEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashtrackingadjustmentedge#main-content)
...
[Anchor to CashTrackingAdjustmentEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashtrackingadjustmentedge#top)
Cash Tracking Adjustment Edge
=============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashtrackingadjustmentedge#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashtrackingadjustmentedge#field-CashTrackingAdjustmentEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashtrackingadjustmentedge#field-CashTrackingAdjustmentEdge.fields.node)node
...
*   <->[CashTrackingAdjustmentConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CashTrackingAdjustmentConnection#field-edges)
