---
title: "SellingPlanGroupEdge"
description: "Shopify GraphQL Admin API documentation for sellingplangroupedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupedge

Markdown Content:
SellingPlanGroupEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupedge#main-content)
...
[Anchor to SellingPlanGroupEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupedge#field-SellingPlanGroupEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplangroupedge#field-SellingPlanGroupEdge.fields.node)node
...
*   <->[SellingPlanGroupConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SellingPlanGroupConnection#field-edges)
