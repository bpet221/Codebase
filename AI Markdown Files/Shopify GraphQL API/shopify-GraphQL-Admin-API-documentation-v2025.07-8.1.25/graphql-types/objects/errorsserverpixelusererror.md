---
title: "ErrorsServerPixelUserError"
description: "Shopify GraphQL Admin API documentation for errorsserverpixelusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror

Markdown Content:
ErrorsServerPixelUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#interfaces)
...
[Anchor to ErrorsServerPixelUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#field-ErrorsServerPixelUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#field-ErrorsServerPixelUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#field-ErrorsServerPixelUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------

[Anchor to eventBridgeServerPixelUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#mutation-eventBridgeServerPixelUpdate)[event Bridge Server Pixel Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/eventBridgeServerPixelUpdate)
...
[Anchor to pubSubServerPixelUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#mutation-pubSubServerPixelUpdate)[pub Sub Server Pixel Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pubSubServerPixelUpdate)
...
[Anchor to serverPixelCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#mutation-serverPixelCreate)[server Pixel Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/serverPixelCreate)
...
[Anchor to serverPixelDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#mutation-serverPixelDelete)[server Pixel Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/serverPixelDelete)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorsserverpixelusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
