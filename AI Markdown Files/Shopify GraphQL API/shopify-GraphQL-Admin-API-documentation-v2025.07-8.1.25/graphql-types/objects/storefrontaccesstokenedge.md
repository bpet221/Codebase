---
title: "StorefrontAccessTokenEdge"
description: "Shopify GraphQL Admin API documentation for storefrontaccesstokenedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/storefrontaccesstokenedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/storefrontaccesstokenedge

Markdown Content:
StorefrontAccessTokenEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/storefrontaccesstokenedge#main-content)
...
[Anchor to StorefrontAccessTokenEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/storefrontaccesstokenedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storefrontaccesstokenedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/storefrontaccesstokenedge#field-StorefrontAccessTokenEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/storefrontaccesstokenedge#field-StorefrontAccessTokenEdge.fields.node)node
...
*   <->[StorefrontAccessTokenConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/StorefrontAccessTokenConnection#field-edges)
