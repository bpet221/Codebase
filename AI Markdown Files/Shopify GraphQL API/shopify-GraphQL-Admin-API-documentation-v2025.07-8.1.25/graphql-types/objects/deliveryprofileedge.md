---
title: "DeliveryProfileEdge"
description: "Shopify GraphQL Admin API documentation for deliveryprofileedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileedge

Markdown Content:
DeliveryProfileEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileedge#main-content)
...
[Anchor to DeliveryProfileEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileedge#field-DeliveryProfileEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileedge#field-DeliveryProfileEdge.fields.node)node
...
*   <->[DeliveryProfileConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryProfileConnection#field-edges)
