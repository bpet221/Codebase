---
title: "InventoryBulkToggleActivationUserError"
description: "Shopify GraphQL Admin API documentation for inventorybulktoggleactivationusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror

Markdown Content:
InventoryBulkToggleActivationUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#interfaces)
...
[Anchor to InventoryBulkToggleActivationUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#field-InventoryBulkToggleActivationUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#field-InventoryBulkToggleActivationUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#field-InventoryBulkToggleActivationUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to inventoryBulkToggleActivation](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#mutation-inventoryBulkToggleActivation)[inventory Bulk Toggle Activation](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryBulkToggleActivation)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorybulktoggleactivationusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
