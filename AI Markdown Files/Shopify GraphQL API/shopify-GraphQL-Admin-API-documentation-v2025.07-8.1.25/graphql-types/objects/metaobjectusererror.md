---
title: "MetaobjectUserError"
description: "Shopify GraphQL Admin API documentation for metaobjectusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror

Markdown Content:
MetaobjectUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#interfaces)
...
[Anchor to MetaobjectUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#field-MetaobjectUserError.fields.code)code
...
[Anchor to elementIndex](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#field-MetaobjectUserError.fields.elementIndex)element Index

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The index of the failing list element in an array.

[Anchor to elementKey](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#field-MetaobjectUserError.fields.elementKey)element Key

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The key of the failing object element.

[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#field-MetaobjectUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#field-MetaobjectUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------

[Anchor to metaobjectBulkDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutation-metaobjectBulkDelete)[metaobject Bulk Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metaobjectBulkDelete)
...
[Anchor to metaobjectCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutation-metaobjectCreate)[metaobject Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metaobjectCreate)
...
[Anchor to metaobjectDefinitionCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutation-metaobjectDefinitionCreate)[metaobject Definition Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metaobjectDefinitionCreate)
...
[Anchor to metaobjectDefinitionDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutation-metaobjectDefinitionDelete)[metaobject Definition Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metaobjectDefinitionDelete)
...
[Anchor to metaobjectDefinitionUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutation-metaobjectDefinitionUpdate)[metaobject Definition Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metaobjectDefinitionUpdate)
...
[Anchor to metaobjectDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutation-metaobjectDelete)[metaobject Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metaobjectDelete)
...
[Anchor to metaobjectUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutation-metaobjectUpdate)[metaobject Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metaobjectUpdate)
...
[Anchor to metaobjectUpsert](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutation-metaobjectUpsert)[metaobject Upsert](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metaobjectUpsert)
...
[Anchor to standardMetaobjectDefinitionEnable](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#mutation-standardMetaobjectDefinitionEnable)[standard Metaobject Definition Enable](https://shopify.dev/docs/api/admin-graphql/latest/mutations/standardMetaobjectDefinitionEnable)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
