---
title: "ErrorsWebPixelUserError"
description: "Shopify GraphQL Admin API documentation for errorswebpixelusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror

Markdown Content:
ErrorsWebPixelUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#interfaces)
...
[Anchor to ErrorsWebPixelUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#field-ErrorsWebPixelUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#field-ErrorsWebPixelUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#field-ErrorsWebPixelUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------

[Anchor to webPixelCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#mutation-webPixelCreate)[web Pixel Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webPixelCreate)
...
[Anchor to webPixelDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#mutation-webPixelDelete)[web Pixel Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webPixelDelete)
...
[Anchor to webPixelUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#mutation-webPixelUpdate)[web Pixel Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webPixelUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/errorswebpixelusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
