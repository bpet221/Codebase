---
title: "CompanyLocationStaffMemberAssignmentEdge"
description: "Shopify GraphQL Admin API documentation for companylocationstaffmemberassignmentedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/companylocationstaffmemberassignmentedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/companylocationstaffmemberassignmentedge

Markdown Content:
CompanyLocationStaffMemberAssignmentEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/companylocationstaffmemberassignmentedge#main-content)
...
[Anchor to CompanyLocationStaffMemberAssignmentEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/companylocationstaffmemberassignmentedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/companylocationstaffmemberassignmentedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/companylocationstaffmemberassignmentedge#field-CompanyLocationStaffMemberAssignmentEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/companylocationstaffmemberassignmentedge#field-CompanyLocationStaffMemberAssignmentEdge.fields.node)node
...
*   <->[CompanyLocationStaffMemberAssignmentConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CompanyLocationStaffMemberAssignmentConnection#field-edges)
