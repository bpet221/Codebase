---
title: "BusinessCustomerUserError"
description: "Shopify GraphQL Admin API documentation for businesscustomerusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror

Markdown Content:
BusinessCustomerUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#interfaces)
...
[Anchor to BusinessCustomerUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#field-BusinessCustomerUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#field-BusinessCustomerUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#field-BusinessCustomerUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to companiesDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companiesDelete)[companies Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companiesDelete)
...
[Anchor to companyAddressDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyAddressDelete)[company Address Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyAddressDelete)
...
[Anchor to companyAssignCustomerAsContact](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyAssignCustomerAsContact)[company Assign Customer As Contact](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyAssignCustomerAsContact)
...
[Anchor to companyAssignMainContact](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyAssignMainContact)[company Assign Main Contact](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyAssignMainContact)
...
[Anchor to companyContactAssignRole](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyContactAssignRole)[company Contact Assign Role](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyContactAssignRole)
...
[Anchor to companyContactAssignRoles](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyContactAssignRoles)[company Contact Assign Roles](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyContactAssignRoles)
...
[Anchor to companyContactCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyContactCreate)[company Contact Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyContactCreate)
...
[Anchor to companyContactDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyContactDelete)[company Contact Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyContactDelete)
...
[Anchor to companyContactRemoveFromCompany](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyContactRemoveFromCompany)[company Contact Remove From Company](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyContactRemoveFromCompany)
...
[Anchor to companyContactRevokeRole](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyContactRevokeRole)[company Contact Revoke Role](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyContactRevokeRole)
...
[Anchor to companyContactRevokeRoles](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyContactRevokeRoles)[company Contact Revoke Roles](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyContactRevokeRoles)
...
[Anchor to companyContactsDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyContactsDelete)[company Contacts Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyContactsDelete)
...
[Anchor to companyContactUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyContactUpdate)[company Contact Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyContactUpdate)
...
[Anchor to companyCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyCreate)[company Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyCreate)
...
[Anchor to companyDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyDelete)[company Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyDelete)
...
[Anchor to companyLocationAssignAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationAssignAddress)[company Location Assign Address](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationAssignAddress)
...
[Anchor to companyLocationAssignRoles](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationAssignRoles)[company Location Assign Roles](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationAssignRoles)
...
[Anchor to companyLocationAssignStaffMembers](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationAssignStaffMembers)[company Location Assign Staff Members](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationAssignStaffMembers)
...
[Anchor to companyLocationCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationCreate)[company Location Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationCreate)
...
[Anchor to companyLocationDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationDelete)[company Location Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationDelete)
...
[Anchor to companyLocationRemoveStaffMembers](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationRemoveStaffMembers)[company Location Remove Staff Members](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationRemoveStaffMembers)
...
[Anchor to companyLocationRevokeRoles](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationRevokeRoles)[company Location Revoke Roles](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationRevokeRoles)
...
[Anchor to companyLocationsDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationsDelete)[company Locations Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationsDelete)
...
[Anchor to companyLocationTaxSettingsUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationTaxSettingsUpdate)[company Location Tax Settings Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationTaxSettingsUpdate)
...
[Anchor to companyLocationUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationUpdate)[company Location Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationUpdate)
...
[Anchor to companyRevokeMainContact](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyRevokeMainContact)[company Revoke Main Contact](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyRevokeMainContact)
...
[Anchor to companyUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyUpdate)[company Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyUpdate)
...
[Anchor to companyLocationAssignTaxExemptions](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationAssignTaxExemptions)[company Location Assign Tax Exemptions](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationAssignTaxExemptions)
...
[Anchor to companyLocationCreateTaxRegistration](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationCreateTaxRegistration)[company Location Create Tax Registration](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationCreateTaxRegistration)
...
[Anchor to companyLocationRevokeTaxExemptions](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationRevokeTaxExemptions)[company Location Revoke Tax Exemptions](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationRevokeTaxExemptions)
...
[Anchor to companyLocationRevokeTaxRegistration](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#mutation-companyLocationRevokeTaxRegistration)[company Location Revoke Tax Registration](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyLocationRevokeTaxRegistration)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/businesscustomerusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
