---
title: "DiscountApplicationEdge"
description: "Shopify GraphQL Admin API documentation for discountapplicationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountapplicationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountapplicationedge

Markdown Content:
DiscountApplicationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountapplicationedge#main-content)
...
[Anchor to DiscountApplicationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountapplicationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountapplicationedge#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountapplicationedge#field-DiscountApplicationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountapplicationedge#field-DiscountApplicationEdge.fields.node)node
...
*   <->[DiscountApplicationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/DiscountApplicationConnection#field-edges)
