---
title: "TranslationUserError"
description: "Shopify GraphQL Admin API documentation for translationusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror

Markdown Content:
TranslationUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#interfaces)
...
[Anchor to TranslationUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#field-TranslationUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#field-TranslationUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#field-TranslationUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------

[Anchor to marketLocalizationsRegister](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#mutation-marketLocalizationsRegister)[market Localizations Register](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketLocalizationsRegister)
...
[Anchor to marketLocalizationsRemove](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#mutation-marketLocalizationsRemove)[market Localizations Remove](https://shopify.dev/docs/api/admin-graphql/latest/mutations/marketLocalizationsRemove)
...
[Anchor to translationsRegister](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#mutation-translationsRegister)[translations Register](https://shopify.dev/docs/api/admin-graphql/latest/mutations/translationsRegister)
...
[Anchor to translationsRemove](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#mutation-translationsRemove)[translations Remove](https://shopify.dev/docs/api/admin-graphql/latest/mutations/translationsRemove)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/translationusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
