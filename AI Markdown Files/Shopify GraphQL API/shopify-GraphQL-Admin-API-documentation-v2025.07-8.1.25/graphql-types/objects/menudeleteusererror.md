---
title: "MenuDeleteUserError"
description: "Shopify GraphQL Admin API documentation for menudeleteusererror"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror

Markdown Content:
MenuDeleteUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#interfaces)
...
[Anchor to MenuDeleteUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#field-MenuDeleteUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#field-MenuDeleteUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#field-MenuDeleteUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------

[Anchor to menuDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#mutation-menuDelete)[menu Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/menuDelete)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/menudeleteusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
