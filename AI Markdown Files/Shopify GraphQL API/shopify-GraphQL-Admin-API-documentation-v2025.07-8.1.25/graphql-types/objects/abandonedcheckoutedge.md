---
title: "AbandonedCheckoutEdge"
description: "Shopify GraphQL Admin API documentation for abandonedcheckoutedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutedge

Markdown Content:
AbandonedCheckoutEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutedge#main-content)
...
[Anchor to AbandonedCheckoutEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutedge#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutedge#field-AbandonedCheckoutEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/abandonedcheckoutedge#field-AbandonedCheckoutEdge.fields.node)node
...
*   <->[AbandonedCheckoutConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/AbandonedCheckoutConnection#field-edges)
