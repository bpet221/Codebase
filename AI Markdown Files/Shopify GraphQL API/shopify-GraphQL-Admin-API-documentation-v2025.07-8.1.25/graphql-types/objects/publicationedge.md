...
description: "Shopify GraphQL Admin API documentation for publicationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationedge

Markdown Content:
PublicationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationedge#main-content)
...
[Anchor to PublicationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationedge#top)
Publication Edge
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationedge#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationedge#field-PublicationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationedge#field-PublicationEdge.fields.node)node
...
*   <->[PublicationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/PublicationConnection#field-edges)
