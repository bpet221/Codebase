---
title: "SaleEdge"
description: "Shopify GraphQL Admin API documentation for saleedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/saleedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/saleedge

Markdown Content:
SaleEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleedge#main-content)
...
[Anchor to SaleEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleedge#top)
Sale Edge
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleedge#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleedge#field-SaleEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleedge#field-SaleEdge.fields.node)node
...
*   <->[SaleConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SaleConnection#field-edges)
