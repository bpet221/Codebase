---
title: "BlogCreateUserError"
description: "Shopify GraphQL Admin API documentation for blogcreateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror

Markdown Content:
BlogCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#interfaces)
...
[Anchor to BlogCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#field-BlogCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#field-BlogCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#field-BlogCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------

[Anchor to blogCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#mutation-blogCreate)[blog Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/blogCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogcreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
