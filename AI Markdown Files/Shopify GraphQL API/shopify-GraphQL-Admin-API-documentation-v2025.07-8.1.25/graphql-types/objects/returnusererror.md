---
title: "ReturnUserError"
description: "Shopify GraphQL Admin API documentation for returnusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror

Markdown Content:
ReturnUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#interfaces)
...
[Anchor to ReturnUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#top)
Return User Error
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#field-ReturnUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#field-ReturnUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#field-ReturnUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------

[Anchor to removeFromReturn](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-removeFromReturn)[remove From Return](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removeFromReturn)
...
[Anchor to returnApproveRequest](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnApproveRequest)[return Approve Request](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnApproveRequest)
...
[Anchor to returnCancel](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnCancel)[return Cancel](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnCancel)
...
[Anchor to returnClose](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnClose)[return Close](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnClose)
...
[Anchor to returnCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnCreate)[return Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnCreate)
...
[Anchor to returnDeclineRequest](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnDeclineRequest)[return Decline Request](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnDeclineRequest)
...
[Anchor to returnProcess](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnProcess)[return Process](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnProcess)
...
[Anchor to returnReopen](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnReopen)[return Reopen](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnReopen)
...
[Anchor to returnRequest](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnRequest)[return Request](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnRequest)
...
[Anchor to reverseDeliveryCreateWithShipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-reverseDeliveryCreateWithShipping)[reverse Delivery Create With Shipping](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reverseDeliveryCreateWithShipping)
...
[Anchor to reverseDeliveryShippingUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-reverseDeliveryShippingUpdate)[reverse Delivery Shipping Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reverseDeliveryShippingUpdate)
...
[Anchor to reverseFulfillmentOrderDispose](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-reverseFulfillmentOrderDispose)[reverse Fulfillment Order Dispose](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reverseFulfillmentOrderDispose)
...
[Anchor to returnLineItemRemoveFromReturn](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnLineItemRemoveFromReturn)[return Line Item Remove From Return](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnLineItemRemoveFromReturn)
...
[Anchor to returnRefund](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#mutation-returnRefund)[return Refund](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnRefund)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
