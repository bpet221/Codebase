---
title: "SegmentMigrationEdge"
description: "Shopify GraphQL Admin API documentation for segmentmigrationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigrationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigrationedge

Markdown Content:
SegmentMigrationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigrationedge#main-content)
...
[Anchor to SegmentMigrationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigrationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigrationedge#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigrationedge#field-SegmentMigrationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigrationedge#field-SegmentMigrationEdge.fields.node)node
...
*   <->[SegmentMigrationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SegmentMigrationConnection#field-edges)
