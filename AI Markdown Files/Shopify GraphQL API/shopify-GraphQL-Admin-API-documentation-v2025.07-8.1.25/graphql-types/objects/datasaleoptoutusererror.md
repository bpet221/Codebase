---
title: "DataSaleOptOutUserError"
description: "Shopify GraphQL Admin API documentation for datasaleoptoutusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror

Markdown Content:
DataSaleOptOutUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#interfaces)
...
[Anchor to DataSaleOptOutUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#field-DataSaleOptOutUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#field-DataSaleOptOutUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#field-DataSaleOptOutUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#mutations)Mutations
---------------------------------------------------------------------------------------------------------------------------

[Anchor to dataSaleOptOut](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#mutation-dataSaleOptOut)[data Sale Opt Out](https://shopify.dev/docs/api/admin-graphql/latest/mutations/dataSaleOptOut)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/datasaleoptoutusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
