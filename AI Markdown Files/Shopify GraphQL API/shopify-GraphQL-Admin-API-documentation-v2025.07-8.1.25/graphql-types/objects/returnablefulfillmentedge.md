---
title: "ReturnableFulfillmentEdge"
description: "Shopify GraphQL Admin API documentation for returnablefulfillmentedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentedge

Markdown Content:
ReturnableFulfillmentEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentedge#main-content)
...
[Anchor to ReturnableFulfillmentEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentedge#field-ReturnableFulfillmentEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentedge#field-ReturnableFulfillmentEdge.fields.node)node
...
*   <->[ReturnableFulfillmentConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReturnableFulfillmentConnection#field-edges)
