---
title: "ChannelEdge"
description: "Shopify GraphQL Admin API documentation for channeledge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/channeledge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/channeledge

Markdown Content:
ChannelEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeledge#main-content)
...
[Anchor to ChannelEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeledge#top)
Channel Edge
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeledge#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeledge#field-ChannelEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/channeledge#field-ChannelEdge.fields.node)node
...
*   <->[ChannelConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ChannelConnection#field-edges)
