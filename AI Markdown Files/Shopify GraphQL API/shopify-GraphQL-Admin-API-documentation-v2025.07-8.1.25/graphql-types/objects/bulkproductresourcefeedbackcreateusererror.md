---
title: "BulkProductResourceFeedbackCreateUserError"
description: "Shopify GraphQL Admin API documentation for bulkproductresourcefeedbackcreateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror

Markdown Content:
BulkProductResourceFeedbackCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#interfaces)
...
[Anchor to BulkProductResourceFeedbackCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#field-BulkProductResourceFeedbackCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#field-BulkProductResourceFeedbackCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#field-BulkProductResourceFeedbackCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to bulkProductResourceFeedbackCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#mutation-bulkProductResourceFeedbackCreate)[bulk Product Resource Feedback Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/bulkProductResourceFeedbackCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/bulkproductresourcefeedbackcreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
