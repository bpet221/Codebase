---
title: "WebhookSubscriptionEdge"
description: "Shopify GraphQL Admin API documentation for webhooksubscriptionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionedge

Markdown Content:
WebhookSubscriptionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionedge#main-content)
...
[Anchor to WebhookSubscriptionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionedge#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionedge#field-WebhookSubscriptionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/webhooksubscriptionedge#field-WebhookSubscriptionEdge.fields.node)node
...
*   <->[WebhookSubscriptionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/WebhookSubscriptionConnection#field-edges)
