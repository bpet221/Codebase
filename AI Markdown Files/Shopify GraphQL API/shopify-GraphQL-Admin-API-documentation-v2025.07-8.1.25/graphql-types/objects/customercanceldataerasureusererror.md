---
title: "CustomerCancelDataErasureUserError"
description: "Shopify GraphQL Admin API documentation for customercanceldataerasureusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror

Markdown Content:
CustomerCancelDataErasureUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#interfaces)
...
[Anchor to CustomerCancelDataErasureUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#field-CustomerCancelDataErasureUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#field-CustomerCancelDataErasureUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#field-CustomerCancelDataErasureUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to customerCancelDataErasure](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#mutation-customerCancelDataErasure)[customer Cancel Data Erasure](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customerCancelDataErasure)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customercanceldataerasureusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
