---
title: "CartTransformCreateUserError"
description: "Shopify GraphQL Admin API documentation for carttransformcreateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror

Markdown Content:
CartTransformCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#interfaces)
...
[Anchor to CartTransformCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#field-CartTransformCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#field-CartTransformCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#field-CartTransformCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to cartTransformCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#mutation-cartTransformCreate)[cart Transform Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/cartTransformCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformcreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
