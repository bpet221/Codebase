---
title: "MetafieldDefinitionConstraintValueEdge"
description: "Shopify GraphQL Admin API documentation for metafielddefinitionconstraintvalueedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionconstraintvalueedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionconstraintvalueedge

Markdown Content:
MetafieldDefinitionConstraintValueEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionconstraintvalueedge#main-content)
...
[Anchor to MetafieldDefinitionConstraintValueEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionconstraintvalueedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionconstraintvalueedge#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionconstraintvalueedge#field-MetafieldDefinitionConstraintValueEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafielddefinitionconstraintvalueedge#field-MetafieldDefinitionConstraintValueEdge.fields.node)node
...
*   <->[MetafieldDefinitionConstraintValueConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MetafieldDefinitionConstraintValueConnection#field-edges)
