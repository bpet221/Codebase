---
title: "StandardMetafieldDefinitionEnableUserError"
description: "Shopify GraphQL Admin API documentation for standardmetafielddefinitionenableusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror

Markdown Content:
StandardMetafieldDefinitionEnableUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#interfaces)
...
[Anchor to StandardMetafieldDefinitionEnableUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#field-StandardMetafieldDefinitionEnableUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#field-StandardMetafieldDefinitionEnableUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#field-StandardMetafieldDefinitionEnableUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to standardMetafieldDefinitionEnable](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#mutation-standardMetafieldDefinitionEnable)[standard Metafield Definition Enable](https://shopify.dev/docs/api/admin-graphql/latest/mutations/standardMetafieldDefinitionEnable)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardmetafielddefinitionenableusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
