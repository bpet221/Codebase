---
title: "CustomerEdge"
description: "Shopify GraphQL Admin API documentation for customeredge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customeredge"
...
Title: CustomerEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customeredge

Markdown Content:
CustomerEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeredge#main-content)
...
[Anchor to CustomerEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeredge#top)
Customer Edge
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeredge#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeredge#field-CustomerEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeredge#field-CustomerEdge.fields.node)node
...
*   <->[CustomerConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CustomerConnection#field-edges)
