...
description: "Shopify GraphQL Admin API documentation for productvariantedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantedge

Markdown Content:
ProductVariantEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantedge#main-content)
...
[Anchor to ProductVariantEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantedge#field-ProductVariantEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantedge#field-ProductVariantEdge.fields.node)node
...
*   <->[ProductVariantConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductVariantConnection#field-edges)
