---
title: "CustomerPaymentMethodCreateFromDuplicationDataUserError"
description: "Shopify GraphQL Admin API documentation for customerpaymentmethodcreatefromduplicationdatausererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror

Markdown Content:
CustomerPaymentMethodCreateFromDuplicationDataUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#interfaces)
...
[Anchor to CustomerPaymentMethodCreateFromDuplicationDataUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#field-CustomerPaymentMethodCreateFromDuplicationDataUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#field-CustomerPaymentMethodCreateFromDuplicationDataUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#field-CustomerPaymentMethodCreateFromDuplicationDataUserError.fields.message)message
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerpaymentmethodcreatefromduplicationdatausererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
