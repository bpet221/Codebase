---
title: "LocalizationExtensionEdge"
description: "Shopify GraphQL Admin API documentation for localizationextensionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/localizationextensionedge"
...
Title: LocalizationExtensionEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/localizationextensionedge

Markdown Content:
LocalizationExtensionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizationextensionedge#main-content)
...
[Anchor to LocalizationExtensionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizationextensionedge#top)
Localization Extension Edge
===========================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizationextensionedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizationextensionedge#field-LocalizationExtensionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/localizationextensionedge#field-LocalizationExtensionEdge.fields.node)node
...
*   <->[LocalizationExtensionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/LocalizationExtensionConnection#field-edges)
