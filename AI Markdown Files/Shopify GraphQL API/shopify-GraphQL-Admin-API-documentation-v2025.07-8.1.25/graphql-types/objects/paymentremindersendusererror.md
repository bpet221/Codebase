---
title: "PaymentReminderSendUserError"
description: "Shopify GraphQL Admin API documentation for paymentremindersendusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror

Markdown Content:
PaymentReminderSendUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#interfaces)
...
[Anchor to PaymentReminderSendUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#field-PaymentReminderSendUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#field-PaymentReminderSendUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#field-PaymentReminderSendUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to paymentReminderSend](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#mutation-paymentReminderSend)[payment Reminder Send](https://shopify.dev/docs/api/admin-graphql/latest/mutations/paymentReminderSend)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymentremindersendusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
