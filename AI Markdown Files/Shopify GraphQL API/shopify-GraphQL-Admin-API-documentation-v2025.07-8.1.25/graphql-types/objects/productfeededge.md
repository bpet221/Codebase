---
title: "ProductFeedEdge"
description: "Shopify GraphQL Admin API documentation for productfeededge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeededge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeededge

Markdown Content:
ProductFeedEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeededge#main-content)
...
[Anchor to ProductFeedEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeededge#top)
Product Feed Edge
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeededge#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeededge#field-ProductFeedEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productfeededge#field-ProductFeedEdge.fields.node)node
...
*   <->[ProductFeedConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductFeedConnection#field-edges)
