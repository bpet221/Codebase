---
title: "InventorySetQuantitiesUserError"
description: "Shopify GraphQL Admin API documentation for inventorysetquantitiesusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror

Markdown Content:
InventorySetQuantitiesUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#interfaces)
...
[Anchor to InventorySetQuantitiesUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#field-InventorySetQuantitiesUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#field-InventorySetQuantitiesUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#field-InventorySetQuantitiesUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to inventorySetQuantities](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#mutation-inventorySetQuantities)[inventory Set Quantities](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorySetQuantities)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorysetquantitiesusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
