---
title: "CustomerVisitProductInfoEdge"
description: "Shopify GraphQL Admin API documentation for customervisitproductinfoedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfoedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfoedge

Markdown Content:
CustomerVisitProductInfoEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfoedge#main-content)
...
[Anchor to CustomerVisitProductInfoEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfoedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfoedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfoedge#field-CustomerVisitProductInfoEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfoedge#field-CustomerVisitProductInfoEdge.fields.node)node
...
*   <->[CustomerVisitProductInfoConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CustomerVisitProductInfoConnection#field-edges)
