---
title: "CustomerMomentEdge"
description: "Shopify GraphQL Admin API documentation for customermomentedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customermomentedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customermomentedge

Markdown Content:
CustomerMomentEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermomentedge#main-content)
...
[Anchor to CustomerMomentEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermomentedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermomentedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermomentedge#field-CustomerMomentEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermomentedge#field-CustomerMomentEdge.fields.node)node
...
*   <->[CustomerMomentConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CustomerMomentConnection#field-edges)
