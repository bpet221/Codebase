---
title: "MarketCatalogEdge"
description: "Shopify GraphQL Admin API documentation for marketcatalogedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalogedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalogedge

Markdown Content:
MarketCatalogEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalogedge#main-content)
...
[Anchor to MarketCatalogEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalogedge#top)
Market Catalog Edge
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalogedge#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalogedge#field-MarketCatalogEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalogedge#field-MarketCatalogEdge.fields.node)node
...
*   <->[MarketCatalogConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MarketCatalogConnection#field-edges)
