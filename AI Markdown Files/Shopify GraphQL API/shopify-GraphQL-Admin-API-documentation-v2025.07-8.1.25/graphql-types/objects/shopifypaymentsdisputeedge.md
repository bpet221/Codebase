---
title: "ShopifyPaymentsDisputeEdge"
description: "Shopify GraphQL Admin API documentation for shopifypaymentsdisputeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsdisputeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsdisputeedge

Markdown Content:
ShopifyPaymentsDisputeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsdisputeedge#main-content)
...
[Anchor to ShopifyPaymentsDisputeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsdisputeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsdisputeedge#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsdisputeedge#field-ShopifyPaymentsDisputeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsdisputeedge#field-ShopifyPaymentsDisputeEdge.fields.node)node
...
*   <->[ShopifyPaymentsDisputeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ShopifyPaymentsDisputeConnection#field-edges)
