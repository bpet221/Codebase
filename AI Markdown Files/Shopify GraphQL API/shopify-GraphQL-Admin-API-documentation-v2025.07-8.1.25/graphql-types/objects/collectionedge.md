...
description: "Shopify GraphQL Admin API documentation for collectionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionedge

Markdown Content:
CollectionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionedge#main-content)
...
[Anchor to CollectionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionedge#top)
Collection Edge
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionedge#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionedge#field-CollectionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionedge#field-CollectionEdge.fields.node)node
...
*   <->[CollectionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CollectionConnection#field-edges)
