---
title: "StoreCreditAccountTransactionEdge"
description: "Shopify GraphQL Admin API documentation for storecreditaccounttransactionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccounttransactionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccounttransactionedge

Markdown Content:
StoreCreditAccountTransactionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccounttransactionedge#main-content)
...
[Anchor to StoreCreditAccountTransactionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccounttransactionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccounttransactionedge#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccounttransactionedge#field-StoreCreditAccountTransactionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/storecreditaccounttransactionedge#field-StoreCreditAccountTransactionEdge.fields.node)node
...
*   <->[StoreCreditAccountTransactionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/StoreCreditAccountTransactionConnection#field-edges)
