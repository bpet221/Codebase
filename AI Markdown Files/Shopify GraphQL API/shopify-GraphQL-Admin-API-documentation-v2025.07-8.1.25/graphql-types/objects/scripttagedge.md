---
title: "ScriptTagEdge"
description: "Shopify GraphQL Admin API documentation for scripttagedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/scripttagedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/scripttagedge

Markdown Content:
ScriptTagEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/scripttagedge#main-content)
...
[Anchor to ScriptTagEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/scripttagedge#top)
Script Tag Edge
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/scripttagedge#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/scripttagedge#field-ScriptTagEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/scripttagedge#field-ScriptTagEdge.fields.node)node
...
*   <->[ScriptTagConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ScriptTagConnection#field-edges)
