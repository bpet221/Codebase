---
title: "GiftCardTransactionEdge"
description: "Shopify GraphQL Admin API documentation for giftcardtransactionedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardtransactionedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardtransactionedge

Markdown Content:
GiftCardTransactionEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardtransactionedge#main-content)
...
[Anchor to GiftCardTransactionEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardtransactionedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardtransactionedge#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardtransactionedge#field-GiftCardTransactionEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardtransactionedge#field-GiftCardTransactionEdge.fields.node)node
...
*   <->[GiftCardTransactionConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/GiftCardTransactionConnection#field-edges)
