---
title: "InventoryTransferCreateAsReadyToShipUserError"
description: "Shopify GraphQL Admin API documentation for inventorytransfercreateasreadytoshipusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror

Markdown Content:
InventoryTransferCreateAsReadyToShipUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#interfaces)
...
[Anchor to InventoryTransferCreateAsReadyToShipUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#fields)Fields
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#field-InventoryTransferCreateAsReadyToShipUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#field-InventoryTransferCreateAsReadyToShipUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#field-InventoryTransferCreateAsReadyToShipUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to inventoryTransferCreateAsReadyToShip](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#mutation-inventoryTransferCreateAsReadyToShip)[inventory Transfer Create As Ready To Ship](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryTransferCreateAsReadyToShip)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventorytransfercreateasreadytoshipusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
