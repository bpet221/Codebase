---
title: "ProductOptionsReorderUserError"
description: "Shopify GraphQL Admin API documentation for productoptionsreorderusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror"
...
Title: ProductOptionsReorderUserError - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror

Markdown Content:
ProductOptionsReorderUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#interfaces)
...
[Anchor to ProductOptionsReorderUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#field-ProductOptionsReorderUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#field-ProductOptionsReorderUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#field-ProductOptionsReorderUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to productOptionsReorder](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#mutation-productOptionsReorder)[product Options Reorder](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productOptionsReorder)
...
<~>ProductOptionsReorderUserError Mutations
-------------------------------------------
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionsreorderusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
...
||-ProductOptionsReorderUserError Implements
--------------------------------------------
