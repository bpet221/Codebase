---
title: "AppPurchaseOneTimeEdge"
description: "Shopify GraphQL Admin API documentation for apppurchaseonetimeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/apppurchaseonetimeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/apppurchaseonetimeedge

Markdown Content:
AppPurchaseOneTimeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/apppurchaseonetimeedge#main-content)
...
[Anchor to AppPurchaseOneTimeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/apppurchaseonetimeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/apppurchaseonetimeedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/apppurchaseonetimeedge#field-AppPurchaseOneTimeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/apppurchaseonetimeedge#field-AppPurchaseOneTimeEdge.fields.node)node
...
*   <->[AppPurchaseOneTimeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/AppPurchaseOneTimeConnection#field-edges)
