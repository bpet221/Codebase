---
title: "MetafieldRelationEdge"
description: "Shopify GraphQL Admin API documentation for metafieldrelationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelationedge"
...
Title: MetafieldRelationEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelationedge

Markdown Content:
MetafieldRelationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelationedge#main-content)
...
[Anchor to MetafieldRelationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelationedge#top)
Metafield Relation Edge
=======================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelationedge#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelationedge#field-MetafieldRelationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldrelationedge#field-MetafieldRelationEdge.fields.node)node
...
*   <->[MetafieldRelationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MetafieldRelationConnection#field-edges)
