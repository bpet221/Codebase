---
title: "QuantityRuleUserError"
description: "Shopify GraphQL Admin API documentation for quantityruleusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror

Markdown Content:
QuantityRuleUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#interfaces)
...
[Anchor to QuantityRuleUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#field-QuantityRuleUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#field-QuantityRuleUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#field-QuantityRuleUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------

[Anchor to quantityRulesAdd](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#mutation-quantityRulesAdd)[quantity Rules Add](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityRulesAdd)
...
[Anchor to quantityRulesDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#mutation-quantityRulesDelete)[quantity Rules Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityRulesDelete)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityruleusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
