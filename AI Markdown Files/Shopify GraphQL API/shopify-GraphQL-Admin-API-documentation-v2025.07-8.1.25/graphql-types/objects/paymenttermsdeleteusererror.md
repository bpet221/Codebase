---
title: "PaymentTermsDeleteUserError"
description: "Shopify GraphQL Admin API documentation for paymenttermsdeleteusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror

Markdown Content:
PaymentTermsDeleteUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#interfaces)
...
[Anchor to PaymentTermsDeleteUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#field-PaymentTermsDeleteUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#field-PaymentTermsDeleteUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#field-PaymentTermsDeleteUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to paymentTermsDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#mutation-paymentTermsDelete)[payment Terms Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/paymentTermsDelete)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermsdeleteusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
