...
description: "Shopify GraphQL Admin API documentation for productpublicationedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublicationedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublicationedge

Markdown Content:
ProductPublicationEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublicationedge#main-content)
...
[Anchor to ProductPublicationEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublicationedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublicationedge#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublicationedge#field-ProductPublicationEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublicationedge#field-ProductPublicationEdge.fields.node)node
...
*   <->[ProductPublicationConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductPublicationConnection#field-edges)
