---
title: "PrivacyFeaturesDisableUserError"
description: "Shopify GraphQL Admin API documentation for privacyfeaturesdisableusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror

Markdown Content:
PrivacyFeaturesDisableUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#interfaces)
...
[Anchor to PrivacyFeaturesDisableUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#field-PrivacyFeaturesDisableUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#field-PrivacyFeaturesDisableUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#field-PrivacyFeaturesDisableUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to privacyFeaturesDisable](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#mutation-privacyFeaturesDisable)[privacy Features Disable](https://shopify.dev/docs/api/admin-graphql/latest/mutations/privacyFeaturesDisable)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/privacyfeaturesdisableusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
