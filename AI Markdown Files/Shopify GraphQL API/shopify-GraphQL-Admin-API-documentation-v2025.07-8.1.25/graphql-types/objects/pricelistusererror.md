...
description: "Shopify GraphQL Admin API documentation for pricelistusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror

Markdown Content:
PriceListUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#interfaces)
...
[Anchor to PriceListUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#field-PriceListUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#field-PriceListUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#field-PriceListUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------

[Anchor to priceListCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#mutation-priceListCreate)[price List Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/priceListCreate)
...
[Anchor to priceListDelete](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#mutation-priceListDelete)[price List Delete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/priceListDelete)
...
[Anchor to priceListUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#mutation-priceListUpdate)[price List Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/priceListUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
