---
title: "PaymentTermsCreateUserError"
description: "Shopify GraphQL Admin API documentation for paymenttermscreateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror

Markdown Content:
PaymentTermsCreateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#interfaces)
...
[Anchor to PaymentTermsCreateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#field-PaymentTermsCreateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#field-PaymentTermsCreateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#field-PaymentTermsCreateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to paymentTermsCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#mutation-paymentTermsCreate)[payment Terms Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/paymentTermsCreate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/paymenttermscreateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
