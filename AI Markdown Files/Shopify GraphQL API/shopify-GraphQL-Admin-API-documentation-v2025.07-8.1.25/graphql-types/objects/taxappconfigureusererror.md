---
title: "TaxAppConfigureUserError"
description: "Shopify GraphQL Admin API documentation for taxappconfigureusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror

Markdown Content:
TaxAppConfigureUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#interfaces)
...
[Anchor to TaxAppConfigureUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#field-TaxAppConfigureUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#field-TaxAppConfigureUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#field-TaxAppConfigureUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------

[Anchor to taxAppConfigure](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#mutation-taxAppConfigure)[tax App Configure](https://shopify.dev/docs/api/admin-graphql/latest/mutations/taxAppConfigure)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxappconfigureusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
