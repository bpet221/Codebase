---
title: "MarketWebPresenceEdge"
description: "Shopify GraphQL Admin API documentation for marketwebpresenceedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketwebpresenceedge"
...
Title: MarketWebPresenceEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketwebpresenceedge

Markdown Content:
MarketWebPresenceEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketwebpresenceedge#main-content)
...
[Anchor to MarketWebPresenceEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketwebpresenceedge#top)
Market Web Presence Edge
========================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketwebpresenceedge#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketwebpresenceedge#field-MarketWebPresenceEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketwebpresenceedge#field-MarketWebPresenceEdge.fields.node)node
...
*   <->[MarketWebPresenceConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MarketWebPresenceConnection#field-edges)
