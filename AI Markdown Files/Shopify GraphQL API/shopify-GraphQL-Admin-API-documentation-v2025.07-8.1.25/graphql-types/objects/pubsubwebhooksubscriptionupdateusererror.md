---
title: "PubSubWebhookSubscriptionUpdateUserError"
description: "Shopify GraphQL Admin API documentation for pubsubwebhooksubscriptionupdateusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror

Markdown Content:
PubSubWebhookSubscriptionUpdateUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#interfaces)
...
[Anchor to PubSubWebhookSubscriptionUpdateUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#field-PubSubWebhookSubscriptionUpdateUserError.fields.code)code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#field-PubSubWebhookSubscriptionUpdateUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#field-PubSubWebhookSubscriptionUpdateUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to pubSubWebhookSubscriptionUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#mutation-pubSubWebhookSubscriptionUpdate)[pub Sub Webhook Subscription Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pubSubWebhookSubscriptionUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/pubsubwebhooksubscriptionupdateusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
