---
title: "ReturnableFulfillmentLineItemEdge"
description: "Shopify GraphQL Admin API documentation for returnablefulfillmentlineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitemedge

Markdown Content:
ReturnableFulfillmentLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitemedge#main-content)
...
[Anchor to ReturnableFulfillmentLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitemedge#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitemedge#field-ReturnableFulfillmentLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitemedge#field-ReturnableFulfillmentLineItemEdge.fields.node)node
...
*   <->[ReturnableFulfillmentLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReturnableFulfillmentLineItemConnection#field-edges)
