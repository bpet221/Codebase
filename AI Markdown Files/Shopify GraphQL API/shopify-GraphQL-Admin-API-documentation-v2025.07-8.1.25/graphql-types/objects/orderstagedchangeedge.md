---
title: "OrderStagedChangeEdge"
description: "Shopify GraphQL Admin API documentation for orderstagedchangeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeedge

Markdown Content:
OrderStagedChangeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeedge#main-content)
...
[Anchor to OrderStagedChangeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeedge#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeedge#field-OrderStagedChangeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeedge#field-OrderStagedChangeEdge.fields.node)node
...
*   <->[OrderStagedChangeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/OrderStagedChangeConnection#field-edges)
