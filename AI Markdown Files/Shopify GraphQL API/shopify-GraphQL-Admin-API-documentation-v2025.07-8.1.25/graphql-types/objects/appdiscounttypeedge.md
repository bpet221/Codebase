---
title: "AppDiscountTypeEdge"
description: "Shopify GraphQL Admin API documentation for appdiscounttypeedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appdiscounttypeedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appdiscounttypeedge

Markdown Content:
AppDiscountTypeEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appdiscounttypeedge#main-content)
...
[Anchor to AppDiscountTypeEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/appdiscounttypeedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appdiscounttypeedge#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/appdiscounttypeedge#field-AppDiscountTypeEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/appdiscounttypeedge#field-AppDiscountTypeEdge.fields.node)node
...
*   <->[AppDiscountTypeConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/AppDiscountTypeConnection#field-edges)
