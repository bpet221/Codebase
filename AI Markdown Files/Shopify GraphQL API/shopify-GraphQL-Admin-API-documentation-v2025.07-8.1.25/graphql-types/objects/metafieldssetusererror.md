---
title: "MetafieldsSetUserError"
description: "Shopify GraphQL Admin API documentation for metafieldssetusererror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror

Markdown Content:
MetafieldsSetUserError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#interfaces)
...
[Anchor to MetafieldsSetUserError](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#field-MetafieldsSetUserError.fields.code)code
...
[Anchor to elementIndex](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#field-MetafieldsSetUserError.fields.elementIndex)element Index

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The index of the array element that's causing the error.

[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#field-MetafieldsSetUserError.fields.field)field

•[[String!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The path to the input field that caused the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#field-MetafieldsSetUserError.fields.message)message
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------

[Anchor to metafieldsSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#mutation-metafieldsSet)[metafields Set](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafieldsSet)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to DisplayableError](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldssetusererror#interface-DisplayableError)[Displayable Error](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DisplayableError)
