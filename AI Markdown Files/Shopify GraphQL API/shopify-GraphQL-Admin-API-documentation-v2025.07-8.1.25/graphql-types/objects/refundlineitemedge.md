---
title: "RefundLineItemEdge"
description: "Shopify GraphQL Admin API documentation for refundlineitemedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitemedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitemedge

Markdown Content:
RefundLineItemEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitemedge#main-content)
...
[Anchor to RefundLineItemEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitemedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitemedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitemedge#field-RefundLineItemEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitemedge#field-RefundLineItemEdge.fields.node)node
...
*   <->[RefundLineItemConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/RefundLineItemConnection#field-edges)
