---
title: "SalesAgreementEdge"
description: "Shopify GraphQL Admin API documentation for salesagreementedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/salesagreementedge"
...
Title: SalesAgreementEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/salesagreementedge

Markdown Content:
SalesAgreementEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/salesagreementedge#main-content)
...
[Anchor to SalesAgreementEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/salesagreementedge#top)
Sales Agreement Edge
====================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/salesagreementedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/salesagreementedge#field-SalesAgreementEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/salesagreementedge#field-SalesAgreementEdge.fields.node)node
...
*   <->[SalesAgreementConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/SalesAgreementConnection#field-edges)
