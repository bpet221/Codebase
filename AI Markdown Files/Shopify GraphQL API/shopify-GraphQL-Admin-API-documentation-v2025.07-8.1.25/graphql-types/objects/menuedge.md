---
title: "MenuEdge"
description: "Shopify GraphQL Admin API documentation for menuedge"
date: "2025-08-01"
...
Title: MenuEdge - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/menuedge

Markdown Content:
MenuEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/menuedge#main-content)
...
[Anchor to MenuEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/menuedge#top)
Menu Edge
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/menuedge#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/menuedge#field-MenuEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/menuedge#field-MenuEdge.fields.node)node
...
*   <->[MenuConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/MenuConnection#field-edges)
