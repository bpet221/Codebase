---
title: "ShopifyPaymentsPayoutEdge"
description: "Shopify GraphQL Admin API documentation for shopifypaymentspayoutedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutedge

Markdown Content:
ShopifyPaymentsPayoutEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutedge#main-content)
...
[Anchor to ShopifyPaymentsPayoutEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutedge#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutedge#field-ShopifyPaymentsPayoutEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentspayoutedge#field-ShopifyPaymentsPayoutEdge.fields.node)node
...
*   <->[ShopifyPaymentsPayoutConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/ShopifyPaymentsPayoutConnection#field-edges)
