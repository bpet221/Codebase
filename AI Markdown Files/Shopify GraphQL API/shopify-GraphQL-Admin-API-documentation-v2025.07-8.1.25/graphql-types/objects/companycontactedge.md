---
title: "CompanyContactEdge"
description: "Shopify GraphQL Admin API documentation for companycontactedge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactedge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactedge

Markdown Content:
CompanyContactEdge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactedge#main-content)
...
[Anchor to CompanyContactEdge](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactedge#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactedge#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to cursor](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactedge#field-CompanyContactEdge.fields.cursor)cursor
...
[Anchor to node](https://shopify.dev/docs/api/admin-graphql/latest/objects/companycontactedge#field-CompanyContactEdge.fields.node)node
...
*   <->[CompanyContactConnection.edges](https://shopify.dev/docs/api/admin-graphql/latest/connections/CompanyContactConnection#field-edges)
