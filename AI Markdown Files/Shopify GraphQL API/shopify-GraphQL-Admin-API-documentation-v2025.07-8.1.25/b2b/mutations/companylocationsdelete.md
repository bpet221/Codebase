---
title: "companyLocationsDelete"
description: "Shopify GraphQL Admin API documentation for companylocationsdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationsdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationsdelete

Markdown Content:
companyLocationsDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationsdelete#main-content)
...
[Anchor to companyLocationsDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationsdelete#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationsdelete#arguments)
Arguments
---------

[Anchor to companyLocationIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationsdelete#arguments-companyLocationIds)company Location Ids
...
[Anchor to CompanyLocationsDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationsdelete#returns)Company Locations Delete Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedCompanyLocationIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationsdelete#returns-deletedCompanyLocationIds)deleted Company Location Ids

•[[ID!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A list of IDs of the deleted company locations.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationsdelete#returns-userErrors)user Errors
