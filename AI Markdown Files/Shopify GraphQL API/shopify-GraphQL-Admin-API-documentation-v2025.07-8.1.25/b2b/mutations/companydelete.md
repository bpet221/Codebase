---
title: "companyDelete"
description: "Shopify GraphQL Admin API documentation for companydelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companydelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companydelete

Markdown Content:
companyDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companydelete#main-content)
...
[Anchor to companyDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companydelete#top)
company Delete
==============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companydelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companydelete#arguments-id)id
...
[Anchor to CompanyDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companydelete#returns)Company Delete Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedCompanyId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companydelete#returns-deletedCompanyId)deleted Company Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the deleted company.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companydelete#returns-userErrors)user Errors
