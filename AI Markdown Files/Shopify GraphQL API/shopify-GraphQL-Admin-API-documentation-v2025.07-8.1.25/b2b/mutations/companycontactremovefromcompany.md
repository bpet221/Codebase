---
title: "companyContactRemoveFromCompany"
description: "Shopify GraphQL Admin API documentation for companycontactremovefromcompany"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactremovefromcompany"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactremovefromcompany

Markdown Content:
companyContactRemoveFromCompany - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactremovefromcompany#main-content)
...
[Anchor to companyContactRemoveFromCompany](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactremovefromcompany#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactremovefromcompany#arguments)
Arguments
---------

[Anchor to companyContactId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactremovefromcompany#arguments-companyContactId)company Contact Id
...
[Anchor to CompanyContactRemoveFromCompanyPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactremovefromcompany#returns)Company Contact Remove From Company Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to removedCompanyContactId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactremovefromcompany#returns-removedCompanyContactId)removed Company Contact Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the removed company contact.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactremovefromcompany#returns-userErrors)user Errors
