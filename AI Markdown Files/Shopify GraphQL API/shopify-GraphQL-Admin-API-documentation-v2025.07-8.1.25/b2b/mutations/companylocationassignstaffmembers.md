---
title: "companyLocationAssignStaffMembers"
description: "Shopify GraphQL Admin API documentation for companylocationassignstaffmembers"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers

Markdown Content:
companyLocationAssignStaffMembers - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers#main-content)
...
[Anchor to companyLocationAssignStaffMembers](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers#arguments)
Arguments
---------

[Anchor to companyLocationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers#arguments-companyLocationId)company Location Id
...
[Anchor to staffMemberIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers#arguments-staffMemberIds)staff Member Ids
...
[Anchor to CompanyLocationAssignStaffMembersPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers#returns)Company Location Assign Staff Members Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to companyLocationStaffMemberAssignments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers#returns-companyLocationStaffMemberAssignments)company Location Staff Member Assignments
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignstaffmembers#returns-userErrors)user Errors
