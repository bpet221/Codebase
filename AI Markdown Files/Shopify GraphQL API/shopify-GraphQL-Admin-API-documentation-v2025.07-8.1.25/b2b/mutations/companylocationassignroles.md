---
title: "companyLocationAssignRoles"
description: "Shopify GraphQL Admin API documentation for companylocationassignroles"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles

Markdown Content:
companyLocationAssignRoles - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles#main-content)
...
[Anchor to companyLocationAssignRoles](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles#arguments)
Arguments
---------

[Anchor to companyLocationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles#arguments-companyLocationId)company Location Id
...
[Anchor to rolesToAssign](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles#arguments-rolesToAssign)roles To Assign
...
[Anchor to CompanyLocationAssignRolesPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles#returns)Company Location Assign Roles Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to roleAssignments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles#returns-roleAssignments)role Assignments
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationassignroles#returns-userErrors)user Errors
