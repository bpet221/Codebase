---
title: "companyLocationRevokeRoles"
description: "Shopify GraphQL Admin API documentation for companylocationrevokeroles"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles

Markdown Content:
companyLocationRevokeRoles - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles#main-content)
...
[Anchor to companyLocationRevokeRoles](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles#arguments)
Arguments
---------

[Anchor to companyLocationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles#arguments-companyLocationId)company Location Id
...
[Anchor to rolesToRevoke](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles#arguments-rolesToRevoke)roles To Revoke
...
[Anchor to CompanyLocationRevokeRolesPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles#returns)Company Location Revoke Roles Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to revokedRoleAssignmentIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles#returns-revokedRoleAssignmentIds)revoked Role Assignment Ids

•[[ID!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A list of role assignment IDs that were removed from the company location.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevokeroles#returns-userErrors)user Errors
