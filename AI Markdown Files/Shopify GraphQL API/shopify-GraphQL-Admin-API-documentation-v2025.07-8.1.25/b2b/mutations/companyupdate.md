---
title: "companyUpdate"
description: "Shopify GraphQL Admin API documentation for companyupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate

Markdown Content:
companyUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate#main-content)
...
[Anchor to companyUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate#top)
company Update
==============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate#arguments)
Arguments
---------

[Anchor to companyId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate#arguments-companyId)company Id
...
[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate#arguments-input)input
...
[Anchor to CompanyUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate#returns)Company Update Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to company](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate#returns-company)company
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyupdate#returns-userErrors)user Errors
