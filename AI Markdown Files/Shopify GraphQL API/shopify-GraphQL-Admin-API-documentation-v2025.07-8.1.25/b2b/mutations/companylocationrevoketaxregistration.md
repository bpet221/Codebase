---
title: "companyLocationRevokeTaxRegistration"
description: "Shopify GraphQL Admin API documentation for companylocationrevoketaxregistration"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevoketaxregistration"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevoketaxregistration

Markdown Content:
companyLocationRevokeTaxRegistration - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevoketaxregistration#main-content)
...
[Anchor to companyLocationRevokeTaxRegistration](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevoketaxregistration#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevoketaxregistration#arguments)
Arguments
---------

[Anchor to companyLocationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevoketaxregistration#arguments-companyLocationId)company Location Id
...
[Anchor to CompanyLocationRevokeTaxRegistrationPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevoketaxregistration#returns)Company Location Revoke Tax Registration Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to companyLocation](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevoketaxregistration#returns-companyLocation)company Location
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationrevoketaxregistration#returns-userErrors)user Errors
