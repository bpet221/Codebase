---
title: "companyRevokeMainContact"
description: "Shopify GraphQL Admin API documentation for companyrevokemaincontact"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyrevokemaincontact"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyrevokemaincontact

Markdown Content:
companyRevokeMainContact - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyrevokemaincontact#main-content)
...
[Anchor to companyRevokeMainContact](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyrevokemaincontact#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyrevokemaincontact#arguments)
Arguments
---------

[Anchor to companyId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyrevokemaincontact#arguments-companyId)company Id
...
[Anchor to CompanyRevokeMainContactPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyrevokemaincontact#returns)Company Revoke Main Contact Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to company](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyrevokemaincontact#returns-company)company
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyrevokemaincontact#returns-userErrors)user Errors
