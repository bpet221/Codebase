---
title: "companyAssignCustomerAsContact"
description: "Shopify GraphQL Admin API documentation for companyassigncustomerascontact"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact

Markdown Content:
companyAssignCustomerAsContact - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact#main-content)
...
[Anchor to companyAssignCustomerAsContact](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact#arguments)
Arguments
---------

[Anchor to companyId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact#arguments-companyId)company Id
...
[Anchor to customerId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact#arguments-customerId)customer Id
...
[Anchor to CompanyAssignCustomerAsContactPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact#returns)Company Assign Customer As Contact Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to companyContact](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact#returns-companyContact)company Contact
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassigncustomerascontact#returns-userErrors)user Errors
