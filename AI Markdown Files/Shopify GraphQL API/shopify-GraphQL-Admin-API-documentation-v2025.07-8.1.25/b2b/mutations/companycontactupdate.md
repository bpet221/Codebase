---
title: "companyContactUpdate"
description: "Shopify GraphQL Admin API documentation for companycontactupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate

Markdown Content:
companyContactUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate#main-content)
...
[Anchor to companyContactUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate#arguments)
Arguments
---------

[Anchor to companyContactId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate#arguments-companyContactId)company Contact Id
...
[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate#arguments-input)input
...
[Anchor to CompanyContactUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate#returns)Company Contact Update Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to companyContact](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate#returns-companyContact)company Contact
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactupdate#returns-userErrors)user Errors
