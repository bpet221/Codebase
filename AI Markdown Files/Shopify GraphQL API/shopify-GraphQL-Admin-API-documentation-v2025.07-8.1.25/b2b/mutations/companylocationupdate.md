---
title: "companyLocationUpdate"
description: "Shopify GraphQL Admin API documentation for companylocationupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate

Markdown Content:
companyLocationUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate#main-content)
...
[Anchor to companyLocationUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate#arguments)
Arguments
---------

[Anchor to companyLocationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate#arguments-companyLocationId)company Location Id
...
[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate#arguments-input)input
...
[Anchor to CompanyLocationUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate#returns)Company Location Update Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to companyLocation](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate#returns-companyLocation)company Location
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationupdate#returns-userErrors)user Errors
