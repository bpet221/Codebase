---
title: "companyLocationDelete"
description: "Shopify GraphQL Admin API documentation for companylocationdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationdelete

Markdown Content:
companyLocationDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationdelete#main-content)
...
[Anchor to companyLocationDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationdelete#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationdelete#arguments)
Arguments
---------

[Anchor to companyLocationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationdelete#arguments-companyLocationId)company Location Id
...
[Anchor to CompanyLocationDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationdelete#returns)Company Location Delete Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedCompanyLocationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationdelete#returns-deletedCompanyLocationId)deleted Company Location Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the deleted company location.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companylocationdelete#returns-userErrors)user Errors
