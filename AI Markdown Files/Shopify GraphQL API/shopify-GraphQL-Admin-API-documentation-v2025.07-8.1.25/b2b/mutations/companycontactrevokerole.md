---
title: "companyContactRevokeRole"
description: "Shopify GraphQL Admin API documentation for companycontactrevokerole"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole

Markdown Content:
companyContactRevokeRole - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole#main-content)
...
[Anchor to companyContactRevokeRole](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole#arguments)
Arguments
---------

[Anchor to companyContactId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole#arguments-companyContactId)company Contact Id
...
[Anchor to companyContactRoleAssignmentId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole#arguments-companyContactRoleAssignmentId)company Contact Role Assignment Id
...
[Anchor to CompanyContactRevokeRolePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole#returns)Company Contact Revoke Role Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to revokedCompanyContactRoleAssignmentId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole#returns-revokedCompanyContactRoleAssignmentId)revoked Company Contact Role Assignment Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The role assignment that was revoked.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokerole#returns-userErrors)user Errors
