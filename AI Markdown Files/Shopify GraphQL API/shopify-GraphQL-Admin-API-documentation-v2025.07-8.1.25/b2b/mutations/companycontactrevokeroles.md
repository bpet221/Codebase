---
title: "companyContactRevokeRoles"
description: "Shopify GraphQL Admin API documentation for companycontactrevokeroles"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles

Markdown Content:
companyContactRevokeRoles - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles#main-content)
...
[Anchor to companyContactRevokeRoles](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles#arguments)
Arguments
---------

[Anchor to companyContactId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles#arguments-companyContactId)company Contact Id
...
[Anchor to revokeAll](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles#arguments-revokeAll)revoke All
...
[Anchor to roleAssignmentIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles#arguments-roleAssignmentIds)role Assignment Ids
...
[Anchor to CompanyContactRevokeRolesPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles#returns)Company Contact Revoke Roles Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to revokedRoleAssignmentIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles#returns-revokedRoleAssignmentIds)revoked Role Assignment Ids

•[[ID!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A list of role assignment IDs that were removed from the company contact.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactrevokeroles#returns-userErrors)user Errors
