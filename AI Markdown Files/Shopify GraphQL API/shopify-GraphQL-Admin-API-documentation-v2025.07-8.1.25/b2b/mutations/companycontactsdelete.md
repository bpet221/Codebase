---
title: "companyContactsDelete"
description: "Shopify GraphQL Admin API documentation for companycontactsdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactsdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactsdelete

Markdown Content:
companyContactsDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactsdelete#main-content)
...
[Anchor to companyContactsDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactsdelete#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactsdelete#arguments)
Arguments
---------

[Anchor to companyContactIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactsdelete#arguments-companyContactIds)company Contact Ids
...
[Anchor to CompanyContactsDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactsdelete#returns)Company Contacts Delete Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedCompanyContactIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactsdelete#returns-deletedCompanyContactIds)deleted Company Contact Ids

•[[ID!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The list of IDs of the deleted company contacts.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companycontactsdelete#returns-userErrors)user Errors
