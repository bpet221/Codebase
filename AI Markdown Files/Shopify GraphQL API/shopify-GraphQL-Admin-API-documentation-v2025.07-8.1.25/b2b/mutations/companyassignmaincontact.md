---
title: "companyAssignMainContact"
description: "Shopify GraphQL Admin API documentation for companyassignmaincontact"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact

Markdown Content:
companyAssignMainContact - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact#main-content)
...
[Anchor to companyAssignMainContact](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact#arguments)
Arguments
---------

[Anchor to companyContactId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact#arguments-companyContactId)company Contact Id
...
[Anchor to companyId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact#arguments-companyId)company Id
...
[Anchor to CompanyAssignMainContactPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact#returns)Company Assign Main Contact Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to company](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact#returns-company)company
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/companyassignmaincontact#returns-userErrors)user Errors
