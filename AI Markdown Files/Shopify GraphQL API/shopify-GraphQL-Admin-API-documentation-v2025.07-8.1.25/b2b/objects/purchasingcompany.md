---
title: "PurchasingCompany"
description: "Shopify GraphQL Admin API documentation for purchasingcompany"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/purchasingcompany"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/purchasingcompany

Markdown Content:
PurchasingCompany - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/purchasingcompany#main-content)
...
[Anchor to PurchasingCompany](https://shopify.dev/docs/api/admin-graphql/latest/objects/purchasingcompany#top)
Purchasing Company
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/purchasingcompany#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to company](https://shopify.dev/docs/api/admin-graphql/latest/objects/purchasingcompany#field-PurchasingCompany.fields.company)company
...
[Anchor to contact](https://shopify.dev/docs/api/admin-graphql/latest/objects/purchasingcompany#field-PurchasingCompany.fields.contact)contact
...
[Anchor to location](https://shopify.dev/docs/api/admin-graphql/latest/objects/purchasingcompany#field-PurchasingCompany.fields.location)location
