---
title: "MarketsRegionsEntitlement"
description: "Shopify GraphQL Admin API documentation for marketsregionsentitlement"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketsregionsentitlement"
...
Title: MarketsRegionsEntitlement - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketsregionsentitlement

Markdown Content:
MarketsRegionsEntitlement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketsregionsentitlement#main-content)
...
[Anchor to MarketsRegionsEntitlement](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketsregionsentitlement#top)
Markets Regions Entitlement
===========================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketsregionsentitlement#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to catalogs](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketsregionsentitlement#field-MarketsRegionsEntitlement.fields.catalogs)catalogs
...
[Anchor to enabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketsregionsentitlement#field-MarketsRegionsEntitlement.fields.enabled)enabled
...
*   {}[MarketsType.regions](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketsType#field-regions)
