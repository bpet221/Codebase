---
title: "LimitedPendingOrderCount"
description: "Shopify GraphQL Admin API documentation for limitedpendingordercount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/limitedpendingordercount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/limitedpendingordercount

Markdown Content:
LimitedPendingOrderCount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/limitedpendingordercount#main-content)
...
[Anchor to LimitedPendingOrderCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/limitedpendingordercount#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/limitedpendingordercount#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to atMax](https://shopify.dev/docs/api/admin-graphql/latest/objects/limitedpendingordercount#field-LimitedPendingOrderCount.fields.atMax)at Max
...
[Anchor to count](https://shopify.dev/docs/api/admin-graphql/latest/objects/limitedpendingordercount#field-LimitedPendingOrderCount.fields.count)count
