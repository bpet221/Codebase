---
title: "CartTransformFeature"
description: "Shopify GraphQL Admin API documentation for carttransformfeature"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformfeature"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformfeature

Markdown Content:
CartTransformFeature - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformfeature#main-content)
...
[Anchor to CartTransformFeature](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformfeature#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformfeature#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to eligibleOperations](https://shopify.dev/docs/api/admin-graphql/latest/objects/carttransformfeature#field-CartTransformFeature.fields.eligibleOperations)eligible Operations
...
*   {}[ShopFeatures.cartTransform](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopFeatures#field-cartTransform)
