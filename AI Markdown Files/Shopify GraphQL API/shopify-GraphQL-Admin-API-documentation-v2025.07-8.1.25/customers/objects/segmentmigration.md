---
title: "SegmentMigration"
description: "Shopify GraphQL Admin API documentation for segmentmigration"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration

Markdown Content:
SegmentMigration - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#queries)
...
[Anchor to SegmentMigration](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#top)
Segment Migration
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#field-SegmentMigration.fields.id)id
...
[Anchor to savedSearchId](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#field-SegmentMigration.fields.savedSearchId)saved Search Id
...
[Anchor to segmentId](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#field-SegmentMigration.fields.segmentId)segment Id
...
*   <->[SegmentMigrationConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/SegmentMigrationConnection#field-nodes)
*   {}[SegmentMigrationEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/SegmentMigrationEdge#field-node)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#queries)Queries
--------------------------------------------------------------------------------------------------------------

[Anchor to segmentMigrations](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmigration#query-segmentMigrations)[segment Migrations](https://shopify.dev/docs/api/admin-graphql/latest/queries/segmentMigrations)
...
*   <?>[segment Migrations](https://shopify.dev/docs/api/admin-graphql/latest/queries/SegmentMigrationConnection)
