---
title: "CustomerMergeError"
description: "Shopify GraphQL Admin API documentation for customermergeerror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeerror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeerror

Markdown Content:
CustomerMergeError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeerror#main-content)
...
[Anchor to CustomerMergeError](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeerror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeerror#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to errorFields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeerror#field-CustomerMergeError.fields.errorFields)error Fields
...
[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeerror#field-CustomerMergeError.fields.message)message
...
*   {}[CustomerMergePreview.customerMergeErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerMergePreview#field-customerMergeErrors)
*   {}[CustomerMergeRequest.customerMergeErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerMergeRequest#field-customerMergeErrors)
