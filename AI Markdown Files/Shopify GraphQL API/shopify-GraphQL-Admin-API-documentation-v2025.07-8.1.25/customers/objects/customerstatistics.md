...
description: "Shopify GraphQL Admin API documentation for customerstatistics"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerstatistics"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerstatistics

Markdown Content:
CustomerStatistics - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerstatistics#main-content)
...
[Anchor to CustomerStatistics](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerstatistics#top)
Customer Statistics
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerstatistics#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to predictedSpendTier](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerstatistics#field-CustomerStatistics.fields.predictedSpendTier)predicted Spend Tier
...
[Anchor to rfmGroup](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerstatistics#field-CustomerStatistics.fields.rfmGroup)rfm Group
...
*   {}[Customer.statistics](https://shopify.dev/docs/api/admin-graphql/latest/objects/Customer#field-statistics)
