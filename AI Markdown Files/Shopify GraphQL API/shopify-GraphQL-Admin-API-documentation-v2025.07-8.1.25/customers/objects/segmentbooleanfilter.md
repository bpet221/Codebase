---
title: "SegmentBooleanFilter"
description: "Shopify GraphQL Admin API documentation for segmentbooleanfilter"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter

Markdown Content:
SegmentBooleanFilter - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#interfaces)
...
[Anchor to SegmentBooleanFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to localizedName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#field-SegmentBooleanFilter.fields.localizedName)localized Name
...
[Anchor to multiValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#field-SegmentBooleanFilter.fields.multiValue)multi Value
...
[Anchor to queryName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#field-SegmentBooleanFilter.fields.queryName)query Name
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------

[Anchor to SegmentFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentbooleanfilter#interface-SegmentFilter)[Segment Filter](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SegmentFilter)
