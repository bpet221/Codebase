...
description: "Shopify GraphQL Admin API documentation for segmentstatistics"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentstatistics"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentstatistics

Markdown Content:
SegmentStatistics - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentstatistics#main-content)
...
[Anchor to SegmentStatistics](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentstatistics#top)
Segment Statistics
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentstatistics#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to attributeStatistics](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentstatistics#field-SegmentStatistics.fields.attributeStatistics)attribute Statistics
...
*   <->[CustomerSegmentMemberConnection.statistics](https://shopify.dev/docs/api/admin-graphql/latest/connections/CustomerSegmentMemberConnection#field-statistics)
