---
title: "CustomerMergeable"
description: "Shopify GraphQL Admin API documentation for customermergeable"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeable"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeable

Markdown Content:
CustomerMergeable - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeable#main-content)
...
[Anchor to CustomerMergeable](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeable#top)
Customer Mergeable
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeable#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to errorFields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeable#field-CustomerMergeable.fields.errorFields)error Fields
...
[Anchor to isMergeable](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeable#field-CustomerMergeable.fields.isMergeable)is Mergeable
...
[Anchor to mergeInProgress](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeable#field-CustomerMergeable.fields.mergeInProgress)merge In Progress
...
[Anchor to reason](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergeable#field-CustomerMergeable.fields.reason)reason
...
*   {}[Customer.mergeable](https://shopify.dev/docs/api/admin-graphql/latest/objects/Customer#field-mergeable)
*   {}[CustomerSegmentMember.mergeable](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerSegmentMember#field-mergeable)
