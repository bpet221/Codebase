---
title: "CustomerAccountsV2"
description: "Shopify GraphQL Admin API documentation for customeraccountsv2"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountsv2"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountsv2

Markdown Content:
CustomerAccountsV2 - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountsv2#main-content)
...
[Anchor to CustomerAccountsV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountsv2#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountsv2#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to customerAccountsVersion](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountsv2#field-CustomerAccountsV2.fields.customerAccountsVersion)customer Accounts Version
...
[Anchor to loginLinksVisibleOnStorefrontAndCheckout](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountsv2#field-CustomerAccountsV2.fields.loginLinksVisibleOnStorefrontAndCheckout)login Links Visible On Storefront And Checkout
...
[Anchor to loginRequiredAtCheckout](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountsv2#field-CustomerAccountsV2.fields.loginRequiredAtCheckout)login Required At Checkout
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/customeraccountsv2#field-CustomerAccountsV2.fields.url)url
...
*   {}[Shop.customerAccountsV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/Shop#field-customerAccountsV2)
