...
description: "Shopify GraphQL Admin API documentation for customerphonenumber"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber

Markdown Content:
CustomerPhoneNumber - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber#main-content)
...
[Anchor to CustomerPhoneNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to marketingCollectedFrom](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber#field-CustomerPhoneNumber.fields.marketingCollectedFrom)marketing Collected From
...
[Anchor to marketingOptInLevel](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber#field-CustomerPhoneNumber.fields.marketingOptInLevel)marketing Opt In Level
...
[Anchor to marketingState](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber#field-CustomerPhoneNumber.fields.marketingState)marketing State
...
[Anchor to marketingUpdatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber#field-CustomerPhoneNumber.fields.marketingUpdatedAt)marketing Updated At
...
[Anchor to phoneNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber#field-CustomerPhoneNumber.fields.phoneNumber)phone Number
...
[Anchor to sourceLocation](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerphonenumber#field-CustomerPhoneNumber.fields.sourceLocation)source Location
...
*   {}[Customer.defaultPhoneNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/Customer#field-defaultPhoneNumber)
*   {}[CustomerMergePreviewAlternateFields.phoneNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerMergePreviewAlternateFields#field-phoneNumber)
*   {}[CustomerMergePreviewDefaultFields.phoneNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerMergePreviewDefaultFields#field-phoneNumber)
*   {}[CustomerSegmentMember.defaultPhoneNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerSegmentMember#field-defaultPhoneNumber)
