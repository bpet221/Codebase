---
title: "SegmentAssociationFilter"
description: "Shopify GraphQL Admin API documentation for segmentassociationfilter"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter

Markdown Content:
SegmentAssociationFilter - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#interfaces)
...
[Anchor to SegmentAssociationFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to localizedName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#field-SegmentAssociationFilter.fields.localizedName)localized Name
...
[Anchor to multiValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#field-SegmentAssociationFilter.fields.multiValue)multi Value
...
[Anchor to queryName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#field-SegmentAssociationFilter.fields.queryName)query Name
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to SegmentFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentassociationfilter#interface-SegmentFilter)[Segment Filter](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SegmentFilter)
