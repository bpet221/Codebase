---
title: "SegmentIntegerFilter"
description: "Shopify GraphQL Admin API documentation for segmentintegerfilter"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter

Markdown Content:
SegmentIntegerFilter - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#interfaces)
...
[Anchor to SegmentIntegerFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to localizedName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#field-SegmentIntegerFilter.fields.localizedName)localized Name
...
[Anchor to maxRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#field-SegmentIntegerFilter.fields.maxRange)max Range

•[Float](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Float)

The maximum range a filter can have.

[Anchor to minRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#field-SegmentIntegerFilter.fields.minRange)min Range

•[Float](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Float)

The minimum range a filter can have.

[Anchor to multiValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#field-SegmentIntegerFilter.fields.multiValue)multi Value
...
[Anchor to queryName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#field-SegmentIntegerFilter.fields.queryName)query Name
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------

[Anchor to SegmentFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentintegerfilter#interface-SegmentFilter)[Segment Filter](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SegmentFilter)
