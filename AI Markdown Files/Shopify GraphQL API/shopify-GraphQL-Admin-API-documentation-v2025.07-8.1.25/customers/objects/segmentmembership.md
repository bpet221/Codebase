...
description: "Shopify GraphQL Admin API documentation for segmentmembership"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmembership"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmembership

Markdown Content:
SegmentMembership - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmembership#main-content)
...
[Anchor to SegmentMembership](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmembership#top)
Segment Membership
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmembership#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to isMember](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmembership#field-SegmentMembership.fields.isMember)is Member
...
[Anchor to segmentId](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentmembership#field-SegmentMembership.fields.segmentId)segment Id
...
*   {}[SegmentMembershipResponse.memberships](https://shopify.dev/docs/api/admin-graphql/latest/objects/SegmentMembershipResponse#field-memberships)
