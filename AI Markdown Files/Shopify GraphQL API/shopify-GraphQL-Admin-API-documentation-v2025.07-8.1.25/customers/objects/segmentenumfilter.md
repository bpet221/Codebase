---
title: "SegmentEnumFilter"
description: "Shopify GraphQL Admin API documentation for segmentenumfilter"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter

Markdown Content:
SegmentEnumFilter - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#interfaces)
...
[Anchor to SegmentEnumFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#top)
Segment Enum Filter
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to localizedName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#field-SegmentEnumFilter.fields.localizedName)localized Name
...
[Anchor to multiValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#field-SegmentEnumFilter.fields.multiValue)multi Value
...
[Anchor to queryName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#field-SegmentEnumFilter.fields.queryName)query Name
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to SegmentFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentenumfilter#interface-SegmentFilter)[Segment Filter](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SegmentFilter)
