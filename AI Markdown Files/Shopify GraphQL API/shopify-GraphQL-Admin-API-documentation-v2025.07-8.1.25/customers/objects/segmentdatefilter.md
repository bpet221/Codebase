---
title: "SegmentDateFilter"
description: "Shopify GraphQL Admin API documentation for segmentdatefilter"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter

Markdown Content:
SegmentDateFilter - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#interfaces)
...
[Anchor to SegmentDateFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#top)
Segment Date Filter
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to localizedName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#field-SegmentDateFilter.fields.localizedName)localized Name
...
[Anchor to multiValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#field-SegmentDateFilter.fields.multiValue)multi Value
...
[Anchor to queryName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#field-SegmentDateFilter.fields.queryName)query Name
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to SegmentFilter](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentdatefilter#interface-SegmentFilter)[Segment Filter](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SegmentFilter)
