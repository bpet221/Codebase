---
title: "CustomerMergePreviewAlternateFields"
description: "Shopify GraphQL Admin API documentation for customermergepreviewalternatefields"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields

Markdown Content:
CustomerMergePreviewAlternateFields - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields#main-content)
...
[Anchor to CustomerMergePreviewAlternateFields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to defaultAddress](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields#field-CustomerMergePreviewAlternateFields.fields.defaultAddress)default Address
...
[Anchor to email](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields#field-CustomerMergePreviewAlternateFields.fields.email)email
...
[Anchor to firstName](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields#field-CustomerMergePreviewAlternateFields.fields.firstName)first Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The first name of a customer.

[Anchor to lastName](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields#field-CustomerMergePreviewAlternateFields.fields.lastName)last Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The last name of a customer.

[Anchor to phoneNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/customermergepreviewalternatefields#field-CustomerMergePreviewAlternateFields.fields.phoneNumber)phone Number
...
*   {}[CustomerMergePreview.alternateFields](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerMergePreview#field-alternateFields)
