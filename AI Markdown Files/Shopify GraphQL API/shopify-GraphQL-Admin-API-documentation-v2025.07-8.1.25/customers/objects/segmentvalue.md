---
title: "SegmentValue"
description: "Shopify GraphQL Admin API documentation for segmentvalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue

Markdown Content:
SegmentValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue#queries)
...
[Anchor to SegmentValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue#top)
Segment Value
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to localizedValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue#field-SegmentValue.fields.localizedValue)localized Value
...
[Anchor to queryName](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue#field-SegmentValue.fields.queryName)query Name
...
*   <->[SegmentValueConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/SegmentValueConnection#field-nodes)
*   {}[SegmentValueEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/SegmentValueEdge#field-node)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue#queries)Queries
----------------------------------------------------------------------------------------------------------

[Anchor to segmentValueSuggestions](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentvalue#query-segmentValueSuggestions)[segment Value Suggestions](https://shopify.dev/docs/api/admin-graphql/latest/queries/segmentValueSuggestions)
...
*   <?>[segment Value Suggestions](https://shopify.dev/docs/api/admin-graphql/latest/queries/SegmentValueConnection)
