---
title: "SegmentAttributeStatistics"
description: "Shopify GraphQL Admin API documentation for segmentattributestatistics"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentattributestatistics"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentattributestatistics

Markdown Content:
SegmentAttributeStatistics - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentattributestatistics#main-content)
...
[Anchor to SegmentAttributeStatistics](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentattributestatistics#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentattributestatistics#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to average](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentattributestatistics#field-SegmentAttributeStatistics.fields.average)average
...
[Anchor to sum](https://shopify.dev/docs/api/admin-graphql/latest/objects/segmentattributestatistics#field-SegmentAttributeStatistics.fields.sum)sum
...
*   {}[SegmentStatistics.attributeStatistics](https://shopify.dev/docs/api/admin-graphql/latest/objects/SegmentStatistics#field-attributeStatistics)
