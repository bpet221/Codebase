...
description: "Shopify GraphQL Admin API documentation for customeraddresscreate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate

Markdown Content:
customerAddressCreate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate#main-content)
...
[Anchor to customerAddressCreate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate#arguments)
Arguments
---------

[Anchor to address](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate#arguments-address)address
...
[Anchor to customerId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate#arguments-customerId)customer Id
...
[Anchor to setAsDefault](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate#arguments-setAsDefault)set As Default
...
[Anchor to CustomerAddressCreatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate#returns)Customer Address Create Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to address](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate#returns-address)address
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/customeraddresscreate#returns-userErrors)user Errors
