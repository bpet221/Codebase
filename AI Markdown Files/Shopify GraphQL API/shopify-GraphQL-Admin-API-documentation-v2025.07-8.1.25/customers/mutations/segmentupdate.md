---
title: "segmentUpdate"
description: "Shopify GraphQL Admin API documentation for segmentupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate

Markdown Content:
segmentUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate#main-content)
...
[Anchor to segmentUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate#top)
segment Update
==============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate#arguments-id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate#arguments-name)name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The new name for the segment.

[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate#arguments-query)query
...
[Anchor to SegmentUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate#returns)Segment Update Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to segment](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate#returns-segment)segment
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentupdate#returns-userErrors)user Errors
