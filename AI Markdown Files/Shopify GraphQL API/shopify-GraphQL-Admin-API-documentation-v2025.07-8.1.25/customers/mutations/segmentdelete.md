---
title: "segmentDelete"
description: "Shopify GraphQL Admin API documentation for segmentdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentdelete

Markdown Content:
segmentDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentdelete#main-content)
...
[Anchor to segmentDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentdelete#top)
segment Delete
==============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentdelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentdelete#arguments-id)id
...
[Anchor to SegmentDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentdelete#returns)Segment Delete Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedSegmentId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentdelete#returns-deletedSegmentId)deleted Segment Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

ID of the deleted segment.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/segmentdelete#returns-userErrors)user Errors
