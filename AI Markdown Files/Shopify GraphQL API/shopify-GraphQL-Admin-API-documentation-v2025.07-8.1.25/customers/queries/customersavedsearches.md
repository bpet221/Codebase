---
title: "customerSavedSearches"
description: "Shopify GraphQL Admin API documentation for customersavedsearches"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches

Markdown Content:
customerSavedSearches - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#main-content)
...
[Anchor to customerSavedSearches](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#arguments)
...
[Anchor to after](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#arguments-after)after

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come after the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to before](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#arguments-before)before

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come before the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to first](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#arguments-first)first

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to last](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#arguments-last)last

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#arguments-query)query
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#argument-query-filter-default)default
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#argument-query-filter-id)id
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#argument-query-filter-name)name

•string

[Anchor to reverse](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#arguments-reverse)reverse
...
[Anchor to sortKey](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#arguments-sortKey)sort Key
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#possible-returns)Possible returns
----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to edges](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#returns-edges)edges
...
[Anchor to nodes](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#returns-nodes)nodes
...
[Anchor to pageInfo](https://shopify.dev/docs/api/admin-graphql/latest/queries/customersavedsearches#returns-pageInfo)page Info
