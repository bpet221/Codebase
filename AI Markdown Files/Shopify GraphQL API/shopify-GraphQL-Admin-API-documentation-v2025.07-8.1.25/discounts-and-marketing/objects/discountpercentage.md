...
description: "Shopify GraphQL Admin API documentation for discountpercentage"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpercentage"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpercentage

Markdown Content:
DiscountPercentage - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpercentage#main-content)
...
[Anchor to DiscountPercentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpercentage#top)
Discount Percentage
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpercentage#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to percentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpercentage#field-DiscountPercentage.fields.percentage)percentage
