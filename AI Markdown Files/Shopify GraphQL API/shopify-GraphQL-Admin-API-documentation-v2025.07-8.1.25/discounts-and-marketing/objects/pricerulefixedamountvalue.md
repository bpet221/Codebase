---
title: "PriceRuleFixedAmountValue"
description: "Shopify GraphQL Admin API documentation for pricerulefixedamountvalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulefixedamountvalue"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulefixedamountvalue

Markdown Content:
PriceRuleFixedAmountValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulefixedamountvalue#main-content)
...
[Anchor to PriceRuleFixedAmountValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulefixedamountvalue#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulefixedamountvalue#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulefixedamountvalue#field-PriceRuleFixedAmountValue.fields.amount)amount
