---
title: "DiscountAutomaticBxgy"
description: "Shopify GraphQL Admin API documentation for discountautomaticbxgy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy

Markdown Content:
DiscountAutomaticBxgy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#interfaces)
...
[Anchor to DiscountAutomaticBxgy](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to asyncUsageCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.asyncUsageCount)async Usage Count
...
[Anchor to combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.combinesWith)combines With
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.createdAt)created At
...
[Anchor to customerBuys](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.customerBuys)customer Buys
...
[Anchor to customerGets](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.customerGets)customer Gets
...
[Anchor to discountClasses](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.discountClasses)discount Classes
...
[Anchor to endsAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.endsAt)ends At
...
[Anchor to events](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.events)events
...
[Anchor to startsAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.startsAt)starts At
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.status)status
...
[Anchor to summary](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.summary)summary
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.title)title
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.updatedAt)updated At
...
[Anchor to usesPerOrderLimit](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.usesPerOrderLimit)uses Per Order Limit
...
[Anchor to discountClass](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.discountClass)discount Class
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.id)id

•[ID!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

non-null Deprecated

[Anchor to usageCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#field-DiscountAutomaticBxgy.fields.usageCount)usage Count
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------

[Anchor to HasEvents](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#interface-HasEvents)[Has Events](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/HasEvents)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountautomaticbxgy#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
