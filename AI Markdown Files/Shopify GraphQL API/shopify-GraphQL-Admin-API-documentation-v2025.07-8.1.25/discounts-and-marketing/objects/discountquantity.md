---
title: "DiscountQuantity"
description: "Shopify GraphQL Admin API documentation for discountquantity"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountquantity"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountquantity

Markdown Content:
DiscountQuantity - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountquantity#main-content)
...
[Anchor to DiscountQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountquantity#top)
Discount Quantity
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountquantity#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountquantity#field-DiscountQuantity.fields.quantity)quantity
...
*   {}[DiscountOnQuantity.quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountOnQuantity#field-quantity)
