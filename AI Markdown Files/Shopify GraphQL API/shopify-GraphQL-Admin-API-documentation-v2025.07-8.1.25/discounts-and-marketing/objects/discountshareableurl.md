---
title: "DiscountShareableUrl"
description: "Shopify GraphQL Admin API documentation for discountshareableurl"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountshareableurl"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountshareableurl

Markdown Content:
DiscountShareableUrl - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountshareableurl#main-content)
...
[Anchor to DiscountShareableUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountshareableurl#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountshareableurl#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to targetItemImage](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountshareableurl#field-DiscountShareableUrl.fields.targetItemImage)target Item Image
...
[Anchor to targetType](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountshareableurl#field-DiscountShareableUrl.fields.targetType)target Type
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountshareableurl#field-DiscountShareableUrl.fields.title)title
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountshareableurl#field-DiscountShareableUrl.fields.url)url
...
*   {}[DiscountCodeApp.shareableUrls](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountCodeApp#field-shareableUrls)
*   {}[DiscountCodeBasic.shareableUrls](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountCodeBasic#field-shareableUrls)
*   {}[DiscountCodeBxgy.shareableUrls](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountCodeBxgy#field-shareableUrls)
*   {}[DiscountCodeFreeShipping.shareableUrls](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountCodeFreeShipping#field-shareableUrls)
