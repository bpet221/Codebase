---
title: "PriceRuleShareableUrl"
description: "Shopify GraphQL Admin API documentation for priceruleshareableurl"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshareableurl"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshareableurl

Markdown Content:
PriceRuleShareableUrl - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshareableurl#main-content)
...
[Anchor to PriceRuleShareableUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshareableurl#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshareableurl#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to targetItemImage](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshareableurl#field-PriceRuleShareableUrl.fields.targetItemImage)target Item Image
...
[Anchor to targetType](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshareableurl#field-PriceRuleShareableUrl.fields.targetType)target Type
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshareableurl#field-PriceRuleShareableUrl.fields.title)title
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshareableurl#field-PriceRuleShareableUrl.fields.url)url
...
*   {}[PriceRule.shareableUrls](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-shareableUrls)
