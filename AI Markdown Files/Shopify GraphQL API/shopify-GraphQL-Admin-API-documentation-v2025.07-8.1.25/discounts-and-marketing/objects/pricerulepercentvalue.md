---
title: "PriceRulePercentValue"
description: "Shopify GraphQL Admin API documentation for pricerulepercentvalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulepercentvalue"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulepercentvalue

Markdown Content:
PriceRulePercentValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulepercentvalue#main-content)
...
[Anchor to PriceRulePercentValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulepercentvalue#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulepercentvalue#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to percentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulepercentvalue#field-PriceRulePercentValue.fields.percentage)percentage
