---
title: "AllDiscountItems"
description: "Shopify GraphQL Admin API documentation for alldiscountitems"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/alldiscountitems"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/alldiscountitems

Markdown Content:
AllDiscountItems - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/alldiscountitems#main-content)
...
[Anchor to AllDiscountItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/alldiscountitems#top)
All Discount Items
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/alldiscountitems#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to allItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/alldiscountitems#field-AllDiscountItems.fields.allItems)all Items
