---
title: "DiscountCodeBxgy"
description: "Shopify GraphQL Admin API documentation for discountcodebxgy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy

Markdown Content:
DiscountCodeBxgy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#main-content)
...
[Anchor to DiscountCodeBxgy](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#top)
Discount Code Bxgy
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to appliesOncePerCustomer](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.appliesOncePerCustomer)applies Once Per Customer
...
[Anchor to asyncUsageCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.asyncUsageCount)async Usage Count
...
[Anchor to codes](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.codes)codes
...
[Anchor to codesCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.codesCount)codes Count
...
[Anchor to combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.combinesWith)combines With
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.createdAt)created At
...
[Anchor to customerBuys](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.customerBuys)customer Buys
...
[Anchor to customerGets](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.customerGets)customer Gets
...
[Anchor to customerSelection](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.customerSelection)customer Selection
...
[Anchor to discountClasses](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.discountClasses)discount Classes
...
[Anchor to endsAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.endsAt)ends At
...
[Anchor to hasTimelineComment](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.hasTimelineComment)has Timeline Comment
...
[Anchor to shareableUrls](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.shareableUrls)shareable Urls
...
[Anchor to startsAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.startsAt)starts At
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.status)status
...
[Anchor to summary](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.summary)summary
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.title)title
...
[Anchor to totalSales](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.totalSales)total Sales
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.updatedAt)updated At
...
[Anchor to usageLimit](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.usageLimit)usage Limit

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The maximum number of times that a customer can use the discount. For discounts with unlimited usage, specify `null`.

[Anchor to usesPerOrderLimit](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.usesPerOrderLimit)uses Per Order Limit

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The maximum number of times that the discount can be applied to an order.

[Anchor to discountClass](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebxgy#field-DiscountCodeBxgy.fields.discountClass)discount Class
