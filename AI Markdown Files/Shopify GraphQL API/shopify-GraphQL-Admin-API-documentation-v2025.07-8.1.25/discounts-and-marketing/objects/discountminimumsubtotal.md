---
title: "DiscountMinimumSubtotal"
description: "Shopify GraphQL Admin API documentation for discountminimumsubtotal"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumsubtotal"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumsubtotal

Markdown Content:
DiscountMinimumSubtotal - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumsubtotal#main-content)
...
[Anchor to DiscountMinimumSubtotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumsubtotal#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumsubtotal#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to greaterThanOrEqualToSubtotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumsubtotal#field-DiscountMinimumSubtotal.fields.greaterThanOrEqualToSubtotal)greater Than Or Equal To Subtotal
