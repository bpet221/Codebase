---
title: "DiscountOnQuantity"
description: "Shopify GraphQL Admin API documentation for discountonquantity"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountonquantity"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountonquantity

Markdown Content:
DiscountOnQuantity - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountonquantity#main-content)
...
[Anchor to DiscountOnQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountonquantity#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountonquantity#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to effect](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountonquantity#field-DiscountOnQuantity.fields.effect)effect
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountonquantity#field-DiscountOnQuantity.fields.quantity)quantity
