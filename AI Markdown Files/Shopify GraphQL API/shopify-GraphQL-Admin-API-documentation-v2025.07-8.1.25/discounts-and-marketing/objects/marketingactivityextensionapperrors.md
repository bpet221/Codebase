---
title: "MarketingActivityExtensionAppErrors"
description: "Shopify GraphQL Admin API documentation for marketingactivityextensionapperrors"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityextensionapperrors"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityextensionapperrors

Markdown Content:
MarketingActivityExtensionAppErrors - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityextensionapperrors#main-content)
...
[Anchor to MarketingActivityExtensionAppErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityextensionapperrors#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityextensionapperrors#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityextensionapperrors#field-MarketingActivityExtensionAppErrors.fields.code)code
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingactivityextensionapperrors#field-MarketingActivityExtensionAppErrors.fields.userErrors)user Errors
...
*   {}[MarketingActivity.appErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketingActivity#field-appErrors)
