...
description: "Shopify GraphQL Admin API documentation for discountproducts"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountproducts"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountproducts

Markdown Content:
DiscountProducts - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountproducts#main-content)
...
[Anchor to DiscountProducts](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountproducts#top)
Discount Products
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountproducts#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to products](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountproducts#field-DiscountProducts.fields.products)products
...
[Anchor to productVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountproducts#field-DiscountProducts.fields.productVariants)product Variants
