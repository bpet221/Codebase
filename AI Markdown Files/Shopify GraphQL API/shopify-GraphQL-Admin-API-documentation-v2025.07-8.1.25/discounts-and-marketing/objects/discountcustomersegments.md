---
title: "DiscountCustomerSegments"
description: "Shopify GraphQL Admin API documentation for discountcustomersegments"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomersegments"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomersegments

Markdown Content:
DiscountCustomerSegments - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomersegments#main-content)
...
[Anchor to DiscountCustomerSegments](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomersegments#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomersegments#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to segments](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomersegments#field-DiscountCustomerSegments.fields.segments)segments
