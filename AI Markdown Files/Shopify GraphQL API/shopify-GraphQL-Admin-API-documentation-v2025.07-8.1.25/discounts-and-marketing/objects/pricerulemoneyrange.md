---
title: "PriceRuleMoneyRange"
description: "Shopify GraphQL Admin API documentation for pricerulemoneyrange"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulemoneyrange"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulemoneyrange

Markdown Content:
PriceRuleMoneyRange - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulemoneyrange#main-content)
...
[Anchor to PriceRuleMoneyRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulemoneyrange#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulemoneyrange#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to greaterThan](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulemoneyrange#field-PriceRuleMoneyRange.fields.greaterThan)greater Than

•[Money](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

The lower bound of the money range.

[Anchor to greaterThanOrEqualTo](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulemoneyrange#field-PriceRuleMoneyRange.fields.greaterThanOrEqualTo)greater Than Or Equal To

•[Money](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

The lower bound or equal of the money range.

[Anchor to lessThan](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulemoneyrange#field-PriceRuleMoneyRange.fields.lessThan)less Than

•[Money](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

The upper bound of the money range.

[Anchor to lessThanOrEqualTo](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulemoneyrange#field-PriceRuleMoneyRange.fields.lessThanOrEqualTo)less Than Or Equal To
...
*   {}[PriceRule.prerequisiteShippingPriceRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-prerequisiteShippingPriceRange)
*   {}[PriceRule.prerequisiteSubtotalRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-prerequisiteSubtotalRange)
