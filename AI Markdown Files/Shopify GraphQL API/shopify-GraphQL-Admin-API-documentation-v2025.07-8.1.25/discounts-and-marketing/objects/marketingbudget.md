...
description: "Shopify GraphQL Admin API documentation for marketingbudget"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingbudget"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingbudget

Markdown Content:
MarketingBudget - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingbudget#main-content)
...
[Anchor to MarketingBudget](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingbudget#top)
Marketing Budget
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingbudget#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to budgetType](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingbudget#field-MarketingBudget.fields.budgetType)budget Type
...
[Anchor to total](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketingbudget#field-MarketingBudget.fields.total)total
...
*   {}[MarketingActivity.budget](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketingActivity#field-budget)
