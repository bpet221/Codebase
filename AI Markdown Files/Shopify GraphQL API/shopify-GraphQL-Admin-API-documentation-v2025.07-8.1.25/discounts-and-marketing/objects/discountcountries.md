---
title: "DiscountCountries"
description: "Shopify GraphQL Admin API documentation for discountcountries"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountries"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountries

Markdown Content:
DiscountCountries - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountries#main-content)
...
[Anchor to DiscountCountries](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountries#top)
Discount Countries
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountries#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to countries](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountries#field-DiscountCountries.fields.countries)countries
...
[Anchor to includeRestOfWorld](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountries#field-DiscountCountries.fields.includeRestOfWorld)include Rest Of World
