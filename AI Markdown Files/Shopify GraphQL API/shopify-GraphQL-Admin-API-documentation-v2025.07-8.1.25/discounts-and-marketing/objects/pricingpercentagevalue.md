...
description: "Shopify GraphQL Admin API documentation for pricingpercentagevalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricingpercentagevalue"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricingpercentagevalue

Markdown Content:
PricingPercentageValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricingpercentagevalue#main-content)
...
[Anchor to PricingPercentageValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricingpercentagevalue#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricingpercentagevalue#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to percentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricingpercentagevalue#field-PricingPercentageValue.fields.percentage)percentage
