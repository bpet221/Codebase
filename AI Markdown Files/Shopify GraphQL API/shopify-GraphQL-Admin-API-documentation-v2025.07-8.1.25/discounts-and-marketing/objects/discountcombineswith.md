---
title: "DiscountCombinesWith"
description: "Shopify GraphQL Admin API documentation for discountcombineswith"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcombineswith"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcombineswith

Markdown Content:
DiscountCombinesWith - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcombineswith#main-content)
...
[Anchor to DiscountCombinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcombineswith#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcombineswith#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to orderDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcombineswith#field-DiscountCombinesWith.fields.orderDiscounts)order Discounts
...
[Anchor to productDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcombineswith#field-DiscountCombinesWith.fields.productDiscounts)product Discounts
...
[Anchor to shippingDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcombineswith#field-DiscountCombinesWith.fields.shippingDiscounts)shipping Discounts
...
*   {}[DiscountAutomaticApp.combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountAutomaticApp#field-combinesWith)
*   {}[DiscountAutomaticBasic.combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountAutomaticBasic#field-combinesWith)
*   {}[DiscountAutomaticBxgy.combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountAutomaticBxgy#field-combinesWith)
*   {}[DiscountAutomaticFreeShipping.combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountAutomaticFreeShipping#field-combinesWith)
*   {}[DiscountCodeApp.combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountCodeApp#field-combinesWith)
*   {}[DiscountCodeBasic.combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountCodeBasic#field-combinesWith)
*   {}[DiscountCodeBxgy.combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountCodeBxgy#field-combinesWith)
*   {}[DiscountCodeFreeShipping.combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountCodeFreeShipping#field-combinesWith)
*   {}[PriceRule.combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-combinesWith)
