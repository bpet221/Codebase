---
title: "UTMParameters"
description: "Shopify GraphQL Admin API documentation for utmparameters"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters

Markdown Content:
UTMParameters - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters#main-content)
...
[Anchor to UTMParameters](https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters#top)
UTMParameters
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to campaign](https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters#field-UTMParameters.fields.campaign)campaign

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The name of a marketing campaign.

[Anchor to content](https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters#field-UTMParameters.fields.content)content
...
[Anchor to medium](https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters#field-UTMParameters.fields.medium)medium

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The medium of a marketing campaign, such as a banner or email newsletter.

[Anchor to source](https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters#field-UTMParameters.fields.source)source

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The source of traffic to the merchant's store, such as Google or an email newsletter.

[Anchor to term](https://shopify.dev/docs/api/admin-graphql/latest/objects/utmparameters#field-UTMParameters.fields.term)term
...
*   {}[CustomerVisit.utmParameters](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerVisit#field-utmParameters)
*   {}[MarketingActivity.utmParameters](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketingActivity#field-utmParameters)
