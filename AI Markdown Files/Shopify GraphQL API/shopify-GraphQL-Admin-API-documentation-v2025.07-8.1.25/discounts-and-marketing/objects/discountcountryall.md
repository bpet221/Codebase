---
title: "DiscountCountryAll"
description: "Shopify GraphQL Admin API documentation for discountcountryall"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountryall"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountryall

Markdown Content:
DiscountCountryAll - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountryall#main-content)
...
[Anchor to DiscountCountryAll](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountryall#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountryall#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to allCountries](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcountryall#field-DiscountCountryAll.fields.allCountries)all Countries
