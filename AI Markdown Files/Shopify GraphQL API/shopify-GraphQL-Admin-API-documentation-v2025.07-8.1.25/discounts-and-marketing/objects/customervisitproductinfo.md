---
title: "CustomerVisitProductInfo"
description: "Shopify GraphQL Admin API documentation for customervisitproductinfo"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfo"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfo

Markdown Content:
CustomerVisitProductInfo - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfo#main-content)
...
[Anchor to CustomerVisitProductInfo](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfo#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfo#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfo#field-CustomerVisitProductInfo.fields.product)product
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfo#field-CustomerVisitProductInfo.fields.quantity)quantity
...
[Anchor to variant](https://shopify.dev/docs/api/admin-graphql/latest/objects/customervisitproductinfo#field-CustomerVisitProductInfo.fields.variant)variant
...
*   {}[Abandonment.productsAddedToCart](https://shopify.dev/docs/api/admin-graphql/latest/objects/Abandonment#field-productsAddedToCart)
*   {}[Abandonment.productsViewed](https://shopify.dev/docs/api/admin-graphql/latest/objects/Abandonment#field-productsViewed)
*   <->[CustomerVisitProductInfoConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/CustomerVisitProductInfoConnection#field-nodes)
*   {}[CustomerVisitProductInfoEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/CustomerVisitProductInfoEdge#field-node)
