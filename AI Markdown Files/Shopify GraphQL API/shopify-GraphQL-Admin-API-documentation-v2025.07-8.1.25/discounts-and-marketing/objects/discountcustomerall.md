---
title: "DiscountCustomerAll"
description: "Shopify GraphQL Admin API documentation for discountcustomerall"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomerall"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomerall

Markdown Content:
DiscountCustomerAll - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomerall#main-content)
...
[Anchor to DiscountCustomerAll](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomerall#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomerall#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to allCustomers](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcustomerall#field-DiscountCustomerAll.fields.allCustomers)all Customers
