---
title: "DiscountCodeBasic"
description: "Shopify GraphQL Admin API documentation for discountcodebasic"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic"
...
Title: DiscountCodeBasic - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic

Markdown Content:
DiscountCodeBasic - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#main-content)
...
[Anchor to DiscountCodeBasic](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#top)
Discount Code Basic
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to appliesOncePerCustomer](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.appliesOncePerCustomer)applies Once Per Customer
...
[Anchor to asyncUsageCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.asyncUsageCount)async Usage Count
...
[Anchor to codes](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.codes)codes
...
[Anchor to codesCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.codesCount)codes Count
...
[Anchor to combinesWith](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.combinesWith)combines With
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.createdAt)created At
...
[Anchor to customerGets](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.customerGets)customer Gets
...
[Anchor to customerSelection](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.customerSelection)customer Selection
...
[Anchor to discountClasses](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.discountClasses)discount Classes
...
[Anchor to endsAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.endsAt)ends At
...
[Anchor to hasTimelineComment](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.hasTimelineComment)has Timeline Comment
...
[Anchor to minimumRequirement](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.minimumRequirement)minimum Requirement
...
[Anchor to recurringCycleLimit](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.recurringCycleLimit)recurring Cycle Limit
...
[Anchor to shareableUrls](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.shareableUrls)shareable Urls
...
[Anchor to shortSummary](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.shortSummary)short Summary
...
[Anchor to startsAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.startsAt)starts At
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.status)status
...
[Anchor to summary](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.summary)summary
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.title)title
...
[Anchor to totalSales](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.totalSales)total Sales
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.updatedAt)updated At
...
[Anchor to usageLimit](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.usageLimit)usage Limit

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The maximum number of times that a customer can use the discount. For discounts with unlimited usage, specify `null`.

[Anchor to discountClass](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodebasic#field-DiscountCodeBasic.fields.discountClass)discount Class
