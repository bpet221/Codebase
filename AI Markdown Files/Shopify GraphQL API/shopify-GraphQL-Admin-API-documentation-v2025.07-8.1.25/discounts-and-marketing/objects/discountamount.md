...
description: "Shopify GraphQL Admin API documentation for discountamount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountamount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountamount

Markdown Content:
DiscountAmount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountamount#main-content)
...
[Anchor to DiscountAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountamount#top)
Discount Amount
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountamount#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountamount#field-DiscountAmount.fields.amount)amount
...
[Anchor to appliesOnEachItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountamount#field-DiscountAmount.fields.appliesOnEachItem)applies On Each Item
