---
title: "DiscountMinimumQuantity"
description: "Shopify GraphQL Admin API documentation for discountminimumquantity"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumquantity"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumquantity

Markdown Content:
DiscountMinimumQuantity - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumquantity#main-content)
...
[Anchor to DiscountMinimumQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumquantity#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumquantity#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to greaterThanOrEqualToQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountminimumquantity#field-DiscountMinimumQuantity.fields.greaterThanOrEqualToQuantity)greater Than Or Equal To Quantity
