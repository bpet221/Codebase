---
title: "PriceRuleShippingLineEntitlements"
description: "Shopify GraphQL Admin API documentation for priceruleshippinglineentitlements"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshippinglineentitlements"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshippinglineentitlements

Markdown Content:
PriceRuleShippingLineEntitlements - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshippinglineentitlements#main-content)
...
[Anchor to PriceRuleShippingLineEntitlements](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshippinglineentitlements#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshippinglineentitlements#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to countryCodes](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshippinglineentitlements#field-PriceRuleShippingLineEntitlements.fields.countryCodes)country Codes
...
[Anchor to includeRestOfWorld](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshippinglineentitlements#field-PriceRuleShippingLineEntitlements.fields.includeRestOfWorld)include Rest Of World
...
[Anchor to targetAllShippingLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleshippinglineentitlements#field-PriceRuleShippingLineEntitlements.fields.targetAllShippingLines)target All Shipping Lines
...
*   {}[PriceRule.shippingEntitlements](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-shippingEntitlements)
