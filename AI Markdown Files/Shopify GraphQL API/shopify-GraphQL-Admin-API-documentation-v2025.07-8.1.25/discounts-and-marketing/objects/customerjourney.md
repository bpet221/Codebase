...
description: "Shopify GraphQL Admin API documentation for customerjourney"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney

Markdown Content:
CustomerJourney - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney#main-content)
...
[Anchor to CustomerJourney](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney#top)
Customer Journey
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to customerOrderIndex](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney#field-CustomerJourney.fields.customerOrderIndex)customer Order Index
...
[Anchor to daysToConversion](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney#field-CustomerJourney.fields.daysToConversion)days To Conversion
...
[Anchor to firstVisit](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney#field-CustomerJourney.fields.firstVisit)first Visit
...
[Anchor to lastVisit](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney#field-CustomerJourney.fields.lastVisit)last Visit
...
[Anchor to moments](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourney#field-CustomerJourney.fields.moments)moments
