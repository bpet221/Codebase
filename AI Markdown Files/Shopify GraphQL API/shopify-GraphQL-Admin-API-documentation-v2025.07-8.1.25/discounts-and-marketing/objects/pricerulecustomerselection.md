...
description: "Shopify GraphQL Admin API documentation for pricerulecustomerselection"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulecustomerselection"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulecustomerselection

Markdown Content:
PriceRuleCustomerSelection - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulecustomerselection#main-content)
...
[Anchor to PriceRuleCustomerSelection](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulecustomerselection#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulecustomerselection#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to customers](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulecustomerselection#field-PriceRuleCustomerSelection.fields.customers)customers
...
[Anchor to forAllCustomers](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulecustomerselection#field-PriceRuleCustomerSelection.fields.forAllCustomers)for All Customers
...
[Anchor to segments](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulecustomerselection#field-PriceRuleCustomerSelection.fields.segments)segments
...
*   {}[PriceRule.customerSelection](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-customerSelection)
