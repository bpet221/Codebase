---
title: "PriceRuleQuantityRange"
description: "Shopify GraphQL Admin API documentation for pricerulequantityrange"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulequantityrange"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulequantityrange

Markdown Content:
PriceRuleQuantityRange - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulequantityrange#main-content)
...
[Anchor to PriceRuleQuantityRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulequantityrange#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulequantityrange#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to greaterThan](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulequantityrange#field-PriceRuleQuantityRange.fields.greaterThan)greater Than

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The lower bound of the quantity range.

[Anchor to greaterThanOrEqualTo](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulequantityrange#field-PriceRuleQuantityRange.fields.greaterThanOrEqualTo)greater Than Or Equal To

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The lower bound or equal of the quantity range.

[Anchor to lessThan](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulequantityrange#field-PriceRuleQuantityRange.fields.lessThan)less Than

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The upper bound of the quantity range.

[Anchor to lessThanOrEqualTo](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulequantityrange#field-PriceRuleQuantityRange.fields.lessThanOrEqualTo)less Than Or Equal To
...
*   {}[PriceRule.prerequisiteQuantityRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-prerequisiteQuantityRange)
