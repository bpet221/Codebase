---
title: "PriceRuleValidityPeriod"
description: "Shopify GraphQL Admin API documentation for pricerulevalidityperiod"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulevalidityperiod"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulevalidityperiod

Markdown Content:
PriceRuleValidityPeriod - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulevalidityperiod#main-content)
...
[Anchor to PriceRuleValidityPeriod](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulevalidityperiod#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulevalidityperiod#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to end](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulevalidityperiod#field-PriceRuleValidityPeriod.fields.end)end

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

The time after which the price rule becomes invalid.

[Anchor to start](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulevalidityperiod#field-PriceRuleValidityPeriod.fields.start)start
...
*   {}[PriceRule.validityPeriod](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-validityPeriod)
