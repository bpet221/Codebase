---
title: "CustomerJourneySummary"
description: "Shopify GraphQL Admin API documentation for customerjourneysummary"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary

Markdown Content:
CustomerJourneySummary - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#main-content)
...
[Anchor to CustomerJourneySummary](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to customerOrderIndex](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#field-CustomerJourneySummary.fields.customerOrderIndex)customer Order Index

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The position of the current order within the customer's order history. Test orders aren't included.

[Anchor to daysToConversion](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#field-CustomerJourneySummary.fields.daysToConversion)days To Conversion
...
[Anchor to firstVisit](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#field-CustomerJourneySummary.fields.firstVisit)first Visit
...
[Anchor to lastVisit](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#field-CustomerJourneySummary.fields.lastVisit)last Visit
...
[Anchor to moments](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#field-CustomerJourneySummary.fields.moments)moments
...
[Anchor to momentsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#field-CustomerJourneySummary.fields.momentsCount)moments Count
...
[Anchor to ready](https://shopify.dev/docs/api/admin-graphql/latest/objects/customerjourneysummary#field-CustomerJourneySummary.fields.ready)ready
...
*   {}[Order.customerJourneySummary](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-customerJourneySummary)
