---
title: "PriceRuleItemEntitlements"
description: "Shopify GraphQL Admin API documentation for priceruleitementitlements"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleitementitlements"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleitementitlements

Markdown Content:
PriceRuleItemEntitlements - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleitementitlements#main-content)
...
[Anchor to PriceRuleItemEntitlements](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleitementitlements#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleitementitlements#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to collections](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleitementitlements#field-PriceRuleItemEntitlements.fields.collections)collections
...
[Anchor to products](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleitementitlements#field-PriceRuleItemEntitlements.fields.products)products
...
[Anchor to productVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleitementitlements#field-PriceRuleItemEntitlements.fields.productVariants)product Variants
...
[Anchor to targetAllLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/priceruleitementitlements#field-PriceRuleItemEntitlements.fields.targetAllLineItems)target All Line Items
...
*   {}[PriceRule.itemEntitlements](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-itemEntitlements)
