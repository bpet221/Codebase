---
title: "PriceRuleLineItemPrerequisites"
description: "Shopify GraphQL Admin API documentation for pricerulelineitemprerequisites"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulelineitemprerequisites"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulelineitemprerequisites

Markdown Content:
PriceRuleLineItemPrerequisites - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulelineitemprerequisites#main-content)
...
[Anchor to PriceRuleLineItemPrerequisites](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulelineitemprerequisites#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulelineitemprerequisites#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to collections](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulelineitemprerequisites#field-PriceRuleLineItemPrerequisites.fields.collections)collections
...
[Anchor to products](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulelineitemprerequisites#field-PriceRuleLineItemPrerequisites.fields.products)products
...
[Anchor to productVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricerulelineitemprerequisites#field-PriceRuleLineItemPrerequisites.fields.productVariants)product Variants
...
*   {}[PriceRule.itemPrerequisites](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceRule#field-itemPrerequisites)
