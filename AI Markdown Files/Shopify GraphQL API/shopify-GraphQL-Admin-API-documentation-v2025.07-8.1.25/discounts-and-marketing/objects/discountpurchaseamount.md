---
title: "DiscountPurchaseAmount"
description: "Shopify GraphQL Admin API documentation for discountpurchaseamount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpurchaseamount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpurchaseamount

Markdown Content:
DiscountPurchaseAmount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpurchaseamount#main-content)
...
[Anchor to DiscountPurchaseAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpurchaseamount#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpurchaseamount#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountpurchaseamount#field-DiscountPurchaseAmount.fields.amount)amount
