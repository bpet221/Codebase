---
title: "abandonmentUpdateActivitiesDeliveryStatuses"
description: "Shopify GraphQL Admin API documentation for abandonmentupdateactivitiesdeliverystatuses"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses

Markdown Content:
abandonmentUpdateActivitiesDeliveryStatuses - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#main-content)
...
[Anchor to abandonmentUpdateActivitiesDeliveryStatuses](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#arguments)
Arguments
---------

[Anchor to abandonmentId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#arguments-abandonmentId)abandonment Id
...
[Anchor to deliveredAt](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#arguments-deliveredAt)delivered At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

The delivery timestamp if the activity delivered.

[Anchor to deliveryStatus](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#arguments-deliveryStatus)delivery Status
...
[Anchor to deliveryStatusChangeReason](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#arguments-deliveryStatusChangeReason)delivery Status Change Reason

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The reason why the activity was or was not delivered.

[Anchor to marketingActivityId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#arguments-marketingActivityId)marketing Activity Id
...
[Anchor to AbandonmentUpdateActivitiesDeliveryStatusesPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#returns)Abandonment Update Activities Delivery Statuses Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to abandonment](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#returns-abandonment)abandonment
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/abandonmentupdateactivitiesdeliverystatuses#returns-userErrors)user Errors
