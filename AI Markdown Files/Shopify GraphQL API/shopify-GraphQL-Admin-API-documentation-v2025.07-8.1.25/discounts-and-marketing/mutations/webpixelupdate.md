---
title: "webPixelUpdate"
description: "Shopify GraphQL Admin API documentation for webpixelupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate

Markdown Content:
webPixelUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate#main-content)
...
[Anchor to webPixelUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate#top)
web Pixel Update
================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate#arguments-id)id
...
[Anchor to webPixel](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate#arguments-webPixel)web Pixel
...
[Anchor to WebPixelUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate#returns)Web Pixel Update Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate#returns-userErrors)user Errors
...
[Anchor to webPixel](https://shopify.dev/docs/api/admin-graphql/latest/mutations/webpixelupdate#returns-webPixel)web Pixel
