---
title: "discountAutomaticDeactivate"
description: "Shopify GraphQL Admin API documentation for discountautomaticdeactivate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountautomaticdeactivate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountautomaticdeactivate

Markdown Content:
discountAutomaticDeactivate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountautomaticdeactivate#main-content)
...
[Anchor to discountAutomaticDeactivate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountautomaticdeactivate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountautomaticdeactivate#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountautomaticdeactivate#arguments-id)id
...
[Anchor to DiscountAutomaticDeactivatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountautomaticdeactivate#returns)Discount Automatic Deactivate Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to automaticDiscountNode](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountautomaticdeactivate#returns-automaticDiscountNode)automatic Discount Node
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountautomaticdeactivate#returns-userErrors)user Errors
