---
title: "discountCodeBulkActivate"
description: "Shopify GraphQL Admin API documentation for discountcodebulkactivate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate

Markdown Content:
discountCodeBulkActivate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate#main-content)
...
[Anchor to discountCodeBulkActivate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate#arguments)
Arguments
---------

[Anchor to ids](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate#arguments-ids)ids

•[[ID!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The IDs of the discounts to activate.

[Anchor to savedSearchId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate#arguments-savedSearchId)saved Search Id
...
[Anchor to search](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate#arguments-search)search
...
[Anchor to DiscountCodeBulkActivatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate#returns)Discount Code Bulk Activate Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to job](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate#returns-job)job
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/discountcodebulkactivate#returns-userErrors)user Errors
...
Show description[Open in GraphiQL](http://localhost:3457/graphiql?query=mutation%20discountCodeBulkActivate(%24search%3A%20String)%20%7B%0A%20%20discountCodeBulkActivate(search%3A%20%24search)%20%7B%0A%20%20%20%20job%20%7B%0A%20%20%20%20%20%20id%0A%20%20%20%20%7D%0A%20%20%20%20userErrors%20%7B%0A%20%20%20%20%20%20code%0A%20%20%20%20%20%20field%0A%20%20%20%20%20%20message%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D&variables=%7B%0A%20%20%22search%22%3A%20%22discount_type%3Apercentage%20starts_at%3Apast_week%22%0A%7D)Copy
