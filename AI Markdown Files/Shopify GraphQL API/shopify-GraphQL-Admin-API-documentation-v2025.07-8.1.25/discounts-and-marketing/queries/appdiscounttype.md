...
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/appdiscounttype"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/appdiscounttype

Markdown Content:
appDiscountType - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/appdiscounttype#main-content)
...
[Anchor to appDiscountType](https://shopify.dev/docs/api/admin-graphql/latest/queries/appdiscounttype#top)
app Discount Type
=================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/appdiscounttype#arguments)
Arguments
---------

[Anchor to functionId](https://shopify.dev/docs/api/admin-graphql/latest/queries/appdiscounttype#arguments-functionId)function Id
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/appdiscounttype#possible-returns)Possible returns
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to AppDiscountType](https://shopify.dev/docs/api/admin-graphql/latest/queries/appdiscounttype#returns-AppDiscountType)App Discount Type
