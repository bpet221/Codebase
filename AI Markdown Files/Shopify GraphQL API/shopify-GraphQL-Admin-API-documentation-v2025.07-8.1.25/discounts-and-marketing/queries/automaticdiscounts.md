---
title: "automaticDiscounts"
description: "Shopify GraphQL Admin API documentation for automaticdiscounts"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts

Markdown Content:
automaticDiscounts - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#main-content)
...
[Anchor to automaticDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#top)
automatic Discounts
===================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#arguments)
...
[Anchor to after](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#arguments-after)after

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come after the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to before](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#arguments-before)before

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come before the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to first](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#arguments-first)first

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to last](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#arguments-last)last

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#arguments-query)query
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#argument-query-filter-default)default
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#argument-query-filter-id)id
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#argument-query-filter-status)status
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#argument-query-filter-type)type
...
[Anchor to reverse](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#arguments-reverse)reverse
...
[Anchor to savedSearchId](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#arguments-savedSearchId)saved Search Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of a [saved search](https://shopify.dev/api/admin-graphql/latest/objects/savedsearch#field-id). The search’s query string is used as the query argument.

[Anchor to sortKey](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#arguments-sortKey)sort Key
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#possible-returns)Possible returns
-------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to edges](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#returns-edges)edges
...
[Anchor to nodes](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#returns-nodes)nodes
...
[Anchor to pageInfo](https://shopify.dev/docs/api/admin-graphql/latest/queries/automaticdiscounts#returns-pageInfo)page Info
