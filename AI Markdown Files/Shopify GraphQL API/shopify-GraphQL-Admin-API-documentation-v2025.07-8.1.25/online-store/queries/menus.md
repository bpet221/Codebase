---
title: "menus"
description: "Shopify GraphQL Admin API documentation for menus"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/menus"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/menus

Markdown Content:
menus - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#main-content)
...
[Anchor to menus](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#top)
menus
=====
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#arguments)
MenuConnection arguments
------------------------

•[MenuConnection!](https://shopify.dev/docs/api/admin-graphql/latest/connections/MenuConnection)

[Anchor to after](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#arguments-after)after

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come after the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to before](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#arguments-before)before

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come before the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to first](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#arguments-first)first

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to last](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#arguments-last)last

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#arguments-query)query
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#argument-query-filter-default)default
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#argument-query-filter-id)id
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#argument-query-filter-title)title

•string

[Anchor to reverse](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#arguments-reverse)reverse
...
[Anchor to sortKey](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#arguments-sortKey)sort Key
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#possible-returns)Possible returns
------------------------------------------------------------------------------------------------------------------------------

[Anchor to edges](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#returns-edges)edges
...
[Anchor to nodes](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#returns-nodes)nodes
...
[Anchor to pageInfo](https://shopify.dev/docs/api/admin-graphql/latest/queries/menus#returns-pageInfo)page Info
