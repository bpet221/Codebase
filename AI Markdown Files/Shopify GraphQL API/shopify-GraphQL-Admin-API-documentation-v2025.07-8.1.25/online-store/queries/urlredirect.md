---
title: "urlRedirect"
description: "Shopify GraphQL Admin API documentation for urlredirect"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/urlredirect"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/urlredirect

Markdown Content:
urlRedirect - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/urlredirect#main-content)
...
[Anchor to urlRedirect](https://shopify.dev/docs/api/admin-graphql/latest/queries/urlredirect#top)
url Redirect
============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/urlredirect#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/queries/urlredirect#arguments-id)id
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/urlredirect#possible-returns)Possible returns
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to UrlRedirect](https://shopify.dev/docs/api/admin-graphql/latest/queries/urlredirect#returns-UrlRedirect)Url Redirect
...
[Open in GraphiQL](http://localhost:3457/graphiql?query=query%20UrlRedirect(%24id%3A%20ID!)%20%7B%0A%20%20urlRedirect(id%3A%20%24id)%20%7B%0A%20%20%20%20id%0A%20%20%20%20path%0A%20%20%20%20target%0A%20%20%7D%0A%7D&variables=%7B%0A%20%20%22id%22%3A%20%22gid%3A%2F%2Fshopify%2FUrlRedirect%2F905192165%22%0A%7D)Copy
