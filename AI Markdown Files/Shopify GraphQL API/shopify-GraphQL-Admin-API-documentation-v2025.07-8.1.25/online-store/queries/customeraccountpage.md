...
description: "Shopify GraphQL Admin API documentation for customeraccountpage"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/customeraccountpage"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/customeraccountpage

Markdown Content:
customerAccountPage - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/customeraccountpage#main-content)
...
[Anchor to customerAccountPage](https://shopify.dev/docs/api/admin-graphql/latest/queries/customeraccountpage#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/customeraccountpage#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/queries/customeraccountpage#arguments-id)id
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/customeraccountpage#possible-returns)Possible returns
--------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to CustomerAccountPage](https://shopify.dev/docs/api/admin-graphql/latest/queries/customeraccountpage#returns-CustomerAccountPage)Customer Account Page
