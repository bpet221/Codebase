---
title: "OnlineStoreThemeFileBodyUrl"
description: "Shopify GraphQL Admin API documentation for onlinestorethemefilebodyurl"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefilebodyurl"
...
Title: OnlineStoreThemeFileBodyUrl - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefilebodyurl

Markdown Content:
OnlineStoreThemeFileBodyUrl - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefilebodyurl#main-content)
...
[Anchor to OnlineStoreThemeFileBodyUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefilebodyurl#top)
Online Store Theme File Body Url
================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefilebodyurl#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestorethemefilebodyurl#field-OnlineStoreThemeFileBodyUrl.fields.url)url
