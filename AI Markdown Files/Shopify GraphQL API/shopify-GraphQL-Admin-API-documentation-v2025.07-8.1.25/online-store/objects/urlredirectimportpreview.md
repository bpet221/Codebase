---
title: "UrlRedirectImportPreview"
description: "Shopify GraphQL Admin API documentation for urlredirectimportpreview"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectimportpreview"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectimportpreview

Markdown Content:
UrlRedirectImportPreview - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectimportpreview#main-content)
...
[Anchor to UrlRedirectImportPreview](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectimportpreview#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectimportpreview#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to path](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectimportpreview#field-UrlRedirectImportPreview.fields.path)path
...
[Anchor to target](https://shopify.dev/docs/api/admin-graphql/latest/objects/urlredirectimportpreview#field-UrlRedirectImportPreview.fields.target)target
...
*   {}[UrlRedirectImport.previewRedirects](https://shopify.dev/docs/api/admin-graphql/latest/objects/UrlRedirectImport#field-previewRedirects)
