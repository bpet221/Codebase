---
title: "CommentAuthor"
description: "Shopify GraphQL Admin API documentation for commentauthor"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/commentauthor"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/commentauthor

Markdown Content:
CommentAuthor - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentauthor#main-content)
...
[Anchor to CommentAuthor](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentauthor#top)
Comment Author
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentauthor#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to email](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentauthor#field-CommentAuthor.fields.email)email
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/commentauthor#field-CommentAuthor.fields.name)name
...
*   {}[Comment.author](https://shopify.dev/docs/api/admin-graphql/latest/objects/Comment#field-author)
