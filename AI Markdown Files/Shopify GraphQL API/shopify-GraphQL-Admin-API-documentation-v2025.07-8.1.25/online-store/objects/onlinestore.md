---
title: "OnlineStore"
description: "Shopify GraphQL Admin API documentation for onlinestore"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore"
...
Title: OnlineStore - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore

Markdown Content:
OnlineStore - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore#queries)
...
[Anchor to OnlineStore](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore#top)
Online Store
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to passwordProtection](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore#field-OnlineStore.fields.passwordProtection)password Protection
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore#queries)Queries
---------------------------------------------------------------------------------------------------------

[Anchor to onlineStore](https://shopify.dev/docs/api/admin-graphql/latest/objects/onlinestore#query-onlineStore)[online Store](https://shopify.dev/docs/api/admin-graphql/latest/queries/onlineStore)
