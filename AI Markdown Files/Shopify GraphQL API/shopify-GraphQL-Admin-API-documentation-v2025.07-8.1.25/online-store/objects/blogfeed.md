---
title: "BlogFeed"
description: "Shopify GraphQL Admin API documentation for blogfeed"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/blogfeed"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/blogfeed

Markdown Content:
BlogFeed - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogfeed#main-content)
...
[Anchor to BlogFeed](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogfeed#top)
Blog Feed
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogfeed#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to location](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogfeed#field-BlogFeed.fields.location)location
...
[Anchor to path](https://shopify.dev/docs/api/admin-graphql/latest/objects/blogfeed#field-BlogFeed.fields.path)path
...
*   {}[Blog.feed](https://shopify.dev/docs/api/admin-graphql/latest/objects/Blog#field-feed)
