---
title: "articleUpdate"
description: "Shopify GraphQL Admin API documentation for articleupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate

Markdown Content:
articleUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate#main-content)
...
[Anchor to articleUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate#top)
article Update
==============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate#arguments)
Arguments
---------

[Anchor to article](https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate#arguments-article)article
...
[Anchor to blog](https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate#arguments-blog)blog
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate#arguments-id)id
...
[Anchor to ArticleUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate#returns)Article Update Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to article](https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate#returns-article)article
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/articleupdate#returns-userErrors)user Errors
