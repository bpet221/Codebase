---
title: "urlRedirectBulkDeleteBySearch"
description: "Shopify GraphQL Admin API documentation for urlredirectbulkdeletebysearch"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebysearch"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebysearch

Markdown Content:
urlRedirectBulkDeleteBySearch - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebysearch#main-content)
...
[Anchor to urlRedirectBulkDeleteBySearch](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebysearch#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebysearch#arguments)
Arguments
---------

[Anchor to search](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebysearch#arguments-search)search
...
[Anchor to UrlRedirectBulkDeleteBySearchPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebysearch#returns)Url Redirect Bulk Delete By Search Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to job](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebysearch#returns-job)job
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebysearch#returns-userErrors)user Errors
