---
title: "commentNotSpam"
description: "Shopify GraphQL Admin API documentation for commentnotspam"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/commentnotspam"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/commentnotspam

Markdown Content:
commentNotSpam - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/commentnotspam#main-content)
...
[Anchor to commentNotSpam](https://shopify.dev/docs/api/admin-graphql/latest/mutations/commentnotspam#top)
comment Not Spam
================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/commentnotspam#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/commentnotspam#arguments-id)id
...
[Anchor to CommentNotSpamPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/commentnotspam#returns)Comment Not Spam Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to comment](https://shopify.dev/docs/api/admin-graphql/latest/mutations/commentnotspam#returns-comment)comment
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/commentnotspam#returns-userErrors)user Errors
...
[Open in GraphiQL](http://localhost:3457/graphiql?query=mutation%20CommentNotSpam(%24id%3A%20ID!)%20%7B%0A%20%20commentNotSpam(id%3A%20%24id)%20%7B%0A%20%20%20%20comment%20%7B%0A%20%20%20%20%20%20id%0A%20%20%20%20%7D%0A%20%20%20%20userErrors%20%7B%0A%20%20%20%20%20%20code%0A%20%20%20%20%20%20field%0A%20%20%20%20%20%20message%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D&variables=%7B%0A%20%20%22id%22%3A%20%22gid%3A%2F%2Fshopify%2FComment%2F9450891%22%0A%7D)Copy
