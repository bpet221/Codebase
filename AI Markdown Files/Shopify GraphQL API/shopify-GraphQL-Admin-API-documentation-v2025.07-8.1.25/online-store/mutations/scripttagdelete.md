---
title: "scriptTagDelete"
description: "Shopify GraphQL Admin API documentation for scripttagdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/scripttagdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/scripttagdelete

Markdown Content:
scriptTagDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/scripttagdelete#main-content)
...
[Anchor to scriptTagDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/scripttagdelete#top)
script Tag Delete
=================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/scripttagdelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/scripttagdelete#arguments-id)id
...
[Anchor to ScriptTagDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/scripttagdelete#returns)Script Tag Delete Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedScriptTagId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/scripttagdelete#returns-deletedScriptTagId)deleted Script Tag Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the deleted script tag.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/scripttagdelete#returns-userErrors)user Errors
...
[Open in GraphiQL](http://localhost:3457/graphiql?query=mutation%20ScriptTagDelete(%24id%3A%20ID!)%20%7B%0A%20%20scriptTagDelete(id%3A%20%24id)%20%7B%0A%20%20%20%20deletedScriptTagId%0A%20%20%20%20userErrors%20%7B%0A%20%20%20%20%20%20field%0A%20%20%20%20%20%20message%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D&variables=%7B%0A%20%20%22id%22%3A%20%22gid%3A%2F%2Fshopify%2FScriptTag%2F421379493%22%0A%7D)Copy
