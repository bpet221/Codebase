---
title: "urlRedirectBulkDeleteByIds"
description: "Shopify GraphQL Admin API documentation for urlredirectbulkdeletebyids"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebyids"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebyids

Markdown Content:
urlRedirectBulkDeleteByIds - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebyids#main-content)
...
[Anchor to urlRedirectBulkDeleteByIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebyids#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebyids#arguments)
Arguments
---------

[Anchor to ids](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebyids#arguments-ids)ids
...
[Anchor to UrlRedirectBulkDeleteByIdsPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebyids#returns)Url Redirect Bulk Delete By Ids Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to job](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebyids#returns-job)job
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/urlredirectbulkdeletebyids#returns-userErrors)user Errors
