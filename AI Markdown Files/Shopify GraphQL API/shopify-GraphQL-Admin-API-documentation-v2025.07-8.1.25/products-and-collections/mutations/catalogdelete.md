---
title: "catalogDelete"
description: "Shopify GraphQL Admin API documentation for catalogdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete

Markdown Content:
catalogDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete#main-content)
...
[Anchor to catalogDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete#top)
catalog Delete
==============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete#arguments)
Arguments
---------

[Anchor to deleteDependentResources](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete#arguments-deleteDependentResources)delete Dependent Resources
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete#arguments-id)id
...
[Anchor to CatalogDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete#returns)Catalog Delete Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete#returns-deletedId)deleted Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the deleted catalog.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogdelete#returns-userErrors)user Errors
