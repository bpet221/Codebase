---
title: "priceListFixedPricesUpdate"
description: "Shopify GraphQL Admin API documentation for pricelistfixedpricesupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate

Markdown Content:
priceListFixedPricesUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#main-content)
...
[Anchor to priceListFixedPricesUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#arguments)
Arguments
---------

[Anchor to priceListId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#arguments-priceListId)price List Id
...
[Anchor to pricesToAdd](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#arguments-pricesToAdd)prices To Add
...
[Anchor to variantIdsToDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#arguments-variantIdsToDelete)variant Ids To Delete
...
[Anchor to PriceListFixedPricesUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#returns)Price List Fixed Prices Update Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedFixedPriceVariantIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#returns-deletedFixedPriceVariantIds)deleted Fixed Price Variant Ids

•[[ID!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A list of deleted variant IDs for prices.

[Anchor to priceList](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#returns-priceList)price List
...
[Anchor to pricesAdded](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#returns-pricesAdded)prices Added
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesupdate#returns-userErrors)user Errors
