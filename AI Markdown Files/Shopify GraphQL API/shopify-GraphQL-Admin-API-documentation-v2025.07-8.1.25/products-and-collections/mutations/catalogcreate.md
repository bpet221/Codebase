---
title: "catalogCreate"
description: "Shopify GraphQL Admin API documentation for catalogcreate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogcreate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogcreate

Markdown Content:
catalogCreate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogcreate#main-content)
...
[Anchor to catalogCreate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogcreate#top)
catalog Create
==============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogcreate#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogcreate#arguments-input)input
...
[Anchor to CatalogCreatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogcreate#returns)Catalog Create Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to catalog](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogcreate#returns-catalog)catalog
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogcreate#returns-userErrors)user Errors
