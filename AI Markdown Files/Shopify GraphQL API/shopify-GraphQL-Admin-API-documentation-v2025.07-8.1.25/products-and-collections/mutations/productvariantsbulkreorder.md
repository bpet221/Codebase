---
title: "productVariantsBulkReorder"
description: "Shopify GraphQL Admin API documentation for productvariantsbulkreorder"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder

Markdown Content:
productVariantsBulkReorder - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder#main-content)
...
[Anchor to productVariantsBulkReorder](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder#arguments)
Arguments
---------

[Anchor to positions](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder#arguments-positions)positions
...
[Anchor to productId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder#arguments-productId)product Id
...
[Anchor to ProductVariantsBulkReorderPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder#returns)Product Variants Bulk Reorder Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder#returns-product)product
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantsbulkreorder#returns-userErrors)user Errors
