...
description: "Shopify GraphQL Admin API documentation for pricelistcreate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistcreate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistcreate

Markdown Content:
priceListCreate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistcreate#main-content)
...
[Anchor to priceListCreate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistcreate#top)
price List Create
=================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistcreate#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistcreate#arguments-input)input
...
[Anchor to PriceListCreatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistcreate#returns)Price List Create Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to priceList](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistcreate#returns-priceList)price List
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistcreate#returns-userErrors)user Errors
