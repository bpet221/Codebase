---
title: "productUnpublish"
description: "Shopify GraphQL Admin API documentation for productunpublish"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish

Markdown Content:
productUnpublish - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish#main-content)
...
[Anchor to productUnpublish](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish#top)
product Unpublish
=================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish#arguments-input)input
...
[Anchor to ProductUnpublishPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish#returns)Product Unpublish Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish#returns-product)product
...
[Anchor to shop](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish#returns-shop)shop
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productunpublish#returns-userErrors)user Errors
