---
title: "quantityRulesDelete"
description: "Shopify GraphQL Admin API documentation for quantityrulesdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete

Markdown Content:
quantityRulesDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete#main-content)
...
[Anchor to quantityRulesDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete#arguments)
Arguments
---------

[Anchor to priceListId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete#arguments-priceListId)price List Id
...
[Anchor to variantIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete#arguments-variantIds)variant Ids
...
[Anchor to QuantityRulesDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete#returns)Quantity Rules Delete Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedQuantityRulesVariantIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete#returns-deletedQuantityRulesVariantIds)deleted Quantity Rules Variant Ids

•[[ID!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A list of product variant IDs whose quantity rules were removed from the price list.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityrulesdelete#returns-userErrors)user Errors
...
Show description[Open in GraphiQL](http://localhost:3457/graphiql?query=mutation%20quantityRulesDelete(%24priceListId%3A%20ID!%2C%20%24variantIds%3A%20%5BID!%5D!)%20%7B%0A%20%20quantityRulesDelete(priceListId%3A%20%24priceListId%2C%20variantIds%3A%20%24variantIds)%20%7B%0A%20%20%20%20deletedQuantityRulesVariantIds%0A%20%20%20%20userErrors%20%7B%0A%20%20%20%20%20%20field%0A%20%20%20%20%20%20code%0A%20%20%20%20%20%20message%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D&variables=%7B%0A%20%20%22priceListId%22%3A%20%22gid%3A%2F%2Fshopify%2FPriceList%2F225060712%22%2C%0A%20%20%22variantIds%22%3A%20%5B%0A%20%20%20%20%22gid%3A%2F%2Fshopify%2FProductVariant%2F43729076%22%2C%0A%20%20%20%20%22gid%3A%2F%2Fshopify%2FProductVariant%2F138327650%22%0A%20%20%5D%0A%7D)Copy
