---
title: "collectionUnpublish"
description: "Shopify GraphQL Admin API documentation for collectionunpublish"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish

Markdown Content:
collectionUnpublish - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish#main-content)
...
[Anchor to collectionUnpublish](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish#arguments-input)input
...
[Anchor to CollectionUnpublishPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish#returns)Collection Unpublish Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to collection](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish#returns-collection)collection
...
[Anchor to shop](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish#returns-shop)shop
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionunpublish#returns-userErrors)user Errors
