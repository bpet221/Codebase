---
title: "sellingPlanGroupRemoveProductVariants"
description: "Shopify GraphQL Admin API documentation for sellingplangroupremoveproductvariants"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants

Markdown Content:
sellingPlanGroupRemoveProductVariants - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants#main-content)
...
[Anchor to sellingPlanGroupRemoveProductVariants](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants#arguments-id)id
...
[Anchor to productVariantIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants#arguments-productVariantIds)product Variant Ids
...
[Anchor to SellingPlanGroupRemoveProductVariantsPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants#returns)Selling Plan Group Remove Product Variants Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to removedProductVariantIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants#returns-removedProductVariantIds)removed Product Variant Ids

•[[ID!]](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The removed product variant ids.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupremoveproductvariants#returns-userErrors)user Errors
