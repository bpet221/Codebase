---
title: "fileAcknowledgeUpdateFailed"
description: "Shopify GraphQL Admin API documentation for fileacknowledgeupdatefailed"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileacknowledgeupdatefailed"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileacknowledgeupdatefailed

Markdown Content:
fileAcknowledgeUpdateFailed - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileacknowledgeupdatefailed#main-content)
...
[Anchor to fileAcknowledgeUpdateFailed](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileacknowledgeupdatefailed#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileacknowledgeupdatefailed#arguments)
Arguments
---------

[Anchor to fileIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileacknowledgeupdatefailed#arguments-fileIds)file Ids
...
[Anchor to FileAcknowledgeUpdateFailedPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileacknowledgeupdatefailed#returns)File Acknowledge Update Failed Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to files](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileacknowledgeupdatefailed#returns-files)files
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fileacknowledgeupdatefailed#returns-userErrors)user Errors
