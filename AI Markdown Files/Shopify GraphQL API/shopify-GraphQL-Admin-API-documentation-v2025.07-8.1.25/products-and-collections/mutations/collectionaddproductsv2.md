---
title: "collectionAddProductsV2"
description: "Shopify GraphQL Admin API documentation for collectionaddproductsv2"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2

Markdown Content:
collectionAddProductsV2 - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2#main-content)
...
[Anchor to collectionAddProductsV2](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2#arguments-id)id
...
[Anchor to productIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2#arguments-productIds)product Ids
...
[Anchor to CollectionAddProductsV2Payload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2#returns)Collection Add Products V2Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to job](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2#returns-job)job
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionaddproductsv2#returns-userErrors)user Errors
