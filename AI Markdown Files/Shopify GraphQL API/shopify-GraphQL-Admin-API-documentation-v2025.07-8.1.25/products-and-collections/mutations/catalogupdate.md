---
title: "catalogUpdate"
description: "Shopify GraphQL Admin API documentation for catalogupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate

Markdown Content:
catalogUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate#main-content)
...
[Anchor to catalogUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate#top)
catalog Update
==============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate#arguments-id)id
...
[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate#arguments-input)input
...
[Anchor to CatalogUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate#returns)Catalog Update Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to catalog](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate#returns-catalog)catalog
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/catalogupdate#returns-userErrors)user Errors
