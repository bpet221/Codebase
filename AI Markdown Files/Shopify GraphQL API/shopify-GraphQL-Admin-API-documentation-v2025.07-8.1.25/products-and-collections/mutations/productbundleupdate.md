---
title: "productBundleUpdate"
description: "Shopify GraphQL Admin API documentation for productbundleupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/productbundleupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/productbundleupdate

Markdown Content:
productBundleUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productbundleupdate#main-content)
...
[Anchor to productBundleUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productbundleupdate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productbundleupdate#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productbundleupdate#arguments-input)input
...
[Anchor to ProductBundleUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productbundleupdate#returns)Product Bundle Update Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to productBundleOperation](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productbundleupdate#returns-productBundleOperation)product Bundle Operation
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productbundleupdate#returns-userErrors)user Errors
