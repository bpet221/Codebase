---
title: "collectionPublish"
description: "Shopify GraphQL Admin API documentation for collectionpublish"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish

Markdown Content:
collectionPublish - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish#main-content)
...
[Anchor to collectionPublish](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish#top)
collection Publish
==================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish#arguments-input)input
...
[Anchor to CollectionPublishPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish#returns)Collection Publish Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to collection](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish#returns-collection)collection
...
[Anchor to collectionPublications](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish#returns-collectionPublications)collection Publications
...
[Anchor to shop](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish#returns-shop)shop
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionpublish#returns-userErrors)user Errors
