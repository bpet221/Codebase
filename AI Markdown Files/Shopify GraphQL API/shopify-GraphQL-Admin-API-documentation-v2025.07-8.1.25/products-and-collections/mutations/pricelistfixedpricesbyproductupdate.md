...
description: "Shopify GraphQL Admin API documentation for pricelistfixedpricesbyproductupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate

Markdown Content:
priceListFixedPricesByProductUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#main-content)
...
[Anchor to priceListFixedPricesByProductUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#arguments)
Arguments
---------

[Anchor to priceListId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#arguments-priceListId)price List Id
...
[Anchor to pricesToAdd](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#arguments-pricesToAdd)prices To Add
...
[Anchor to pricesToDeleteByProductIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#arguments-pricesToDeleteByProductIds)prices To Delete By Product Ids
...
[Anchor to PriceListFixedPricesByProductUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#returns)Price List Fixed Prices By Product Update Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to priceList](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#returns-priceList)price List
...
[Anchor to pricesToAddProducts](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#returns-pricesToAddProducts)prices To Add Products
...
[Anchor to pricesToDeleteProducts](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#returns-pricesToDeleteProducts)prices To Delete Products
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/pricelistfixedpricesbyproductupdate#returns-userErrors)user Errors
