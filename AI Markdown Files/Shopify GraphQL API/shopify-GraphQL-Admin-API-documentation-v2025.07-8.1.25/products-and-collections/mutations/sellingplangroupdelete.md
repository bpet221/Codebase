---
title: "sellingPlanGroupDelete"
description: "Shopify GraphQL Admin API documentation for sellingplangroupdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupdelete

Markdown Content:
sellingPlanGroupDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupdelete#main-content)
...
[Anchor to sellingPlanGroupDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupdelete#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupdelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupdelete#arguments-id)id
...
[Anchor to SellingPlanGroupDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupdelete#returns)Selling Plan Group Delete Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedSellingPlanGroupId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupdelete#returns-deletedSellingPlanGroupId)deleted Selling Plan Group Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the deleted selling plan group object.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/sellingplangroupdelete#returns-userErrors)user Errors
