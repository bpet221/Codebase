---
title: "productVariantLeaveSellingPlanGroups"
description: "Shopify GraphQL Admin API documentation for productvariantleavesellingplangroups"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups

Markdown Content:
productVariantLeaveSellingPlanGroups - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups#main-content)
...
[Anchor to productVariantLeaveSellingPlanGroups](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups#arguments-id)id
...
[Anchor to sellingPlanGroupIds](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups#arguments-sellingPlanGroupIds)selling Plan Group Ids
...
[Anchor to ProductVariantLeaveSellingPlanGroupsPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups#returns)Product Variant Leave Selling Plan Groups Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to productVariant](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups#returns-productVariant)product Variant
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productvariantleavesellingplangroups#returns-userErrors)user Errors
