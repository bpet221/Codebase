...
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/taxonomy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/taxonomy

Markdown Content:
taxonomy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/taxonomy#main-content)
...
[Anchor to taxonomy](https://shopify.dev/docs/api/admin-graphql/latest/queries/taxonomy#top)
taxonomy
========
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/taxonomy#possible-returns)Possible returns
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to Taxonomy](https://shopify.dev/docs/api/admin-graphql/latest/queries/taxonomy#returns-Taxonomy)Taxonomy
