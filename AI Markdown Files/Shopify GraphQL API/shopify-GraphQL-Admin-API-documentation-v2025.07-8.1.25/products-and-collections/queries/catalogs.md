---
title: "catalogs"
description: "Shopify GraphQL Admin API documentation for catalogs"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs

Markdown Content:
catalogs - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#main-content)
...
[Anchor to catalogs](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#top)
catalogs
========
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#arguments)
...
[Anchor to after](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#arguments-after)after

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come after the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to before](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#arguments-before)before

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come before the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to first](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#arguments-first)first

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to last](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#arguments-last)last

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#arguments-query)query
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#argument-query-filter-default)default
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#argument-query-filter-app_id)app_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#argument-query-filter-company_id)company_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#argument-query-filter-company_location_id)company_location_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#argument-query-filter-id)id
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#argument-query-filter-managed_country_id)managed_country_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#argument-query-filter-market_id)market_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#argument-query-filter-status)status

•string

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#argument-query-filter-title)title

•string

[Anchor to reverse](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#arguments-reverse)reverse
...
[Anchor to sortKey](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#arguments-sortKey)sort Key
...
[Anchor to type](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#arguments-type)type
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#possible-returns)Possible returns
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to edges](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#returns-edges)edges
...
[Anchor to nodes](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#returns-nodes)nodes
...
[Anchor to pageInfo](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogs#returns-pageInfo)page Info
