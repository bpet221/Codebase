---
title: "catalogsCount"
description: "Shopify GraphQL Admin API documentation for catalogscount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount

Markdown Content:
catalogsCount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#main-content)
...
[Anchor to catalogsCount](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#top)
catalogs Count
==============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#arguments)
Arguments
---------

[Anchor to limit](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#arguments-limit)limit
...
[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#arguments-query)query
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#argument-query-filter-default)default
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#argument-query-filter-app_id)app_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#argument-query-filter-company_id)company_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#argument-query-filter-company_location_id)company_location_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#argument-query-filter-id)id
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#argument-query-filter-managed_country_id)managed_country_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#argument-query-filter-market_id)market_id

•id

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#argument-query-filter-status)status

•string

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#argument-query-filter-title)title

•string

[Anchor to type](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#arguments-type)type
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#possible-returns)Possible returns
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to Count](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogscount#returns-Count)Count
