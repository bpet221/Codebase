---
title: "catalogOperations"
description: "Shopify GraphQL Admin API documentation for catalogoperations"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogoperations"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogoperations

Markdown Content:
catalogOperations - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogoperations#main-content)
...
[Anchor to catalogOperations](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogoperations#top)
catalog Operations
==================
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogoperations#possible-returns)Possible returns
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to ResourceOperation](https://shopify.dev/docs/api/admin-graphql/latest/queries/catalogoperations#returns-ResourceOperation)Resource Operation
