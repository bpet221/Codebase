---
title: "sellingPlanGroups"
description: "Shopify GraphQL Admin API documentation for sellingplangroups"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups

Markdown Content:
sellingPlanGroups - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#main-content)
...
[Anchor to sellingPlanGroups](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#top)
selling Plan Groups
===================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#arguments)
...
[Anchor to after](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#arguments-after)after

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come after the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to before](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#arguments-before)before

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come before the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to first](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#arguments-first)first

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to last](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#arguments-last)last

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#arguments-query)query
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#argument-query-filter-default)default
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#argument-query-filter-app_id)app_id
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#argument-query-filter-category)category
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#argument-query-filter-created_at)created_at

•time

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#argument-query-filter-delivery_frequency)delivery_frequency

•string

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#argument-query-filter-id)id
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#argument-query-filter-name)name

•string

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#argument-query-filter-percentage_off)percentage_off

•float

[Anchor to reverse](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#arguments-reverse)reverse
...
[Anchor to sortKey](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#arguments-sortKey)sort Key
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#possible-returns)Possible returns
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to edges](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#returns-edges)edges
...
[Anchor to nodes](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#returns-nodes)nodes
...
[Anchor to pageInfo](https://shopify.dev/docs/api/admin-graphql/latest/queries/sellingplangroups#returns-pageInfo)page Info
