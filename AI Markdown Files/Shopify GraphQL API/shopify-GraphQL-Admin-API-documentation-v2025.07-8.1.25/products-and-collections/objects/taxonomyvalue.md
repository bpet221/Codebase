---
title: "TaxonomyValue"
description: "Shopify GraphQL Admin API documentation for taxonomyvalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue

Markdown Content:
TaxonomyValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue#interfaces)
...
[Anchor to TaxonomyValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue#top)
Taxonomy Value
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue#field-TaxonomyValue.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue#field-TaxonomyValue.fields.name)name
...
*   {}[TaxonomyChoiceListAttribute.values](https://shopify.dev/docs/api/admin-graphql/latest/objects/TaxonomyChoiceListAttribute#field-values)
*   <->[TaxonomyValueConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/TaxonomyValueConnection#field-nodes)
*   {}[TaxonomyValueEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/TaxonomyValueEdge#field-node)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyvalue#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
