---
title: "Weight"
description: "Shopify GraphQL Admin API documentation for weight"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/weight"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/weight

Markdown Content:
Weight - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/weight#main-content)
...
[Anchor to Weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/weight#top)
Weight
======
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/weight#fields)Fields
-------------------------------------------------------------------------------------------------

[Anchor to unit](https://shopify.dev/docs/api/admin-graphql/latest/objects/weight#field-Weight.fields.unit)unit
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/weight#field-Weight.fields.value)value
...
*   {}[CalculatedDraftOrderLineItem.weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-weight)
*   {}[DraftOrderLineItem.weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrderLineItem#field-weight)
*   {}[FulfillmentOrderLineItem.weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/FulfillmentOrderLineItem#field-weight)
*   {}[InventoryItemMeasurement.weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/InventoryItemMeasurement#field-weight)
*   {}[ReturnLineItem.totalWeight](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReturnLineItem#field-totalWeight)
