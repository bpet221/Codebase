---
title: "SellingPlanFixedPricingPolicy"
description: "Shopify GraphQL Admin API documentation for sellingplanfixedpricingpolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy

Markdown Content:
SellingPlanFixedPricingPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#interfaces)
...
[Anchor to SellingPlanFixedPricingPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to adjustmentType](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#field-SellingPlanFixedPricingPolicy.fields.adjustmentType)adjustment Type
...
[Anchor to adjustmentValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#field-SellingPlanFixedPricingPolicy.fields.adjustmentValue)adjustment Value
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#field-SellingPlanFixedPricingPolicy.fields.createdAt)created At
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to SellingPlanPricingPolicyBase](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixedpricingpolicy#interface-SellingPlanPricingPolicyBase)[Selling Plan Pricing Policy Base](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SellingPlanPricingPolicyBase)
