---
title: "CollectionRuleProductCategoryCondition"
description: "Shopify GraphQL Admin API documentation for collectionruleproductcategorycondition"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleproductcategorycondition"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleproductcategorycondition

Markdown Content:
CollectionRuleProductCategoryCondition - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleproductcategorycondition#main-content)
...
[Anchor to CollectionRuleProductCategoryCondition](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleproductcategorycondition#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleproductcategorycondition#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleproductcategorycondition#field-CollectionRuleProductCategoryCondition.fields.value)value
