---
title: "ExternalVideo"
description: "Shopify GraphQL Admin API documentation for externalvideo"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo

Markdown Content:
ExternalVideo - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#interfaces)
...
[Anchor to ExternalVideo](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#top)
External Video
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to alt](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.alt)alt

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A word or phrase to describe the contents or the function of a file.

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.createdAt)created At
...
[Anchor to embedUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.embedUrl)embed Url
...
[Anchor to fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.fileErrors)file Errors
...
[Anchor to fileStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.fileStatus)file Status
...
[Anchor to host](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.host)host
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.id)id
...
[Anchor to mediaContentType](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.mediaContentType)media Content Type
...
[Anchor to mediaErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.mediaErrors)media Errors
...
[Anchor to mediaWarnings](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.mediaWarnings)media Warnings
...
[Anchor to originUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.originUrl)origin Url
...
[Anchor to preview](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.preview)preview
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.status)status
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.updatedAt)updated At
...
[Anchor to embeddedUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#field-ExternalVideo.fields.embeddedUrl)embedded Url
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------

[Anchor to File](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#interface-File)[File](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/File)

•interface

[Anchor to Media](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#interface-Media)[Media](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Media)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/externalvideo#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
