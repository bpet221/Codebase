---
title: "Taxonomy"
description: "Shopify GraphQL Admin API documentation for taxonomy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy

Markdown Content:
Taxonomy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy#queries)
...
[Anchor to Taxonomy](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy#top)
Taxonomy
========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to categories](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy#field-Taxonomy.fields.categories)categories
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy#queries)Queries
------------------------------------------------------------------------------------------------------

[Anchor to taxonomy](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomy#query-taxonomy)[taxonomy](https://shopify.dev/docs/api/admin-graphql/latest/queries/taxonomy)
