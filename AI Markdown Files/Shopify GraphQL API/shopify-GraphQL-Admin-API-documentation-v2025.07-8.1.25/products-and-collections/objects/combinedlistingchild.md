---
title: "CombinedListingChild"
description: "Shopify GraphQL Admin API documentation for combinedlistingchild"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchild"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchild

Markdown Content:
CombinedListingChild - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchild#main-content)
...
[Anchor to CombinedListingChild](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchild#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchild#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to parentVariant](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchild#field-CombinedListingChild.fields.parentVariant)parent Variant
...
[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlistingchild#field-CombinedListingChild.fields.product)product
...
*   {}[CombinedListing.combinedListingChildren](https://shopify.dev/docs/api/admin-graphql/latest/objects/CombinedListing#field-combinedListingChildren)
*   <->[CombinedListingChildConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/CombinedListingChildConnection#field-nodes)
*   {}[CombinedListingChildEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/CombinedListingChildEdge#field-node)
