...
description: "Shopify GraphQL Admin API documentation for model3dboundingbox"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dboundingbox"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dboundingbox

Markdown Content:
Model3dBoundingBox - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dboundingbox#main-content)
...
[Anchor to Model3dBoundingBox](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dboundingbox#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dboundingbox#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to size](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dboundingbox#field-Model3dBoundingBox.fields.size)size
...
*   {}[Model3d.boundingBox](https://shopify.dev/docs/api/admin-graphql/latest/objects/Model3d#field-boundingBox)
