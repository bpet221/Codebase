---
title: "AppCatalog"
description: "Shopify GraphQL Admin API documentation for appcatalog"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog

Markdown Content:
AppCatalog - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#interfaces)
...
[Anchor to AppCatalog](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#top)
App Catalog
===========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#fields)Fields
-----------------------------------------------------------------------------------------------------

[Anchor to apps](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#field-AppCatalog.fields.apps)apps
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#field-AppCatalog.fields.id)id
...
[Anchor to operations](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#field-AppCatalog.fields.operations)operations
...
[Anchor to priceList](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#field-AppCatalog.fields.priceList)price List
...
[Anchor to publication](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#field-AppCatalog.fields.publication)publication
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#field-AppCatalog.fields.status)status
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#field-AppCatalog.fields.title)title
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------

[Anchor to Catalog](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#interface-Catalog)[Catalog](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Catalog)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/appcatalog#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
