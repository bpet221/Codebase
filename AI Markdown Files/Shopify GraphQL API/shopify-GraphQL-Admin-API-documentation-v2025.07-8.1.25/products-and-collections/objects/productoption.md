---
title: "ProductOption"
description: "Shopify GraphQL Admin API documentation for productoption"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption

Markdown Content:
ProductOption - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#interfaces)
...
[Anchor to ProductOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#top)
Product Option
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#field-ProductOption.fields.id)id
...
[Anchor to linkedMetafield](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#field-ProductOption.fields.linkedMetafield)linked Metafield
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#field-ProductOption.fields.name)name
...
[Anchor to optionValues](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#field-ProductOption.fields.optionValues)option Values
...
[Anchor to position](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#field-ProductOption.fields.position)position
...
[Anchor to translations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#field-ProductOption.fields.translations)translations
...
[Anchor to values](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#field-ProductOption.fields.values)values
...
*   {}[Product.options](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-options)
*   {}[ProductBundleComponentOptionSelection.componentOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductBundleComponentOptionSelection#field-componentOption)
*   {}[ProductBundleComponentOptionSelection.parentOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductBundleComponentOptionSelection#field-parentOption)
*   {}[ProductBundleComponentQuantityOption.parentOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductBundleComponentQuantityOption#field-parentOption)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------

[Anchor to HasPublishedTranslations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#interface-HasPublishedTranslations)[Has Published Translations](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/HasPublishedTranslations)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoption#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
