---
title: "SellingPlanPricingPolicyPercentageValue"
description: "Shopify GraphQL Admin API documentation for sellingplanpricingpolicypercentagevalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanpricingpolicypercentagevalue"
...
Title: SellingPlanPricingPolicyPercentageValue - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanpricingpolicypercentagevalue

Markdown Content:
SellingPlanPricingPolicyPercentageValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanpricingpolicypercentagevalue#main-content)
...
[Anchor to SellingPlanPricingPolicyPercentageValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanpricingpolicypercentagevalue#top)
Selling Plan Pricing Policy Percentage Value
============================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanpricingpolicypercentagevalue#fields)Fields
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to percentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanpricingpolicypercentagevalue#field-SellingPlanPricingPolicyPercentageValue.fields.percentage)percentage
