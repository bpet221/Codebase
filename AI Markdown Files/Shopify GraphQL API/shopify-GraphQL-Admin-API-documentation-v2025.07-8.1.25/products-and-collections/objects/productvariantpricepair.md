---
title: "ProductVariantPricePair"
description: "Shopify GraphQL Admin API documentation for productvariantpricepair"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepair"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepair

Markdown Content:
ProductVariantPricePair - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepair#main-content)
...
[Anchor to ProductVariantPricePair](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepair#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepair#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to compareAtPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepair#field-ProductVariantPricePair.fields.compareAtPrice)compare At Price
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantpricepair#field-ProductVariantPricePair.fields.price)price
...
*   <->[ProductVariantPricePairConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductVariantPricePairConnection#field-nodes)
*   {}[ProductVariantPricePairEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductVariantPricePairEdge#field-node)
