---
title: "Model3d"
description: "Shopify GraphQL Admin API documentation for model3d"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d

Markdown Content:
Model3d - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#interfaces)
...
[Anchor to Model3d](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#top)
Model3d
=======
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#fields)Fields
--------------------------------------------------------------------------------------------------

[Anchor to alt](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.alt)alt

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A word or phrase to describe the contents or the function of a file.

[Anchor to boundingBox](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.boundingBox)bounding Box
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.createdAt)created At
...
[Anchor to fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.fileErrors)file Errors
...
[Anchor to filename](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.filename)filename
...
[Anchor to fileStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.fileStatus)file Status
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.id)id
...
[Anchor to mediaContentType](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.mediaContentType)media Content Type
...
[Anchor to mediaErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.mediaErrors)media Errors
...
[Anchor to mediaWarnings](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.mediaWarnings)media Warnings
...
[Anchor to originalSource](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.originalSource)original Source
...
[Anchor to preview](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.preview)preview
...
[Anchor to sources](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.sources)sources
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.status)status
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#field-Model3d.fields.updatedAt)updated At
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------

[Anchor to File](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#interface-File)[File](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/File)

•interface

[Anchor to Media](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#interface-Media)[Media](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Media)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3d#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
