---
title: "StandardizedProductType"
description: "Shopify GraphQL Admin API documentation for standardizedproducttype"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/standardizedproducttype"
...
Title: StandardizedProductType - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/standardizedproducttype

Markdown Content:
StandardizedProductType - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardizedproducttype#main-content)
...
[Anchor to StandardizedProductType](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardizedproducttype#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardizedproducttype#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to productTaxonomyNode](https://shopify.dev/docs/api/admin-graphql/latest/objects/standardizedproducttype#field-StandardizedProductType.fields.productTaxonomyNode)product Taxonomy Node
