...
description: "Shopify GraphQL Admin API documentation for quantitypricebreak"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak

Markdown Content:
QuantityPriceBreak - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#interfaces)
...
[Anchor to QuantityPriceBreak](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#field-QuantityPriceBreak.fields.id)id
...
[Anchor to minimumQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#field-QuantityPriceBreak.fields.minimumQuantity)minimum Quantity
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#field-QuantityPriceBreak.fields.price)price
...
[Anchor to priceList](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#field-QuantityPriceBreak.fields.priceList)price List
...
[Anchor to variant](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#field-QuantityPriceBreak.fields.variant)variant
...
*   {}[PriceListPrice.quantityPriceBreaks](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceListPrice#field-quantityPriceBreaks)
*   {}[ProductVariantContextualPricing.quantityPriceBreaks](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductVariantContextualPricing#field-quantityPriceBreaks)
*   <->[QuantityPriceBreakConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/QuantityPriceBreakConnection#field-nodes)
*   {}[QuantityPriceBreakEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/QuantityPriceBreakEdge#field-node)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantitypricebreak#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
