---
title: "Model3dSource"
description: "Shopify GraphQL Admin API documentation for model3dsource"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dsource"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dsource

Markdown Content:
Model3dSource - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dsource#main-content)
...
[Anchor to Model3dSource](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dsource#top)
Model3d Source
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dsource#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to filesize](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dsource#field-Model3dSource.fields.filesize)filesize
...
[Anchor to format](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dsource#field-Model3dSource.fields.format)format
...
[Anchor to mimeType](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dsource#field-Model3dSource.fields.mimeType)mime Type
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/model3dsource#field-Model3dSource.fields.url)url
...
*   {}[Model3d.originalSource](https://shopify.dev/docs/api/admin-graphql/latest/objects/Model3d#field-originalSource)
*   {}[Model3d.sources](https://shopify.dev/docs/api/admin-graphql/latest/objects/Model3d#field-sources)
