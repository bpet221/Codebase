---
title: "MarketCatalog"
description: "Shopify GraphQL Admin API documentation for marketcatalog"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog

Markdown Content:
MarketCatalog - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#interfaces)
...
[Anchor to MarketCatalog](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#top)
Market Catalog
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#field-MarketCatalog.fields.id)id
...
[Anchor to markets](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#field-MarketCatalog.fields.markets)markets
...
[Anchor to marketsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#field-MarketCatalog.fields.marketsCount)markets Count
...
[Anchor to operations](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#field-MarketCatalog.fields.operations)operations
...
[Anchor to priceList](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#field-MarketCatalog.fields.priceList)price List
...
[Anchor to publication](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#field-MarketCatalog.fields.publication)publication
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#field-MarketCatalog.fields.status)status
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#field-MarketCatalog.fields.title)title
...
*   {}[Market.catalogs](https://shopify.dev/docs/api/admin-graphql/latest/objects/Market#field-catalogs)
*   <->[MarketCatalogConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/MarketCatalogConnection#field-nodes)
*   {}[MarketCatalogEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketCatalogEdge#field-node)
*   {}[MarketsResolvedValues.catalogs](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketsResolvedValues#field-catalogs)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------

[Anchor to Catalog](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#interface-Catalog)[Catalog](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Catalog)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketcatalog#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
