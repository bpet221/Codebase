...
description: "Shopify GraphQL Admin API documentation for resourcepublication"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication

Markdown Content:
ResourcePublication - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication#main-content)
...
[Anchor to ResourcePublication](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to isPublished](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication#field-ResourcePublication.fields.isPublished)is Published
...
[Anchor to publication](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication#field-ResourcePublication.fields.publication)publication
...
[Anchor to publishable](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication#field-ResourcePublication.fields.publishable)publishable
...
[Anchor to publishDate](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication#field-ResourcePublication.fields.publishDate)publish Date
...
[Anchor to channel](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublication#field-ResourcePublication.fields.channel)channel
...
*   {}[Channel.collectionPublicationsV3](https://shopify.dev/docs/api/admin-graphql/latest/objects/Channel#field-collectionPublicationsV3)
*   {}[Channel.productPublicationsV3](https://shopify.dev/docs/api/admin-graphql/latest/objects/Channel#field-productPublicationsV3)
*   {}[Collection.resourcePublications](https://shopify.dev/docs/api/admin-graphql/latest/objects/Collection#field-resourcePublications)
*   {}[Product.resourcePublications](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-resourcePublications)
*   {}[Publication.collectionPublicationsV3](https://shopify.dev/docs/api/admin-graphql/latest/objects/Publication#field-collectionPublicationsV3)
*   {}[Publication.productPublicationsV3](https://shopify.dev/docs/api/admin-graphql/latest/objects/Publication#field-productPublicationsV3)
*   ||-[Publishable.resourcePublications](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Publishable#field-resourcePublications)
*   <->[ResourcePublicationConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ResourcePublicationConnection#field-nodes)
*   {}[ResourcePublicationEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ResourcePublicationEdge#field-node)
