---
title: "PriceListAdjustment"
description: "Shopify GraphQL Admin API documentation for pricelistadjustment"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustment"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustment

Markdown Content:
PriceListAdjustment - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustment#main-content)
...
[Anchor to PriceListAdjustment](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustment#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustment#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to type](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustment#field-PriceListAdjustment.fields.type)type
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustment#field-PriceListAdjustment.fields.value)value
...
*   {}[PriceListParent.adjustment](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceListParent#field-adjustment)
