---
title: "ProductBundleComponentQuantityOptionValue"
description: "Shopify GraphQL Admin API documentation for productbundlecomponentquantityoptionvalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoptionvalue"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoptionvalue

Markdown Content:
ProductBundleComponentQuantityOptionValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoptionvalue#main-content)
...
[Anchor to ProductBundleComponentQuantityOptionValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoptionvalue#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoptionvalue#fields)Fields
------------------------------------------------------------------------------------------------------------------------------------

[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoptionvalue#field-ProductBundleComponentQuantityOptionValue.fields.name)name
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoptionvalue#field-ProductBundleComponentQuantityOptionValue.fields.quantity)quantity
...
*   {}[ProductBundleComponentQuantityOption.values](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductBundleComponentQuantityOption#field-values)
