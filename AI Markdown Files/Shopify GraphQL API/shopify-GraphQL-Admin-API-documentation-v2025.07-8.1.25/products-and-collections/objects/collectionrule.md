...
description: "Shopify GraphQL Admin API documentation for collectionrule"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrule"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrule

Markdown Content:
CollectionRule - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrule#main-content)
...
[Anchor to CollectionRule](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrule#top)
Collection Rule
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrule#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to column](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrule#field-CollectionRule.fields.column)column
...
[Anchor to condition](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrule#field-CollectionRule.fields.condition)condition
...
[Anchor to conditionObject](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrule#field-CollectionRule.fields.conditionObject)condition Object
...
[Anchor to relation](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrule#field-CollectionRule.fields.relation)relation
...
*   {}[CollectionRuleSet.rules](https://shopify.dev/docs/api/admin-graphql/latest/objects/CollectionRuleSet#field-rules)
