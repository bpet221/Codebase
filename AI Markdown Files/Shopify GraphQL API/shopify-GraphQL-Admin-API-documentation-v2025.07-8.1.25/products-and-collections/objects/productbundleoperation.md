---
title: "ProductBundleOperation"
description: "Shopify GraphQL Admin API documentation for productbundleoperation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation

Markdown Content:
ProductBundleOperation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#interfaces)
...
[Anchor to ProductBundleOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#field-ProductBundleOperation.fields.id)id
...
[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#field-ProductBundleOperation.fields.product)product
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#field-ProductBundleOperation.fields.status)status
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#field-ProductBundleOperation.fields.userErrors)user Errors
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------

[Anchor to productBundleCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#mutation-productBundleCreate)[product Bundle Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productBundleCreate)
...
[Anchor to productBundleUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#mutation-productBundleUpdate)[product Bundle Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productBundleUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to ProductOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundleoperation#interface-ProductOperation)[Product Operation](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/ProductOperation)
