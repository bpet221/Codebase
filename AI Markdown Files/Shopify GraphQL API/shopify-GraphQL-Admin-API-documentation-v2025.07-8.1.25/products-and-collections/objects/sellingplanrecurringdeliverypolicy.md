---
title: "SellingPlanRecurringDeliveryPolicy"
description: "Shopify GraphQL Admin API documentation for sellingplanrecurringdeliverypolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy

Markdown Content:
SellingPlanRecurringDeliveryPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#main-content)
...
[Anchor to SellingPlanRecurringDeliveryPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to anchors](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#field-SellingPlanRecurringDeliveryPolicy.fields.anchors)anchors
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#field-SellingPlanRecurringDeliveryPolicy.fields.createdAt)created At
...
[Anchor to cutoff](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#field-SellingPlanRecurringDeliveryPolicy.fields.cutoff)cutoff

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

Number of days which represent a buffer period for orders to be included in a cycle.

[Anchor to intent](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#field-SellingPlanRecurringDeliveryPolicy.fields.intent)intent
...
[Anchor to interval](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#field-SellingPlanRecurringDeliveryPolicy.fields.interval)interval
...
[Anchor to intervalCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#field-SellingPlanRecurringDeliveryPolicy.fields.intervalCount)interval Count
...
[Anchor to preAnchorBehavior](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringdeliverypolicy#field-SellingPlanRecurringDeliveryPolicy.fields.preAnchorBehavior)pre Anchor Behavior
