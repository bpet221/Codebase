...
description: "Shopify GraphQL Admin API documentation for sellingplancheckoutchargepercentagevalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplancheckoutchargepercentagevalue"
...
Title: SellingPlanCheckoutChargePercentageValue - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplancheckoutchargepercentagevalue

Markdown Content:
SellingPlanCheckoutChargePercentageValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplancheckoutchargepercentagevalue#main-content)
...
[Anchor to SellingPlanCheckoutChargePercentageValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplancheckoutchargepercentagevalue#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplancheckoutchargepercentagevalue#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to percentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplancheckoutchargepercentagevalue#field-SellingPlanCheckoutChargePercentageValue.fields.percentage)percentage
