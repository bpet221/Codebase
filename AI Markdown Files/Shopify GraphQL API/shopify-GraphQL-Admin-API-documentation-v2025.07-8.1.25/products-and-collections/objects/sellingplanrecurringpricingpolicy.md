---
title: "SellingPlanRecurringPricingPolicy"
description: "Shopify GraphQL Admin API documentation for sellingplanrecurringpricingpolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy

Markdown Content:
SellingPlanRecurringPricingPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#interfaces)
...
[Anchor to SellingPlanRecurringPricingPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to adjustmentType](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#field-SellingPlanRecurringPricingPolicy.fields.adjustmentType)adjustment Type
...
[Anchor to adjustmentValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#field-SellingPlanRecurringPricingPolicy.fields.adjustmentValue)adjustment Value
...
[Anchor to afterCycle](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#field-SellingPlanRecurringPricingPolicy.fields.afterCycle)after Cycle

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

Cycle after which this pricing policy applies.

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#field-SellingPlanRecurringPricingPolicy.fields.createdAt)created At
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to SellingPlanPricingPolicyBase](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringpricingpolicy#interface-SellingPlanPricingPolicyBase)[Selling Plan Pricing Policy Base](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SellingPlanPricingPolicyBase)
