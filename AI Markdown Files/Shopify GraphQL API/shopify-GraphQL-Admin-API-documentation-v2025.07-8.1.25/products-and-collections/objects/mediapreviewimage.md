...
description: "Shopify GraphQL Admin API documentation for mediapreviewimage"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mediapreviewimage

Markdown Content:
MediaPreviewImage - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediapreviewimage#main-content)
...
[Anchor to MediaPreviewImage](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediapreviewimage#top)
Media Preview Image
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediapreviewimage#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to image](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediapreviewimage#field-MediaPreviewImage.fields.image)image
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediapreviewimage#field-MediaPreviewImage.fields.status)status
...
*   {}[ExternalVideo.preview](https://shopify.dev/docs/api/admin-graphql/latest/objects/ExternalVideo#field-preview)
*   ||-[File.preview](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/File#field-preview)
*   {}[GenericFile.preview](https://shopify.dev/docs/api/admin-graphql/latest/objects/GenericFile#field-preview)
*   ||-[Media.preview](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Media#field-preview)
*   {}[MediaImage.preview](https://shopify.dev/docs/api/admin-graphql/latest/objects/MediaImage#field-preview)
*   {}[Model3d.preview](https://shopify.dev/docs/api/admin-graphql/latest/objects/Model3d#field-preview)
*   {}[Video.preview](https://shopify.dev/docs/api/admin-graphql/latest/objects/Video#field-preview)
