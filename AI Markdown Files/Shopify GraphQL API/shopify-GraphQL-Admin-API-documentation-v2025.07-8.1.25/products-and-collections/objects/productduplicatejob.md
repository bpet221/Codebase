---
title: "ProductDuplicateJob"
description: "Shopify GraphQL Admin API documentation for productduplicatejob"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob

Markdown Content:
ProductDuplicateJob - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob#queries)
...
[Anchor to ProductDuplicateJob](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to done](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob#field-ProductDuplicateJob.fields.done)done
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob#field-ProductDuplicateJob.fields.id)id
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob#queries)Queries
-----------------------------------------------------------------------------------------------------------------

[Anchor to productDuplicateJob](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicatejob#query-productDuplicateJob)[product Duplicate Job](https://shopify.dev/docs/api/admin-graphql/latest/queries/productDuplicateJob)
