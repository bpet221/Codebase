---
title: "CollectionRuleMetafieldCondition"
description: "Shopify GraphQL Admin API documentation for collectionrulemetafieldcondition"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulemetafieldcondition"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulemetafieldcondition

Markdown Content:
CollectionRuleMetafieldCondition - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulemetafieldcondition#main-content)
...
[Anchor to CollectionRuleMetafieldCondition](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulemetafieldcondition#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulemetafieldcondition#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to metafieldDefinition](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulemetafieldcondition#field-CollectionRuleMetafieldCondition.fields.metafieldDefinition)metafield Definition
