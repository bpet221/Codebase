---
title: "ProductContextualPricing"
description: "Shopify GraphQL Admin API documentation for productcontextualpricing"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productcontextualpricing"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productcontextualpricing

Markdown Content:
ProductContextualPricing - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcontextualpricing#main-content)
...
[Anchor to ProductContextualPricing](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcontextualpricing#top)
...
The price of a product in a specific country. Prices vary between countries. Refer to [Product](https://shopify.dev/docs/api/admin-graphql/latest/queries/product?example=Get+the+price+range+for+a+product+for+buyers+from+Canada) for more information on how to use this object.

[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcontextualpricing#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to fixedQuantityRulesCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcontextualpricing#field-ProductContextualPricing.fields.fixedQuantityRulesCount)fixed Quantity Rules Count
...
[Anchor to maxVariantPricing](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcontextualpricing#field-ProductContextualPricing.fields.maxVariantPricing)max Variant Pricing
...
[Anchor to minVariantPricing](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcontextualpricing#field-ProductContextualPricing.fields.minVariantPricing)min Variant Pricing
...
[Anchor to priceRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcontextualpricing#field-ProductContextualPricing.fields.priceRange)price Range
...
*   {}[Product.contextualPricing](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-contextualPricing)
