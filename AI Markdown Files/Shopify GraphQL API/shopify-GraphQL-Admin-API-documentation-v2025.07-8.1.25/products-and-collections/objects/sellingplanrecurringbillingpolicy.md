---
title: "SellingPlanRecurringBillingPolicy"
description: "Shopify GraphQL Admin API documentation for sellingplanrecurringbillingpolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy

Markdown Content:
SellingPlanRecurringBillingPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy#main-content)
...
[Anchor to SellingPlanRecurringBillingPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to anchors](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy#field-SellingPlanRecurringBillingPolicy.fields.anchors)anchors
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy#field-SellingPlanRecurringBillingPolicy.fields.createdAt)created At
...
[Anchor to interval](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy#field-SellingPlanRecurringBillingPolicy.fields.interval)interval
...
[Anchor to intervalCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy#field-SellingPlanRecurringBillingPolicy.fields.intervalCount)interval Count
...
[Anchor to maxCycles](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy#field-SellingPlanRecurringBillingPolicy.fields.maxCycles)max Cycles

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

Maximum number of billing iterations.

[Anchor to minCycles](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanrecurringbillingpolicy#field-SellingPlanRecurringBillingPolicy.fields.minCycles)min Cycles
