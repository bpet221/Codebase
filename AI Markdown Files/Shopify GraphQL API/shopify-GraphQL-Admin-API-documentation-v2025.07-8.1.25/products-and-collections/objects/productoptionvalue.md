...
description: "Shopify GraphQL Admin API documentation for productoptionvalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue

Markdown Content:
ProductOptionValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#interfaces)
...
[Anchor to ProductOptionValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to hasVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#field-ProductOptionValue.fields.hasVariants)has Variants
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#field-ProductOptionValue.fields.id)id
...
[Anchor to linkedMetafieldValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#field-ProductOptionValue.fields.linkedMetafieldValue)linked Metafield Value

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The value of the linked metafield.

[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#field-ProductOptionValue.fields.name)name
...
[Anchor to swatch](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#field-ProductOptionValue.fields.swatch)swatch
...
[Anchor to translations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#field-ProductOptionValue.fields.translations)translations
...
*   {}[ProductOption.optionValues](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductOption#field-optionValues)
*   {}[SelectedOption.optionValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/SelectedOption#field-optionValue)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------

[Anchor to HasPublishedTranslations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#interface-HasPublishedTranslations)[Has Published Translations](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/HasPublishedTranslations)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productoptionvalue#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
