---
title: "ProductComponentType"
description: "Shopify GraphQL Admin API documentation for productcomponenttype"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype

Markdown Content:
ProductComponentType - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype#main-content)
...
[Anchor to ProductComponentType](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to componentVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype#field-ProductComponentType.fields.componentVariants)component Variants
...
[Anchor to componentVariantsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype#field-ProductComponentType.fields.componentVariantsCount)component Variants Count
...
[Anchor to nonComponentVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype#field-ProductComponentType.fields.nonComponentVariants)non Component Variants
...
[Anchor to nonComponentVariantsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype#field-ProductComponentType.fields.nonComponentVariantsCount)non Component Variants Count
...
[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcomponenttype#field-ProductComponentType.fields.product)product
...
*   {}[Product.productComponents](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-productComponents)
*   <->[ProductComponentTypeConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductComponentTypeConnection#field-nodes)
*   {}[ProductComponentTypeEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductComponentTypeEdge#field-node)
