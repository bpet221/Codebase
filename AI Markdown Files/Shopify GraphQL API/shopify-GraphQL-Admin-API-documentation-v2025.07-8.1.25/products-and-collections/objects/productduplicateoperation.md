---
title: "ProductDuplicateOperation"
description: "Shopify GraphQL Admin API documentation for productduplicateoperation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation

Markdown Content:
ProductDuplicateOperation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#interfaces)
...
[Anchor to ProductDuplicateOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#field-ProductDuplicateOperation.fields.id)id
...
[Anchor to newProduct](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#field-ProductDuplicateOperation.fields.newProduct)new Product
...
[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#field-ProductDuplicateOperation.fields.product)product
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#field-ProductDuplicateOperation.fields.status)status
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#field-ProductDuplicateOperation.fields.userErrors)user Errors
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to productDuplicate](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#mutation-productDuplicate)[product Duplicate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productDuplicate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to ProductOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/productduplicateoperation#interface-ProductOperation)[Product Operation](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/ProductOperation)
