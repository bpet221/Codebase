...
description: "Shopify GraphQL Admin API documentation for pricelistprice"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice

Markdown Content:
PriceListPrice - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#mutations)
...
[Anchor to PriceListPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#top)
Price List Price
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to compareAtPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#field-PriceListPrice.fields.compareAtPrice)compare At Price
...
[Anchor to originType](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#field-PriceListPrice.fields.originType)origin Type
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#field-PriceListPrice.fields.price)price
...
[Anchor to quantityPriceBreaks](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#field-PriceListPrice.fields.quantityPriceBreaks)quantity Price Breaks
...
[Anchor to variant](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#field-PriceListPrice.fields.variant)variant
...
*   {}[PriceList.prices](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceList#field-prices)
*   <->[PriceListPriceConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/PriceListPriceConnection#field-nodes)
*   {}[PriceListPriceEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceListPriceEdge#field-node)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#mutations)Mutations
------------------------------------------------------------------------------------------------------------------

[Anchor to priceListFixedPricesAdd](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#mutation-priceListFixedPricesAdd)[price List Fixed Prices Add](https://shopify.dev/docs/api/admin-graphql/latest/mutations/priceListFixedPricesAdd)
...
[Anchor to priceListFixedPricesUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistprice#mutation-priceListFixedPricesUpdate)[price List Fixed Prices Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/priceListFixedPricesUpdate)
