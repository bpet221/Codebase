---
title: "ProductVariantContextualPricing"
description: "Shopify GraphQL Admin API documentation for productvariantcontextualpricing"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing

Markdown Content:
ProductVariantContextualPricing - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing#main-content)
...
[Anchor to ProductVariantContextualPricing](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to compareAtPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing#field-ProductVariantContextualPricing.fields.compareAtPrice)compare At Price
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing#field-ProductVariantContextualPricing.fields.price)price
...
[Anchor to quantityPriceBreaks](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing#field-ProductVariantContextualPricing.fields.quantityPriceBreaks)quantity Price Breaks
...
[Anchor to quantityRule](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing#field-ProductVariantContextualPricing.fields.quantityRule)quantity Rule
...
[Anchor to unitPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/productvariantcontextualpricing#field-ProductVariantContextualPricing.fields.unitPrice)unit Price
...
*   {}[ProductContextualPricing.maxVariantPricing](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductContextualPricing#field-maxVariantPricing)
*   {}[ProductContextualPricing.minVariantPricing](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductContextualPricing#field-minVariantPricing)
*   {}[ProductVariant.contextualPricing](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductVariant#field-contextualPricing)
