...
description: "Shopify GraphQL Admin API documentation for selectedoption"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/selectedoption"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/selectedoption

Markdown Content:
SelectedOption - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/selectedoption#main-content)
...
[Anchor to SelectedOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/selectedoption#top)
Selected Option
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/selectedoption#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/selectedoption#field-SelectedOption.fields.name)name
...
[Anchor to optionValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/selectedoption#field-SelectedOption.fields.optionValue)option Value
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/selectedoption#field-SelectedOption.fields.value)value
...
*   {}[ProductVariant.selectedOptions](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductVariant#field-selectedOptions)
