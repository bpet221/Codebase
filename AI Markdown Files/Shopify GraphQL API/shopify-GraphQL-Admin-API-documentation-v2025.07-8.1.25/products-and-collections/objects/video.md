---
title: "Video"
description: "Shopify GraphQL Admin API documentation for video"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/video"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/video

Markdown Content:
Video - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#interfaces)
...
[Anchor to Video](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#top)
Video
=====
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#fields)Fields
------------------------------------------------------------------------------------------------

[Anchor to alt](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.alt)alt

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A word or phrase to share the nature or contents of a media.

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.createdAt)created At
...
[Anchor to duration](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.duration)duration
...
[Anchor to fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.fileErrors)file Errors
...
[Anchor to filename](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.filename)filename
...
[Anchor to fileStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.fileStatus)file Status
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.id)id
...
[Anchor to mediaContentType](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.mediaContentType)media Content Type
...
[Anchor to mediaErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.mediaErrors)media Errors
...
[Anchor to mediaWarnings](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.mediaWarnings)media Warnings
...
[Anchor to originalSource](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.originalSource)original Source
...
[Anchor to preview](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.preview)preview
...
[Anchor to sources](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.sources)sources
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.status)status
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#field-Video.fields.updatedAt)updated At
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------

[Anchor to File](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#interface-File)[File](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/File)

•interface

[Anchor to Media](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#interface-Media)[Media](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Media)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/video#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
