---
title: "AddAllProductsOperation"
description: "Shopify GraphQL Admin API documentation for addallproductsoperation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation

Markdown Content:
AddAllProductsOperation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#interfaces)
...
[Anchor to AddAllProductsOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#field-AddAllProductsOperation.fields.id)id
...
[Anchor to processedRowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#field-AddAllProductsOperation.fields.processedRowCount)processed Row Count

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The count of processed rows, summing imported, failed, and skipped rows.

[Anchor to rowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#field-AddAllProductsOperation.fields.rowCount)row Count
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#field-AddAllProductsOperation.fields.status)status
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to ResourceOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/addallproductsoperation#interface-ResourceOperation)[Resource Operation](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/ResourceOperation)
