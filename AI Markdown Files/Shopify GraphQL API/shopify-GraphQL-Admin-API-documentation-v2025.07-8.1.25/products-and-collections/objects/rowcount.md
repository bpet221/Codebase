---
title: "RowCount"
description: "Shopify GraphQL Admin API documentation for rowcount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/rowcount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/rowcount

Markdown Content:
RowCount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/rowcount#main-content)
...
[Anchor to RowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/rowcount#top)
Row Count
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/rowcount#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to count](https://shopify.dev/docs/api/admin-graphql/latest/objects/rowcount#field-RowCount.fields.count)count
...
[Anchor to exceedsMax](https://shopify.dev/docs/api/admin-graphql/latest/objects/rowcount#field-RowCount.fields.exceedsMax)exceeds Max
...
*   {}[AddAllProductsOperation.rowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/AddAllProductsOperation#field-rowCount)
*   {}[CatalogCsvOperation.rowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/CatalogCsvOperation#field-rowCount)
*   {}[PublicationResourceOperation.rowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/PublicationResourceOperation#field-rowCount)
*   ||-[ResourceOperation.rowCount](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/ResourceOperation#field-rowCount)
