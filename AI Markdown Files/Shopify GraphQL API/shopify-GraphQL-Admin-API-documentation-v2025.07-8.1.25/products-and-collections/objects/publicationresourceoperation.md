---
title: "PublicationResourceOperation"
description: "Shopify GraphQL Admin API documentation for publicationresourceoperation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation

Markdown Content:
PublicationResourceOperation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#interfaces)
...
[Anchor to PublicationResourceOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#field-PublicationResourceOperation.fields.id)id
...
[Anchor to processedRowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#field-PublicationResourceOperation.fields.processedRowCount)processed Row Count

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The count of processed rows, summing imported, failed, and skipped rows.

[Anchor to rowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#field-PublicationResourceOperation.fields.rowCount)row Count
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#field-PublicationResourceOperation.fields.status)status
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to ResourceOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/publicationresourceoperation#interface-ResourceOperation)[Resource Operation](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/ResourceOperation)
