---
title: "CatalogCsvOperation"
description: "Shopify GraphQL Admin API documentation for catalogcsvoperation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation

Markdown Content:
CatalogCsvOperation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#interfaces)
...
[Anchor to CatalogCsvOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#field-CatalogCsvOperation.fields.id)id
...
[Anchor to processedRowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#field-CatalogCsvOperation.fields.processedRowCount)processed Row Count

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The count of processed rows, summing imported, failed, and skipped rows.

[Anchor to rowCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#field-CatalogCsvOperation.fields.rowCount)row Count
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#field-CatalogCsvOperation.fields.status)status
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to ResourceOperation](https://shopify.dev/docs/api/admin-graphql/latest/objects/catalogcsvoperation#interface-ResourceOperation)[Resource Operation](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/ResourceOperation)
