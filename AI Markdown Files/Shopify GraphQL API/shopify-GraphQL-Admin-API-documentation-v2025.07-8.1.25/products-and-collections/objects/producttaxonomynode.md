---
title: "ProductTaxonomyNode"
description: "Shopify GraphQL Admin API documentation for producttaxonomynode"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode

Markdown Content:
ProductTaxonomyNode - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#interfaces)
...
[Anchor to ProductTaxonomyNode](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to fullName](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#field-ProductTaxonomyNode.fields.fullName)full Name
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#field-ProductTaxonomyNode.fields.id)id
...
[Anchor to isLeaf](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#field-ProductTaxonomyNode.fields.isLeaf)is Leaf
...
[Anchor to isRoot](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#field-ProductTaxonomyNode.fields.isRoot)is Root
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#field-ProductTaxonomyNode.fields.name)name
...
*   {}[CollectionRuleProductCategoryCondition.value](https://shopify.dev/docs/api/admin-graphql/latest/objects/CollectionRuleProductCategoryCondition#field-value)
*   {}[ProductCategory.productTaxonomyNode](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductCategory#field-productTaxonomyNode)
*   {}[StandardizedProductType.productTaxonomyNode](https://shopify.dev/docs/api/admin-graphql/latest/objects/StandardizedProductType#field-productTaxonomyNode)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/producttaxonomynode#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
