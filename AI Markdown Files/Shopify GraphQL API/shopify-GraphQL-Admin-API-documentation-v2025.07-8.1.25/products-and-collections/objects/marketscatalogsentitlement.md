---
title: "MarketsCatalogsEntitlement"
description: "Shopify GraphQL Admin API documentation for marketscatalogsentitlement"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/marketscatalogsentitlement"
...
Title: MarketsCatalogsEntitlement - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/marketscatalogsentitlement

Markdown Content:
MarketsCatalogsEntitlement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketscatalogsentitlement#main-content)
...
[Anchor to MarketsCatalogsEntitlement](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketscatalogsentitlement#top)
Markets Catalogs Entitlement
============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketscatalogsentitlement#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to enabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/marketscatalogsentitlement#field-MarketsCatalogsEntitlement.fields.enabled)enabled
...
*   {}[MarketsB2BEntitlement.catalogs](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketsB2BEntitlement#field-catalogs)
*   {}[MarketsRegionsEntitlement.catalogs](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketsRegionsEntitlement#field-catalogs)
*   {}[MarketsRetailEntitlement.catalogs](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketsRetailEntitlement#field-catalogs)
