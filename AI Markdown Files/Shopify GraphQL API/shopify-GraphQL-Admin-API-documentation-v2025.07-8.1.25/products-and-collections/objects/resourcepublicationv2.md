---
title: "ResourcePublicationV2"
description: "Shopify GraphQL Admin API documentation for resourcepublicationv2"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2

Markdown Content:
ResourcePublicationV2 - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2#main-content)
...
[Anchor to ResourcePublicationV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to isPublished](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2#field-ResourcePublicationV2.fields.isPublished)is Published
...
[Anchor to publication](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2#field-ResourcePublicationV2.fields.publication)publication
...
[Anchor to publishable](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2#field-ResourcePublicationV2.fields.publishable)publishable
...
[Anchor to publishDate](https://shopify.dev/docs/api/admin-graphql/latest/objects/resourcepublicationv2#field-ResourcePublicationV2.fields.publishDate)publish Date
...
*   {}[Collection.resourcePublicationsV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/Collection#field-resourcePublicationsV2)
*   {}[Product.resourcePublicationOnCurrentPublication](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-resourcePublicationOnCurrentPublication)
*   {}[Product.resourcePublicationsV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-resourcePublicationsV2)
*   ||-[Publishable.resourcePublicationsV2](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Publishable#field-resourcePublicationsV2)
*   <->[ResourcePublicationV2Connection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ResourcePublicationV2Connection#field-nodes)
*   {}[ResourcePublicationV2Edge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ResourcePublicationV2Edge#field-node)
