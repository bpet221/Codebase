---
title: "ProductBundleComponent"
description: "Shopify GraphQL Admin API documentation for productbundlecomponent"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent

Markdown Content:
ProductBundleComponent - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent#main-content)
...
[Anchor to ProductBundleComponent](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to componentProduct](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent#field-ProductBundleComponent.fields.componentProduct)component Product
...
[Anchor to componentVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent#field-ProductBundleComponent.fields.componentVariants)component Variants
...
[Anchor to componentVariantsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent#field-ProductBundleComponent.fields.componentVariantsCount)component Variants Count
...
[Anchor to optionSelections](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent#field-ProductBundleComponent.fields.optionSelections)option Selections
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent#field-ProductBundleComponent.fields.quantity)quantity
...
[Anchor to quantityOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponent#field-ProductBundleComponent.fields.quantityOption)quantity Option
...
*   {}[Product.bundleComponents](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-bundleComponents)
*   <->[ProductBundleComponentConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductBundleComponentConnection#field-nodes)
*   {}[ProductBundleComponentEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductBundleComponentEdge#field-node)
