---
title: "TaxonomyMeasurementAttribute"
description: "Shopify GraphQL Admin API documentation for taxonomymeasurementattribute"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute

Markdown Content:
TaxonomyMeasurementAttribute - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#interfaces)
...
[Anchor to TaxonomyMeasurementAttribute](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#field-TaxonomyMeasurementAttribute.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#field-TaxonomyMeasurementAttribute.fields.name)name
...
[Anchor to options](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#field-TaxonomyMeasurementAttribute.fields.options)options
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomymeasurementattribute#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
