---
title: "PriceListAdjustmentSettings"
description: "Shopify GraphQL Admin API documentation for pricelistadjustmentsettings"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustmentsettings"
...
Title: PriceListAdjustmentSettings - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustmentsettings

Markdown Content:
PriceListAdjustmentSettings - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustmentsettings#main-content)
...
[Anchor to PriceListAdjustmentSettings](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustmentsettings#top)
Price List Adjustment Settings
==============================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustmentsettings#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to compareAtMode](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistadjustmentsettings#field-PriceListAdjustmentSettings.fields.compareAtMode)compare At Mode

•[Price List Compare At Mode!](https://shopify.dev/docs/api/admin-graphql/latest/enums/PriceListCompareAtMode)
...
*   {}[PriceListParent.settings](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceListParent#field-settings)
