---
title: "FileError"
description: "Shopify GraphQL Admin API documentation for fileerror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fileerror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fileerror

Markdown Content:
FileError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileerror#main-content)
...
[Anchor to FileError](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileerror#top)
File Error
==========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileerror#fields)Fields
----------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileerror#field-FileError.fields.code)code
...
[Anchor to details](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileerror#field-FileError.fields.details)details

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

Additional details regarding the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/fileerror#field-FileError.fields.message)message
...
*   {}[ExternalVideo.fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/ExternalVideo#field-fileErrors)
*   ||-[File.fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/File#field-fileErrors)
*   {}[GenericFile.fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/GenericFile#field-fileErrors)
*   {}[MediaImage.fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/MediaImage#field-fileErrors)
*   {}[Model3d.fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/Model3d#field-fileErrors)
*   {}[Video.fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/Video#field-fileErrors)
