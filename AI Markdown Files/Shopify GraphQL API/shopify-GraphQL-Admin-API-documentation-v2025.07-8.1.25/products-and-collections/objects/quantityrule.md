---
title: "QuantityRule"
description: "Shopify GraphQL Admin API documentation for quantityrule"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule

Markdown Content:
QuantityRule - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#mutations)
...
[Anchor to QuantityRule](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#top)
Quantity Rule
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to increment](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#field-QuantityRule.fields.increment)increment
...
[Anchor to isDefault](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#field-QuantityRule.fields.isDefault)is Default
...
[Anchor to maximum](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#field-QuantityRule.fields.maximum)maximum
...
[Anchor to minimum](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#field-QuantityRule.fields.minimum)minimum
...
[Anchor to originType](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#field-QuantityRule.fields.originType)origin Type
...
[Anchor to productVariant](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#field-QuantityRule.fields.productVariant)product Variant
...
*   {}[PriceList.quantityRules](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceList#field-quantityRules)
*   {}[ProductVariantContextualPricing.quantityRule](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductVariantContextualPricing#field-quantityRule)
*   <->[QuantityRuleConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/QuantityRuleConnection#field-nodes)
*   {}[QuantityRuleEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/QuantityRuleEdge#field-node)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#mutations)Mutations
----------------------------------------------------------------------------------------------------------------

[Anchor to quantityRulesAdd](https://shopify.dev/docs/api/admin-graphql/latest/objects/quantityrule#mutation-quantityRulesAdd)[quantity Rules Add](https://shopify.dev/docs/api/admin-graphql/latest/mutations/quantityRulesAdd)
