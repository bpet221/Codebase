---
title: "PriceListParent"
description: "Shopify GraphQL Admin API documentation for pricelistparent"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistparent"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistparent

Markdown Content:
PriceListParent - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistparent#main-content)
...
[Anchor to PriceListParent](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistparent#top)
Price List Parent
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistparent#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to adjustment](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistparent#field-PriceListParent.fields.adjustment)adjustment
...
[Anchor to settings](https://shopify.dev/docs/api/admin-graphql/latest/objects/pricelistparent#field-PriceListParent.fields.settings)settings
...
*   {}[PriceList.parent](https://shopify.dev/docs/api/admin-graphql/latest/objects/PriceList#field-parent)
