---
title: "RestrictedForResource"
description: "Shopify GraphQL Admin API documentation for restrictedforresource"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/restrictedforresource"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/restrictedforresource

Markdown Content:
RestrictedForResource - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/restrictedforresource#main-content)
...
[Anchor to RestrictedForResource](https://shopify.dev/docs/api/admin-graphql/latest/objects/restrictedforresource#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/restrictedforresource#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to restricted](https://shopify.dev/docs/api/admin-graphql/latest/objects/restrictedforresource#field-RestrictedForResource.fields.restricted)restricted
...
[Anchor to restrictedReason](https://shopify.dev/docs/api/admin-graphql/latest/objects/restrictedforresource#field-RestrictedForResource.fields.restrictedReason)restricted Reason
...
*   {}[Product.restrictedForResource](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-restrictedForResource)
