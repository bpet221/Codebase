---
title: "ProductCompareAtPriceRange"
description: "Shopify GraphQL Admin API documentation for productcompareatpricerange"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productcompareatpricerange"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productcompareatpricerange

Markdown Content:
ProductCompareAtPriceRange - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcompareatpricerange#main-content)
...
[Anchor to ProductCompareAtPriceRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcompareatpricerange#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcompareatpricerange#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to maxVariantCompareAtPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcompareatpricerange#field-ProductCompareAtPriceRange.fields.maxVariantCompareAtPrice)max Variant Compare At Price
...
[Anchor to minVariantCompareAtPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcompareatpricerange#field-ProductCompareAtPriceRange.fields.minVariantCompareAtPrice)min Variant Compare At Price
...
*   {}[Product.compareAtPriceRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-compareAtPriceRange)
