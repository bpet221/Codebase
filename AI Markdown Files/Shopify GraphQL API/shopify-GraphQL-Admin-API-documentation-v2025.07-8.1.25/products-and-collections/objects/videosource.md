---
title: "VideoSource"
description: "Shopify GraphQL Admin API documentation for videosource"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource

Markdown Content:
VideoSource - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource#main-content)
...
[Anchor to VideoSource](https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource#top)
Video Source
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to fileSize](https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource#field-VideoSource.fields.fileSize)file Size

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The video source's file size in bytes.

[Anchor to format](https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource#field-VideoSource.fields.format)format
...
[Anchor to height](https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource#field-VideoSource.fields.height)height
...
[Anchor to mimeType](https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource#field-VideoSource.fields.mimeType)mime Type
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource#field-VideoSource.fields.url)url
...
[Anchor to width](https://shopify.dev/docs/api/admin-graphql/latest/objects/videosource#field-VideoSource.fields.width)width
...
*   {}[Video.originalSource](https://shopify.dev/docs/api/admin-graphql/latest/objects/Video#field-originalSource)
*   {}[Video.sources](https://shopify.dev/docs/api/admin-graphql/latest/objects/Video#field-sources)
