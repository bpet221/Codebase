---
title: "Vector3"
description: "Shopify GraphQL Admin API documentation for vector3"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/vector3"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/vector3

Markdown Content:
Vector3 - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/vector3#main-content)
...
[Anchor to Vector3](https://shopify.dev/docs/api/admin-graphql/latest/objects/vector3#top)
Vector3
=======
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/vector3#fields)Fields
--------------------------------------------------------------------------------------------------

[Anchor to x](https://shopify.dev/docs/api/admin-graphql/latest/objects/vector3#field-Vector3.fields.x)x
...
[Anchor to y](https://shopify.dev/docs/api/admin-graphql/latest/objects/vector3#field-Vector3.fields.y)y
...
[Anchor to z](https://shopify.dev/docs/api/admin-graphql/latest/objects/vector3#field-Vector3.fields.z)z
...
*   {}[Model3dBoundingBox.size](https://shopify.dev/docs/api/admin-graphql/latest/objects/Model3dBoundingBox#field-size)
