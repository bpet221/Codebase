---
title: "CollectionRuleCategoryCondition"
description: "Shopify GraphQL Admin API documentation for collectionrulecategorycondition"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulecategorycondition"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulecategorycondition

Markdown Content:
CollectionRuleCategoryCondition - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulecategorycondition#main-content)
...
[Anchor to CollectionRuleCategoryCondition](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulecategorycondition#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulecategorycondition#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionrulecategorycondition#field-CollectionRuleCategoryCondition.fields.value)value
