---
title: "GenericFile"
description: "Shopify GraphQL Admin API documentation for genericfile"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile

Markdown Content:
GenericFile - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#interfaces)
...
[Anchor to GenericFile](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#top)
Generic File
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to alt](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.alt)alt

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A word or phrase to describe the contents or the function of a file.

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.createdAt)created At
...
[Anchor to fileErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.fileErrors)file Errors
...
[Anchor to fileStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.fileStatus)file Status
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.id)id
...
[Anchor to mimeType](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.mimeType)mime Type

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The generic file's MIME type.

[Anchor to originalFileSize](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.originalFileSize)original File Size

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The generic file's size in bytes.

[Anchor to preview](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.preview)preview
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.updatedAt)updated At
...
[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#field-GenericFile.fields.url)url
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------

[Anchor to File](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#interface-File)[File](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/File)

•interface

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/genericfile#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
