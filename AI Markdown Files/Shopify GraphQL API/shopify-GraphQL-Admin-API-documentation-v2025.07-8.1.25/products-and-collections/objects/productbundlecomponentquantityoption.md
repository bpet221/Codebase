---
title: "ProductBundleComponentQuantityOption"
description: "Shopify GraphQL Admin API documentation for productbundlecomponentquantityoption"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoption"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoption

Markdown Content:
ProductBundleComponentQuantityOption - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoption#main-content)
...
[Anchor to ProductBundleComponentQuantityOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoption#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoption#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoption#field-ProductBundleComponentQuantityOption.fields.name)name
...
[Anchor to parentOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoption#field-ProductBundleComponentQuantityOption.fields.parentOption)parent Option
...
[Anchor to values](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentquantityoption#field-ProductBundleComponentQuantityOption.fields.values)values
...
*   {}[ProductBundleComponent.quantityOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductBundleComponent#field-quantityOption)
