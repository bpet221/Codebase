---
title: "TaxonomyAttribute"
description: "Shopify GraphQL Admin API documentation for taxonomyattribute"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute"
...
Title: TaxonomyAttribute - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute

Markdown Content:
TaxonomyAttribute - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute#interfaces)
...
[Anchor to TaxonomyAttribute](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute#top)
Taxonomy Attribute
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute#field-TaxonomyAttribute.fields.id)id
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomyattribute#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
