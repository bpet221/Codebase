...
description: "Shopify GraphQL Admin API documentation for collectionpublication"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication

Markdown Content:
CollectionPublication - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#mutations)
...
[Anchor to CollectionPublication](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to collection](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#field-CollectionPublication.fields.collection)collection
...
[Anchor to isPublished](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#field-CollectionPublication.fields.isPublished)is Published
...
[Anchor to publication](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#field-CollectionPublication.fields.publication)publication
...
[Anchor to publishDate](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#field-CollectionPublication.fields.publishDate)publish Date
...
[Anchor to channel](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#field-CollectionPublication.fields.channel)channel
...
*   <->[CollectionPublicationConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/CollectionPublicationConnection#field-nodes)
*   {}[CollectionPublicationEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/CollectionPublicationEdge#field-node)

Show deprecations

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------

[Anchor to collectionPublish](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionpublication#mutation-collectionPublish)[collection Publish](https://shopify.dev/docs/api/admin-graphql/latest/mutations/collectionPublish)
