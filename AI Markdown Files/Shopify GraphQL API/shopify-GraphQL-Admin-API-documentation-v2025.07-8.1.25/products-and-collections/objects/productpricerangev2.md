---
title: "ProductPriceRangeV2"
description: "Shopify GraphQL Admin API documentation for productpricerangev2"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerangev2"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerangev2

Markdown Content:
ProductPriceRangeV2 - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerangev2#main-content)
...
[Anchor to ProductPriceRangeV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerangev2#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerangev2#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to maxVariantPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerangev2#field-ProductPriceRangeV2.fields.maxVariantPrice)max Variant Price
...
[Anchor to minVariantPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerangev2#field-ProductPriceRangeV2.fields.minVariantPrice)min Variant Price
...
*   {}[Product.priceRangeV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-priceRangeV2)
*   {}[ProductContextualPricing.priceRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductContextualPricing#field-priceRange)
