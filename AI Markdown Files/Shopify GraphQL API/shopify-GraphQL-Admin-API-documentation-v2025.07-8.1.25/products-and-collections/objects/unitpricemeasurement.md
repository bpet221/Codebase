---
title: "UnitPriceMeasurement"
description: "Shopify GraphQL Admin API documentation for unitpricemeasurement"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement

Markdown Content:
UnitPriceMeasurement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement#main-content)
...
[Anchor to UnitPriceMeasurement](https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to measuredType](https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement#field-UnitPriceMeasurement.fields.measuredType)measured Type
...
[Anchor to quantityUnit](https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement#field-UnitPriceMeasurement.fields.quantityUnit)quantity Unit
...
[Anchor to quantityValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement#field-UnitPriceMeasurement.fields.quantityValue)quantity Value
...
[Anchor to referenceUnit](https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement#field-UnitPriceMeasurement.fields.referenceUnit)reference Unit
...
[Anchor to referenceValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/unitpricemeasurement#field-UnitPriceMeasurement.fields.referenceValue)reference Value
...
*   {}[ProductVariant.unitPriceMeasurement](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductVariant#field-unitPriceMeasurement)
