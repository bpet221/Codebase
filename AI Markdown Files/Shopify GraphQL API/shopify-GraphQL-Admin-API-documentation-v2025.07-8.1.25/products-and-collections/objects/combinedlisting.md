---
title: "CombinedListing"
description: "Shopify GraphQL Admin API documentation for combinedlisting"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlisting"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlisting

Markdown Content:
CombinedListing - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlisting#main-content)
...
[Anchor to CombinedListing](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlisting#top)
Combined Listing
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlisting#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to combinedListingChildren](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlisting#field-CombinedListing.fields.combinedListingChildren)combined Listing Children
...
[Anchor to parentProduct](https://shopify.dev/docs/api/admin-graphql/latest/objects/combinedlisting#field-CombinedListing.fields.parentProduct)parent Product
...
*   {}[Product.combinedListing](https://shopify.dev/docs/api/admin-graphql/latest/objects/Product#field-combinedListing)
