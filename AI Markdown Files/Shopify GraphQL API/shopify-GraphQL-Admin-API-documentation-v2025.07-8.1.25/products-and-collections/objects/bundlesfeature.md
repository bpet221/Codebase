---
title: "BundlesFeature"
description: "Shopify GraphQL Admin API documentation for bundlesfeature"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/bundlesfeature"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/bundlesfeature

Markdown Content:
BundlesFeature - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/bundlesfeature#main-content)
...
[Anchor to BundlesFeature](https://shopify.dev/docs/api/admin-graphql/latest/objects/bundlesfeature#top)
Bundles Feature
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/bundlesfeature#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to eligibleForBundles](https://shopify.dev/docs/api/admin-graphql/latest/objects/bundlesfeature#field-BundlesFeature.fields.eligibleForBundles)eligible For Bundles
...
[Anchor to ineligibilityReason](https://shopify.dev/docs/api/admin-graphql/latest/objects/bundlesfeature#field-BundlesFeature.fields.ineligibilityReason)ineligibility Reason

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The reason why a shop is not eligible for bundles.

[Anchor to sellsBundles](https://shopify.dev/docs/api/admin-graphql/latest/objects/bundlesfeature#field-BundlesFeature.fields.sellsBundles)sells Bundles
...
*   {}[ShopFeatures.bundles](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopFeatures#field-bundles)
