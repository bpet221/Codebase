---
title: "ProductBundleComponentOptionSelectionValue"
description: "Shopify GraphQL Admin API documentation for productbundlecomponentoptionselectionvalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentoptionselectionvalue"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentoptionselectionvalue

Markdown Content:
ProductBundleComponentOptionSelectionValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentoptionselectionvalue#main-content)
...
[Anchor to ProductBundleComponentOptionSelectionValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentoptionselectionvalue#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentoptionselectionvalue#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------------

[Anchor to selectionStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentoptionselectionvalue#field-ProductBundleComponentOptionSelectionValue.fields.selectionStatus)selection Status
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/productbundlecomponentoptionselectionvalue#field-ProductBundleComponentOptionSelectionValue.fields.value)value
...
*   {}[ProductBundleComponentOptionSelection.values](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductBundleComponentOptionSelection#field-values)
