---
title: "MetafieldCapabilitySmartCollectionCondition"
description: "Shopify GraphQL Admin API documentation for metafieldcapabilitysmartcollectioncondition"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilitysmartcollectioncondition"
...
Title: MetafieldCapabilitySmartCollectionCondition - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilitysmartcollectioncondition

Markdown Content:
MetafieldCapabilitySmartCollectionCondition - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilitysmartcollectioncondition#main-content)
...
[Anchor to MetafieldCapabilitySmartCollectionCondition](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilitysmartcollectioncondition#top)
Metafield Capability Smart Collection Condition
===============================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilitysmartcollectioncondition#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to eligible](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilitysmartcollectioncondition#field-MetafieldCapabilitySmartCollectionCondition.fields.eligible)eligible
...
[Anchor to enabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/metafieldcapabilitysmartcollectioncondition#field-MetafieldCapabilitySmartCollectionCondition.fields.enabled)enabled
...
*   {}[MetafieldCapabilities.smartCollectionCondition](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetafieldCapabilities#field-smartCollectionCondition)
