---
title: "CollectionRuleConditions"
description: "Shopify GraphQL Admin API documentation for collectionruleconditions"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions

Markdown Content:
CollectionRuleConditions - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#queries)
...
[Anchor to CollectionRuleConditions](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to allowedRelations](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#field-CollectionRuleConditions.fields.allowedRelations)allowed Relations
...
[Anchor to defaultRelation](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#field-CollectionRuleConditions.fields.defaultRelation)default Relation
...
[Anchor to ruleObject](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#field-CollectionRuleConditions.fields.ruleObject)rule Object
...
[Anchor to ruleType](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#field-CollectionRuleConditions.fields.ruleType)rule Type
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#queries)Queries
----------------------------------------------------------------------------------------------------------------------

[Anchor to collectionRulesConditions](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleconditions#query-collectionRulesConditions)[collection Rules Conditions](https://shopify.dev/docs/api/admin-graphql/latest/queries/collectionRulesConditions)
...
*   <?>[collection Rules Conditions](https://shopify.dev/docs/api/admin-graphql/latest/queries/CollectionRuleConditions)
