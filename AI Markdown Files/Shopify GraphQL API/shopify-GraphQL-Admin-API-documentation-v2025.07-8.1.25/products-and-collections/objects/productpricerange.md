...
description: "Shopify GraphQL Admin API documentation for productpricerange"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerange"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerange

Markdown Content:
ProductPriceRange - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerange#main-content)
...
[Anchor to ProductPriceRange](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerange#top)
Product Price Range
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerange#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to maxVariantPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerange#field-ProductPriceRange.fields.maxVariantPrice)max Variant Price
...
[Anchor to minVariantPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpricerange#field-ProductPriceRange.fields.minVariantPrice)min Variant Price
