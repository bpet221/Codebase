---
title: "MediaImageOriginalSource"
description: "Shopify GraphQL Admin API documentation for mediaimageoriginalsource"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaimageoriginalsource"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaimageoriginalsource

Markdown Content:
MediaImageOriginalSource - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaimageoriginalsource#main-content)
...
[Anchor to MediaImageOriginalSource](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaimageoriginalsource#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaimageoriginalsource#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to fileSize](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaimageoriginalsource#field-MediaImageOriginalSource.fields.fileSize)file Size

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The size of the original file in bytes.

[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaimageoriginalsource#field-MediaImageOriginalSource.fields.url)url
...
*   {}[MediaImage.originalSource](https://shopify.dev/docs/api/admin-graphql/latest/objects/MediaImage#field-originalSource)
