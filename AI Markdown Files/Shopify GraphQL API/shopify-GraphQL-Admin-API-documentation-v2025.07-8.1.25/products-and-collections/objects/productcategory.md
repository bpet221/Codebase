...
description: "Shopify GraphQL Admin API documentation for productcategory"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productcategory"
...
Title: ProductCategory - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productcategory

Markdown Content:
ProductCategory - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcategory#main-content)
...
[Anchor to ProductCategory](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcategory#top)
Product Category
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcategory#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to productTaxonomyNode](https://shopify.dev/docs/api/admin-graphql/latest/objects/productcategory#field-ProductCategory.fields.productTaxonomyNode)product Taxonomy Node
