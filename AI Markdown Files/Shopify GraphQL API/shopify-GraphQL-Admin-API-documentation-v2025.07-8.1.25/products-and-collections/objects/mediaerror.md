---
title: "MediaError"
description: "Shopify GraphQL Admin API documentation for mediaerror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaerror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaerror

Markdown Content:
MediaError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaerror#main-content)
...
[Anchor to MediaError](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaerror#top)
Media Error
===========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaerror#fields)Fields
-----------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaerror#field-MediaError.fields.code)code
...
[Anchor to details](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaerror#field-MediaError.fields.details)details

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

Additional details regarding the error.

[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediaerror#field-MediaError.fields.message)message
...
*   {}[ExternalVideo.mediaErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/ExternalVideo#field-mediaErrors)
*   ||-[Media.mediaErrors](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Media#field-mediaErrors)
*   {}[MediaImage.mediaErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/MediaImage#field-mediaErrors)
*   {}[Model3d.mediaErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/Model3d#field-mediaErrors)
*   {}[Video.mediaErrors](https://shopify.dev/docs/api/admin-graphql/latest/objects/Video#field-mediaErrors)
