---
title: "SellingPlanInventoryPolicy"
description: "Shopify GraphQL Admin API documentation for sellingplaninventorypolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplaninventorypolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplaninventorypolicy

Markdown Content:
SellingPlanInventoryPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplaninventorypolicy#main-content)
...
[Anchor to SellingPlanInventoryPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplaninventorypolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplaninventorypolicy#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to reserve](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplaninventorypolicy#field-SellingPlanInventoryPolicy.fields.reserve)reserve
...
*   {}[SellingPlan.inventoryPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/SellingPlan#field-inventoryPolicy)
