---
title: "MediaWarning"
description: "Shopify GraphQL Admin API documentation for mediawarning"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/mediawarning"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/mediawarning

Markdown Content:
MediaWarning - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediawarning#main-content)
...
[Anchor to MediaWarning](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediawarning#top)
Media Warning
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediawarning#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediawarning#field-MediaWarning.fields.code)code
...
[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/mediawarning#field-MediaWarning.fields.message)message
...
*   {}[ExternalVideo.mediaWarnings](https://shopify.dev/docs/api/admin-graphql/latest/objects/ExternalVideo#field-mediaWarnings)
*   ||-[Media.mediaWarnings](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Media#field-mediaWarnings)
*   {}[MediaImage.mediaWarnings](https://shopify.dev/docs/api/admin-graphql/latest/objects/MediaImage#field-mediaWarnings)
*   {}[Model3d.mediaWarnings](https://shopify.dev/docs/api/admin-graphql/latest/objects/Model3d#field-mediaWarnings)
*   {}[Video.mediaWarnings](https://shopify.dev/docs/api/admin-graphql/latest/objects/Video#field-mediaWarnings)
