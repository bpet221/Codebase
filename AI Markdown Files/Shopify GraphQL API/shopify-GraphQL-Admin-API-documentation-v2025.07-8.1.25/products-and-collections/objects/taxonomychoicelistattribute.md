---
title: "TaxonomyChoiceListAttribute"
description: "Shopify GraphQL Admin API documentation for taxonomychoicelistattribute"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute

Markdown Content:
TaxonomyChoiceListAttribute - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#interfaces)
...
[Anchor to TaxonomyChoiceListAttribute](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#field-TaxonomyChoiceListAttribute.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#field-TaxonomyChoiceListAttribute.fields.name)name
...
[Anchor to values](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#field-TaxonomyChoiceListAttribute.fields.values)values
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/taxonomychoicelistattribute#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
