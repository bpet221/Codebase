...
description: "Shopify GraphQL Admin API documentation for productpublication"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication

Markdown Content:
ProductPublication - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#mutations)
...
[Anchor to ProductPublication](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#top)
Product Publication
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to channel](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#field-ProductPublication.fields.channel)channel
...
[Anchor to isPublished](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#field-ProductPublication.fields.isPublished)is Published
...
[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#field-ProductPublication.fields.product)product
...
[Anchor to publishDate](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#field-ProductPublication.fields.publishDate)publish Date
...
*   <->[ProductPublicationConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ProductPublicationConnection#field-nodes)
*   {}[ProductPublicationEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductPublicationEdge#field-node)

Show deprecations

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------

[Anchor to productPublish](https://shopify.dev/docs/api/admin-graphql/latest/objects/productpublication#mutation-productPublish)[product Publish](https://shopify.dev/docs/api/admin-graphql/latest/mutations/productPublish)
