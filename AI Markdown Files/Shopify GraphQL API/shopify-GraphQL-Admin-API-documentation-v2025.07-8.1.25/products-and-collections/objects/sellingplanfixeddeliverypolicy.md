---
title: "SellingPlanFixedDeliveryPolicy"
description: "Shopify GraphQL Admin API documentation for sellingplanfixeddeliverypolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy

Markdown Content:
SellingPlanFixedDeliveryPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy#main-content)
...
[Anchor to SellingPlanFixedDeliveryPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to anchors](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy#field-SellingPlanFixedDeliveryPolicy.fields.anchors)anchors
...
[Anchor to cutoff](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy#field-SellingPlanFixedDeliveryPolicy.fields.cutoff)cutoff

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

A buffer period for orders to be included in next fulfillment anchor.

[Anchor to fulfillmentExactTime](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy#field-SellingPlanFixedDeliveryPolicy.fields.fulfillmentExactTime)fulfillment Exact Time

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

The date and time when the fulfillment should trigger.

[Anchor to fulfillmentTrigger](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy#field-SellingPlanFixedDeliveryPolicy.fields.fulfillmentTrigger)fulfillment Trigger
...
[Anchor to intent](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy#field-SellingPlanFixedDeliveryPolicy.fields.intent)intent
...
[Anchor to preAnchorBehavior](https://shopify.dev/docs/api/admin-graphql/latest/objects/sellingplanfixeddeliverypolicy#field-SellingPlanFixedDeliveryPolicy.fields.preAnchorBehavior)pre Anchor Behavior
