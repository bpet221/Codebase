...
description: "Shopify GraphQL Admin API documentation for collectionruleset"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleset"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleset

Markdown Content:
CollectionRuleSet - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleset#main-content)
...
[Anchor to CollectionRuleSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleset#top)
Collection Rule Set
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleset#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to appliedDisjunctively](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleset#field-CollectionRuleSet.fields.appliedDisjunctively)applied Disjunctively
...
[Anchor to rules](https://shopify.dev/docs/api/admin-graphql/latest/objects/collectionruleset#field-CollectionRuleSet.fields.rules)rules
...
*   {}[Collection.ruleSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/Collection#field-ruleSet)
