---
title: "ShopifyPaymentsJpChargeStatementDescriptor"
description: "Shopify GraphQL Admin API documentation for shopifypaymentsjpchargestatementdescriptor"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor

Markdown Content:
ShopifyPaymentsJpChargeStatementDescriptor - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#interfaces)
...
[Anchor to ShopifyPaymentsJpChargeStatementDescriptor](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------------

[Anchor to default](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#field-ShopifyPaymentsJpChargeStatementDescriptor.fields.default)default

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The default charge statement descriptor.

[Anchor to kana](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#field-ShopifyPaymentsJpChargeStatementDescriptor.fields.kana)kana

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The charge statement descriptor in kana.

[Anchor to kanji](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#field-ShopifyPaymentsJpChargeStatementDescriptor.fields.kanji)kanji

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The charge statement descriptor in kanji.

[Anchor to prefix](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#field-ShopifyPaymentsJpChargeStatementDescriptor.fields.prefix)prefix
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsjpchargestatementdescriptor#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------------------------
