---
title: "ShopifyPaymentsTaxIdentification"
description: "Shopify GraphQL Admin API documentation for shopifypaymentstaxidentification"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstaxidentification"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstaxidentification

Markdown Content:
ShopifyPaymentsTaxIdentification - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstaxidentification#main-content)
...
[Anchor to ShopifyPaymentsTaxIdentification](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstaxidentification#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstaxidentification#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to taxIdentificationType](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstaxidentification#field-ShopifyPaymentsTaxIdentification.fields.taxIdentificationType)tax Identification Type
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstaxidentification#field-ShopifyPaymentsTaxIdentification.fields.value)value
...
*   {}[FinanceKycInformation.taxIdentification](https://shopify.dev/docs/api/admin-graphql/latest/objects/FinanceKycInformation#field-taxIdentification)
