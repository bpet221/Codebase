---
title: "ShopifyPaymentsAssociatedOrder"
description: "Shopify GraphQL Admin API documentation for shopifypaymentsassociatedorder"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsassociatedorder"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsassociatedorder

Markdown Content:
ShopifyPaymentsAssociatedOrder - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsassociatedorder#main-content)
...
[Anchor to ShopifyPaymentsAssociatedOrder](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsassociatedorder#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsassociatedorder#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsassociatedorder#field-ShopifyPaymentsAssociatedOrder.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsassociatedorder#field-ShopifyPaymentsAssociatedOrder.fields.name)name
...
*   {}[ShopifyPaymentsBalanceTransaction.associatedOrder](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopifyPaymentsBalanceTransaction#field-associatedOrder)
