---
title: "ShopifyPaymentsBalanceTransactionAssociatedPayout"
description: "Shopify GraphQL Admin API documentation for shopifypaymentsbalancetransactionassociatedpayout"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionassociatedpayout"
...
Title: ShopifyPaymentsBalanceTransactionAssociatedPayout - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionassociatedpayout

Markdown Content:
ShopifyPaymentsBalanceTransactionAssociatedPayout - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionassociatedpayout#main-content)
...
[Anchor to ShopifyPaymentsBalanceTransactionAssociatedPayout](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionassociatedpayout#top)
Shopify Payments Balance Transaction Associated Payout
======================================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionassociatedpayout#fields)Fields
--------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionassociatedpayout#field-ShopifyPaymentsBalanceTransactionAssociatedPayout.fields.id)id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the payout associated with the balance transaction.

[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsbalancetransactionassociatedpayout#field-ShopifyPaymentsBalanceTransactionAssociatedPayout.fields.status)status

•[Shopify Payments Balance Transaction Payout Status](https://shopify.dev/docs/api/admin-graphql/latest/enums/ShopifyPaymentsBalanceTransactionPayoutStatus)
...
*   {}[ShopifyPaymentsBalanceTransaction.associatedPayout](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopifyPaymentsBalanceTransaction#field-associatedPayout)
