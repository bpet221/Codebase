---
title: "FinancialKycShopOwner"
description: "Shopify GraphQL Admin API documentation for financialkycshopowner"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner

Markdown Content:
FinancialKycShopOwner - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner#main-content)
...
[Anchor to FinancialKycShopOwner](https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to email](https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner#field-FinancialKycShopOwner.fields.email)email
...
[Anchor to firstName](https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner#field-FinancialKycShopOwner.fields.firstName)first Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The first name of the shop owner.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner#field-FinancialKycShopOwner.fields.id)id
...
[Anchor to lastName](https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner#field-FinancialKycShopOwner.fields.lastName)last Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The last name of the shop owner.

[Anchor to phone](https://shopify.dev/docs/api/admin-graphql/latest/objects/financialkycshopowner#field-FinancialKycShopOwner.fields.phone)phone
...
*   {}[FinanceKycInformation.shopOwner](https://shopify.dev/docs/api/admin-graphql/latest/objects/FinanceKycInformation#field-shopOwner)
