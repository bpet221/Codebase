---
title: "ShopifyPaymentsAdjustmentOrder"
description: "Shopify GraphQL Admin API documentation for shopifypaymentsadjustmentorder"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder

Markdown Content:
ShopifyPaymentsAdjustmentOrder - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder#main-content)
...
[Anchor to ShopifyPaymentsAdjustmentOrder](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder#field-ShopifyPaymentsAdjustmentOrder.fields.amount)amount
...
[Anchor to fees](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder#field-ShopifyPaymentsAdjustmentOrder.fields.fees)fees
...
[Anchor to link](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder#field-ShopifyPaymentsAdjustmentOrder.fields.link)link
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder#field-ShopifyPaymentsAdjustmentOrder.fields.name)name
...
[Anchor to net](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder#field-ShopifyPaymentsAdjustmentOrder.fields.net)net
...
[Anchor to orderTransactionId](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsadjustmentorder#field-ShopifyPaymentsAdjustmentOrder.fields.orderTransactionId)order Transaction Id
...
*   {}[ShopifyPaymentsBalanceTransaction.adjustmentsOrders](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopifyPaymentsBalanceTransaction#field-adjustmentsOrders)
