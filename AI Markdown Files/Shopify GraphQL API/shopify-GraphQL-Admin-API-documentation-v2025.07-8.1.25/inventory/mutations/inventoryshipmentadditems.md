---
title: "inventoryShipmentAddItems"
description: "Shopify GraphQL Admin API documentation for inventoryshipmentadditems"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems

Markdown Content:
inventoryShipmentAddItems - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems#main-content)
...
[Anchor to inventoryShipmentAddItems](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems#arguments-id)id
...
[Anchor to lineItems](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems#arguments-lineItems)line Items
...
[Anchor to InventoryShipmentAddItemsPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems#returns)Inventory Shipment Add Items Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to addedItems](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems#returns-addedItems)added Items
...
[Anchor to inventoryShipment](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems#returns-inventoryShipment)inventory Shipment
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventoryshipmentadditems#returns-userErrors)user Errors
