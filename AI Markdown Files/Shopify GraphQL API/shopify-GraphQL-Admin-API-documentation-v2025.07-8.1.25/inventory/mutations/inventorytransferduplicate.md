---
title: "inventoryTransferDuplicate"
description: "Shopify GraphQL Admin API documentation for inventorytransferduplicate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransferduplicate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransferduplicate

Markdown Content:
inventoryTransferDuplicate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransferduplicate#main-content)
...
[Anchor to inventoryTransferDuplicate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransferduplicate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransferduplicate#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransferduplicate#arguments-id)id
...
[Anchor to InventoryTransferDuplicatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransferduplicate#returns)Inventory Transfer Duplicate Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to inventoryTransfer](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransferduplicate#returns-inventoryTransfer)inventory Transfer
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransferduplicate#returns-userErrors)user Errors
