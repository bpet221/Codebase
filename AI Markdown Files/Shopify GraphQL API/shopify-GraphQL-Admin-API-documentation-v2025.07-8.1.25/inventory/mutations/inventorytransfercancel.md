...
description: "Shopify GraphQL Admin API documentation for inventorytransfercancel"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransfercancel"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransfercancel

Markdown Content:
inventoryTransferCancel - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransfercancel#main-content)
...
[Anchor to inventoryTransferCancel](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransfercancel#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransfercancel#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransfercancel#arguments-id)id
...
[Anchor to InventoryTransferCancelPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransfercancel#returns)Inventory Transfer Cancel Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to inventoryTransfer](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransfercancel#returns-inventoryTransfer)inventory Transfer
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/inventorytransfercancel#returns-userErrors)user Errors
