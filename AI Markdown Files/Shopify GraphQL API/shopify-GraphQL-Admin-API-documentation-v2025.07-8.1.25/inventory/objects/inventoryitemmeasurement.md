---
title: "InventoryItemMeasurement"
description: "Shopify GraphQL Admin API documentation for inventoryitemmeasurement"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement

Markdown Content:
InventoryItemMeasurement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement#interfaces)
...
[Anchor to InventoryItemMeasurement](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement#field-InventoryItemMeasurement.fields.id)id
...
[Anchor to weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement#field-InventoryItemMeasurement.fields.weight)weight
...
*   {}[InventoryItem.measurement](https://shopify.dev/docs/api/admin-graphql/latest/objects/InventoryItem#field-measurement)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryitemmeasurement#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
