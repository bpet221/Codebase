---
title: "InventoryQuantityName"
description: "Shopify GraphQL Admin API documentation for inventoryquantityname"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname

Markdown Content:
InventoryQuantityName - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname#main-content)
...
[Anchor to InventoryQuantityName](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to belongsTo](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname#field-InventoryQuantityName.fields.belongsTo)belongs To
...
[Anchor to comprises](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname#field-InventoryQuantityName.fields.comprises)comprises
...
[Anchor to displayName](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname#field-InventoryQuantityName.fields.displayName)display Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The display name for quantity names translated into applicable language.

[Anchor to isInUse](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname#field-InventoryQuantityName.fields.isInUse)is In Use
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/inventoryquantityname#field-InventoryQuantityName.fields.name)name
...
*   {}[InventoryProperties.quantityNames](https://shopify.dev/docs/api/admin-graphql/latest/objects/InventoryProperties#field-quantityNames)
