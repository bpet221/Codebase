---
title: "subscriptionBillingAttempts"
description: "Shopify GraphQL Admin API documentation for subscriptionbillingattempts"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts

Markdown Content:
subscriptionBillingAttempts - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#main-content)
...
[Anchor to subscriptionBillingAttempts](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#arguments)
...
[Anchor to after](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#arguments-after)after

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come after the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to before](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#arguments-before)before

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The elements that come before the specified [cursor](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to first](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#arguments-first)first

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The first `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to last](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#arguments-last)last

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The last `n` elements from the [paginated list](https://shopify.dev/api/usage/pagination-graphql).

[Anchor to query](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#arguments-query)query
...
[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#argument-query-filter-created_at)created_at

•time

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#argument-query-filter-error_code)error_code

•string

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#argument-query-filter-error_message)error_message

•string

[Anchor to](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#argument-query-filter-id)id
...
[Anchor to reverse](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#arguments-reverse)reverse
...
[Anchor to sortKey](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#arguments-sortKey)sort Key
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#possible-returns)Possible returns
----------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to edges](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#returns-edges)edges
...
[Anchor to nodes](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#returns-nodes)nodes
...
[Anchor to pageInfo](https://shopify.dev/docs/api/admin-graphql/latest/queries/subscriptionbillingattempts#returns-pageInfo)page Info
...
# subscriptionBillingAttempts fields
