...
description: "Shopify GraphQL Admin API documentation for pendingorderscount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/pendingorderscount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/pendingorderscount

Markdown Content:
pendingOrdersCount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/pendingorderscount#main-content)
...
[Anchor to pendingOrdersCount](https://shopify.dev/docs/api/admin-graphql/latest/queries/pendingorderscount#top)
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/pendingorderscount#possible-returns)Possible returns
-------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to Count](https://shopify.dev/docs/api/admin-graphql/latest/queries/pendingorderscount#returns-Count)Count
