---
title: "returnCalculate"
description: "Shopify GraphQL Admin API documentation for returncalculate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/returncalculate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/returncalculate

Markdown Content:
returnCalculate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/returncalculate#main-content)
...
[Anchor to returnCalculate](https://shopify.dev/docs/api/admin-graphql/latest/queries/returncalculate#top)
return Calculate
================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/returncalculate#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/queries/returncalculate#arguments-input)input
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/returncalculate#possible-returns)Possible returns
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to CalculatedReturn](https://shopify.dev/docs/api/admin-graphql/latest/queries/returncalculate#returns-CalculatedReturn)Calculated Return
