---
title: "availableBackupRegions"
description: "Shopify GraphQL Admin API documentation for availablebackupregions"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/availablebackupregions"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/availablebackupregions

Markdown Content:
availableBackupRegions - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/availablebackupregions#main-content)
...
[Anchor to availableBackupRegions](https://shopify.dev/docs/api/admin-graphql/latest/queries/availablebackupregions#top)
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/availablebackupregions#possible-returns)Possible returns
-----------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to MarketRegion](https://shopify.dev/docs/api/admin-graphql/latest/queries/availablebackupregions#returns-MarketRegion)Market Region
