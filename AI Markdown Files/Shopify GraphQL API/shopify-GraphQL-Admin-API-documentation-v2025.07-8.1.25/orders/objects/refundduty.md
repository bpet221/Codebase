---
title: "RefundDuty"
description: "Shopify GraphQL Admin API documentation for refundduty"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/refundduty"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/refundduty

Markdown Content:
RefundDuty - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundduty#main-content)
...
[Anchor to RefundDuty](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundduty#top)
Refund Duty
===========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundduty#fields)Fields
-----------------------------------------------------------------------------------------------------

[Anchor to amountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundduty#field-RefundDuty.fields.amountSet)amount Set
...
[Anchor to originalDuty](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundduty#field-RefundDuty.fields.originalDuty)original Duty
...
*   {}[Refund.duties](https://shopify.dev/docs/api/admin-graphql/latest/objects/Refund#field-duties)
*   {}[SuggestedRefund.refundDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/SuggestedRefund#field-refundDuties)
*   {}[SuggestedReturnFinancialOutcome.refundDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/SuggestedReturnFinancialOutcome#field-refundDuties)
*   {}[SuggestedReturnRefund.refundDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/SuggestedReturnRefund#field-refundDuties)
