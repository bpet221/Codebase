---
title: "OrderApp"
description: "Shopify GraphQL Admin API documentation for orderapp"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderapp

Markdown Content:
OrderApp - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderapp#main-content)
...
[Anchor to OrderApp](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderapp#top)
Order App
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderapp#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to icon](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderapp#field-OrderApp.fields.icon)icon
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderapp#field-OrderApp.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderapp#field-OrderApp.fields.name)name
...
*   {}[Order.app](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-app)
*   {}[Order.merchantOfRecordApp](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-merchantOfRecordApp)
