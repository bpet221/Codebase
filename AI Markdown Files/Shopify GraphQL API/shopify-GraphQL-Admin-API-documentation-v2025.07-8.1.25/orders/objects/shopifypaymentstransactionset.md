...
description: "Shopify GraphQL Admin API documentation for shopifypaymentstransactionset"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstransactionset"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstransactionset

Markdown Content:
ShopifyPaymentsTransactionSet - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstransactionset#main-content)
...
[Anchor to ShopifyPaymentsTransactionSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstransactionset#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstransactionset#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to extendedAuthorizationSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstransactionset#field-ShopifyPaymentsTransactionSet.fields.extendedAuthorizationSet)extended Authorization Set
...
[Anchor to refundSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentstransactionset#field-ShopifyPaymentsTransactionSet.fields.refundSet)refund Set
...
*   {}[OrderTransaction.shopifyPaymentsSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/OrderTransaction#field-shopifyPaymentsSet)
