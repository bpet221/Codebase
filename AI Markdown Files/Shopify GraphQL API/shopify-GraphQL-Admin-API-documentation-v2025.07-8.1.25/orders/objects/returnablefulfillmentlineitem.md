---
title: "ReturnableFulfillmentLineItem"
description: "Shopify GraphQL Admin API documentation for returnablefulfillmentlineitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitem

Markdown Content:
ReturnableFulfillmentLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitem#main-content)
...
[Anchor to ReturnableFulfillmentLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitem#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to fulfillmentLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitem#field-ReturnableFulfillmentLineItem.fields.fulfillmentLineItem)fulfillment Line Item
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillmentlineitem#field-ReturnableFulfillmentLineItem.fields.quantity)quantity
...
*   {}[ReturnableFulfillment.returnableFulfillmentLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReturnableFulfillment#field-returnableFulfillmentLineItems)
*   <->[ReturnableFulfillmentLineItemConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReturnableFulfillmentLineItemConnection#field-nodes)
*   {}[ReturnableFulfillmentLineItemEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReturnableFulfillmentLineItemEdge#field-node)
