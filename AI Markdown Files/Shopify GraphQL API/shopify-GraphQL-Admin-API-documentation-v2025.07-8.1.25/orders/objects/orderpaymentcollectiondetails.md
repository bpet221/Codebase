...
description: "Shopify GraphQL Admin API documentation for orderpaymentcollectiondetails"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentcollectiondetails"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentcollectiondetails

Markdown Content:
OrderPaymentCollectionDetails - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentcollectiondetails#main-content)
...
[Anchor to OrderPaymentCollectionDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentcollectiondetails#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentcollectiondetails#fields)Fields
------------------------------------------------------------------------------------------------------------------------

[Anchor to additionalPaymentCollectionUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentcollectiondetails#field-OrderPaymentCollectionDetails.fields.additionalPaymentCollectionUrl)additional Payment Collection Url

•[URL](https://shopify.dev/docs/api/admin-graphql/latest/scalars/URL)

The URL to use for collecting an additional payment on the order.

[Anchor to vaultedPaymentMethods](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderpaymentcollectiondetails#field-OrderPaymentCollectionDetails.fields.vaultedPaymentMethods)vaulted Payment Methods
...
*   {}[Order.paymentCollectionDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-paymentCollectionDetails)
