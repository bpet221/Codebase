...
description: "Shopify GraphQL Admin API documentation for subscriptionshippingoption"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption

Markdown Content:
SubscriptionShippingOption - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#main-content)
...
[Anchor to SubscriptionShippingOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#field-SubscriptionShippingOption.fields.code)code
...
[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#field-SubscriptionShippingOption.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The description of the shipping option.

[Anchor to phoneRequired](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#field-SubscriptionShippingOption.fields.phoneRequired)phone Required

•[Boolean](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Boolean)

If a phone number is required for the shipping option.

[Anchor to presentmentTitle](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#field-SubscriptionShippingOption.fields.presentmentTitle)presentment Title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The presentment title of the shipping option.

[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#field-SubscriptionShippingOption.fields.price)price
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#field-SubscriptionShippingOption.fields.title)title
...
[Anchor to carrierService](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionshippingoption#field-SubscriptionShippingOption.fields.carrierService)carrier Service
...
*   {}[SubscriptionShippingOptionResultSuccess.shippingOptions](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionShippingOptionResultSuccess#field-shippingOptions)
