---
title: "ManualDiscountApplication"
description: "Shopify GraphQL Admin API documentation for manualdiscountapplication"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication

Markdown Content:
ManualDiscountApplication - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#interfaces)
...
[Anchor to ManualDiscountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to allocationMethod](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#field-ManualDiscountApplication.fields.allocationMethod)allocation Method
...
[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#field-ManualDiscountApplication.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The description of the discount application.

[Anchor to index](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#field-ManualDiscountApplication.fields.index)index
...
[Anchor to targetSelection](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#field-ManualDiscountApplication.fields.targetSelection)target Selection
...
[Anchor to targetType](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#field-ManualDiscountApplication.fields.targetType)target Type
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#field-ManualDiscountApplication.fields.title)title
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#field-ManualDiscountApplication.fields.value)value
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to DiscountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/manualdiscountapplication#interface-DiscountApplication)[Discount Application](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DiscountApplication)
