---
title: "ShippingLine"
description: "Shopify GraphQL Admin API documentation for shippingline"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline

Markdown Content:
ShippingLine - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#main-content)
...
[Anchor to ShippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#top)
Shipping Line
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to carrierIdentifier](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.carrierIdentifier)carrier Identifier
...
[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.code)code

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A reference to the shipping method.

[Anchor to currentDiscountedPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.currentDiscountedPriceSet)current Discounted Price Set
...
[Anchor to custom](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.custom)custom
...
[Anchor to deliveryCategory](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.deliveryCategory)delivery Category

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The general classification of the delivery method.

[Anchor to discountAllocations](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.discountAllocations)discount Allocations
...
[Anchor to discountedPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.discountedPriceSet)discounted Price Set
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.id)id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A globally-unique ID.

[Anchor to isRemoved](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.isRemoved)is Removed
...
[Anchor to originalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.originalPriceSet)original Price Set
...
[Anchor to phone](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.phone)phone

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The phone number at the shipping address.

[Anchor to shippingRateHandle](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.shippingRateHandle)shipping Rate Handle

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A unique identifier for the shipping rate. The format can change without notice and isn't meant to be shown to users.

[Anchor to source](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.source)source

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

Returns the rate source for the shipping line.

[Anchor to taxLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.taxLines)tax Lines
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.title)title
...
[Anchor to discountedPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.discountedPrice)discounted Price
...
[Anchor to originalPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.originalPrice)original Price
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.price)price

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to requestedFulfillmentService](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingline#field-ShippingLine.fields.requestedFulfillmentService)requested Fulfillment Service
...
*   {}[CalculatedDraftOrder.shippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-shippingLine)
*   {}[DraftOrder.shippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrder#field-shippingLine)
*   {}[Order.shippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-shippingLine)
*   {}[Order.shippingLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-shippingLines)
*   {}[OrderStagedChangeRemoveShippingLine.shippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/OrderStagedChangeRemoveShippingLine#field-shippingLine)
*   {}[RefundShippingLine.shippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/RefundShippingLine#field-shippingLine)
*   <->[ShippingLineConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ShippingLineConnection#field-nodes)
*   {}[ShippingLineEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShippingLineEdge#field-node)
*   {}[ShippingLineSale.shippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShippingLineSale#field-shippingLine)
