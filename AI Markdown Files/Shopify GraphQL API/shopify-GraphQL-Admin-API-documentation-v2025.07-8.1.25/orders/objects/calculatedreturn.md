...
description: "Shopify GraphQL Admin API documentation for calculatedreturn"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn

Markdown Content:
CalculatedReturn - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#queries)
...
[Anchor to CalculatedReturn](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#top)
Calculated Return
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to exchangeLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#field-CalculatedReturn.fields.exchangeLineItems)exchange Line Items
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#field-CalculatedReturn.fields.id)id
...
[Anchor to returnLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#field-CalculatedReturn.fields.returnLineItems)return Line Items
...
[Anchor to returnShippingFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#field-CalculatedReturn.fields.returnShippingFee)return Shipping Fee
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#queries)Queries
--------------------------------------------------------------------------------------------------------------

[Anchor to returnCalculate](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturn#query-returnCalculate)[return Calculate](https://shopify.dev/docs/api/admin-graphql/latest/queries/returnCalculate)
...
*   <?>[return Calculate](https://shopify.dev/docs/api/admin-graphql/latest/queries/CalculatedReturn)
