---
title: "RefundReturnOutcome"
description: "Shopify GraphQL Admin API documentation for refundreturnoutcome"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/refundreturnoutcome"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/refundreturnoutcome

Markdown Content:
RefundReturnOutcome - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundreturnoutcome#main-content)
...
[Anchor to RefundReturnOutcome](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundreturnoutcome#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundreturnoutcome#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundreturnoutcome#field-RefundReturnOutcome.fields.amount)amount
...
[Anchor to suggestedRefundMethods](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundreturnoutcome#field-RefundReturnOutcome.fields.suggestedRefundMethods)suggested Refund Methods
...
[Anchor to suggestedTransactions](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundreturnoutcome#field-RefundReturnOutcome.fields.suggestedTransactions)suggested Transactions
