---
title: "ReturnShippingFee"
description: "Shopify GraphQL Admin API documentation for returnshippingfee"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee

Markdown Content:
ReturnShippingFee - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee#interfaces)
...
[Anchor to ReturnShippingFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee#top)
Return Shipping Fee
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to amountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee#field-ReturnShippingFee.fields.amountSet)amount Set
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee#field-ReturnShippingFee.fields.id)id
...
*   {}[Return.returnShippingFees](https://shopify.dev/docs/api/admin-graphql/latest/objects/Return#field-returnShippingFees)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to Fee](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnshippingfee#interface-Fee)[Fee](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Fee)
