...
description: "Shopify GraphQL Admin API documentation for orderrisksummary"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisksummary"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisksummary

Markdown Content:
OrderRiskSummary - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisksummary#main-content)
...
[Anchor to OrderRiskSummary](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisksummary#top)
Order Risk Summary
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisksummary#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to assessments](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisksummary#field-OrderRiskSummary.fields.assessments)assessments
...
[Anchor to recommendation](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisksummary#field-OrderRiskSummary.fields.recommendation)recommendation
...
*   {}[Order.risk](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-risk)
