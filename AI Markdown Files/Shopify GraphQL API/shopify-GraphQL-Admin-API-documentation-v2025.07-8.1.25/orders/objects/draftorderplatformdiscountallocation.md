---
title: "DraftOrderPlatformDiscountAllocation"
description: "Shopify GraphQL Admin API documentation for draftorderplatformdiscountallocation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation

Markdown Content:
DraftOrderPlatformDiscountAllocation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation#main-content)
...
[Anchor to DraftOrderPlatformDiscountAllocation](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation#field-DraftOrderPlatformDiscountAllocation.fields.id)id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the allocation.

[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation#field-DraftOrderPlatformDiscountAllocation.fields.quantity)quantity

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The quantity of the target being discounted.

[Anchor to reductionAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation#field-DraftOrderPlatformDiscountAllocation.fields.reductionAmount)reduction Amount
...
[Anchor to reductionAmountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation#field-DraftOrderPlatformDiscountAllocation.fields.reductionAmountSet)reduction Amount Set
...
[Anchor to target](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscountallocation#field-DraftOrderPlatformDiscountAllocation.fields.target)target
...
*   {}[DraftOrderPlatformDiscount.allocations](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrderPlatformDiscount#field-allocations)
