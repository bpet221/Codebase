...
description: "Shopify GraphQL Admin API documentation for returnlineitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem

Markdown Content:
ReturnLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#interfaces)
...
[Anchor to ReturnLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#top)
Return Line Item
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to customerNote](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.customerNote)customer Note

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A note from the customer that describes the item to be returned. Maximum length: 300 characters.

[Anchor to fulfillmentLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.fulfillmentLineItem)fulfillment Line Item
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.id)id
...
[Anchor to processableQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.processableQuantity)processable Quantity
...
[Anchor to processedQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.processedQuantity)processed Quantity
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.quantity)quantity
...
[Anchor to refundableQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.refundableQuantity)refundable Quantity
...
[Anchor to refundedQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.refundedQuantity)refunded Quantity
...
[Anchor to restockingFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.restockingFee)restocking Fee
...
[Anchor to returnReason](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.returnReason)return Reason
...
[Anchor to returnReasonNote](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.returnReasonNote)return Reason Note
...
[Anchor to totalWeight](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.totalWeight)total Weight
...
[Anchor to unprocessedQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.unprocessedQuantity)unprocessed Quantity
...
[Anchor to withCodeDiscountedTotalPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#field-ReturnLineItem.fields.withCodeDiscountedTotalPriceSet)with Code Discounted Total Price Set
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to ReturnLineItemType](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnlineitem#interface-ReturnLineItemType)[Return Line Item Type](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/ReturnLineItemType)
