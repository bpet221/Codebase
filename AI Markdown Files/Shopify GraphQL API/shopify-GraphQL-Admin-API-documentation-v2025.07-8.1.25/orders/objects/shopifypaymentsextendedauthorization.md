---
title: "ShopifyPaymentsExtendedAuthorization"
description: "Shopify GraphQL Admin API documentation for shopifypaymentsextendedauthorization"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsextendedauthorization"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsextendedauthorization

Markdown Content:
ShopifyPaymentsExtendedAuthorization - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsextendedauthorization#main-content)
...
[Anchor to ShopifyPaymentsExtendedAuthorization](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsextendedauthorization#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsextendedauthorization#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to extendedAuthorizationExpiresAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsextendedauthorization#field-ShopifyPaymentsExtendedAuthorization.fields.extendedAuthorizationExpiresAt)extended Authorization Expires At
...
[Anchor to standardAuthorizationExpiresAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifypaymentsextendedauthorization#field-ShopifyPaymentsExtendedAuthorization.fields.standardAuthorizationExpiresAt)standard Authorization Expires At
...
*   {}[ShopifyPaymentsTransactionSet.extendedAuthorizationSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopifyPaymentsTransactionSet#field-extendedAuthorizationSet)
