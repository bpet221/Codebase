...
description: "Shopify GraphQL Admin API documentation for draftorderbundleaddedwarning"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning

Markdown Content:
DraftOrderBundleAddedWarning - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#interfaces)
...
[Anchor to DraftOrderBundleAddedWarning](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to errorCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#field-DraftOrderBundleAddedWarning.fields.errorCode)error Code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#field-DraftOrderBundleAddedWarning.fields.field)field
...
[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#field-DraftOrderBundleAddedWarning.fields.message)message
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to DraftOrderWarning](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderbundleaddedwarning#interface-DraftOrderWarning)[Draft Order Warning](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DraftOrderWarning)
