...
description: "Shopify GraphQL Admin API documentation for orderadjustment"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment

Markdown Content:
OrderAdjustment - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#interfaces)
...
[Anchor to OrderAdjustment](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#top)
Order Adjustment
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to amountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#field-OrderAdjustment.fields.amountSet)amount Set
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#field-OrderAdjustment.fields.id)id
...
[Anchor to reason](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#field-OrderAdjustment.fields.reason)reason
...
[Anchor to taxAmountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#field-OrderAdjustment.fields.taxAmountSet)tax Amount Set
...
*   <->[OrderAdjustmentConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/OrderAdjustmentConnection#field-nodes)
*   {}[OrderAdjustmentEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/OrderAdjustmentEdge#field-node)
*   {}[Refund.orderAdjustments](https://shopify.dev/docs/api/admin-graphql/latest/objects/Refund#field-orderAdjustments)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderadjustment#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
