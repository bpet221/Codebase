---
title: "CalculatedScriptDiscountApplication"
description: "Shopify GraphQL Admin API documentation for calculatedscriptdiscountapplication"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication"
...
Title: CalculatedScriptDiscountApplication - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication

Markdown Content:
CalculatedScriptDiscountApplication - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#interfaces)
...
[Anchor to CalculatedScriptDiscountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#top)
Calculated Script Discount Application
======================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to allocationMethod](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#field-CalculatedScriptDiscountApplication.fields.allocationMethod)allocation Method
...
[Anchor to appliedTo](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#field-CalculatedScriptDiscountApplication.fields.appliedTo)applied To
...
[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#field-CalculatedScriptDiscountApplication.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The description of discount application. Indicates the reason why the discount was applied.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#field-CalculatedScriptDiscountApplication.fields.id)id
...
[Anchor to targetSelection](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#field-CalculatedScriptDiscountApplication.fields.targetSelection)target Selection
...
[Anchor to targetType](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#field-CalculatedScriptDiscountApplication.fields.targetType)target Type
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#field-CalculatedScriptDiscountApplication.fields.value)value
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to CalculatedDiscountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedscriptdiscountapplication#interface-CalculatedDiscountApplication)[Calculated Discount Application](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/CalculatedDiscountApplication)
...
||-CalculatedScriptDiscountApplication Implements
-------------------------------------------------
