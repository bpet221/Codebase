---
title: "CalculatedDiscountAllocation"
description: "Shopify GraphQL Admin API documentation for calculateddiscountallocation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountallocation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountallocation

Markdown Content:
CalculatedDiscountAllocation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountallocation#main-content)
...
[Anchor to CalculatedDiscountAllocation](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountallocation#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountallocation#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to allocatedAmountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountallocation#field-CalculatedDiscountAllocation.fields.allocatedAmountSet)allocated Amount Set
...
[Anchor to discountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculateddiscountallocation#field-CalculatedDiscountAllocation.fields.discountApplication)discount Application
...
*   {}[CalculatedExchangeLineItem.calculatedDiscountAllocations](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedExchangeLineItem#field-calculatedDiscountAllocations)
*   {}[CalculatedLineItem.calculatedDiscountAllocations](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedLineItem#field-calculatedDiscountAllocations)
