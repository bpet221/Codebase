...
description: "Shopify GraphQL Admin API documentation for orderagreement"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement"
...
Title: OrderAgreement - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement

Markdown Content:
OrderAgreement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#interfaces)
...
[Anchor to OrderAgreement](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#top)
Order Agreement
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to app](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#field-OrderAgreement.fields.app)app
...
[Anchor to happenedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#field-OrderAgreement.fields.happenedAt)happened At
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#field-OrderAgreement.fields.id)id
...
[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#field-OrderAgreement.fields.order)order
...
[Anchor to reason](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#field-OrderAgreement.fields.reason)reason
...
[Anchor to sales](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#field-OrderAgreement.fields.sales)sales
...
[Anchor to user](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#field-OrderAgreement.fields.user)user
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------

[Anchor to SalesAgreement](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderagreement#interface-SalesAgreement)[Sales Agreement](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SalesAgreement)
