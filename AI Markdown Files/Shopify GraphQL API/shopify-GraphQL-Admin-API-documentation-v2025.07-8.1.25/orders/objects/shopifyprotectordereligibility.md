---
title: "ShopifyProtectOrderEligibility"
description: "Shopify GraphQL Admin API documentation for shopifyprotectordereligibility"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordereligibility"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordereligibility

Markdown Content:
ShopifyProtectOrderEligibility - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordereligibility#main-content)
...
[Anchor to ShopifyProtectOrderEligibility](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordereligibility#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordereligibility#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordereligibility#field-ShopifyProtectOrderEligibility.fields.status)status
...
*   {}[ShopifyProtectOrderSummary.eligibility](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShopifyProtectOrderSummary#field-eligibility)
