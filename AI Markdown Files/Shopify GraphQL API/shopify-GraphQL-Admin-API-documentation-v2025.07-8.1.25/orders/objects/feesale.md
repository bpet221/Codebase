---
title: "FeeSale"
description: "Shopify GraphQL Admin API documentation for feesale"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale

Markdown Content:
FeeSale - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#interfaces)
...
[Anchor to FeeSale](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#top)
Fee Sale
========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#fields)Fields
--------------------------------------------------------------------------------------------------

[Anchor to actionType](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.actionType)action Type
...
[Anchor to fee](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.fee)fee
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.id)id
...
[Anchor to lineType](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.lineType)line Type
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.quantity)quantity

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The number of units either ordered or intended to be returned.

[Anchor to taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.taxes)taxes
...
[Anchor to totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.totalAmount)total Amount
...
[Anchor to totalDiscountAmountAfterTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.totalDiscountAmountAfterTaxes)total Discount Amount After Taxes
...
[Anchor to totalDiscountAmountBeforeTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.totalDiscountAmountBeforeTaxes)total Discount Amount Before Taxes
...
[Anchor to totalTaxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#field-FeeSale.fields.totalTaxAmount)total Tax Amount
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------

[Anchor to Sale](https://shopify.dev/docs/api/admin-graphql/latest/objects/feesale#interface-Sale)[Sale](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Sale)
