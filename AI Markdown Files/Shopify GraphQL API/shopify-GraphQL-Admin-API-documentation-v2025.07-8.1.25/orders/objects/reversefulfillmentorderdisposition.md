---
title: "ReverseFulfillmentOrderDisposition"
description: "Shopify GraphQL Admin API documentation for reversefulfillmentorderdisposition"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition

Markdown Content:
ReverseFulfillmentOrderDisposition - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#interfaces)
...
[Anchor to ReverseFulfillmentOrderDisposition](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#field-ReverseFulfillmentOrderDisposition.fields.createdAt)created At
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#field-ReverseFulfillmentOrderDisposition.fields.id)id
...
[Anchor to location](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#field-ReverseFulfillmentOrderDisposition.fields.location)location
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#field-ReverseFulfillmentOrderDisposition.fields.quantity)quantity
...
[Anchor to type](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#field-ReverseFulfillmentOrderDisposition.fields.type)type
...
*   {}[ReverseDeliveryLineItem.dispositions](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseDeliveryLineItem#field-dispositions)
*   {}[ReverseFulfillmentOrderLineItem.dispositions](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseFulfillmentOrderLineItem#field-dispositions)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderdisposition#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
