...
description: "Shopify GraphQL Admin API documentation for cardpaymentdetails"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails

Markdown Content:
CardPaymentDetails - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#interfaces)
...
[Anchor to CardPaymentDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to avsResultCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.avsResultCode)avs Result Code

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The response code from the address verification system (AVS). The code is always a single letter.

[Anchor to bin](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.bin)bin
...
[Anchor to company](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.company)company

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The name of the company that issued the customer's credit card.

[Anchor to cvvResultCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.cvvResultCode)cvv Result Code
...
[Anchor to expirationMonth](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.expirationMonth)expiration Month

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The month in which the used credit card expires.

[Anchor to expirationYear](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.expirationYear)expiration Year

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The year in which the used credit card expires.

[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.name)name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The holder of the credit card.

[Anchor to number](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.number)number

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The customer's credit card number, with most of the leading digits redacted.

[Anchor to paymentMethodName](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.paymentMethodName)payment Method Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The name of payment method used by the buyer.

[Anchor to wallet](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#field-CardPaymentDetails.fields.wallet)wallet
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------

[Anchor to BasePaymentDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/cardpaymentdetails#interface-BasePaymentDetails)[Base Payment Details](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/BasePaymentDetails)
