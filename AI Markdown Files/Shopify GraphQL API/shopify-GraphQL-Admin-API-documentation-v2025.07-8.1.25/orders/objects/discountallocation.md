...
description: "Shopify GraphQL Admin API documentation for discountallocation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocation

Markdown Content:
DiscountAllocation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocation#main-content)
...
[Anchor to DiscountAllocation](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocation#top)
Discount Allocation
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocation#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to allocatedAmountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocation#field-DiscountAllocation.fields.allocatedAmountSet)allocated Amount Set
...
[Anchor to discountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocation#field-DiscountAllocation.fields.discountApplication)discount Application
...
[Anchor to allocatedAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountallocation#field-DiscountAllocation.fields.allocatedAmount)allocated Amount
...
*   {}[AbandonedCheckoutLineItem.discountAllocations](https://shopify.dev/docs/api/admin-graphql/latest/objects/AbandonedCheckoutLineItem#field-discountAllocations)
*   <->[DiscountAllocationConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/DiscountAllocationConnection#field-nodes)
*   {}[DiscountAllocationEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/DiscountAllocationEdge#field-node)
*   {}[LineItem.discountAllocations](https://shopify.dev/docs/api/admin-graphql/latest/objects/LineItem#field-discountAllocations)
*   {}[ShippingLine.discountAllocations](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShippingLine#field-discountAllocations)
