---
title: "ReverseFulfillmentOrderThirdPartyConfirmation"
description: "Shopify GraphQL Admin API documentation for reversefulfillmentorderthirdpartyconfirmation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderthirdpartyconfirmation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderthirdpartyconfirmation

Markdown Content:
ReverseFulfillmentOrderThirdPartyConfirmation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderthirdpartyconfirmation#main-content)
...
[Anchor to ReverseFulfillmentOrderThirdPartyConfirmation](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderthirdpartyconfirmation#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderthirdpartyconfirmation#fields)Fields
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderthirdpartyconfirmation#field-ReverseFulfillmentOrderThirdPartyConfirmation.fields.status)status
...
*   {}[ReverseFulfillmentOrder.thirdPartyConfirmation](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseFulfillmentOrder#field-thirdPartyConfirmation)
