---
title: "DutySale"
description: "Shopify GraphQL Admin API documentation for dutysale"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale

Markdown Content:
DutySale - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#interfaces)
...
[Anchor to DutySale](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#top)
Duty Sale
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to actionType](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.actionType)action Type
...
[Anchor to duty](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.duty)duty
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.id)id
...
[Anchor to lineType](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.lineType)line Type
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.quantity)quantity

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The number of units either ordered or intended to be returned.

[Anchor to taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.taxes)taxes
...
[Anchor to totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.totalAmount)total Amount
...
[Anchor to totalDiscountAmountAfterTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.totalDiscountAmountAfterTaxes)total Discount Amount After Taxes
...
[Anchor to totalDiscountAmountBeforeTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.totalDiscountAmountBeforeTaxes)total Discount Amount Before Taxes
...
[Anchor to totalTaxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#field-DutySale.fields.totalTaxAmount)total Tax Amount
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------

[Anchor to Sale](https://shopify.dev/docs/api/admin-graphql/latest/objects/dutysale#interface-Sale)[Sale](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Sale)
