---
title: "ReturnDecline"
description: "Shopify GraphQL Admin API documentation for returndecline"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returndecline"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returndecline

Markdown Content:
ReturnDecline - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returndecline#main-content)
...
[Anchor to ReturnDecline](https://shopify.dev/docs/api/admin-graphql/latest/objects/returndecline#top)
Return Decline
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returndecline#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to note](https://shopify.dev/docs/api/admin-graphql/latest/objects/returndecline#field-ReturnDecline.fields.note)note
...
[Anchor to reason](https://shopify.dev/docs/api/admin-graphql/latest/objects/returndecline#field-ReturnDecline.fields.reason)reason
...
*   {}[Return.decline](https://shopify.dev/docs/api/admin-graphql/latest/objects/Return#field-decline)
