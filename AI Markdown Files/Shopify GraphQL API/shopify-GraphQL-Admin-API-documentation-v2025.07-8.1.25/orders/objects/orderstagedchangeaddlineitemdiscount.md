---
title: "OrderStagedChangeAddLineItemDiscount"
description: "Shopify GraphQL Admin API documentation for orderstagedchangeaddlineitemdiscount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount

Markdown Content:
OrderStagedChangeAddLineItemDiscount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#mutations)
...
[Anchor to OrderStagedChangeAddLineItemDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#field-OrderStagedChangeAddLineItemDiscount.fields.description)description
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#field-OrderStagedChangeAddLineItemDiscount.fields.id)id
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#field-OrderStagedChangeAddLineItemDiscount.fields.value)value
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#mutations)Mutations
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to orderEditAddLineItemDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddlineitemdiscount#mutation-orderEditAddLineItemDiscount)[order Edit Add Line Item Discount](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderEditAddLineItemDiscount)
