---
title: "DraftOrderPlatformDiscount"
description: "Shopify GraphQL Admin API documentation for draftorderplatformdiscount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount

Markdown Content:
DraftOrderPlatformDiscount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#main-content)
...
[Anchor to DraftOrderPlatformDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to allocations](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.allocations)allocations
...
[Anchor to automaticDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.automaticDiscount)automatic Discount
...
[Anchor to bxgyDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.bxgyDiscount)bxgy Discount
...
[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.code)code

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

If a code-based discount, the code used to add the discount.

[Anchor to discountClasses](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.discountClasses)discount Classes
...
[Anchor to discountNode](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.discountNode)discount Node
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.id)id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the discount.

[Anchor to presentationLevel](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.presentationLevel)presentation Level
...
[Anchor to shortSummary](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.shortSummary)short Summary
...
[Anchor to summary](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.summary)summary
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.title)title
...
[Anchor to totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.totalAmount)total Amount
...
[Anchor to totalAmountPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.totalAmountPriceSet)total Amount Price Set
...
[Anchor to discountClass](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderplatformdiscount#field-DraftOrderPlatformDiscount.fields.discountClass)discount Class
...
*   {}[CalculatedDraftOrder.platformDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-platformDiscounts)
*   {}[DraftOrder.platformDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrder#field-platformDiscounts)
