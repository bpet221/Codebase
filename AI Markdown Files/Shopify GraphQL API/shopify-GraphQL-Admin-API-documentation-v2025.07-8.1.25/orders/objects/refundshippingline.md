---
title: "RefundShippingLine"
description: "Shopify GraphQL Admin API documentation for refundshippingline"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline

Markdown Content:
RefundShippingLine - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#interfaces)
...
[Anchor to RefundShippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#field-RefundShippingLine.fields.id)id
...
[Anchor to shippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#field-RefundShippingLine.fields.shippingLine)shipping Line
...
[Anchor to subtotalAmountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#field-RefundShippingLine.fields.subtotalAmountSet)subtotal Amount Set
...
[Anchor to taxAmountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#field-RefundShippingLine.fields.taxAmountSet)tax Amount Set
...
*   {}[Refund.refundShippingLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/Refund#field-refundShippingLines)
*   <->[RefundShippingLineConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/RefundShippingLineConnection#field-nodes)
*   {}[RefundShippingLineEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/RefundShippingLineEdge#field-node)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundshippingline#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
