...
description: "Shopify GraphQL Admin API documentation for currencysetting"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting

Markdown Content:
CurrencySetting - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting#main-content)
...
[Anchor to CurrencySetting](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting#top)
Currency Setting
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to currencyCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting#field-CurrencySetting.fields.currencyCode)currency Code
...
[Anchor to currencyName](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting#field-CurrencySetting.fields.currencyName)currency Name
...
[Anchor to enabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting#field-CurrencySetting.fields.enabled)enabled
...
[Anchor to manualRate](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting#field-CurrencySetting.fields.manualRate)manual Rate
...
[Anchor to rateUpdatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/currencysetting#field-CurrencySetting.fields.rateUpdatedAt)rate Updated At
...
*   <->[CurrencySettingConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/CurrencySettingConnection#field-nodes)
*   {}[CurrencySettingEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/CurrencySettingEdge#field-node)
*   {}[MarketCurrencySettings.baseCurrency](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketCurrencySettings#field-baseCurrency)
*   {}[MarketRegionCountry.currency](https://shopify.dev/docs/api/admin-graphql/latest/objects/MarketRegionCountry#field-currency)
*   {}[Shop.currencySettings](https://shopify.dev/docs/api/admin-graphql/latest/objects/Shop#field-currencySettings)
