---
title: "ReverseDeliveryTrackingV2"
description: "Shopify GraphQL Admin API documentation for reversedeliverytrackingv2"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverytrackingv2"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverytrackingv2

Markdown Content:
ReverseDeliveryTrackingV2 - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverytrackingv2#main-content)
...
[Anchor to ReverseDeliveryTrackingV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverytrackingv2#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverytrackingv2#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to carrierName](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverytrackingv2#field-ReverseDeliveryTrackingV2.fields.carrierName)carrier Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The provider of the tracking information, in a human-readable format for display purposes.

[Anchor to number](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverytrackingv2#field-ReverseDeliveryTrackingV2.fields.number)number

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The identifier used by the courier to identify the shipment.

[Anchor to url](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverytrackingv2#field-ReverseDeliveryTrackingV2.fields.url)url
...
*   {}[ReverseDeliveryShippingDeliverable.tracking](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseDeliveryShippingDeliverable#field-tracking)
