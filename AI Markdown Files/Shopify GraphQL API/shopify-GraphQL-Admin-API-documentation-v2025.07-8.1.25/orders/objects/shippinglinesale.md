---
title: "ShippingLineSale"
description: "Shopify GraphQL Admin API documentation for shippinglinesale"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale

Markdown Content:
ShippingLineSale - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#interfaces)
...
[Anchor to ShippingLineSale](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#top)
Shipping Line Sale
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to actionType](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.actionType)action Type
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.id)id
...
[Anchor to lineType](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.lineType)line Type
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.quantity)quantity

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The number of units either ordered or intended to be returned.

[Anchor to shippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.shippingLine)shipping Line
...
[Anchor to taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.taxes)taxes
...
[Anchor to totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.totalAmount)total Amount
...
[Anchor to totalDiscountAmountAfterTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.totalDiscountAmountAfterTaxes)total Discount Amount After Taxes
...
[Anchor to totalDiscountAmountBeforeTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.totalDiscountAmountBeforeTaxes)total Discount Amount Before Taxes
...
[Anchor to totalTaxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#field-ShippingLineSale.fields.totalTaxAmount)total Tax Amount
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------

[Anchor to Sale](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippinglinesale#interface-Sale)[Sale](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Sale)
