---
title: "OrderRisk"
description: "Shopify GraphQL Admin API documentation for orderrisk"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisk"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisk

Markdown Content:
OrderRisk - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisk#main-content)
...
[Anchor to OrderRisk](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisk#top)
Order Risk
==========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisk#fields)Fields
----------------------------------------------------------------------------------------------------

### Deprecated fields

[Anchor to display](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisk#field-OrderRisk.fields.display)display

•[Boolean!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Boolean)

non-null Deprecated

[Anchor to level](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisk#field-OrderRisk.fields.level)level
...
[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderrisk#field-OrderRisk.fields.message)message
