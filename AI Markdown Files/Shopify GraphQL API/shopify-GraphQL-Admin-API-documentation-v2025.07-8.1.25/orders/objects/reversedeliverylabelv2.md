---
title: "ReverseDeliveryLabelV2"
description: "Shopify GraphQL Admin API documentation for reversedeliverylabelv2"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverylabelv2"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverylabelv2

Markdown Content:
ReverseDeliveryLabelV2 - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverylabelv2#main-content)
...
[Anchor to ReverseDeliveryLabelV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverylabelv2#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverylabelv2#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverylabelv2#field-ReverseDeliveryLabelV2.fields.createdAt)created At
...
[Anchor to publicFileUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverylabelv2#field-ReverseDeliveryLabelV2.fields.publicFileUrl)public File Url

•[URL](https://shopify.dev/docs/api/admin-graphql/latest/scalars/URL)

A public link that can be used to download the label image.

[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedeliverylabelv2#field-ReverseDeliveryLabelV2.fields.updatedAt)updated At
...
*   {}[ReverseDeliveryShippingDeliverable.label](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseDeliveryShippingDeliverable#field-label)
