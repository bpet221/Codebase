...
description: "Shopify GraphQL Admin API documentation for transactionfee"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee

Markdown Content:
TransactionFee - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#interfaces)
...
[Anchor to TransactionFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#top)
Transaction Fee
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#field-TransactionFee.fields.amount)amount
...
[Anchor to flatFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#field-TransactionFee.fields.flatFee)flat Fee
...
[Anchor to flatFeeName](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#field-TransactionFee.fields.flatFeeName)flat Fee Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

Name of the credit card flat fee.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#field-TransactionFee.fields.id)id
...
[Anchor to rate](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#field-TransactionFee.fields.rate)rate
...
[Anchor to rateName](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#field-TransactionFee.fields.rateName)rate Name

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

Name of the credit card rate.

[Anchor to taxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#field-TransactionFee.fields.taxAmount)tax Amount
...
[Anchor to type](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#field-TransactionFee.fields.type)type
...
*   {}[OrderTransaction.fees](https://shopify.dev/docs/api/admin-graphql/latest/objects/OrderTransaction#field-fees)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/transactionfee#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
