---
title: "PaypalWalletPaymentDetails"
description: "Shopify GraphQL Admin API documentation for paypalwalletpaymentdetails"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails

Markdown Content:
PaypalWalletPaymentDetails - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails#interfaces)
...
[Anchor to PaypalWalletPaymentDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to paymentMethodName](https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails#field-PaypalWalletPaymentDetails.fields.paymentMethodName)payment Method Name
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to BasePaymentDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/paypalwalletpaymentdetails#interface-BasePaymentDetails)[Base Payment Details](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/BasePaymentDetails)
