---
title: "SubscriptionPricingPolicy"
description: "Shopify GraphQL Admin API documentation for subscriptionpricingpolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpricingpolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpricingpolicy

Markdown Content:
SubscriptionPricingPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpricingpolicy#main-content)
...
[Anchor to SubscriptionPricingPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpricingpolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpricingpolicy#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to basePrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpricingpolicy#field-SubscriptionPricingPolicy.fields.basePrice)base Price
...
[Anchor to cycleDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpricingpolicy#field-SubscriptionPricingPolicy.fields.cycleDiscounts)cycle Discounts
...
*   {}[SubscriptionLine.pricingPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionLine#field-pricingPolicy)
