...
description: "Shopify GraphQL Admin API documentation for orderriskassessment"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment

Markdown Content:
OrderRiskAssessment - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#mutations)
...
[Anchor to OrderRiskAssessment](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to facts](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#field-OrderRiskAssessment.fields.facts)facts
...
[Anchor to provider](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#field-OrderRiskAssessment.fields.provider)provider
...
[Anchor to riskLevel](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#field-OrderRiskAssessment.fields.riskLevel)risk Level
...
*   {}[OrderRiskSummary.assessments](https://shopify.dev/docs/api/admin-graphql/latest/objects/OrderRiskSummary#field-assessments)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------

[Anchor to orderRiskAssessmentCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderriskassessment#mutation-orderRiskAssessmentCreate)[order Risk Assessment Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderRiskAssessmentCreate)
