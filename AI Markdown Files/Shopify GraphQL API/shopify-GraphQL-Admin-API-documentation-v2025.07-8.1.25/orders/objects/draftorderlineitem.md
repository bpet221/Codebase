---
title: "DraftOrderLineItem"
description: "Shopify GraphQL Admin API documentation for draftorderlineitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem

Markdown Content:
DraftOrderLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#interfaces)
...
[Anchor to DraftOrderLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to appliedDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.appliedDiscount)applied Discount
...
[Anchor to approximateDiscountedUnitPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.approximateDiscountedUnitPriceSet)approximate Discounted Unit Price Set
...
[Anchor to components](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.components)components
...
[Anchor to custom](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.custom)custom
...
[Anchor to customAttributes](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.customAttributes)custom Attributes
...
[Anchor to customAttributesV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.customAttributesV2)custom Attributes V2
...
[Anchor to discountedTotalSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.discountedTotalSet)discounted Total Set
...
[Anchor to fulfillmentService](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.fulfillmentService)fulfillment Service
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.id)id
...
[Anchor to image](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.image)image
...
[Anchor to isGiftCard](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.isGiftCard)is Gift Card
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.name)name
...
[Anchor to originalTotalSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.originalTotalSet)original Total Set
...
[Anchor to originalUnitPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.originalUnitPriceSet)original Unit Price Set
...
[Anchor to originalUnitPriceWithCurrency](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.originalUnitPriceWithCurrency)original Unit Price With Currency
...
[Anchor to priceOverride](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.priceOverride)price Override
...
[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.product)product
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.quantity)quantity
...
[Anchor to requiresShipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.requiresShipping)requires Shipping
...
[Anchor to sku](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.sku)sku

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The SKU number of the product variant.

[Anchor to taxable](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.taxable)taxable
...
[Anchor to taxLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.taxLines)tax Lines
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.title)title
...
[Anchor to totalDiscountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.totalDiscountSet)total Discount Set
...
[Anchor to uuid](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.uuid)uuid
...
[Anchor to variant](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.variant)variant
...
[Anchor to variantTitle](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.variantTitle)variant Title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The name of the variant.

[Anchor to vendor](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.vendor)vendor

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The name of the vendor who created the product variant.

[Anchor to weight](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.weight)weight
...
[Anchor to bundleComponents](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.bundleComponents)bundle Components
...
[Anchor to discountedTotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.discountedTotal)discounted Total

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to discountedUnitPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.discountedUnitPrice)discounted Unit Price

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to discountedUnitPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.discountedUnitPriceSet)discounted Unit Price Set
...
[Anchor to grams](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.grams)grams

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

Deprecated

[Anchor to originalTotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.originalTotal)original Total

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to originalUnitPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.originalUnitPrice)original Unit Price

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to totalDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#field-DraftOrderLineItem.fields.totalDiscount)total Discount
...
*   {}[DraftOrder.lineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrder#field-lineItems)
*   {}[DraftOrderLineItem.components](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrderLineItem#field-components)
*   <->[DraftOrderLineItemConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/DraftOrderLineItemConnection#field-nodes)
*   {}[DraftOrderLineItemEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrderLineItemEdge#field-node)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderlineitem#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
