---
title: "ReturnAgreement"
description: "Shopify GraphQL Admin API documentation for returnagreement"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement

Markdown Content:
ReturnAgreement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#interfaces)
...
[Anchor to ReturnAgreement](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#top)
Return Agreement
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to app](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#field-ReturnAgreement.fields.app)app
...
[Anchor to happenedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#field-ReturnAgreement.fields.happenedAt)happened At
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#field-ReturnAgreement.fields.id)id
...
[Anchor to reason](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#field-ReturnAgreement.fields.reason)reason
...
[Anchor to return](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#field-ReturnAgreement.fields.return)return
...
[Anchor to sales](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#field-ReturnAgreement.fields.sales)sales
...
[Anchor to user](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#field-ReturnAgreement.fields.user)user
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------

[Anchor to SalesAgreement](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnagreement#interface-SalesAgreement)[Sales Agreement](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SalesAgreement)
