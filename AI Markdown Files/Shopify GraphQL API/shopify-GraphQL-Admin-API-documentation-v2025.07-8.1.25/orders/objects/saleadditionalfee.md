---
title: "SaleAdditionalFee"
description: "Shopify GraphQL Admin API documentation for saleadditionalfee"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee

Markdown Content:
SaleAdditionalFee - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#interfaces)
...
[Anchor to SaleAdditionalFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#top)
Sale Additional Fee
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#field-SaleAdditionalFee.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#field-SaleAdditionalFee.fields.name)name
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#field-SaleAdditionalFee.fields.price)price
...
[Anchor to taxLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#field-SaleAdditionalFee.fields.taxLines)tax Lines
...
*   {}[AdditionalFeeSale.additionalFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdditionalFeeSale#field-additionalFee)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/saleadditionalfee#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
