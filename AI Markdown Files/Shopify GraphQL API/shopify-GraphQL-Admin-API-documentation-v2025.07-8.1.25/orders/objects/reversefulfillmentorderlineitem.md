---
title: "ReverseFulfillmentOrderLineItem"
description: "Shopify GraphQL Admin API documentation for reversefulfillmentorderlineitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem

Markdown Content:
ReverseFulfillmentOrderLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#interfaces)
...
[Anchor to ReverseFulfillmentOrderLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to dispositions](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#field-ReverseFulfillmentOrderLineItem.fields.dispositions)dispositions
...
[Anchor to fulfillmentLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#field-ReverseFulfillmentOrderLineItem.fields.fulfillmentLineItem)fulfillment Line Item
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#field-ReverseFulfillmentOrderLineItem.fields.id)id
...
[Anchor to totalQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#field-ReverseFulfillmentOrderLineItem.fields.totalQuantity)total Quantity
...
*   {}[ReverseDeliveryLineItem.reverseFulfillmentOrderLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseDeliveryLineItem#field-reverseFulfillmentOrderLineItem)
*   {}[ReverseFulfillmentOrder.lineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseFulfillmentOrder#field-lineItems)
*   <->[ReverseFulfillmentOrderLineItemConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReverseFulfillmentOrderLineItemConnection#field-nodes)
*   {}[ReverseFulfillmentOrderLineItemEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseFulfillmentOrderLineItemEdge#field-node)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#mutations)Mutations
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to reverseFulfillmentOrderDispose](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#mutation-reverseFulfillmentOrderDispose)[reverse Fulfillment Order Dispose](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reverseFulfillmentOrderDispose)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversefulfillmentorderlineitem#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
