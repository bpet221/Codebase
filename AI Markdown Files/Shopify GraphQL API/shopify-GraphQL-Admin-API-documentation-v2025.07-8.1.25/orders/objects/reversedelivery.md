---
title: "ReverseDelivery"
description: "Shopify GraphQL Admin API documentation for reversedelivery"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery

Markdown Content:
ReverseDelivery - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#queries)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#interfaces)
...
[Anchor to ReverseDelivery](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#top)
Reverse Delivery
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to deliverable](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#field-ReverseDelivery.fields.deliverable)deliverable
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#field-ReverseDelivery.fields.id)id
...
[Anchor to reverseDeliveryLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#field-ReverseDelivery.fields.reverseDeliveryLineItems)reverse Delivery Line Items
...
[Anchor to reverseFulfillmentOrder](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#field-ReverseDelivery.fields.reverseFulfillmentOrder)reverse Fulfillment Order
...
*   <->[ReverseDeliveryConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReverseDeliveryConnection#field-nodes)
*   {}[ReverseDeliveryEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseDeliveryEdge#field-node)
*   {}[ReverseFulfillmentOrder.reverseDeliveries](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReverseFulfillmentOrder#field-reverseDeliveries)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#queries)Queries
-------------------------------------------------------------------------------------------------------------

[Anchor to reverseDelivery](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#query-reverseDelivery)[reverse Delivery](https://shopify.dev/docs/api/admin-graphql/latest/queries/reverseDelivery)
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------

[Anchor to reverseDeliveryCreateWithShipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#mutation-reverseDeliveryCreateWithShipping)[reverse Delivery Create With Shipping](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reverseDeliveryCreateWithShipping)
...
[Anchor to reverseDeliveryShippingUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#mutation-reverseDeliveryShippingUpdate)[reverse Delivery Shipping Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reverseDeliveryShippingUpdate)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/reversedelivery#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
