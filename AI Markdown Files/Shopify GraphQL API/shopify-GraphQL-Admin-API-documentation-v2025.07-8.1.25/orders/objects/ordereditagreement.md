---
title: "OrderEditAgreement"
description: "Shopify GraphQL Admin API documentation for ordereditagreement"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement

Markdown Content:
OrderEditAgreement - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#interfaces)
...
[Anchor to OrderEditAgreement](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#fields)Fields
-------------------------------------------------------------------------------------------------------------

[Anchor to app](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#field-OrderEditAgreement.fields.app)app
...
[Anchor to happenedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#field-OrderEditAgreement.fields.happenedAt)happened At
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#field-OrderEditAgreement.fields.id)id
...
[Anchor to reason](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#field-OrderEditAgreement.fields.reason)reason
...
[Anchor to sales](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#field-OrderEditAgreement.fields.sales)sales
...
[Anchor to user](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#field-OrderEditAgreement.fields.user)user
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------

[Anchor to SalesAgreement](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordereditagreement#interface-SalesAgreement)[Sales Agreement](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SalesAgreement)
