---
title: "OrderStagedChangeDecrementItem"
description: "Shopify GraphQL Admin API documentation for orderstagedchangedecrementitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangedecrementitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangedecrementitem

Markdown Content:
OrderStagedChangeDecrementItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangedecrementitem#main-content)
...
[Anchor to OrderStagedChangeDecrementItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangedecrementitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangedecrementitem#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to delta](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangedecrementitem#field-OrderStagedChangeDecrementItem.fields.delta)delta
...
[Anchor to lineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangedecrementitem#field-OrderStagedChangeDecrementItem.fields.lineItem)line Item
...
[Anchor to restock](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangedecrementitem#field-OrderStagedChangeDecrementItem.fields.restock)restock
