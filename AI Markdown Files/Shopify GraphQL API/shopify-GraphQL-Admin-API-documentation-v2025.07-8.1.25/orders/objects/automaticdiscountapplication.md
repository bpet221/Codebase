---
title: "AutomaticDiscountApplication"
description: "Shopify GraphQL Admin API documentation for automaticdiscountapplication"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication

Markdown Content:
AutomaticDiscountApplication - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#interfaces)
...
[Anchor to AutomaticDiscountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to allocationMethod](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#field-AutomaticDiscountApplication.fields.allocationMethod)allocation Method
...
[Anchor to index](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#field-AutomaticDiscountApplication.fields.index)index
...
[Anchor to targetSelection](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#field-AutomaticDiscountApplication.fields.targetSelection)target Selection
...
[Anchor to targetType](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#field-AutomaticDiscountApplication.fields.targetType)target Type
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#field-AutomaticDiscountApplication.fields.title)title
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#field-AutomaticDiscountApplication.fields.value)value
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------------------

[Anchor to DiscountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/automaticdiscountapplication#interface-DiscountApplication)[Discount Application](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DiscountApplication)
