---
title: "ProductSale"
description: "Shopify GraphQL Admin API documentation for productsale"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale"
...
Title: ProductSale - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale

Markdown Content:
ProductSale - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#interfaces)
...
[Anchor to ProductSale](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#top)
Product Sale
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to actionType](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.actionType)action Type
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.id)id
...
[Anchor to lineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.lineItem)line Item
...
[Anchor to lineType](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.lineType)line Type
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.quantity)quantity

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The number of units either ordered or intended to be returned.

[Anchor to taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.taxes)taxes
...
[Anchor to totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.totalAmount)total Amount
...
[Anchor to totalDiscountAmountAfterTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.totalDiscountAmountAfterTaxes)total Discount Amount After Taxes
...
[Anchor to totalDiscountAmountBeforeTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.totalDiscountAmountBeforeTaxes)total Discount Amount Before Taxes
...
[Anchor to totalTaxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#field-ProductSale.fields.totalTaxAmount)total Tax Amount
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------

[Anchor to Sale](https://shopify.dev/docs/api/admin-graphql/latest/objects/productsale#interface-Sale)[Sale](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Sale)
