---
title: "SubscriptionDeliveryMethodPickupOption"
description: "Shopify GraphQL Admin API documentation for subscriptiondeliverymethodpickupoption"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption

Markdown Content:
SubscriptionDeliveryMethodPickupOption - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption#main-content)
...
[Anchor to SubscriptionDeliveryMethodPickupOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption#field-SubscriptionDeliveryMethodPickupOption.fields.code)code

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A custom reference to the delivery method for use with automations.

[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption#field-SubscriptionDeliveryMethodPickupOption.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The details displayed to the customer to describe the pickup option.

[Anchor to location](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption#field-SubscriptionDeliveryMethodPickupOption.fields.location)location
...
[Anchor to presentmentTitle](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption#field-SubscriptionDeliveryMethodPickupOption.fields.presentmentTitle)presentment Title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The presentment title of the pickup option.

[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickupoption#field-SubscriptionDeliveryMethodPickupOption.fields.title)title
...
*   {}[SubscriptionDeliveryMethodPickup.pickupOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionDeliveryMethodPickup#field-pickupOption)
