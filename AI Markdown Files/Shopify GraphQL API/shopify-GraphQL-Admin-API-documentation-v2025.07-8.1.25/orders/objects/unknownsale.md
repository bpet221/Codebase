---
title: "UnknownSale"
description: "Shopify GraphQL Admin API documentation for unknownsale"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale

Markdown Content:
UnknownSale - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#interfaces)
...
[Anchor to UnknownSale](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#top)
Unknown Sale
============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#fields)Fields
------------------------------------------------------------------------------------------------------

[Anchor to actionType](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#field-UnknownSale.fields.actionType)action Type
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#field-UnknownSale.fields.id)id
...
[Anchor to lineType](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#field-UnknownSale.fields.lineType)line Type
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#field-UnknownSale.fields.quantity)quantity

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The number of units either ordered or intended to be returned.

[Anchor to taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#field-UnknownSale.fields.taxes)taxes
...
[Anchor to totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#field-UnknownSale.fields.totalAmount)total Amount
...
[Anchor to totalDiscountAmountAfterTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#field-UnknownSale.fields.totalDiscountAmountAfterTaxes)total Discount Amount After Taxes
...
[Anchor to totalDiscountAmountBeforeTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#field-UnknownSale.fields.totalDiscountAmountBeforeTaxes)total Discount Amount Before Taxes
...
[Anchor to totalTaxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#field-UnknownSale.fields.totalTaxAmount)total Tax Amount
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------

[Anchor to Sale](https://shopify.dev/docs/api/admin-graphql/latest/objects/unknownsale#interface-Sale)[Sale](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Sale)
