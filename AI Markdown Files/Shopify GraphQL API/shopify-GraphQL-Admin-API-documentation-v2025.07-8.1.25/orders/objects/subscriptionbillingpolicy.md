---
title: "SubscriptionBillingPolicy"
description: "Shopify GraphQL Admin API documentation for subscriptionbillingpolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy

Markdown Content:
SubscriptionBillingPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy#main-content)
...
[Anchor to SubscriptionBillingPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to anchors](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy#field-SubscriptionBillingPolicy.fields.anchors)anchors
...
[Anchor to interval](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy#field-SubscriptionBillingPolicy.fields.interval)interval
...
[Anchor to intervalCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy#field-SubscriptionBillingPolicy.fields.intervalCount)interval Count
...
[Anchor to maxCycles](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy#field-SubscriptionBillingPolicy.fields.maxCycles)max Cycles

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

Maximum amount of cycles after which the subscription ends.

[Anchor to minCycles](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingpolicy#field-SubscriptionBillingPolicy.fields.minCycles)min Cycles
...
*   {}[SubscriptionContract.billingPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionContract#field-billingPolicy)
*   {}[SubscriptionDraft.billingPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionDraft#field-billingPolicy)
