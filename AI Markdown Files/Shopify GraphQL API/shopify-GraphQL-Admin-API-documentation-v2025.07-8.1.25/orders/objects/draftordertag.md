---
title: "DraftOrderTag"
description: "Shopify GraphQL Admin API documentation for draftordertag"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag

Markdown Content:
DraftOrderTag - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#queries)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#interfaces)
...
[Anchor to DraftOrderTag](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#top)
Draft Order Tag
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to handle](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#field-DraftOrderTag.fields.handle)handle
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#field-DraftOrderTag.fields.id)id
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#field-DraftOrderTag.fields.title)title
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#queries)Queries
-----------------------------------------------------------------------------------------------------------

[Anchor to draftOrderTag](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#query-draftOrderTag)[draft Order Tag](https://shopify.dev/docs/api/admin-graphql/latest/queries/draftOrderTag)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordertag#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
