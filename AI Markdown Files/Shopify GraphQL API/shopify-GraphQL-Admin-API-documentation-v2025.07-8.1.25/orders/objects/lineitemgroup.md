---
title: "LineItemGroup"
description: "Shopify GraphQL Admin API documentation for lineitemgroup"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup

Markdown Content:
LineItemGroup - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#interfaces)
...
[Anchor to LineItemGroup](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#top)
Line Item Group
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to customAttributes](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#field-LineItemGroup.fields.customAttributes)custom Attributes
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#field-LineItemGroup.fields.id)id
...
[Anchor to productId](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#field-LineItemGroup.fields.productId)product Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

ID of the product of the line item group.

[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#field-LineItemGroup.fields.quantity)quantity
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#field-LineItemGroup.fields.title)title
...
[Anchor to variantId](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#field-LineItemGroup.fields.variantId)variant Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

ID of the variant of the line item group.

[Anchor to variantSku](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#field-LineItemGroup.fields.variantSku)variant Sku
...
*   {}[LineItem.lineItemGroup](https://shopify.dev/docs/api/admin-graphql/latest/objects/LineItem#field-lineItemGroup)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemgroup#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
