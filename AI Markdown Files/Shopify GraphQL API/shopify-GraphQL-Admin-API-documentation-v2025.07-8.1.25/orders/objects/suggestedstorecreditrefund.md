---
title: "SuggestedStoreCreditRefund"
description: "Shopify GraphQL Admin API documentation for suggestedstorecreditrefund"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund

Markdown Content:
SuggestedStoreCreditRefund - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#interfaces)
...
[Anchor to SuggestedStoreCreditRefund](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#field-SuggestedStoreCreditRefund.fields.amount)amount
...
[Anchor to expiresAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#field-SuggestedStoreCreditRefund.fields.expiresAt)expires At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

The suggested expiration date for the store credit.

[Anchor to maximumRefundable](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#field-SuggestedStoreCreditRefund.fields.maximumRefundable)maximum Refundable
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to SuggestedRefundMethod](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedstorecreditrefund#interface-SuggestedRefundMethod)[Suggested Refund Method](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SuggestedRefundMethod)
