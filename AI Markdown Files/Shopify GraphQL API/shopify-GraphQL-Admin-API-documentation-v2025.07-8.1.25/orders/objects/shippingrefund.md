...
description: "Shopify GraphQL Admin API documentation for shippingrefund"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund

Markdown Content:
ShippingRefund - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund#main-content)
...
[Anchor to ShippingRefund](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund#top)
Shipping Refund
===============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to amountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund#field-ShippingRefund.fields.amountSet)amount Set
...
[Anchor to maximumRefundableSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund#field-ShippingRefund.fields.maximumRefundableSet)maximum Refundable Set
...
[Anchor to taxSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund#field-ShippingRefund.fields.taxSet)tax Set
...
[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund#field-ShippingRefund.fields.amount)amount

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to maximumRefundable](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund#field-ShippingRefund.fields.maximumRefundable)maximum Refundable

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to tax](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrefund#field-ShippingRefund.fields.tax)tax
...
*   {}[SuggestedRefund.shipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/SuggestedRefund#field-shipping)
*   {}[SuggestedReturnFinancialOutcome.shipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/SuggestedReturnFinancialOutcome#field-shipping)
*   {}[SuggestedReturnRefund.shipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/SuggestedReturnRefund#field-shipping)
