---
title: "SubscriptionDeliveryMethodLocalDeliveryOption"
description: "Shopify GraphQL Admin API documentation for subscriptiondeliverymethodlocaldeliveryoption"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption

Markdown Content:
SubscriptionDeliveryMethodLocalDeliveryOption - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption#main-content)
...
[Anchor to SubscriptionDeliveryMethodLocalDeliveryOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption#fields)Fields
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption#field-SubscriptionDeliveryMethodLocalDeliveryOption.fields.code)code

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A custom reference to the delivery method for use with automations.

[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption#field-SubscriptionDeliveryMethodLocalDeliveryOption.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The details displayed to the customer to describe the local delivery option.

[Anchor to instructions](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption#field-SubscriptionDeliveryMethodLocalDeliveryOption.fields.instructions)instructions

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The delivery instructions that the customer can provide to the merchant.

[Anchor to phone](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption#field-SubscriptionDeliveryMethodLocalDeliveryOption.fields.phone)phone
...
[Anchor to presentmentTitle](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption#field-SubscriptionDeliveryMethodLocalDeliveryOption.fields.presentmentTitle)presentment Title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The presentment title of the local delivery option.

[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodlocaldeliveryoption#field-SubscriptionDeliveryMethodLocalDeliveryOption.fields.title)title
...
*   {}[SubscriptionDeliveryMethodLocalDelivery.localDeliveryOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionDeliveryMethodLocalDelivery#field-localDeliveryOption)
