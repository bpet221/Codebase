---
title: "UnverifiedReturnLineItem"
description: "Shopify GraphQL Admin API documentation for unverifiedreturnlineitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem

Markdown Content:
UnverifiedReturnLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#interfaces)
...
[Anchor to UnverifiedReturnLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to customerNote](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.customerNote)customer Note

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

A note from the customer that describes the item to be returned. Maximum length: 300 characters.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.id)id
...
[Anchor to processableQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.processableQuantity)processable Quantity
...
[Anchor to processedQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.processedQuantity)processed Quantity
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.quantity)quantity
...
[Anchor to refundableQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.refundableQuantity)refundable Quantity
...
[Anchor to refundedQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.refundedQuantity)refunded Quantity
...
[Anchor to returnReason](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.returnReason)return Reason
...
[Anchor to returnReasonNote](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.returnReasonNote)return Reason Note
...
[Anchor to unitPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.unitPrice)unit Price
...
[Anchor to unprocessedQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#field-UnverifiedReturnLineItem.fields.unprocessedQuantity)unprocessed Quantity
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)

•interface

[Anchor to ReturnLineItemType](https://shopify.dev/docs/api/admin-graphql/latest/objects/unverifiedreturnlineitem#interface-ReturnLineItemType)[Return Line Item Type](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/ReturnLineItemType)
