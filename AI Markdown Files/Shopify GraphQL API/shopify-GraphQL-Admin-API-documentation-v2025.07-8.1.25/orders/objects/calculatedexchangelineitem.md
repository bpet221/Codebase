---
title: "CalculatedExchangeLineItem"
description: "Shopify GraphQL Admin API documentation for calculatedexchangelineitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem

Markdown Content:
CalculatedExchangeLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#main-content)
...
[Anchor to CalculatedExchangeLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to calculatedDiscountAllocations](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#field-CalculatedExchangeLineItem.fields.calculatedDiscountAllocations)calculated Discount Allocations
...
[Anchor to discountedUnitPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#field-CalculatedExchangeLineItem.fields.discountedUnitPriceSet)discounted Unit Price Set
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#field-CalculatedExchangeLineItem.fields.id)id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A globally-unique ID.

[Anchor to originalUnitPriceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#field-CalculatedExchangeLineItem.fields.originalUnitPriceSet)original Unit Price Set
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#field-CalculatedExchangeLineItem.fields.quantity)quantity
...
[Anchor to subtotalSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#field-CalculatedExchangeLineItem.fields.subtotalSet)subtotal Set
...
[Anchor to totalTaxSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#field-CalculatedExchangeLineItem.fields.totalTaxSet)total Tax Set
...
[Anchor to variant](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedexchangelineitem#field-CalculatedExchangeLineItem.fields.variant)variant
...
*   {}[CalculatedReturn.exchangeLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedReturn#field-exchangeLineItems)
