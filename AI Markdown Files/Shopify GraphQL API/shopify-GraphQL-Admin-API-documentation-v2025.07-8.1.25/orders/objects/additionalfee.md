---
title: "AdditionalFee"
description: "Shopify GraphQL Admin API documentation for additionalfee"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee

Markdown Content:
AdditionalFee - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#interfaces)
...
[Anchor to AdditionalFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#top)
Additional Fee
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#field-AdditionalFee.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#field-AdditionalFee.fields.name)name
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#field-AdditionalFee.fields.price)price
...
[Anchor to taxLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#field-AdditionalFee.fields.taxLines)tax Lines
...
*   {}[Order.additionalFees](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-additionalFees)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfee#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
