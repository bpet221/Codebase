...
description: "Shopify GraphQL Admin API documentation for exchangelineitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem

Markdown Content:
ExchangeLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#interfaces)
...
[Anchor to ExchangeLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#top)
Exchange Line Item
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#field-ExchangeLineItem.fields.id)id
...
[Anchor to lineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#field-ExchangeLineItem.fields.lineItems)line Items
...
[Anchor to processableQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#field-ExchangeLineItem.fields.processableQuantity)processable Quantity
...
[Anchor to processedQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#field-ExchangeLineItem.fields.processedQuantity)processed Quantity
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#field-ExchangeLineItem.fields.quantity)quantity
...
[Anchor to unprocessedQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#field-ExchangeLineItem.fields.unprocessedQuantity)unprocessed Quantity
...
[Anchor to variantId](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#field-ExchangeLineItem.fields.variantId)variant Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the variant at time of return creation.

[Anchor to lineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#field-ExchangeLineItem.fields.lineItem)line Item
...
*   <->[ExchangeLineItemConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ExchangeLineItemConnection#field-nodes)
*   {}[ExchangeLineItemEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ExchangeLineItemEdge#field-node)
*   {}[Return.exchangeLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/Return#field-exchangeLineItems)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/exchangelineitem#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
