---
title: "DiscountCodeApplication"
description: "Shopify GraphQL Admin API documentation for discountcodeapplication"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication

Markdown Content:
DiscountCodeApplication - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#interfaces)
...
[Anchor to DiscountCodeApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to allocationMethod](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#field-DiscountCodeApplication.fields.allocationMethod)allocation Method
...
[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#field-DiscountCodeApplication.fields.code)code
...
[Anchor to index](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#field-DiscountCodeApplication.fields.index)index
...
[Anchor to targetSelection](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#field-DiscountCodeApplication.fields.targetSelection)target Selection
...
[Anchor to targetType](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#field-DiscountCodeApplication.fields.targetType)target Type
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#field-DiscountCodeApplication.fields.value)value
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------

[Anchor to DiscountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/discountcodeapplication#interface-DiscountApplication)[Discount Application](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DiscountApplication)
