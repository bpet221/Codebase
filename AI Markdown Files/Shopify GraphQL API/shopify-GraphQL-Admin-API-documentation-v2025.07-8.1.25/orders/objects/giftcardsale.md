---
title: "GiftCardSale"
description: "Shopify GraphQL Admin API documentation for giftcardsale"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale"
...
Title: GiftCardSale - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale

Markdown Content:
GiftCardSale - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#interfaces)
...
[Anchor to GiftCardSale](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#top)
Gift Card Sale
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to actionType](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.actionType)action Type
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.id)id
...
[Anchor to lineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.lineItem)line Item
...
[Anchor to lineType](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.lineType)line Type
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.quantity)quantity

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The number of units either ordered or intended to be returned.

[Anchor to taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.taxes)taxes
...
[Anchor to totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.totalAmount)total Amount
...
[Anchor to totalDiscountAmountAfterTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.totalDiscountAmountAfterTaxes)total Discount Amount After Taxes
...
[Anchor to totalDiscountAmountBeforeTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.totalDiscountAmountBeforeTaxes)total Discount Amount Before Taxes
...
[Anchor to totalTaxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#field-GiftCardSale.fields.totalTaxAmount)total Tax Amount
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------

[Anchor to Sale](https://shopify.dev/docs/api/admin-graphql/latest/objects/giftcardsale#interface-Sale)[Sale](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Sale)
