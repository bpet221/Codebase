---
title: "TenderTransactionCreditCardDetails"
description: "Shopify GraphQL Admin API documentation for tendertransactioncreditcarddetails"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactioncreditcarddetails"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactioncreditcarddetails

Markdown Content:
TenderTransactionCreditCardDetails - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactioncreditcarddetails#main-content)
...
[Anchor to TenderTransactionCreditCardDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactioncreditcarddetails#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactioncreditcarddetails#fields)Fields
-----------------------------------------------------------------------------------------------------------------------------

[Anchor to creditCardCompany](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactioncreditcarddetails#field-TenderTransactionCreditCardDetails.fields.creditCardCompany)credit Card Company

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The name of the company that issued the customer's credit card. Example: `Visa`.

[Anchor to creditCardNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransactioncreditcarddetails#field-TenderTransactionCreditCardDetails.fields.creditCardNumber)credit Card Number
