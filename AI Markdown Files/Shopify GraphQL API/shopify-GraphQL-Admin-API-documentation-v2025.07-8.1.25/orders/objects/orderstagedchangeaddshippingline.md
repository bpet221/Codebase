---
title: "OrderStagedChangeAddShippingLine"
description: "Shopify GraphQL Admin API documentation for orderstagedchangeaddshippingline"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddshippingline"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddshippingline

Markdown Content:
OrderStagedChangeAddShippingLine - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddshippingline#main-content)
...
[Anchor to OrderStagedChangeAddShippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddshippingline#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddshippingline#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to phone](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddshippingline#field-OrderStagedChangeAddShippingLine.fields.phone)phone

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The phone number at the shipping address.

[Anchor to presentmentTitle](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddshippingline#field-OrderStagedChangeAddShippingLine.fields.presentmentTitle)presentment Title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The shipping line's title that's shown to the buyer.

[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddshippingline#field-OrderStagedChangeAddShippingLine.fields.price)price
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddshippingline#field-OrderStagedChangeAddShippingLine.fields.title)title
