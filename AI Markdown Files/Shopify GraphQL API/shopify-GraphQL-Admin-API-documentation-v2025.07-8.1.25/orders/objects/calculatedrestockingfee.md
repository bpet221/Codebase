---
title: "CalculatedRestockingFee"
description: "Shopify GraphQL Admin API documentation for calculatedrestockingfee"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee

Markdown Content:
CalculatedRestockingFee - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#interfaces)
...
[Anchor to CalculatedRestockingFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#fields)Fields
------------------------------------------------------------------------------------------------------------------

[Anchor to amountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#field-CalculatedRestockingFee.fields.amountSet)amount Set
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#field-CalculatedRestockingFee.fields.id)id
...
[Anchor to percentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#field-CalculatedRestockingFee.fields.percentage)percentage
...
*   {}[CalculatedReturnLineItem.restockingFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedReturnLineItem#field-restockingFee)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------

[Anchor to CalculatedReturnFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedrestockingfee#interface-CalculatedReturnFee)[Calculated Return Fee](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/CalculatedReturnFee)
