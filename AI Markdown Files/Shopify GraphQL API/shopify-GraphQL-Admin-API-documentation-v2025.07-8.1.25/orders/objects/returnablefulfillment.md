...
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment

Markdown Content:
ReturnableFulfillment - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#queries)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#interfaces)
...
[Anchor to ReturnableFulfillment](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to fulfillment](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#field-ReturnableFulfillment.fields.fulfillment)fulfillment
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#field-ReturnableFulfillment.fields.id)id
...
[Anchor to returnableFulfillmentLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#field-ReturnableFulfillment.fields.returnableFulfillmentLineItems)returnable Fulfillment Line Items
...
*   <->[ReturnableFulfillmentConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReturnableFulfillmentConnection#field-nodes)
*   {}[ReturnableFulfillmentEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReturnableFulfillmentEdge#field-node)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#queries)Queries
-------------------------------------------------------------------------------------------------------------------

[Anchor to returnableFulfillment](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#query-returnableFulfillment)[returnable Fulfillment](https://shopify.dev/docs/api/admin-graphql/latest/queries/returnableFulfillment)
...
[Anchor to returnableFulfillments](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#query-returnableFulfillments)[returnable Fulfillments](https://shopify.dev/docs/api/admin-graphql/latest/queries/returnableFulfillments)
...
*   <?>[returnable Fulfillments](https://shopify.dev/docs/api/admin-graphql/latest/queries/ReturnableFulfillmentConnection)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/returnablefulfillment#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
