...
description: "Shopify GraphQL Admin API documentation for refundlineitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem

Markdown Content:
RefundLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#main-content)
...
[Anchor to RefundLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#top)
Refund Line Item
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#fields)Fields
---------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.id)id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A globally-unique ID.

[Anchor to lineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.lineItem)line Item
...
[Anchor to location](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.location)location
...
[Anchor to priceSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.priceSet)price Set
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.quantity)quantity
...
[Anchor to restocked](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.restocked)restocked
...
[Anchor to restockType](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.restockType)restock Type
...
[Anchor to subtotalSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.subtotalSet)subtotal Set
...
[Anchor to totalTaxSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.totalTaxSet)total Tax Set
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.price)price

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to subtotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.subtotal)subtotal

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to totalTax](https://shopify.dev/docs/api/admin-graphql/latest/objects/refundlineitem#field-RefundLineItem.fields.totalTax)total Tax
...
*   {}[Refund.refundLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/Refund#field-refundLineItems)
*   <->[RefundLineItemConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/RefundLineItemConnection#field-nodes)
*   {}[RefundLineItemEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/RefundLineItemEdge#field-node)
*   {}[SuggestedRefund.refundLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/SuggestedRefund#field-refundLineItems)
