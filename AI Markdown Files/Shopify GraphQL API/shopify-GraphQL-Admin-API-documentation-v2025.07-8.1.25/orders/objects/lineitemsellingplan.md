---
title: "LineItemSellingPlan"
description: "Shopify GraphQL Admin API documentation for lineitemsellingplan"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemsellingplan"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemsellingplan

Markdown Content:
LineItemSellingPlan - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemsellingplan#main-content)
...
[Anchor to LineItemSellingPlan](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemsellingplan#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemsellingplan#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemsellingplan#field-LineItemSellingPlan.fields.name)name
...
[Anchor to sellingPlanId](https://shopify.dev/docs/api/admin-graphql/latest/objects/lineitemsellingplan#field-LineItemSellingPlan.fields.sellingPlanId)selling Plan Id
...
*   {}[LineItem.sellingPlan](https://shopify.dev/docs/api/admin-graphql/latest/objects/LineItem#field-sellingPlan)
