---
title: "ShopPayInstallmentsPaymentDetails"
description: "Shopify GraphQL Admin API documentation for shoppayinstallmentspaymentdetails"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails

Markdown Content:
ShopPayInstallmentsPaymentDetails - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails#interfaces)
...
[Anchor to ShopPayInstallmentsPaymentDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to paymentMethodName](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails#field-ShopPayInstallmentsPaymentDetails.fields.paymentMethodName)payment Method Name
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to BasePaymentDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/shoppayinstallmentspaymentdetails#interface-BasePaymentDetails)[Base Payment Details](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/BasePaymentDetails)
