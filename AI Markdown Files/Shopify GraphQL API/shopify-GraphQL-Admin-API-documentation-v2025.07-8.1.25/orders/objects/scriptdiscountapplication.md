---
title: "ScriptDiscountApplication"
description: "Shopify GraphQL Admin API documentation for scriptdiscountapplication"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication

Markdown Content:
ScriptDiscountApplication - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#interfaces)
...
[Anchor to ScriptDiscountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to allocationMethod](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#field-ScriptDiscountApplication.fields.allocationMethod)allocation Method
...
[Anchor to index](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#field-ScriptDiscountApplication.fields.index)index
...
[Anchor to targetSelection](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#field-ScriptDiscountApplication.fields.targetSelection)target Selection
...
[Anchor to targetType](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#field-ScriptDiscountApplication.fields.targetType)target Type
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#field-ScriptDiscountApplication.fields.title)title
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#field-ScriptDiscountApplication.fields.value)value
...
[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#field-ScriptDiscountApplication.fields.description)description
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------------

[Anchor to DiscountApplication](https://shopify.dev/docs/api/admin-graphql/latest/objects/scriptdiscountapplication#interface-DiscountApplication)[Discount Application](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DiscountApplication)
