---
title: "SubscriptionCyclePriceAdjustment"
description: "Shopify GraphQL Admin API documentation for subscriptioncyclepriceadjustment"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncyclepriceadjustment"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncyclepriceadjustment

Markdown Content:
SubscriptionCyclePriceAdjustment - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncyclepriceadjustment#main-content)
...
[Anchor to SubscriptionCyclePriceAdjustment](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncyclepriceadjustment#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncyclepriceadjustment#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to adjustmentType](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncyclepriceadjustment#field-SubscriptionCyclePriceAdjustment.fields.adjustmentType)adjustment Type
...
[Anchor to adjustmentValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncyclepriceadjustment#field-SubscriptionCyclePriceAdjustment.fields.adjustmentValue)adjustment Value
...
[Anchor to afterCycle](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncyclepriceadjustment#field-SubscriptionCyclePriceAdjustment.fields.afterCycle)after Cycle
...
[Anchor to computedPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptioncyclepriceadjustment#field-SubscriptionCyclePriceAdjustment.fields.computedPrice)computed Price
...
*   {}[SubscriptionPricingPolicy.cycleDiscounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionPricingPolicy#field-cycleDiscounts)
