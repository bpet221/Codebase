...
description: "Shopify GraphQL Admin API documentation for suggestedrefund"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund

Markdown Content:
SuggestedRefund - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#main-content)
...
[Anchor to SuggestedRefund](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#top)
Suggested Refund
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to amountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.amountSet)amount Set
...
[Anchor to discountedSubtotalSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.discountedSubtotalSet)discounted Subtotal Set
...
[Anchor to maximumRefundableSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.maximumRefundableSet)maximum Refundable Set
...
[Anchor to refundDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.refundDuties)refund Duties
...
[Anchor to refundLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.refundLineItems)refund Line Items
...
[Anchor to shipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.shipping)shipping
...
[Anchor to subtotalSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.subtotalSet)subtotal Set
...
[Anchor to suggestedRefundMethods](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.suggestedRefundMethods)suggested Refund Methods
...
[Anchor to suggestedTransactions](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.suggestedTransactions)suggested Transactions
...
[Anchor to totalCartDiscountAmountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.totalCartDiscountAmountSet)total Cart Discount Amount Set
...
[Anchor to totalDutiesSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.totalDutiesSet)total Duties Set
...
[Anchor to totalTaxSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.totalTaxSet)total Tax Set
...
[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.amount)amount

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to maximumRefundable](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.maximumRefundable)maximum Refundable

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to subtotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.subtotal)subtotal

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to totalTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedrefund#field-SuggestedRefund.fields.totalTaxes)total Taxes
...
*   {}[Order.suggestedRefund](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-suggestedRefund)
