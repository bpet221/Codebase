---
title: "SubscriptionLocalDeliveryOption"
description: "Shopify GraphQL Admin API documentation for subscriptionlocaldeliveryoption"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption

Markdown Content:
SubscriptionLocalDeliveryOption - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption#main-content)
...
[Anchor to SubscriptionLocalDeliveryOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption#field-SubscriptionLocalDeliveryOption.fields.code)code
...
[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption#field-SubscriptionLocalDeliveryOption.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The description of the local delivery option.

[Anchor to phoneRequired](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption#field-SubscriptionLocalDeliveryOption.fields.phoneRequired)phone Required
...
[Anchor to presentmentTitle](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption#field-SubscriptionLocalDeliveryOption.fields.presentmentTitle)presentment Title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The presentment title of the local delivery option.

[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption#field-SubscriptionLocalDeliveryOption.fields.price)price
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionlocaldeliveryoption#field-SubscriptionLocalDeliveryOption.fields.title)title
