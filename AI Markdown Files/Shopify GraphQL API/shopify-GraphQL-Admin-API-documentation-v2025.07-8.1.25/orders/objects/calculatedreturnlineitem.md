...
description: "Shopify GraphQL Admin API documentation for calculatedreturnlineitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem

Markdown Content:
CalculatedReturnLineItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#main-content)
...
[Anchor to CalculatedReturnLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to fulfillmentLineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#field-CalculatedReturnLineItem.fields.fulfillmentLineItem)fulfillment Line Item
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#field-CalculatedReturnLineItem.fields.id)id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A globally-unique ID.

[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#field-CalculatedReturnLineItem.fields.quantity)quantity
...
[Anchor to restockingFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#field-CalculatedReturnLineItem.fields.restockingFee)restocking Fee
...
[Anchor to subtotalBeforeOrderDiscountsSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#field-CalculatedReturnLineItem.fields.subtotalBeforeOrderDiscountsSet)subtotal Before Order Discounts Set
...
[Anchor to subtotalSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#field-CalculatedReturnLineItem.fields.subtotalSet)subtotal Set
...
[Anchor to totalTaxSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedreturnlineitem#field-CalculatedReturnLineItem.fields.totalTaxSet)total Tax Set
...
*   {}[CalculatedReturn.returnLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedReturn#field-returnLineItems)
