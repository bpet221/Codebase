---
title: "SubscriptionBillingCycleEditedContract"
description: "Shopify GraphQL Admin API documentation for subscriptionbillingcycleeditedcontract"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract

Markdown Content:
SubscriptionBillingCycleEditedContract - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#interfaces)
...
[Anchor to SubscriptionBillingCycleEditedContract](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------

[Anchor to app](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.app)app
...
[Anchor to appAdminUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.appAdminUrl)app Admin Url

•[URL](https://shopify.dev/docs/api/admin-graphql/latest/scalars/URL)

The URL of the subscription contract page on the subscription app.

[Anchor to billingCycles](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.billingCycles)billing Cycles
...
[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.createdAt)created At
...
[Anchor to currencyCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.currencyCode)currency Code
...
[Anchor to customAttributes](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.customAttributes)custom Attributes
...
[Anchor to customer](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.customer)customer
...
[Anchor to customerPaymentMethod](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.customerPaymentMethod)customer Payment Method
...
[Anchor to deliveryMethod](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.deliveryMethod)delivery Method
...
[Anchor to deliveryPrice](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.deliveryPrice)delivery Price
...
[Anchor to discounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.discounts)discounts
...
[Anchor to lines](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.lines)lines
...
[Anchor to linesCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.linesCount)lines Count
...
[Anchor to note](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.note)note

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The note field that will be applied to the generated orders.

[Anchor to orders](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.orders)orders
...
[Anchor to updatedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.updatedAt)updated At
...
[Anchor to lineCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#field-SubscriptionBillingCycleEditedContract.fields.lineCount)line Count
...
*   {}[SubscriptionBillingCycle.editedContract](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionBillingCycle#field-editedContract)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to subscriptionBillingCycleContractDraftCommit](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#mutation-subscriptionBillingCycleContractDraftCommit)[subscription Billing Cycle Contract Draft Commit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionBillingCycleContractDraftCommit)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to SubscriptionContractBase](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingcycleeditedcontract#interface-SubscriptionContractBase)[Subscription Contract Base](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SubscriptionContractBase)
