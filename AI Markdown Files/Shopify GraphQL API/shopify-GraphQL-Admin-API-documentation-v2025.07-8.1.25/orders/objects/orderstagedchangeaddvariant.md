...
description: "Shopify GraphQL Admin API documentation for orderstagedchangeaddvariant"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddvariant"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddvariant

Markdown Content:
OrderStagedChangeAddVariant - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddvariant#main-content)
...
[Anchor to OrderStagedChangeAddVariant](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddvariant#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddvariant#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddvariant#field-OrderStagedChangeAddVariant.fields.quantity)quantity
...
[Anchor to variant](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeaddvariant#field-OrderStagedChangeAddVariant.fields.variant)variant
