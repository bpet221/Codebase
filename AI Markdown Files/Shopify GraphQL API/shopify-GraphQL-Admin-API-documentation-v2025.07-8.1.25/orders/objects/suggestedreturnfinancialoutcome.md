---
title: "SuggestedReturnFinancialOutcome"
description: "Shopify GraphQL Admin API documentation for suggestedreturnfinancialoutcome"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome

Markdown Content:
SuggestedReturnFinancialOutcome - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#main-content)
...
[Anchor to SuggestedReturnFinancialOutcome](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to discountedSubtotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#field-SuggestedReturnFinancialOutcome.fields.discountedSubtotal)discounted Subtotal
...
[Anchor to financialTransfer](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#field-SuggestedReturnFinancialOutcome.fields.financialTransfer)financial Transfer
...
[Anchor to maximumRefundable](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#field-SuggestedReturnFinancialOutcome.fields.maximumRefundable)maximum Refundable
...
[Anchor to refundDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#field-SuggestedReturnFinancialOutcome.fields.refundDuties)refund Duties
...
[Anchor to shipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#field-SuggestedReturnFinancialOutcome.fields.shipping)shipping
...
[Anchor to totalAdditionalFees](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#field-SuggestedReturnFinancialOutcome.fields.totalAdditionalFees)total Additional Fees
...
[Anchor to totalCartDiscountAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#field-SuggestedReturnFinancialOutcome.fields.totalCartDiscountAmount)total Cart Discount Amount
...
[Anchor to totalDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#field-SuggestedReturnFinancialOutcome.fields.totalDuties)total Duties
...
[Anchor to totalTax](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnfinancialoutcome#field-SuggestedReturnFinancialOutcome.fields.totalTax)total Tax
...
*   {}[Return.suggestedFinancialOutcome](https://shopify.dev/docs/api/admin-graphql/latest/objects/Return#field-suggestedFinancialOutcome)
