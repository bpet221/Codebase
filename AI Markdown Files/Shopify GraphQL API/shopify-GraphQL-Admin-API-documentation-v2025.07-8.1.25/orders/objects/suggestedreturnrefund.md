---
title: "SuggestedReturnRefund"
description: "Shopify GraphQL Admin API documentation for suggestedreturnrefund"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund

Markdown Content:
SuggestedReturnRefund - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#main-content)
...
[Anchor to SuggestedReturnRefund](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.amount)amount
...
[Anchor to discountedSubtotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.discountedSubtotal)discounted Subtotal
...
[Anchor to maximumRefundable](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.maximumRefundable)maximum Refundable
...
[Anchor to refundDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.refundDuties)refund Duties
...
[Anchor to shipping](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.shipping)shipping
...
[Anchor to subtotal](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.subtotal)subtotal
...
[Anchor to suggestedTransactions](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.suggestedTransactions)suggested Transactions
...
[Anchor to totalCartDiscountAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.totalCartDiscountAmount)total Cart Discount Amount
...
[Anchor to totalDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.totalDuties)total Duties
...
[Anchor to totalTax](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedreturnrefund#field-SuggestedReturnRefund.fields.totalTax)total Tax
