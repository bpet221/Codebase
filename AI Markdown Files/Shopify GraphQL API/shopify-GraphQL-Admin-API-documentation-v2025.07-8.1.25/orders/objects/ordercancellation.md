...
description: "Shopify GraphQL Admin API documentation for ordercancellation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancellation"
...
Title: OrderCancellation - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancellation

Markdown Content:
OrderCancellation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancellation#main-content)
...
[Anchor to OrderCancellation](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancellation#top)
Order Cancellation
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancellation#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to staffNote](https://shopify.dev/docs/api/admin-graphql/latest/objects/ordercancellation#field-OrderCancellation.fields.staffNote)staff Note
...
*   {}[Order.cancellation](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-cancellation)
