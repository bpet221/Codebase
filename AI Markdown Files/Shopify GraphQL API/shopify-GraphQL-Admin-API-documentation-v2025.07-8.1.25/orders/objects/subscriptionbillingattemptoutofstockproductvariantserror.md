...
description: "Shopify GraphQL Admin API documentation for subscriptionbillingattemptoutofstockproductvariantserror"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror

Markdown Content:
SubscriptionBillingAttemptOutOfStockProductVariantsError - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror#interfaces)
...
[Anchor to SubscriptionBillingAttemptOutOfStockProductVariantsError](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror#fields)Fields
---------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror#field-SubscriptionBillingAttemptOutOfStockProductVariantsError.fields.code)code
...
[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror#field-SubscriptionBillingAttemptOutOfStockProductVariantsError.fields.message)message
...
[Anchor to outOfStockProductVariants](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror#field-SubscriptionBillingAttemptOutOfStockProductVariantsError.fields.outOfStockProductVariants)out Of Stock Product Variants
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionbillingattemptoutofstockproductvariantserror#interfaces)Interfaces
---------------------------------------------------------------------------------------------------------------------------------------------------------------
