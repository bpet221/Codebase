---
title: "InvoiceReturnOutcome"
description: "Shopify GraphQL Admin API documentation for invoicereturnoutcome"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/invoicereturnoutcome"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/invoicereturnoutcome

Markdown Content:
InvoiceReturnOutcome - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/invoicereturnoutcome#main-content)
...
[Anchor to InvoiceReturnOutcome](https://shopify.dev/docs/api/admin-graphql/latest/objects/invoicereturnoutcome#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/invoicereturnoutcome#fields)Fields
---------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/invoicereturnoutcome#field-InvoiceReturnOutcome.fields.amount)amount
