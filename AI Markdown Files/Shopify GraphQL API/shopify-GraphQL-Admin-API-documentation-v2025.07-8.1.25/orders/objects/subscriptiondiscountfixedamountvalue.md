---
title: "SubscriptionDiscountFixedAmountValue"
description: "Shopify GraphQL Admin API documentation for subscriptiondiscountfixedamountvalue"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountfixedamountvalue"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountfixedamountvalue

Markdown Content:
SubscriptionDiscountFixedAmountValue - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountfixedamountvalue#main-content)
...
[Anchor to SubscriptionDiscountFixedAmountValue](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountfixedamountvalue#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountfixedamountvalue#fields)Fields
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountfixedamountvalue#field-SubscriptionDiscountFixedAmountValue.fields.amount)amount
...
[Anchor to appliesOnEachItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondiscountfixedamountvalue#field-SubscriptionDiscountFixedAmountValue.fields.appliesOnEachItem)applies On Each Item
