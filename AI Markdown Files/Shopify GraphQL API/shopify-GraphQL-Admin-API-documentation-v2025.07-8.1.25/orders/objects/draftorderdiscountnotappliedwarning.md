---
title: "DraftOrderDiscountNotAppliedWarning"
description: "Shopify GraphQL Admin API documentation for draftorderdiscountnotappliedwarning"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning

Markdown Content:
DraftOrderDiscountNotAppliedWarning - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#interfaces)
...
[Anchor to DraftOrderDiscountNotAppliedWarning](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to discountCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#field-DraftOrderDiscountNotAppliedWarning.fields.discountCode)discount Code

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The code of the discount that can't be applied.

[Anchor to discountTitle](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#field-DraftOrderDiscountNotAppliedWarning.fields.discountTitle)discount Title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The title of the discount that can't be applied.

[Anchor to errorCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#field-DraftOrderDiscountNotAppliedWarning.fields.errorCode)error Code
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#field-DraftOrderDiscountNotAppliedWarning.fields.field)field
...
[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#field-DraftOrderDiscountNotAppliedWarning.fields.message)message
...
[Anchor to priceRule](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#field-DraftOrderDiscountNotAppliedWarning.fields.priceRule)price Rule
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DraftOrderWarning](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderdiscountnotappliedwarning#interface-DraftOrderWarning)[Draft Order Warning](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/DraftOrderWarning)
