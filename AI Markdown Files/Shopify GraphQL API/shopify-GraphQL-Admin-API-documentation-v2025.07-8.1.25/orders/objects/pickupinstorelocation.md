---
title: "PickupInStoreLocation"
description: "Shopify GraphQL Admin API documentation for pickupinstorelocation"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation

Markdown Content:
PickupInStoreLocation - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#main-content)
...
[Anchor to PickupInStoreLocation](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#field-PickupInStoreLocation.fields.code)code
...
[Anchor to distanceFromBuyer](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#field-PickupInStoreLocation.fields.distanceFromBuyer)distance From Buyer
...
[Anchor to handle](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#field-PickupInStoreLocation.fields.handle)handle
...
[Anchor to instructions](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#field-PickupInStoreLocation.fields.instructions)instructions
...
[Anchor to locationId](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#field-PickupInStoreLocation.fields.locationId)location Id
...
[Anchor to source](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#field-PickupInStoreLocation.fields.source)source
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/pickupinstorelocation#field-PickupInStoreLocation.fields.title)title
...
*   {}[DraftOrderAvailableDeliveryOptions.availableLocalPickupOptions](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrderAvailableDeliveryOptions#field-availableLocalPickupOptions)
