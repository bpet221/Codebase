---
title: "RestockingFee"
description: "Shopify GraphQL Admin API documentation for restockingfee"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee

Markdown Content:
RestockingFee - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#interfaces)
...
[Anchor to RestockingFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#top)
Restocking Fee
==============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#fields)Fields
--------------------------------------------------------------------------------------------------------

[Anchor to amountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#field-RestockingFee.fields.amountSet)amount Set
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#field-RestockingFee.fields.id)id
...
[Anchor to percentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#field-RestockingFee.fields.percentage)percentage
...
*   {}[ReturnLineItem.restockingFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReturnLineItem#field-restockingFee)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------

[Anchor to Fee](https://shopify.dev/docs/api/admin-graphql/latest/objects/restockingfee#interface-Fee)[Fee](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Fee)
