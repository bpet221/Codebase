...
description: "Shopify GraphQL Admin API documentation for tendertransaction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction

Markdown Content:
TenderTransaction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#queries)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#interfaces)
...
[Anchor to TenderTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#top)
Tender Transaction
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#field-TenderTransaction.fields.amount)amount
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#field-TenderTransaction.fields.id)id
...
[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#field-TenderTransaction.fields.order)order
...
[Anchor to paymentMethod](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#field-TenderTransaction.fields.paymentMethod)payment Method

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

Information about the payment method used for the transaction.

[Anchor to processedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#field-TenderTransaction.fields.processedAt)processed At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

Date and time when the transaction was processed.

[Anchor to remoteReference](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#field-TenderTransaction.fields.remoteReference)remote Reference

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The remote gateway reference associated with the tender transaction.

[Anchor to test](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#field-TenderTransaction.fields.test)test
...
[Anchor to transactionDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#field-TenderTransaction.fields.transactionDetails)transaction Details
...
[Anchor to user](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#field-TenderTransaction.fields.user)user
...
*   <->[TenderTransactionConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/TenderTransactionConnection#field-nodes)
*   {}[TenderTransactionEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/TenderTransactionEdge#field-node)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#queries)Queries
---------------------------------------------------------------------------------------------------------------

[Anchor to tenderTransactions](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#query-tenderTransactions)[tender Transactions](https://shopify.dev/docs/api/admin-graphql/latest/queries/tenderTransactions)
...
*   <?>[tender Transactions](https://shopify.dev/docs/api/admin-graphql/latest/queries/TenderTransactionConnection)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/tendertransaction#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
