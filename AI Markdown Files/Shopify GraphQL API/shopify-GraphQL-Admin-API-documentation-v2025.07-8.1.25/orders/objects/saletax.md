---
title: "SaleTax"
description: "Shopify GraphQL Admin API documentation for saletax"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/saletax"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/saletax

Markdown Content:
SaleTax - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/saletax#main-content)
...
[Anchor to SaleTax](https://shopify.dev/docs/api/admin-graphql/latest/objects/saletax#top)
Sale Tax
========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/saletax#fields)Fields
--------------------------------------------------------------------------------------------------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/saletax#field-SaleTax.fields.amount)amount
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/saletax#field-SaleTax.fields.id)id
...
[Anchor to taxLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/saletax#field-SaleTax.fields.taxLine)tax Line
...
*   {}[AdditionalFeeSale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdditionalFeeSale#field-taxes)
*   {}[AdjustmentSale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/AdjustmentSale#field-taxes)
*   {}[DutySale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/DutySale#field-taxes)
*   {}[FeeSale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/FeeSale#field-taxes)
*   {}[GiftCardSale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/GiftCardSale#field-taxes)
*   {}[ProductSale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/ProductSale#field-taxes)
*   ||-[Sale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Sale#field-taxes)
*   {}[ShippingLineSale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/ShippingLineSale#field-taxes)
*   {}[TipSale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/TipSale#field-taxes)
*   {}[UnknownSale.taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/UnknownSale#field-taxes)
