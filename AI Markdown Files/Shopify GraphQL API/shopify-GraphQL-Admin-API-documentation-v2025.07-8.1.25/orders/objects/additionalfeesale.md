---
title: "AdditionalFeeSale"
description: "Shopify GraphQL Admin API documentation for additionalfeesale"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale

Markdown Content:
AdditionalFeeSale - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#interfaces)
...
[Anchor to AdditionalFeeSale](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#top)
Additional Fee Sale
===================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to actionType](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.actionType)action Type
...
[Anchor to additionalFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.additionalFee)additional Fee
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.id)id
...
[Anchor to lineType](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.lineType)line Type
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.quantity)quantity

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The number of units either ordered or intended to be returned.

[Anchor to taxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.taxes)taxes
...
[Anchor to totalAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.totalAmount)total Amount
...
[Anchor to totalDiscountAmountAfterTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.totalDiscountAmountAfterTaxes)total Discount Amount After Taxes
...
[Anchor to totalDiscountAmountBeforeTaxes](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.totalDiscountAmountBeforeTaxes)total Discount Amount Before Taxes
...
[Anchor to totalTaxAmount](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#field-AdditionalFeeSale.fields.totalTaxAmount)total Tax Amount
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to Sale](https://shopify.dev/docs/api/admin-graphql/latest/objects/additionalfeesale#interface-Sale)[Sale](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Sale)
