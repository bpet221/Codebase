---
title: "SubscriptionPickupOption"
description: "Shopify GraphQL Admin API documentation for subscriptionpickupoption"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption

Markdown Content:
SubscriptionPickupOption - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#main-content)
...
[Anchor to SubscriptionPickupOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#field-SubscriptionPickupOption.fields.code)code
...
[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#field-SubscriptionPickupOption.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The description of the pickup option.

[Anchor to location](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#field-SubscriptionPickupOption.fields.location)location
...
[Anchor to phoneRequired](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#field-SubscriptionPickupOption.fields.phoneRequired)phone Required
...
[Anchor to pickupTime](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#field-SubscriptionPickupOption.fields.pickupTime)pickup Time
...
[Anchor to presentmentTitle](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#field-SubscriptionPickupOption.fields.presentmentTitle)presentment Title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The presentment title of the pickup option.

[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#field-SubscriptionPickupOption.fields.price)price
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionpickupoption#field-SubscriptionPickupOption.fields.title)title
