---
title: "ShopifyProtectOrderSummary"
description: "Shopify GraphQL Admin API documentation for shopifyprotectordersummary"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordersummary"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordersummary

Markdown Content:
ShopifyProtectOrderSummary - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordersummary#main-content)
...
[Anchor to ShopifyProtectOrderSummary](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordersummary#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordersummary#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to eligibility](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordersummary#field-ShopifyProtectOrderSummary.fields.eligibility)eligibility
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/shopifyprotectordersummary#field-ShopifyProtectOrderSummary.fields.status)status
...
*   {}[Order.shopifyProtect](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-shopifyProtect)
