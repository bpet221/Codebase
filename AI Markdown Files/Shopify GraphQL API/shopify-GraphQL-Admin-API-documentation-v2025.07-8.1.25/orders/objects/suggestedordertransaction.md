---
title: "SuggestedOrderTransaction"
description: "Shopify GraphQL Admin API documentation for suggestedordertransaction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction

Markdown Content:
SuggestedOrderTransaction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#main-content)
...
[Anchor to SuggestedOrderTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to accountNumber](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.accountNumber)account Number

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The masked account number associated with the payment method.

[Anchor to amountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.amountSet)amount Set
...
[Anchor to formattedGateway](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.formattedGateway)formatted Gateway

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The human-readable payment gateway name suggested to process the transaction.

[Anchor to gateway](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.gateway)gateway

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The suggested payment gateway used to process the transaction.

[Anchor to kind](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.kind)kind
...
[Anchor to maximumRefundableSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.maximumRefundableSet)maximum Refundable Set
...
[Anchor to parentTransaction](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.parentTransaction)parent Transaction
...
[Anchor to paymentDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.paymentDetails)payment Details
...
[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.amount)amount

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to maximumRefundable](https://shopify.dev/docs/api/admin-graphql/latest/objects/suggestedordertransaction#field-SuggestedOrderTransaction.fields.maximumRefundable)maximum Refundable
...
*   {}[RefundReturnOutcome.suggestedTransactions](https://shopify.dev/docs/api/admin-graphql/latest/objects/RefundReturnOutcome#field-suggestedTransactions)
*   {}[SuggestedRefund.suggestedTransactions](https://shopify.dev/docs/api/admin-graphql/latest/objects/SuggestedRefund#field-suggestedTransactions)
*   {}[SuggestedReturnRefund.suggestedTransactions](https://shopify.dev/docs/api/admin-graphql/latest/objects/SuggestedReturnRefund#field-suggestedTransactions)
