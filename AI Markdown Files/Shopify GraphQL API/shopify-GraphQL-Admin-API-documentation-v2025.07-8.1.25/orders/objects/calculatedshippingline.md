---
title: "CalculatedShippingLine"
description: "Shopify GraphQL Admin API documentation for calculatedshippingline"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline

Markdown Content:
CalculatedShippingLine - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#mutations)
...
[Anchor to CalculatedShippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#field-CalculatedShippingLine.fields.id)id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

A globally-unique ID.

[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#field-CalculatedShippingLine.fields.price)price
...
[Anchor to stagedStatus](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#field-CalculatedShippingLine.fields.stagedStatus)staged Status
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#field-CalculatedShippingLine.fields.title)title
...
*   {}[CalculatedOrder.shippingLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedOrder#field-shippingLines)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#mutations)Mutations
--------------------------------------------------------------------------------------------------------------------------

[Anchor to orderEditAddShippingLine](https://shopify.dev/docs/api/admin-graphql/latest/objects/calculatedshippingline#mutation-orderEditAddShippingLine)[order Edit Add Shipping Line](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderEditAddShippingLine)
