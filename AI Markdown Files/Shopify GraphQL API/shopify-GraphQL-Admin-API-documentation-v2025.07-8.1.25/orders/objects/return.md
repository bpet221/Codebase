...
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/return"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/return

Markdown Content:
Return - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#queries)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutations)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#interfaces)
...
[Anchor to Return](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#top)
Return
======
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#fields)Fields
-------------------------------------------------------------------------------------------------

[Anchor to closedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.closedAt)closed At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

The date and time when the return was closed.

[Anchor to createdAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.createdAt)created At
...
[Anchor to decline](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.decline)decline
...
[Anchor to exchangeLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.exchangeLineItems)exchange Line Items
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.name)name
...
[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.order)order
...
[Anchor to refunds](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.refunds)refunds
...
[Anchor to requestApprovedAt](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.requestApprovedAt)request Approved At

•[Date Time](https://shopify.dev/docs/api/admin-graphql/latest/scalars/DateTime)

The date and time when the return was approved.

[Anchor to returnLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.returnLineItems)return Line Items
...
[Anchor to returnShippingFees](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.returnShippingFees)return Shipping Fees
...
[Anchor to reverseFulfillmentOrders](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.reverseFulfillmentOrders)reverse Fulfillment Orders
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.status)status
...
[Anchor to suggestedFinancialOutcome](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.suggestedFinancialOutcome)suggested Financial Outcome
...
[Anchor to totalQuantity](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.totalQuantity)total Quantity
...
[Anchor to suggestedRefund](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#field-Return.fields.suggestedRefund)suggested Refund
...
*   {}[Order.returns](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-returns)
*   {}[Refund.return](https://shopify.dev/docs/api/admin-graphql/latest/objects/Refund#field-return)
*   {}[ReturnAgreement.return](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReturnAgreement#field-return)
*   <->[ReturnConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/ReturnConnection#field-nodes)
*   {}[ReturnEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/ReturnEdge#field-node)

* * *

[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#queries)Queries
----------------------------------------------------------------------------------------------------

[Anchor to return](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#query-return)[return](https://shopify.dev/docs/api/admin-graphql/latest/queries/return)
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutations)Mutations
----------------------------------------------------------------------------------------------------------

[Anchor to removeFromReturn](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-removeFromReturn)[remove From Return](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removeFromReturn)
...
[Anchor to returnApproveRequest](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-returnApproveRequest)[return Approve Request](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnApproveRequest)
...
[Anchor to returnCancel](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-returnCancel)[return Cancel](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnCancel)
...
[Anchor to returnClose](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-returnClose)[return Close](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnClose)
...
[Anchor to returnCreate](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-returnCreate)[return Create](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnCreate)
...
[Anchor to returnDeclineRequest](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-returnDeclineRequest)[return Decline Request](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnDeclineRequest)
...
[Anchor to returnProcess](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-returnProcess)[return Process](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnProcess)
...
[Anchor to returnReopen](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-returnReopen)[return Reopen](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnReopen)
...
[Anchor to returnRequest](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-returnRequest)[return Request](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnRequest)
...
[Anchor to returnLineItemRemoveFromReturn](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#mutation-returnLineItemRemoveFromReturn)[return Line Item Remove From Return](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnLineItemRemoveFromReturn)
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/return#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
