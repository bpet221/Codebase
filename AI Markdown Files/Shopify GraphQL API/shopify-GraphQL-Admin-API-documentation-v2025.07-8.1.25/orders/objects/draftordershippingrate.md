---
title: "DraftOrderShippingRate"
description: "Shopify GraphQL Admin API documentation for draftordershippingrate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate

Markdown Content:
DraftOrderShippingRate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate#main-content)
...
[Anchor to DraftOrderShippingRate](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate#field-DraftOrderShippingRate.fields.code)code
...
[Anchor to handle](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate#field-DraftOrderShippingRate.fields.handle)handle
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate#field-DraftOrderShippingRate.fields.price)price
...
[Anchor to source](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate#field-DraftOrderShippingRate.fields.source)source
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftordershippingrate#field-DraftOrderShippingRate.fields.title)title
...
*   {}[DraftOrderAvailableDeliveryOptions.availableLocalDeliveryRates](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrderAvailableDeliveryOptions#field-availableLocalDeliveryRates)
*   {}[DraftOrderAvailableDeliveryOptions.availableShippingRates](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrderAvailableDeliveryOptions#field-availableShippingRates)
