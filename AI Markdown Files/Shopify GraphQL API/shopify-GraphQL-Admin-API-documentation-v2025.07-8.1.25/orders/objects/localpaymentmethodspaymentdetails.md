---
title: "LocalPaymentMethodsPaymentDetails"
description: "Shopify GraphQL Admin API documentation for localpaymentmethodspaymentdetails"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails

Markdown Content:
LocalPaymentMethodsPaymentDetails - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails#interfaces)
...
[Anchor to LocalPaymentMethodsPaymentDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to paymentDescriptor](https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails#field-LocalPaymentMethodsPaymentDetails.fields.paymentDescriptor)payment Descriptor

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The descriptor by the payment provider. Only available for Amazon Pay and Buy with Prime.

[Anchor to paymentMethodName](https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails#field-LocalPaymentMethodsPaymentDetails.fields.paymentMethodName)payment Method Name
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------------------

[Anchor to BasePaymentDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/localpaymentmethodspaymentdetails#interface-BasePaymentDetails)[Base Payment Details](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/BasePaymentDetails)
