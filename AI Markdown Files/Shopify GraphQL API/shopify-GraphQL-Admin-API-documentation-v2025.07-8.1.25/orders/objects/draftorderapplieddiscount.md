---
title: "DraftOrderAppliedDiscount"
description: "Shopify GraphQL Admin API documentation for draftorderapplieddiscount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount

Markdown Content:
DraftOrderAppliedDiscount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#main-content)
...
[Anchor to DraftOrderAppliedDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to amountSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#field-DraftOrderAppliedDiscount.fields.amountSet)amount Set
...
[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#field-DraftOrderAppliedDiscount.fields.description)description
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#field-DraftOrderAppliedDiscount.fields.title)title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

Name of the order-level discount.

[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#field-DraftOrderAppliedDiscount.fields.value)value
...
[Anchor to valueType](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#field-DraftOrderAppliedDiscount.fields.valueType)value Type
...
[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#field-DraftOrderAppliedDiscount.fields.amount)amount

•[Money!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Money)

non-null Deprecated

[Anchor to amountV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/draftorderapplieddiscount#field-DraftOrderAppliedDiscount.fields.amountV2)amount V2
...
*   {}[CalculatedDraftOrder.appliedDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-appliedDiscount)
*   {}[CalculatedDraftOrderLineItem.appliedDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrderLineItem#field-appliedDiscount)
*   {}[DraftOrder.appliedDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrder#field-appliedDiscount)
*   {}[DraftOrderLineItem.appliedDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/DraftOrderLineItem#field-appliedDiscount)
