---
title: "SubscriptionManualDiscount"
description: "Shopify GraphQL Admin API documentation for subscriptionmanualdiscount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount

Markdown Content:
SubscriptionManualDiscount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#mutations)
...
[Anchor to SubscriptionManualDiscount](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to entitledLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#field-SubscriptionManualDiscount.fields.entitledLines)entitled Lines
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#field-SubscriptionManualDiscount.fields.id)id
...
[Anchor to recurringCycleLimit](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#field-SubscriptionManualDiscount.fields.recurringCycleLimit)recurring Cycle Limit

•[Int](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Int)

The maximum number of times the subscription discount will be applied on orders.

[Anchor to rejectionReason](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#field-SubscriptionManualDiscount.fields.rejectionReason)rejection Reason
...
[Anchor to targetType](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#field-SubscriptionManualDiscount.fields.targetType)target Type
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#field-SubscriptionManualDiscount.fields.title)title

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The title associated with the subscription discount.

[Anchor to type](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#field-SubscriptionManualDiscount.fields.type)type
...
[Anchor to usageCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#field-SubscriptionManualDiscount.fields.usageCount)usage Count
...
[Anchor to value](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#field-SubscriptionManualDiscount.fields.value)value
...
*   {}[SubscriptionBillingCycleEditedContract.discounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionBillingCycleEditedContract#field-discounts)
*   {}[SubscriptionContract.discounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionContract#field-discounts)
*   ||-[SubscriptionContractBase.discounts](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/SubscriptionContractBase#field-discounts)
*   <->[SubscriptionManualDiscountConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/SubscriptionManualDiscountConnection#field-nodes)
*   {}[SubscriptionManualDiscountEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionManualDiscountEdge#field-node)
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#mutations)Mutations
------------------------------------------------------------------------------------------------------------------------------

[Anchor to subscriptionDraftDiscountAdd](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#mutation-subscriptionDraftDiscountAdd)[subscription Draft Discount Add](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftDiscountAdd)
...
[Anchor to subscriptionDraftDiscountUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#mutation-subscriptionDraftDiscountUpdate)[subscription Draft Discount Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftDiscountUpdate)
...
[Anchor to subscriptionDraftLineRemove](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptionmanualdiscount#mutation-subscriptionDraftLineRemove)[subscription Draft Line Remove](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionDraftLineRemove)
