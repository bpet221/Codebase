---
title: "OrderStagedChangeIncrementItem"
description: "Shopify GraphQL Admin API documentation for orderstagedchangeincrementitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeincrementitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeincrementitem

Markdown Content:
OrderStagedChangeIncrementItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeincrementitem#main-content)
...
[Anchor to OrderStagedChangeIncrementItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeincrementitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeincrementitem#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to delta](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeincrementitem#field-OrderStagedChangeIncrementItem.fields.delta)delta
...
[Anchor to lineItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/orderstagedchangeincrementitem#field-OrderStagedChangeIncrementItem.fields.lineItem)line Item
