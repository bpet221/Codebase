---
title: "SubscriptionDeliveryMethodPickup"
description: "Shopify GraphQL Admin API documentation for subscriptiondeliverymethodpickup"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickup"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickup

Markdown Content:
SubscriptionDeliveryMethodPickup - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickup#main-content)
...
[Anchor to SubscriptionDeliveryMethodPickup](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickup#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickup#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to pickupOption](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverymethodpickup#field-SubscriptionDeliveryMethodPickup.fields.pickupOption)pickup Option
