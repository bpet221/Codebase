---
title: "CashRoundingAdjustment"
description: "Shopify GraphQL Admin API documentation for cashroundingadjustment"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/cashroundingadjustment"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/cashroundingadjustment

Markdown Content:
CashRoundingAdjustment - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashroundingadjustment#main-content)
...
[Anchor to CashRoundingAdjustment](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashroundingadjustment#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashroundingadjustment#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to paymentSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashroundingadjustment#field-CashRoundingAdjustment.fields.paymentSet)payment Set
...
[Anchor to refundSet](https://shopify.dev/docs/api/admin-graphql/latest/objects/cashroundingadjustment#field-CashRoundingAdjustment.fields.refundSet)refund Set
...
*   {}[Order.totalCashRoundingAdjustment](https://shopify.dev/docs/api/admin-graphql/latest/objects/Order#field-totalCashRoundingAdjustment)
