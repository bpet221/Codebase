---
title: "Duty"
description: "Shopify GraphQL Admin API documentation for duty"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/duty"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/duty

Markdown Content:
Duty - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#interfaces)
...
[Anchor to Duty](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#top)
Duty
====
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#fields)Fields
-----------------------------------------------------------------------------------------------

[Anchor to countryCodeOfOrigin](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#field-Duty.fields.countryCodeOfOrigin)country Code Of Origin
...
[Anchor to harmonizedSystemCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#field-Duty.fields.harmonizedSystemCode)harmonized System Code

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The harmonized system code of the item used in calculating the duty.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#field-Duty.fields.id)id
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#field-Duty.fields.price)price
...
[Anchor to taxLines](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#field-Duty.fields.taxLines)tax Lines
...
*   {}[DutySale.duty](https://shopify.dev/docs/api/admin-graphql/latest/objects/DutySale#field-duty)
*   {}[LineItem.duties](https://shopify.dev/docs/api/admin-graphql/latest/objects/LineItem#field-duties)
*   {}[RefundDuty.originalDuty](https://shopify.dev/docs/api/admin-graphql/latest/objects/RefundDuty#field-originalDuty)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/duty#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
