---
title: "RiskFact"
description: "Shopify GraphQL Admin API documentation for riskfact"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/riskfact"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/riskfact

Markdown Content:
RiskFact - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/riskfact#main-content)
...
[Anchor to RiskFact](https://shopify.dev/docs/api/admin-graphql/latest/objects/riskfact#top)
Risk Fact
=========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/riskfact#fields)Fields
---------------------------------------------------------------------------------------------------

[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/riskfact#field-RiskFact.fields.description)description
...
[Anchor to sentiment](https://shopify.dev/docs/api/admin-graphql/latest/objects/riskfact#field-RiskFact.fields.sentiment)sentiment
...
*   {}[OrderRiskAssessment.facts](https://shopify.dev/docs/api/admin-graphql/latest/objects/OrderRiskAssessment#field-facts)
