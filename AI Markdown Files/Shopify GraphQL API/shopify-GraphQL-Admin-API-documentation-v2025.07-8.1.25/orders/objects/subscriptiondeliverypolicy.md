---
title: "SubscriptionDeliveryPolicy"
description: "Shopify GraphQL Admin API documentation for subscriptiondeliverypolicy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverypolicy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverypolicy

Markdown Content:
SubscriptionDeliveryPolicy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverypolicy#main-content)
...
[Anchor to SubscriptionDeliveryPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverypolicy#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverypolicy#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to anchors](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverypolicy#field-SubscriptionDeliveryPolicy.fields.anchors)anchors
...
[Anchor to interval](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverypolicy#field-SubscriptionDeliveryPolicy.fields.interval)interval
...
[Anchor to intervalCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/subscriptiondeliverypolicy#field-SubscriptionDeliveryPolicy.fields.intervalCount)interval Count
...
*   {}[SubscriptionContract.deliveryPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionContract#field-deliveryPolicy)
*   {}[SubscriptionDraft.deliveryPolicy](https://shopify.dev/docs/api/admin-graphql/latest/objects/SubscriptionDraft#field-deliveryPolicy)
