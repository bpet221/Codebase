---
title: "subscriptionBillingCycleBulkSearch"
description: "Shopify GraphQL Admin API documentation for subscriptionbillingcyclebulksearch"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch

Markdown Content:
subscriptionBillingCycleBulkSearch - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch#main-content)
...
[Anchor to subscriptionBillingCycleBulkSearch](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch#arguments)
Arguments
---------

[Anchor to billingAttemptExpectedDateRange](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch#arguments-billingAttemptExpectedDateRange)billing Attempt Expected Date Range
...
[Anchor to filters](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch#arguments-filters)filters
...
[Anchor to SubscriptionBillingCycleBulkSearchPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch#returns)Subscription Billing Cycle Bulk Search Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to job](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch#returns-job)job
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclebulksearch#returns-userErrors)user Errors
