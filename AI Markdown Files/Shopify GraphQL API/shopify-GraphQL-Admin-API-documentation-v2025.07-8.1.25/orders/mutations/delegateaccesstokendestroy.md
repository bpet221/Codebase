---
title: "delegateAccessTokenDestroy"
description: "Shopify GraphQL Admin API documentation for delegateaccesstokendestroy"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy

Markdown Content:
delegateAccessTokenDestroy - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy#main-content)
...
[Anchor to delegateAccessTokenDestroy](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy#arguments)
Arguments
---------

[Anchor to accessToken](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy#arguments-accessToken)access Token
...
[Anchor to DelegateAccessTokenDestroyPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy#returns)Delegate Access Token Destroy Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to shop](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy#returns-shop)shop
...
[Anchor to status](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy#returns-status)status

•[Boolean](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Boolean)

The status of the delegate access token destroy operation. Returns true if successful.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/delegateaccesstokendestroy#returns-userErrors)user Errors
