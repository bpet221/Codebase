---
title: "reverseFulfillmentOrderDispose"
description: "Shopify GraphQL Admin API documentation for reversefulfillmentorderdispose"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversefulfillmentorderdispose"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversefulfillmentorderdispose

Markdown Content:
reverseFulfillmentOrderDispose - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversefulfillmentorderdispose#main-content)
...
[Anchor to reverseFulfillmentOrderDispose](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversefulfillmentorderdispose#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversefulfillmentorderdispose#arguments)
Arguments
---------

[Anchor to dispositionInputs](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversefulfillmentorderdispose#arguments-dispositionInputs)disposition Inputs
...
[Anchor to ReverseFulfillmentOrderDisposePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversefulfillmentorderdispose#returns)Reverse Fulfillment Order Dispose Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to reverseFulfillmentOrderLineItems](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversefulfillmentorderdispose#returns-reverseFulfillmentOrderLineItems)reverse Fulfillment Order Line Items
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversefulfillmentorderdispose#returns-userErrors)user Errors
...
# ReverseFulfillmentOrderLineItem fields
