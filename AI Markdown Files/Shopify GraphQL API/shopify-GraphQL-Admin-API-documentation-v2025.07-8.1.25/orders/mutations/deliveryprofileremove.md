---
title: "deliveryProfileRemove"
description: "Shopify GraphQL Admin API documentation for deliveryprofileremove"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliveryprofileremove"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliveryprofileremove

Markdown Content:
deliveryProfileRemove - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliveryprofileremove#main-content)
...
[Anchor to deliveryProfileRemove](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliveryprofileremove#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliveryprofileremove#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliveryprofileremove#arguments-id)id
...
[Anchor to DeliveryProfileRemovePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliveryprofileremove#returns)Delivery Profile Remove Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to job](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliveryprofileremove#returns-job)job
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliveryprofileremove#returns-userErrors)user Errors
