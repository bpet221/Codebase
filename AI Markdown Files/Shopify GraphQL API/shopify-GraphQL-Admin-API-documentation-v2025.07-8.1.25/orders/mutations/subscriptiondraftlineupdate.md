---
title: "subscriptionDraftLineUpdate"
description: "Shopify GraphQL Admin API documentation for subscriptiondraftlineupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate

Markdown Content:
subscriptionDraftLineUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#main-content)
...
[Anchor to subscriptionDraftLineUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#arguments)
Arguments
---------

[Anchor to draftId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#arguments-draftId)draft Id
...
[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#arguments-input)input
...
[Anchor to lineId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#arguments-lineId)line Id
...
[Anchor to SubscriptionDraftLineUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#returns)Subscription Draft Line Update Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to draft](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#returns-draft)draft
...
[Anchor to lineUpdated](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#returns-lineUpdated)line Updated
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftlineupdate#returns-userErrors)user Errors
