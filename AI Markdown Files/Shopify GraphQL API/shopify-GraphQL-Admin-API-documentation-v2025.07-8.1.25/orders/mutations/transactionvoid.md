...
description: "Shopify GraphQL Admin API documentation for transactionvoid"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionvoid"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionvoid

Markdown Content:
transactionVoid - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionvoid#main-content)
...
[Anchor to transactionVoid](https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionvoid#top)
transaction Void
================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionvoid#arguments)
Arguments
---------

[Anchor to parentTransactionId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionvoid#arguments-parentTransactionId)parent Transaction Id
...
[Anchor to TransactionVoidPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionvoid#returns)Transaction Void Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to transaction](https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionvoid#returns-transaction)transaction
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/transactionvoid#returns-userErrors)user Errors
