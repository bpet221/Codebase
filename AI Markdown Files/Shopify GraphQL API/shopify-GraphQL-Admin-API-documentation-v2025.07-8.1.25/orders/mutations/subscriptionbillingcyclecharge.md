---
title: "subscriptionBillingCycleCharge"
description: "Shopify GraphQL Admin API documentation for subscriptionbillingcyclecharge"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge

Markdown Content:
subscriptionBillingCycleCharge - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge#main-content)
...
[Anchor to subscriptionBillingCycleCharge](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge#arguments)
Arguments
---------

[Anchor to billingCycleSelector](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge#arguments-billingCycleSelector)billing Cycle Selector
...
[Anchor to inventoryPolicy](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge#arguments-inventoryPolicy)inventory Policy
...
[Anchor to subscriptionContractId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge#arguments-subscriptionContractId)subscription Contract Id
...
[Anchor to SubscriptionBillingCycleChargePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge#returns)Subscription Billing Cycle Charge Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to subscriptionBillingAttempt](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge#returns-subscriptionBillingAttempt)subscription Billing Attempt
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecharge#returns-userErrors)user Errors
