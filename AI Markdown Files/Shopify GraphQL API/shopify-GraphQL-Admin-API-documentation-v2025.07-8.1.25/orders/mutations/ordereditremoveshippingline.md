---
title: "orderEditRemoveShippingLine"
description: "Shopify GraphQL Admin API documentation for ordereditremoveshippingline"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline

Markdown Content:
orderEditRemoveShippingLine - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline#main-content)
...
[Anchor to orderEditRemoveShippingLine](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline#arguments-id)id
...
[Anchor to shippingLineId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline#arguments-shippingLineId)shipping Line Id
...
[Anchor to OrderEditRemoveShippingLinePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline#returns)Order Edit Remove Shipping Line Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to calculatedOrder](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline#returns-calculatedOrder)calculated Order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremoveshippingline#returns-userErrors)user Errors
