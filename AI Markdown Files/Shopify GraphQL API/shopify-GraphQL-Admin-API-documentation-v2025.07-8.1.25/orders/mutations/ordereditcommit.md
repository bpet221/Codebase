---
title: "orderEditCommit"
description: "Shopify GraphQL Admin API documentation for ordereditcommit"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit

Markdown Content:
orderEditCommit - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit#main-content)
...
[Anchor to orderEditCommit](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit#top)
order Edit Commit
=================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit#arguments-id)id

•[ID!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

required

The ID of the [calculated order](https://shopify.dev/api/admin-graphql/latest/objects/calculatedorder) that will have its changes applied to the order.

[Anchor to notifyCustomer](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit#arguments-notifyCustomer)notify Customer

•[Boolean](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Boolean)

Whether to notify the customer or not.

[Anchor to staffNote](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit#arguments-staffNote)staff Note
...
[Anchor to OrderEditCommitPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit#returns)Order Edit Commit Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit#returns-order)order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditcommit#returns-userErrors)user Errors
