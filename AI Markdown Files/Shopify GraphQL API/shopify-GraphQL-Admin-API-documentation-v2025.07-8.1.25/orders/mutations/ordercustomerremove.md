---
title: "orderCustomerRemove"
description: "Shopify GraphQL Admin API documentation for ordercustomerremove"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercustomerremove"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercustomerremove

Markdown Content:
orderCustomerRemove - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercustomerremove#main-content)
...
[Anchor to orderCustomerRemove](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercustomerremove#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercustomerremove#arguments)
Arguments
---------

[Anchor to orderId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercustomerremove#arguments-orderId)order Id
...
[Anchor to OrderCustomerRemovePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercustomerremove#returns)Order Customer Remove Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercustomerremove#returns-order)order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercustomerremove#returns-userErrors)user Errors
