---
title: "orderClose"
description: "Shopify GraphQL Admin API documentation for orderclose"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderclose"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderclose

Markdown Content:
orderClose - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderclose#main-content)
...
[Anchor to orderClose](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderclose#top)
order Close
===========
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderclose#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderclose#arguments-input)input
...
[Anchor to OrderClosePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderclose#returns)Order Close Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderclose#returns-order)order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderclose#returns-userErrors)user Errors
