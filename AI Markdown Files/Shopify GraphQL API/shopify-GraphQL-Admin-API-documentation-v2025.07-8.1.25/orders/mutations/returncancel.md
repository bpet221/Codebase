---
title: "returnCancel"
description: "Shopify GraphQL Admin API documentation for returncancel"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel

Markdown Content:
returnCancel - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel#main-content)
...
[Anchor to returnCancel](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel#top)
return Cancel
=============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel#arguments-id)id
...
[Anchor to notifyCustomer](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel#arguments-notifyCustomer)notify Customer
...
[Anchor to ReturnCancelPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel#returns)Return Cancel Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to return](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel#returns-return)return
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returncancel#returns-userErrors)user Errors
