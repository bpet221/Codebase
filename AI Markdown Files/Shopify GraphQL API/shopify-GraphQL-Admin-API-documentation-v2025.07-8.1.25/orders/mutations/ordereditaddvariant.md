---
title: "orderEditAddVariant"
description: "Shopify GraphQL Admin API documentation for ordereditaddvariant"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant

Markdown Content:
orderEditAddVariant - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#main-content)
...
[Anchor to orderEditAddVariant](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#arguments)
Arguments
---------

[Anchor to allowDuplicates](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#arguments-allowDuplicates)allow Duplicates
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#arguments-id)id
...
[Anchor to locationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#arguments-locationId)location Id
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#arguments-quantity)quantity
...
[Anchor to variantId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#arguments-variantId)variant Id
...
[Anchor to OrderEditAddVariantPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#returns)Order Edit Add Variant Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to calculatedLineItem](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#returns-calculatedLineItem)calculated Line Item
...
[Anchor to calculatedOrder](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#returns-calculatedOrder)calculated Order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditaddvariant#returns-userErrors)user Errors
