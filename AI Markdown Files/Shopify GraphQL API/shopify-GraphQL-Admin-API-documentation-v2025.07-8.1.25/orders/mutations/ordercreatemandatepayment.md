---
title: "orderCreateMandatePayment"
description: "Shopify GraphQL Admin API documentation for ordercreatemandatepayment"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment

Markdown Content:
orderCreateMandatePayment - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#main-content)
...
[Anchor to orderCreateMandatePayment](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#arguments)
Arguments
---------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#arguments-amount)amount
...
[Anchor to autoCapture](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#arguments-autoCapture)auto Capture
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#arguments-id)id
...
[Anchor to idempotencyKey](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#arguments-idempotencyKey)idempotency Key
...
[Anchor to mandateId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#arguments-mandateId)mandate Id
...
[Anchor to paymentScheduleId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#arguments-paymentScheduleId)payment Schedule Id
...
[Anchor to OrderCreateMandatePaymentPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#returns)Order Create Mandate Payment Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to job](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#returns-job)job
...
[Anchor to paymentReferenceId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#returns-paymentReferenceId)payment Reference Id

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The Unique ID for the created payment.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemandatepayment#returns-userErrors)user Errors
