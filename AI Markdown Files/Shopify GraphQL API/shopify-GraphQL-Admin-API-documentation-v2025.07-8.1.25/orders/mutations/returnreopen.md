---
title: "returnReopen"
description: "Shopify GraphQL Admin API documentation for returnreopen"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnreopen"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnreopen

Markdown Content:
returnReopen - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnreopen#main-content)
...
[Anchor to returnReopen](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnreopen#top)
return Reopen
=============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnreopen#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnreopen#arguments-id)id
...
[Anchor to ReturnReopenPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnreopen#returns)Return Reopen Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to return](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnreopen#returns-return)return
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnreopen#returns-userErrors)user Errors
