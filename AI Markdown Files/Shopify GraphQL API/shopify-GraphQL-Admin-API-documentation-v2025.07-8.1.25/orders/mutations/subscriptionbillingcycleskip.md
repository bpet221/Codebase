---
title: "subscriptionBillingCycleSkip"
description: "Shopify GraphQL Admin API documentation for subscriptionbillingcycleskip"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcycleskip"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcycleskip

Markdown Content:
subscriptionBillingCycleSkip - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcycleskip#main-content)
...
[Anchor to subscriptionBillingCycleSkip](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcycleskip#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcycleskip#arguments)
Arguments
---------

[Anchor to billingCycleInput](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcycleskip#arguments-billingCycleInput)billing Cycle Input
...
[Anchor to SubscriptionBillingCycleSkipPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcycleskip#returns)Subscription Billing Cycle Skip Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to billingCycle](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcycleskip#returns-billingCycle)billing Cycle
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcycleskip#returns-userErrors)user Errors
