---
title: "orderOpen"
description: "Shopify GraphQL Admin API documentation for orderopen"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderopen"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderopen

Markdown Content:
orderOpen - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderopen#main-content)
...
[Anchor to orderOpen](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderopen#top)
order Open
==========
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderopen#arguments)
Arguments
---------

[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderopen#arguments-input)input
...
[Anchor to OrderOpenPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderopen#returns)Order Open Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderopen#returns-order)order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderopen#returns-userErrors)user Errors
