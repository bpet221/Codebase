---
title: "orderCreateManualPayment"
description: "Shopify GraphQL Admin API documentation for ordercreatemanualpayment"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment

Markdown Content:
orderCreateManualPayment - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#main-content)
...
[Anchor to orderCreateManualPayment](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#arguments)
Arguments
---------

[Anchor to amount](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#arguments-amount)amount
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#arguments-id)id
...
[Anchor to paymentMethodName](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#arguments-paymentMethodName)payment Method Name
...
[Anchor to processedAt](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#arguments-processedAt)processed At
...
[Anchor to OrderCreateManualPaymentPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#returns)Order Create Manual Payment Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to order](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#returns-order)order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordercreatemanualpayment#returns-userErrors)user Errors
