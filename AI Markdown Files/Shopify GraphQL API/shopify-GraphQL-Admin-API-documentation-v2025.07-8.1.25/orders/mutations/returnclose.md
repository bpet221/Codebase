---
title: "returnClose"
description: "Shopify GraphQL Admin API documentation for returnclose"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnclose"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnclose

Markdown Content:
returnClose - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnclose#main-content)
...
[Anchor to returnClose](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnclose#top)
return Close
============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnclose#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnclose#arguments-id)id
...
[Anchor to ReturnClosePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnclose#returns)Return Close Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to return](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnclose#returns-return)return
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnclose#returns-userErrors)user Errors
