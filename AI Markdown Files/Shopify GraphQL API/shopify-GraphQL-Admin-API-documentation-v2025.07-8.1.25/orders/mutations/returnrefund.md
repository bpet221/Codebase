---
title: "returnRefund"
description: "Shopify GraphQL Admin API documentation for returnrefund"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnrefund"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnrefund

Markdown Content:
returnRefund - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnrefund#main-content)
...
[Anchor to returnRefund](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnrefund#top)
return Refund
=============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnrefund#arguments)
Arguments
---------

[Anchor to returnRefundInput](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnrefund#arguments-returnRefundInput)return Refund Input
...
[Anchor to ReturnRefundPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnrefund#returns)Return Refund Payload returns
------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to refund](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnrefund#returns-refund)refund
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/returnrefund#returns-userErrors)user Errors
