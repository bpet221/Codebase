---
title: "subscriptionDraftDiscountAdd"
description: "Shopify GraphQL Admin API documentation for subscriptiondraftdiscountadd"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd

Markdown Content:
subscriptionDraftDiscountAdd - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd#main-content)
...
[Anchor to subscriptionDraftDiscountAdd](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd#arguments)
Arguments
---------

[Anchor to draftId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd#arguments-draftId)draft Id
...
[Anchor to input](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd#arguments-input)input
...
[Anchor to SubscriptionDraftDiscountAddPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd#returns)Subscription Draft Discount Add Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to discountAdded](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd#returns-discountAdded)discount Added
...
[Anchor to draft](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd#returns-draft)draft
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountadd#returns-userErrors)user Errors
