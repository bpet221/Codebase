---
title: "reverseDeliveryShippingUpdate"
description: "Shopify GraphQL Admin API documentation for reversedeliveryshippingupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate

Markdown Content:
reverseDeliveryShippingUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#main-content)
...
[Anchor to reverseDeliveryShippingUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#arguments)
Arguments
---------

[Anchor to labelInput](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#arguments-labelInput)label Input
...
[Anchor to notifyCustomer](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#arguments-notifyCustomer)notify Customer
...
[Anchor to reverseDeliveryId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#arguments-reverseDeliveryId)reverse Delivery Id
...
[Anchor to trackingInput](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#arguments-trackingInput)tracking Input
...
[Anchor to ReverseDeliveryShippingUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#returns)Reverse Delivery Shipping Update Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to reverseDelivery](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#returns-reverseDelivery)reverse Delivery
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/reversedeliveryshippingupdate#returns-userErrors)user Errors
