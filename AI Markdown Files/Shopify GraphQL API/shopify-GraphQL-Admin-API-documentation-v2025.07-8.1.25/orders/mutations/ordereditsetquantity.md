...
description: "Shopify GraphQL Admin API documentation for ordereditsetquantity"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity

Markdown Content:
orderEditSetQuantity - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#main-content)
...
[Anchor to orderEditSetQuantity](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#arguments-id)id

•[ID!](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

required

The ID of the [calculated order](https://shopify.dev/api/admin-graphql/latest/objects/calculatedorder) to edit. The edit changes the quantity on the line item.

[Anchor to lineItemId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#arguments-lineItemId)line Item Id
...
[Anchor to quantity](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#arguments-quantity)quantity
...
[Anchor to restock](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#arguments-restock)restock

•[Boolean](https://shopify.dev/docs/api/admin-graphql/latest/scalars/Boolean)

Whether or not to restock the line item when the updated quantity is less than the original quantity.

[Anchor to locationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#arguments-locationId)location Id
...
[Anchor to OrderEditSetQuantityPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#returns)Order Edit Set Quantity Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to calculatedLineItem](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#returns-calculatedLineItem)calculated Line Item
...
[Anchor to calculatedOrder](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#returns-calculatedOrder)calculated Order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditsetquantity#returns-userErrors)user Errors
