---
title: "subscriptionBillingCycleContractDraftConcatenate"
description: "Shopify GraphQL Admin API documentation for subscriptionbillingcyclecontractdraftconcatenate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate

Markdown Content:
subscriptionBillingCycleContractDraftConcatenate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate#main-content)
...
[Anchor to subscriptionBillingCycleContractDraftConcatenate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate#arguments)
Arguments
---------

[Anchor to concatenatedBillingCycleContracts](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate#arguments-concatenatedBillingCycleContracts)concatenated Billing Cycle Contracts
...
[Anchor to draftId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate#arguments-draftId)draft Id
...
[Anchor to SubscriptionBillingCycleContractDraftConcatenatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate#returns)Subscription Billing Cycle Contract Draft Concatenate Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to draft](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate#returns-draft)draft
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptionbillingcyclecontractdraftconcatenate#returns-userErrors)user Errors
