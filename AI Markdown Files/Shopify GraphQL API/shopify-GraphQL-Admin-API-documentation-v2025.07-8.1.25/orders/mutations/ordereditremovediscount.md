---
title: "orderEditRemoveDiscount"
description: "Shopify GraphQL Admin API documentation for ordereditremovediscount"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount

Markdown Content:
orderEditRemoveDiscount - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount#main-content)
...
[Anchor to orderEditRemoveDiscount](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount#arguments)
Arguments
---------

[Anchor to discountApplicationId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount#arguments-discountApplicationId)discount Application Id
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount#arguments-id)id
...
[Anchor to OrderEditRemoveDiscountPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount#returns)Order Edit Remove Discount Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to calculatedOrder](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount#returns-calculatedOrder)calculated Order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/ordereditremovediscount#returns-userErrors)user Errors
