---
title: "subscriptionDraftDiscountRemove"
description: "Shopify GraphQL Admin API documentation for subscriptiondraftdiscountremove"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove

Markdown Content:
subscriptionDraftDiscountRemove - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove#main-content)
...
[Anchor to subscriptionDraftDiscountRemove](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove#arguments)
Arguments
---------

[Anchor to discountId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove#arguments-discountId)discount Id
...
[Anchor to draftId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove#arguments-draftId)draft Id
...
[Anchor to SubscriptionDraftDiscountRemovePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove#returns)Subscription Draft Discount Remove Payload returns
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to discountRemoved](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove#returns-discountRemoved)discount Removed
...
[Anchor to draft](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove#returns-draft)draft
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptiondraftdiscountremove#returns-userErrors)user Errors
