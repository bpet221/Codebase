---
title: "subscriptionContractUpdate"
description: "Shopify GraphQL Admin API documentation for subscriptioncontractupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptioncontractupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptioncontractupdate

Markdown Content:
subscriptionContractUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptioncontractupdate#main-content)
...
[Anchor to subscriptionContractUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptioncontractupdate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptioncontractupdate#arguments)
Arguments
---------

[Anchor to contractId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptioncontractupdate#arguments-contractId)contract Id
...
[Anchor to SubscriptionContractUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptioncontractupdate#returns)Subscription Contract Update Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to draft](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptioncontractupdate#returns-draft)draft
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/subscriptioncontractupdate#returns-userErrors)user Errors
