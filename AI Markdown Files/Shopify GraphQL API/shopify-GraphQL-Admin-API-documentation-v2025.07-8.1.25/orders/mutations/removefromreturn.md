---
title: "removeFromReturn"
description: "Shopify GraphQL Admin API documentation for removefromreturn"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn

Markdown Content:
removeFromReturn - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn#main-content)
...
[Anchor to removeFromReturn](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn#top)
remove From Return
==================
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn#arguments)
Arguments
---------

[Anchor to exchangeLineItems](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn#arguments-exchangeLineItems)exchange Line Items
...
[Anchor to returnId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn#arguments-returnId)return Id
...
[Anchor to returnLineItems](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn#arguments-returnLineItems)return Line Items
...
[Anchor to RemoveFromReturnPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn#returns)Remove From Return Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to return](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn#returns-return)return
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/removefromreturn#returns-userErrors)user Errors
