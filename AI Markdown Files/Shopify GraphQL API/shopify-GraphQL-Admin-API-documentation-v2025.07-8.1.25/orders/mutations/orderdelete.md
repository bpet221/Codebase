---
title: "orderDelete"
description: "Shopify GraphQL Admin API documentation for orderdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderdelete

Markdown Content:
orderDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderdelete#main-content)
...
[Anchor to orderDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderdelete#top)
order Delete
============
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderdelete#arguments)
Arguments
---------

[Anchor to orderId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderdelete#arguments-orderId)order Id
...
[Anchor to OrderDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderdelete#returns)Order Delete Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderdelete#returns-deletedId)deleted Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

Deleted order ID.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/orderdelete#returns-userErrors)user Errors
...
[Open in GraphiQL](http://localhost:3457/graphiql?query=mutation%20OrderDelete(%24orderId%3A%20ID!)%20%7B%0A%20%20orderDelete(orderId%3A%20%24orderId)%20%7B%0A%20%20%20%20deletedId%0A%20%20%20%20userErrors%20%7B%0A%20%20%20%20%20%20field%0A%20%20%20%20%20%20message%0A%20%20%20%20%20%20code%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D&variables=%7B%0A%20%20%22orderId%22%3A%20%22gid%3A%2F%2Fshopify%2FOrder%2F776341364%22%0A%7D)Copy
