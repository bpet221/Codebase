---
title: "DeliveryZone"
description: "Shopify GraphQL Admin API documentation for deliveryzone"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone

Markdown Content:
DeliveryZone - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#interfaces)
...
[Anchor to DeliveryZone](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#top)
Delivery Zone
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to countries](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#field-DeliveryZone.fields.countries)countries
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#field-DeliveryZone.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#field-DeliveryZone.fields.name)name
...
*   {}[DeliveryLocationGroupZone.zone](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryLocationGroupZone#field-zone)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryzone#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
