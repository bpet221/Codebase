---
title: "CountriesInShippingZones"
description: "Shopify GraphQL Admin API documentation for countriesinshippingzones"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/countriesinshippingzones"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/countriesinshippingzones

Markdown Content:
CountriesInShippingZones - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/countriesinshippingzones#main-content)
...
[Anchor to CountriesInShippingZones](https://shopify.dev/docs/api/admin-graphql/latest/objects/countriesinshippingzones#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/countriesinshippingzones#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to countryCodes](https://shopify.dev/docs/api/admin-graphql/latest/objects/countriesinshippingzones#field-CountriesInShippingZones.fields.countryCodes)country Codes
...
[Anchor to includeRestOfWorld](https://shopify.dev/docs/api/admin-graphql/latest/objects/countriesinshippingzones#field-CountriesInShippingZones.fields.includeRestOfWorld)include Rest Of World
...
*   {}[Shop.countriesInShippingZones](https://shopify.dev/docs/api/admin-graphql/latest/objects/Shop#field-countriesInShippingZones)
