...
description: "Shopify GraphQL Admin API documentation for deliverycondition"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition

Markdown Content:
DeliveryCondition - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#interfaces)
...
[Anchor to DeliveryCondition](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#top)
Delivery Condition
==================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#fields)Fields
------------------------------------------------------------------------------------------------------------

[Anchor to conditionCriteria](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#field-DeliveryCondition.fields.conditionCriteria)condition Criteria
...
[Anchor to field](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#field-DeliveryCondition.fields.field)field
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#field-DeliveryCondition.fields.id)id
...
[Anchor to operator](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#field-DeliveryCondition.fields.operator)operator
...
*   {}[DeliveryMethodDefinition.methodConditions](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryMethodDefinition#field-methodConditions)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#interfaces)Interfaces
------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycondition#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
