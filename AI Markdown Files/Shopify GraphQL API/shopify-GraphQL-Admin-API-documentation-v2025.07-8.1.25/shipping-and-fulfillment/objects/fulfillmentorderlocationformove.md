---
title: "FulfillmentOrderLocationForMove"
description: "Shopify GraphQL Admin API documentation for fulfillmentorderlocationformove"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove

Markdown Content:
FulfillmentOrderLocationForMove - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#main-content)
...
[Anchor to FulfillmentOrderLocationForMove](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to availableLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#field-FulfillmentOrderLocationForMove.fields.availableLineItems)available Line Items
...
[Anchor to availableLineItemsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#field-FulfillmentOrderLocationForMove.fields.availableLineItemsCount)available Line Items Count
...
[Anchor to location](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#field-FulfillmentOrderLocationForMove.fields.location)location
...
[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#field-FulfillmentOrderLocationForMove.fields.message)message
...
[Anchor to movable](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#field-FulfillmentOrderLocationForMove.fields.movable)movable
...
[Anchor to unavailableLineItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#field-FulfillmentOrderLocationForMove.fields.unavailableLineItems)unavailable Line Items
...
[Anchor to unavailableLineItemsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderlocationformove#field-FulfillmentOrderLocationForMove.fields.unavailableLineItemsCount)unavailable Line Items Count
...
*   {}[FulfillmentOrder.locationsForMove](https://shopify.dev/docs/api/admin-graphql/latest/objects/FulfillmentOrder#field-locationsForMove)
*   <->[FulfillmentOrderLocationForMoveConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/FulfillmentOrderLocationForMoveConnection#field-nodes)
*   {}[FulfillmentOrderLocationForMoveEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/FulfillmentOrderLocationForMoveEdge#field-node)
