---
title: "ShippingRate"
description: "Shopify GraphQL Admin API documentation for shippingrate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrate

Markdown Content:
ShippingRate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrate#main-content)
...
[Anchor to ShippingRate](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrate#top)
Shipping Rate
=============
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrate#fields)Fields
-------------------------------------------------------------------------------------------------------

[Anchor to handle](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrate#field-ShippingRate.fields.handle)handle
...
[Anchor to price](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrate#field-ShippingRate.fields.price)price
...
[Anchor to title](https://shopify.dev/docs/api/admin-graphql/latest/objects/shippingrate#field-ShippingRate.fields.title)title
...
*   {}[CalculatedDraftOrder.availableShippingRates](https://shopify.dev/docs/api/admin-graphql/latest/objects/CalculatedDraftOrder#field-availableShippingRates)
