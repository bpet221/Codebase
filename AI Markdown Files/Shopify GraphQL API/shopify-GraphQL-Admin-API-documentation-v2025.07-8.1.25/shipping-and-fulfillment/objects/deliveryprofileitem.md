---
title: "DeliveryProfileItem"
description: "Shopify GraphQL Admin API documentation for deliveryprofileitem"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem

Markdown Content:
DeliveryProfileItem - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#interfaces)
...
[Anchor to DeliveryProfileItem](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#field-DeliveryProfileItem.fields.id)id
...
[Anchor to product](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#field-DeliveryProfileItem.fields.product)product
...
[Anchor to variants](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#field-DeliveryProfileItem.fields.variants)variants
...
*   {}[DeliveryProfile.profileItems](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryProfile#field-profileItems)
*   <->[DeliveryProfileItemConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryProfileItemConnection#field-nodes)
*   {}[DeliveryProfileItemEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryProfileItemEdge#field-node)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofileitem#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
