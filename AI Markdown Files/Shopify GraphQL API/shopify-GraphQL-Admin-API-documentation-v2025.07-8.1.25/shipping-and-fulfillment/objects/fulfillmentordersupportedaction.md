---
title: "FulfillmentOrderSupportedAction"
description: "Shopify GraphQL Admin API documentation for fulfillmentordersupportedaction"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersupportedaction"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersupportedaction

Markdown Content:
FulfillmentOrderSupportedAction - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersupportedaction#main-content)
...
[Anchor to FulfillmentOrderSupportedAction](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersupportedaction#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersupportedaction#fields)Fields
--------------------------------------------------------------------------------------------------------------------------

[Anchor to action](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersupportedaction#field-FulfillmentOrderSupportedAction.fields.action)action
...
[Anchor to externalUrl](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersupportedaction#field-FulfillmentOrderSupportedAction.fields.externalUrl)external Url
...
*   {}[FulfillmentOrder.supportedActions](https://shopify.dev/docs/api/admin-graphql/latest/objects/FulfillmentOrder#field-supportedActions)
