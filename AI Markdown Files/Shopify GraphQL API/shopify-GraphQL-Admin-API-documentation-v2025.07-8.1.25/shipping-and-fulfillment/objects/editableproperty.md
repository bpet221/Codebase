---
title: "EditableProperty"
description: "Shopify GraphQL Admin API documentation for editableproperty"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/editableproperty"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/editableproperty

Markdown Content:
EditableProperty - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/editableproperty#main-content)
...
[Anchor to EditableProperty](https://shopify.dev/docs/api/admin-graphql/latest/objects/editableproperty#top)
Editable Property
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/editableproperty#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to locked](https://shopify.dev/docs/api/admin-graphql/latest/objects/editableproperty#field-EditableProperty.fields.locked)locked
...
[Anchor to reason](https://shopify.dev/docs/api/admin-graphql/latest/objects/editableproperty#field-EditableProperty.fields.reason)reason
...
*   {}[InventoryItem.trackedEditable](https://shopify.dev/docs/api/admin-graphql/latest/objects/InventoryItem#field-trackedEditable)
