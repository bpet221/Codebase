---
title: "DeliveryLegacyModeBlocked"
description: "Shopify GraphQL Admin API documentation for deliverylegacymodeblocked"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylegacymodeblocked"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylegacymodeblocked

Markdown Content:
DeliveryLegacyModeBlocked - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylegacymodeblocked#main-content)
...
[Anchor to DeliveryLegacyModeBlocked](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylegacymodeblocked#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylegacymodeblocked#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to blocked](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylegacymodeblocked#field-DeliveryLegacyModeBlocked.fields.blocked)blocked
...
[Anchor to reasons](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylegacymodeblocked#field-DeliveryLegacyModeBlocked.fields.reasons)reasons
...
*   {}[DeliverySetting.legacyModeBlocked](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliverySetting#field-legacyModeBlocked)
