---
title: "DeliveryAvailableService"
description: "Shopify GraphQL Admin API documentation for deliveryavailableservice"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryavailableservice"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryavailableservice

Markdown Content:
DeliveryAvailableService - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryavailableservice#main-content)
...
[Anchor to DeliveryAvailableService](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryavailableservice#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryavailableservice#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to countries](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryavailableservice#field-DeliveryAvailableService.fields.countries)countries
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryavailableservice#field-DeliveryAvailableService.fields.name)name
...
*   {}[DeliveryCarrierService.availableServicesForCountries](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryCarrierService#field-availableServicesForCountries)
