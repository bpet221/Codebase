---
title: "DeliverySetting"
description: "Shopify GraphQL Admin API documentation for deliverysetting"
date: "2025-08-01"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting

Markdown Content:
DeliverySetting - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#queries)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#mutations)
...
[Anchor to DeliverySetting](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#top)
Delivery Setting
================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#fields)Fields
----------------------------------------------------------------------------------------------------------

[Anchor to legacyModeBlocked](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#field-DeliverySetting.fields.legacyModeBlocked)legacy Mode Blocked
...
[Anchor to legacyModeProfiles](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#field-DeliverySetting.fields.legacyModeProfiles)legacy Mode Profiles
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#queries)Queries
-------------------------------------------------------------------------------------------------------------

[Anchor to deliverySettings](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#query-deliverySettings)[delivery Settings](https://shopify.dev/docs/api/admin-graphql/latest/queries/deliverySettings)
...
*   <?>[delivery Settings](https://shopify.dev/docs/api/admin-graphql/latest/queries/DeliverySetting)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------

[Anchor to deliverySettingUpdate](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverysetting#mutation-deliverySettingUpdate)[delivery Setting Update](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverySettingUpdate)
