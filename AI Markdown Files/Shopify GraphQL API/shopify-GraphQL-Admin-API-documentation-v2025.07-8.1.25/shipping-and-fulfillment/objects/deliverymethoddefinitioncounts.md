---
title: "DeliveryMethodDefinitionCounts"
description: "Shopify GraphQL Admin API documentation for deliverymethoddefinitioncounts"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitioncounts"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitioncounts

Markdown Content:
DeliveryMethodDefinitionCounts - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitioncounts#main-content)
...
[Anchor to DeliveryMethodDefinitionCounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitioncounts#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitioncounts#fields)Fields
-------------------------------------------------------------------------------------------------------------------------

[Anchor to participantDefinitionsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitioncounts#field-DeliveryMethodDefinitionCounts.fields.participantDefinitionsCount)participant Definitions Count
...
[Anchor to rateDefinitionsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinitioncounts#field-DeliveryMethodDefinitionCounts.fields.rateDefinitionsCount)rate Definitions Count
...
*   {}[DeliveryLocationGroupZone.methodDefinitionCounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryLocationGroupZone#field-methodDefinitionCounts)
