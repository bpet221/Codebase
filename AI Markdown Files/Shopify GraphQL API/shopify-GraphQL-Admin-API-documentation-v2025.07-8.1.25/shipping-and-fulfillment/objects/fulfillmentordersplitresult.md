---
title: "FulfillmentOrderSplitResult"
description: "Shopify GraphQL Admin API documentation for fulfillmentordersplitresult"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult

Markdown Content:
FulfillmentOrderSplitResult - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#mutations)
...
[Anchor to FulfillmentOrderSplitResult](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to fulfillmentOrder](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#field-FulfillmentOrderSplitResult.fields.fulfillmentOrder)fulfillment Order
...
[Anchor to remainingFulfillmentOrder](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#field-FulfillmentOrderSplitResult.fields.remainingFulfillmentOrder)remaining Fulfillment Order
...
[Anchor to replacementFulfillmentOrder](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#field-FulfillmentOrderSplitResult.fields.replacementFulfillmentOrder)replacement Fulfillment Order
...
[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to fulfillmentOrderSplit](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentordersplitresult#mutation-fulfillmentOrderSplit)[fulfillment Order Split](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentOrderSplit)
