---
title: "DeliveryProfileLocationGroup"
description: "Shopify GraphQL Admin API documentation for deliveryprofilelocationgroup"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofilelocationgroup"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofilelocationgroup

Markdown Content:
DeliveryProfileLocationGroup - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofilelocationgroup#main-content)
...
[Anchor to DeliveryProfileLocationGroup](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofilelocationgroup#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofilelocationgroup#fields)Fields
-----------------------------------------------------------------------------------------------------------------------

[Anchor to countriesInAnyZone](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofilelocationgroup#field-DeliveryProfileLocationGroup.fields.countriesInAnyZone)countries In Any Zone
...
[Anchor to locationGroup](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofilelocationgroup#field-DeliveryProfileLocationGroup.fields.locationGroup)location Group
...
[Anchor to locationGroupZones](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprofilelocationgroup#field-DeliveryProfileLocationGroup.fields.locationGroupZones)location Group Zones
...
*   {}[DeliveryProfile.profileLocationGroups](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryProfile#field-profileLocationGroups)
