---
title: "DeliveryMethodDefinition"
description: "Shopify GraphQL Admin API documentation for deliverymethoddefinition"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition

Markdown Content:
DeliveryMethodDefinition - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#interfaces)
...
[Anchor to DeliveryMethodDefinition](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#fields)Fields
-------------------------------------------------------------------------------------------------------------------

[Anchor to active](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#field-DeliveryMethodDefinition.fields.active)active
...
[Anchor to description](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#field-DeliveryMethodDefinition.fields.description)description

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

The description of the method definition. Only available on shipping rates that are custom.

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#field-DeliveryMethodDefinition.fields.id)id
...
[Anchor to methodConditions](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#field-DeliveryMethodDefinition.fields.methodConditions)method Conditions
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#field-DeliveryMethodDefinition.fields.name)name
...
[Anchor to rateProvider](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#field-DeliveryMethodDefinition.fields.rateProvider)rate Provider
...
*   {}[DeliveryLocationGroupZone.methodDefinitions](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryLocationGroupZone#field-methodDefinitions)
*   <->[DeliveryMethodDefinitionConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryMethodDefinitionConnection#field-nodes)
*   {}[DeliveryMethodDefinitionEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryMethodDefinitionEdge#field-node)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#interfaces)Interfaces
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverymethoddefinition#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
