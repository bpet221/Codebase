---
title: "DeliveryLocationGroup"
description: "Shopify GraphQL Admin API documentation for deliverylocationgroup"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup

Markdown Content:
DeliveryLocationGroup - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#interfaces)
...
[Anchor to DeliveryLocationGroup](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#fields)Fields
----------------------------------------------------------------------------------------------------------------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#field-DeliveryLocationGroup.fields.id)id
...
[Anchor to locations](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#field-DeliveryLocationGroup.fields.locations)locations
...
[Anchor to locationsCount](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#field-DeliveryLocationGroup.fields.locationsCount)locations Count
...
*   {}[DeliveryProfileLocationGroup.locationGroup](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryProfileLocationGroup#field-locationGroup)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#interfaces)Interfaces
----------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroup#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
