---
title: "DeliveryBrandedPromise"
description: "Shopify GraphQL Admin API documentation for deliverybrandedpromise"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverybrandedpromise"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverybrandedpromise

Markdown Content:
DeliveryBrandedPromise - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverybrandedpromise#main-content)
...
[Anchor to DeliveryBrandedPromise](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverybrandedpromise#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverybrandedpromise#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to handle](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverybrandedpromise#field-DeliveryBrandedPromise.fields.handle)handle
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverybrandedpromise#field-DeliveryBrandedPromise.fields.name)name
...
*   {}[DeliveryMethod.brandedPromise](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryMethod#field-brandedPromise)
