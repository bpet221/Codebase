---
title: "DeliveryCountryCodesOrRestOfWorld"
description: "Shopify GraphQL Admin API documentation for deliverycountrycodesorrestofworld"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodesorrestofworld"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodesorrestofworld

Markdown Content:
DeliveryCountryCodesOrRestOfWorld - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodesorrestofworld#main-content)
...
[Anchor to DeliveryCountryCodesOrRestOfWorld](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodesorrestofworld#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodesorrestofworld#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to countryCodes](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodesorrestofworld#field-DeliveryCountryCodesOrRestOfWorld.fields.countryCodes)country Codes
...
[Anchor to restOfWorld](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodesorrestofworld#field-DeliveryCountryCodesOrRestOfWorld.fields.restOfWorld)rest Of World
...
*   {}[DeliveryAvailableService.countries](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryAvailableService#field-countries)
