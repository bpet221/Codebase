---
title: "DeliveryCountryCodeOrRestOfWorld"
description: "Shopify GraphQL Admin API documentation for deliverycountrycodeorrestofworld"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodeorrestofworld"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodeorrestofworld

Markdown Content:
DeliveryCountryCodeOrRestOfWorld - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodeorrestofworld#main-content)
...
[Anchor to DeliveryCountryCodeOrRestOfWorld](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodeorrestofworld#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodeorrestofworld#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to countryCode](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodeorrestofworld#field-DeliveryCountryCodeOrRestOfWorld.fields.countryCode)country Code
...
[Anchor to restOfWorld](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountrycodeorrestofworld#field-DeliveryCountryCodeOrRestOfWorld.fields.restOfWorld)rest Of World
...
*   {}[DeliveryCountry.code](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryCountry#field-code)
