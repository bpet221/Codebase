---
title: "DeliveryParticipant"
description: "Shopify GraphQL Admin API documentation for deliveryparticipant"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant

Markdown Content:
DeliveryParticipant - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#interfaces)
...
[Anchor to DeliveryParticipant](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#fields)Fields
--------------------------------------------------------------------------------------------------------------

[Anchor to adaptToNewServicesFlag](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#field-DeliveryParticipant.fields.adaptToNewServicesFlag)adapt To New Services Flag
...
[Anchor to carrierService](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#field-DeliveryParticipant.fields.carrierService)carrier Service
...
[Anchor to fixedFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#field-DeliveryParticipant.fields.fixedFee)fixed Fee
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#field-DeliveryParticipant.fields.id)id
...
[Anchor to participantServices](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#field-DeliveryParticipant.fields.participantServices)participant Services
...
[Anchor to percentageOfRateFee](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#field-DeliveryParticipant.fields.percentageOfRateFee)percentage Of Rate Fee
...
[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#interfaces)Interfaces
--------------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipant#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
