---
title: "DeliveryLocalPickupSettings"
description: "Shopify GraphQL Admin API documentation for deliverylocalpickupsettings"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings

Markdown Content:
DeliveryLocalPickupSettings - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings#fields)
        *   [Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings#mutations)
...
[Anchor to DeliveryLocalPickupSettings](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings#fields)Fields
----------------------------------------------------------------------------------------------------------------------

[Anchor to instructions](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings#field-DeliveryLocalPickupSettings.fields.instructions)instructions
...
[Anchor to pickupTime](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings#field-DeliveryLocalPickupSettings.fields.pickupTime)pickup Time
...
*   {}[Location.localPickupSettingsV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/Location#field-localPickupSettingsV2)

* * *

[Anchor to Mutations](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings#mutations)Mutations
-------------------------------------------------------------------------------------------------------------------------------

[Anchor to locationLocalPickupEnable](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocalpickupsettings#mutation-locationLocalPickupEnable)[location Local Pickup Enable](https://shopify.dev/docs/api/admin-graphql/latest/mutations/locationLocalPickupEnable)
