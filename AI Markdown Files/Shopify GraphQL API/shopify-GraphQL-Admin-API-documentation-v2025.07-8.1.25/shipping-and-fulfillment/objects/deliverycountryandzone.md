---
title: "DeliveryCountryAndZone"
description: "Shopify GraphQL Admin API documentation for deliverycountryandzone"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountryandzone"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountryandzone

Markdown Content:
DeliveryCountryAndZone - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountryandzone#main-content)
...
[Anchor to DeliveryCountryAndZone](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountryandzone#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountryandzone#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to country](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountryandzone#field-DeliveryCountryAndZone.fields.country)country
...
[Anchor to zone](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverycountryandzone#field-DeliveryCountryAndZone.fields.zone)zone
...
*   {}[DeliveryProfileLocationGroup.countriesInAnyZone](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryProfileLocationGroup#field-countriesInAnyZone)
