---
title: "DeliveryParticipantService"
description: "Shopify GraphQL Admin API documentation for deliveryparticipantservice"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipantservice"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipantservice

Markdown Content:
DeliveryParticipantService - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipantservice#main-content)
...
[Anchor to DeliveryParticipantService](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipantservice#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipantservice#fields)Fields
---------------------------------------------------------------------------------------------------------------------

[Anchor to active](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipantservice#field-DeliveryParticipantService.fields.active)active
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryparticipantservice#field-DeliveryParticipantService.fields.name)name
...
*   {}[DeliveryParticipant.participantServices](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryParticipant#field-participantServices)
