---
title: "DeliveryProvince"
description: "Shopify GraphQL Admin API documentation for deliveryprovince"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince

Markdown Content:
DeliveryProvince - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#fields)
        *   [Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#interfaces)
...
[Anchor to DeliveryProvince](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#top)
Delivery Province
=================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#fields)Fields
-----------------------------------------------------------------------------------------------------------

[Anchor to code](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#field-DeliveryProvince.fields.code)code
...
[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#field-DeliveryProvince.fields.id)id
...
[Anchor to name](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#field-DeliveryProvince.fields.name)name
...
[Anchor to translatedName](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#field-DeliveryProvince.fields.translatedName)translated Name
...
*   {}[DeliveryCountry.provinces](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryCountry#field-provinces)

* * *

[Anchor to Interfaces](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#interfaces)Interfaces
-----------------------------------------------------------------------------------------------------------------------

[Anchor to Node](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliveryprovince#interface-Node)[Node](https://shopify.dev/docs/api/admin-graphql/latest/interfaces/Node)
