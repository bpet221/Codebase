---
title: "DeliveryPromiseSetting"
description: "Shopify GraphQL Admin API documentation for deliverypromisesetting"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting

Markdown Content:
DeliveryPromiseSetting - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting#main-content)
...
Objects
        ...
        *   [Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting#fields)
        *   [Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting#queries)
...
[Anchor to DeliveryPromiseSetting](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting#fields)Fields
-----------------------------------------------------------------------------------------------------------------

[Anchor to deliveryDatesEnabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting#field-DeliveryPromiseSetting.fields.deliveryDatesEnabled)delivery Dates Enabled
...
[Anchor to processingTime](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting#field-DeliveryPromiseSetting.fields.processingTime)processing Time
...
[Anchor to Queries](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting#queries)Queries
--------------------------------------------------------------------------------------------------------------------

[Anchor to deliveryPromiseSettings](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverypromisesetting#query-deliveryPromiseSettings)[delivery Promise Settings](https://shopify.dev/docs/api/admin-graphql/latest/queries/deliveryPromiseSettings)
...
*   <?>[delivery Promise Settings](https://shopify.dev/docs/api/admin-graphql/latest/queries/DeliveryPromiseSetting)
