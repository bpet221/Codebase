---
title: "DeliveryLocationGroupZone"
description: "Shopify GraphQL Admin API documentation for deliverylocationgroupzone"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzone"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzone

Markdown Content:
DeliveryLocationGroupZone - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzone#main-content)
...
[Anchor to DeliveryLocationGroupZone](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzone#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzone#fields)Fields
--------------------------------------------------------------------------------------------------------------------

[Anchor to methodDefinitionCounts](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzone#field-DeliveryLocationGroupZone.fields.methodDefinitionCounts)method Definition Counts
...
[Anchor to methodDefinitions](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzone#field-DeliveryLocationGroupZone.fields.methodDefinitions)method Definitions
...
[Anchor to zone](https://shopify.dev/docs/api/admin-graphql/latest/objects/deliverylocationgroupzone#field-DeliveryLocationGroupZone.fields.zone)zone
...
*   <->[DeliveryLocationGroupZoneConnection.nodes](https://shopify.dev/docs/api/admin-graphql/latest/connections/DeliveryLocationGroupZoneConnection#field-nodes)
*   {}[DeliveryLocationGroupZoneEdge.node](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryLocationGroupZoneEdge#field-node)
*   {}[DeliveryProfileLocationGroup.locationGroupZones](https://shopify.dev/docs/api/admin-graphql/latest/objects/DeliveryProfileLocationGroup#field-locationGroupZones)
