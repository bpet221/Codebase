---
title: "FulfillmentOrderInternationalDuties"
description: "Shopify GraphQL Admin API documentation for fulfillmentorderinternationalduties"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderinternationalduties"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderinternationalduties

Markdown Content:
FulfillmentOrderInternationalDuties - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderinternationalduties#main-content)
...
[Anchor to FulfillmentOrderInternationalDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderinternationalduties#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderinternationalduties#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to incoterm](https://shopify.dev/docs/api/admin-graphql/latest/objects/fulfillmentorderinternationalduties#field-FulfillmentOrderInternationalDuties.fields.incoterm)incoterm
...
*   {}[FulfillmentOrder.internationalDuties](https://shopify.dev/docs/api/admin-graphql/latest/objects/FulfillmentOrder#field-internationalDuties)
