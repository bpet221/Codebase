...
description: "Shopify GraphQL Admin API documentation for shippingpackagedelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagedelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagedelete

Markdown Content:
shippingPackageDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagedelete#main-content)
...
[Anchor to shippingPackageDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagedelete#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagedelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagedelete#arguments-id)id
...
[Anchor to ShippingPackageDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagedelete#returns)Shipping Package Delete Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagedelete#returns-deletedId)deleted Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the deleted shipping package.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagedelete#returns-userErrors)user Errors
