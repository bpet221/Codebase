---
title: "deliveryCustomizationDelete"
description: "Shopify GraphQL Admin API documentation for deliverycustomizationdelete"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverycustomizationdelete"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverycustomizationdelete

Markdown Content:
deliveryCustomizationDelete - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverycustomizationdelete#main-content)
...
[Anchor to deliveryCustomizationDelete](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverycustomizationdelete#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverycustomizationdelete#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverycustomizationdelete#arguments-id)id
...
[Anchor to DeliveryCustomizationDeletePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverycustomizationdelete#returns)Delivery Customization Delete Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to deletedId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverycustomizationdelete#returns-deletedId)deleted Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

Returns the deleted delivery customization ID.

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverycustomizationdelete#returns-userErrors)user Errors
