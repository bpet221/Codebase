---
title: "shippingPackageMakeDefault"
description: "Shopify GraphQL Admin API documentation for shippingpackagemakedefault"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagemakedefault"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagemakedefault

Markdown Content:
shippingPackageMakeDefault - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagemakedefault#main-content)
...
[Anchor to shippingPackageMakeDefault](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagemakedefault#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagemakedefault#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagemakedefault#arguments-id)id
...
[Anchor to ShippingPackageMakeDefaultPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagemakedefault#returns)Shipping Package Make Default Payload returns
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/shippingpackagemakedefault#returns-userErrors)user Errors
