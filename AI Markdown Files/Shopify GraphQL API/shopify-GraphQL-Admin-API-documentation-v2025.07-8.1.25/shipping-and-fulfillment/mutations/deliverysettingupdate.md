---
title: "deliverySettingUpdate"
description: "Shopify GraphQL Admin API documentation for deliverysettingupdate"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverysettingupdate"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverysettingupdate

Markdown Content:
deliverySettingUpdate - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverysettingupdate#main-content)
...
[Anchor to deliverySettingUpdate](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverysettingupdate#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverysettingupdate#arguments)
Arguments
---------

[Anchor to setting](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverysettingupdate#arguments-setting)setting
...
[Anchor to DeliverySettingUpdatePayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverysettingupdate#returns)Delivery Setting Update Payload returns
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to setting](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverysettingupdate#returns-setting)setting
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/deliverysettingupdate#returns-userErrors)user Errors
