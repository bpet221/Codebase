---
title: "fulfillmentOrderRejectFulfillmentRequest"
description: "Shopify GraphQL Admin API documentation for fulfillmentorderrejectfulfillmentrequest"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest

Markdown Content:
fulfillmentOrderRejectFulfillmentRequest - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#main-content)
...
[Anchor to fulfillmentOrderRejectFulfillmentRequest](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#arguments)
Arguments
---------

[Anchor to id](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#arguments-id)id
...
[Anchor to lineItems](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#arguments-lineItems)line Items
...
[Anchor to message](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#arguments-message)message

•[String](https://shopify.dev/docs/api/admin-graphql/latest/scalars/String)

An optional reason for rejecting the fulfillment request.

[Anchor to reason](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#arguments-reason)reason
...
[Anchor to FulfillmentOrderRejectFulfillmentRequestPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#returns)Fulfillment Order Reject Fulfillment Request Payload returns
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to fulfillmentOrder](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#returns-fulfillmentOrder)fulfillment Order
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/fulfillmentorderrejectfulfillmentrequest#returns-userErrors)user Errors
