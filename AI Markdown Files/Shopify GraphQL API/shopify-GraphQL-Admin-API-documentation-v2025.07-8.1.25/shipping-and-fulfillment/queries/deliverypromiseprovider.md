---
title: "deliveryPromiseProvider"
description: "Shopify GraphQL Admin API documentation for deliverypromiseprovider"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/queries/deliverypromiseprovider"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/queries/deliverypromiseprovider

Markdown Content:
deliveryPromiseProvider - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/queries/deliverypromiseprovider#main-content)
...
[Anchor to deliveryPromiseProvider](https://shopify.dev/docs/api/admin-graphql/latest/queries/deliverypromiseprovider#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/queries/deliverypromiseprovider#arguments)
Arguments
---------

[Anchor to locationId](https://shopify.dev/docs/api/admin-graphql/latest/queries/deliverypromiseprovider#arguments-locationId)location Id
...
[Anchor to Possible returns](https://shopify.dev/docs/api/admin-graphql/latest/queries/deliverypromiseprovider#possible-returns)Possible returns
------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to DeliveryPromiseProvider](https://shopify.dev/docs/api/admin-graphql/latest/queries/deliverypromiseprovider#returns-DeliveryPromiseProvider)Delivery Promise Provider
...
deliveryPromiseProvider(locationId){
