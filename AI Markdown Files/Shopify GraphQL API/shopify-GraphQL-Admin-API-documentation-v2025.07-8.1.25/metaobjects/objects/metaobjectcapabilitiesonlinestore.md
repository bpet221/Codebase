---
title: "MetaobjectCapabilitiesOnlineStore"
description: "Shopify GraphQL Admin API documentation for metaobjectcapabilitiesonlinestore"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesonlinestore"
...
Title: MetaobjectCapabilitiesOnlineStore - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesonlinestore

Markdown Content:
MetaobjectCapabilitiesOnlineStore - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesonlinestore#main-content)
...
[Anchor to MetaobjectCapabilitiesOnlineStore](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesonlinestore#top)
Metaobject Capabilities Online Store
====================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesonlinestore#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to data](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesonlinestore#field-MetaobjectCapabilitiesOnlineStore.fields.data)data
...
[Anchor to enabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesonlinestore#field-MetaobjectCapabilitiesOnlineStore.fields.enabled)enabled
...
*   {}[MetaobjectCapabilities.onlineStore](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetaobjectCapabilities#field-onlineStore)
