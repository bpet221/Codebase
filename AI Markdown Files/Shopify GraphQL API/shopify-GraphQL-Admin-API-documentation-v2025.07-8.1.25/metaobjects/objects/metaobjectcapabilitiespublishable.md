---
title: "MetaobjectCapabilitiesPublishable"
description: "Shopify GraphQL Admin API documentation for metaobjectcapabilitiespublishable"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiespublishable"
...
Title: MetaobjectCapabilitiesPublishable - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiespublishable

Markdown Content:
MetaobjectCapabilitiesPublishable - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiespublishable#main-content)
...
[Anchor to MetaobjectCapabilitiesPublishable](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiespublishable#top)
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiespublishable#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to enabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiespublishable#field-MetaobjectCapabilitiesPublishable.fields.enabled)enabled
...
*   {}[MetaobjectCapabilities.publishable](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetaobjectCapabilities#field-publishable)
