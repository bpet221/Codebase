---
title: "MetaobjectCapabilitiesRenderable"
description: "Shopify GraphQL Admin API documentation for metaobjectcapabilitiesrenderable"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesrenderable"
...
Title: MetaobjectCapabilitiesRenderable - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesrenderable

Markdown Content:
MetaobjectCapabilitiesRenderable - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesrenderable#main-content)
...
[Anchor to MetaobjectCapabilitiesRenderable](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesrenderable#top)
Metaobject Capabilities Renderable
==================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesrenderable#fields)Fields
---------------------------------------------------------------------------------------------------------------------------

[Anchor to data](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesrenderable#field-MetaobjectCapabilitiesRenderable.fields.data)data
...
[Anchor to enabled](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitiesrenderable#field-MetaobjectCapabilitiesRenderable.fields.enabled)enabled
...
*   {}[MetaobjectCapabilities.renderable](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetaobjectCapabilities#field-renderable)
