---
title: "MetaobjectCapabilityDataOnlineStore"
description: "Shopify GraphQL Admin API documentation for metaobjectcapabilitydataonlinestore"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitydataonlinestore"
...
Title: MetaobjectCapabilityDataOnlineStore - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitydataonlinestore

Markdown Content:
MetaobjectCapabilityDataOnlineStore - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitydataonlinestore#main-content)
...
[Anchor to MetaobjectCapabilityDataOnlineStore](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitydataonlinestore#top)
Metaobject Capability Data Online Store
=======================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitydataonlinestore#fields)Fields
------------------------------------------------------------------------------------------------------------------------------

[Anchor to templateSuffix](https://shopify.dev/docs/api/admin-graphql/latest/objects/metaobjectcapabilitydataonlinestore#field-MetaobjectCapabilityDataOnlineStore.fields.templateSuffix)template Suffix
...
*   {}[MetaobjectCapabilityData.onlineStore](https://shopify.dev/docs/api/admin-graphql/latest/objects/MetaobjectCapabilityData#field-onlineStore)
