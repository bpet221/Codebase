---
title: "metafieldDefinitionUnpin"
description: "Shopify GraphQL Admin API documentation for metafielddefinitionunpin"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin

Markdown Content:
metafieldDefinitionUnpin - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin#main-content)
...
[Anchor to metafieldDefinitionUnpin](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin#top)
...
[Anchor to Arguments](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin#arguments)
Arguments
---------

[Anchor to definitionId](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin#arguments-definitionId)definition Id

•[ID](https://shopify.dev/docs/api/admin-graphql/latest/scalars/ID)

The ID of the metafield definition to unpin. Using `identifier` is preferred.

[Anchor to identifier](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin#arguments-identifier)identifier
...
[Anchor to MetafieldDefinitionUnpinPayload returns](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin#returns)Metafield Definition Unpin Payload returns
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

[Anchor to unpinnedDefinition](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin#returns-unpinnedDefinition)unpinned Definition
...
[Anchor to userErrors](https://shopify.dev/docs/api/admin-graphql/latest/mutations/metafielddefinitionunpin#returns-userErrors)user Errors
...
Show description[Open in GraphiQL](http://localhost:3457/graphiql?query=mutation%20metafieldDefinitionUnpin(%24definitionId%3A%20ID!)%20%7B%0A%20%20metafieldDefinitionUnpin(definitionId%3A%20%24definitionId)%20%7B%0A%20%20%20%20unpinnedDefinition%20%7B%0A%20%20%20%20%20%20name%0A%20%20%20%20%20%20key%0A%20%20%20%20%20%20namespace%0A%20%20%20%20%20%20pinnedPosition%0A%20%20%20%20%7D%0A%20%20%20%20userErrors%20%7B%0A%20%20%20%20%20%20field%0A%20%20%20%20%20%20message%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D&variables=%7B%0A%20%20%22definitionId%22%3A%20%22gid%3A%2F%2Fshopify%2FMetafieldDefinition%2F1071456133%22%0A%7D)Copy
