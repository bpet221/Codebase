---
title: "AppPlanV2"
description: "Shopify GraphQL Admin API documentation for appplanv2"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appplanv2"
...
URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appplanv2

Markdown Content:
AppPlanV2 - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appplanv2#main-content)
...
[Anchor to AppPlanV2](https://shopify.dev/docs/api/admin-graphql/latest/objects/appplanv2#top)
App Plan V2
===========
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appplanv2#fields)Fields
----------------------------------------------------------------------------------------------------

[Anchor to pricingDetails](https://shopify.dev/docs/api/admin-graphql/latest/objects/appplanv2#field-AppPlanV2.fields.pricingDetails)pricing Details
...
*   {}[AppSubscriptionLineItem.plan](https://shopify.dev/docs/api/admin-graphql/latest/objects/AppSubscriptionLineItem#field-plan)
