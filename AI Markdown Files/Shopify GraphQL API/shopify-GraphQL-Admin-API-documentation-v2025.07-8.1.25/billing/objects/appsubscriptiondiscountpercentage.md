---
title: "AppSubscriptionDiscountPercentage"
description: "Shopify GraphQL Admin API documentation for appsubscriptiondiscountpercentage"
date: "2025-08-01"
source: "https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiondiscountpercentage"
...
Title: AppSubscriptionDiscountPercentage - GraphQL Admin

URL Source: https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiondiscountpercentage

Markdown Content:
AppSubscriptionDiscountPercentage - GraphQL Admin

===============
[Skip to main content](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiondiscountpercentage#main-content)
...
[Anchor to AppSubscriptionDiscountPercentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiondiscountpercentage#top)
App Subscription Discount Percentage
====================================
...
[Anchor to Fields](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiondiscountpercentage#fields)Fields
----------------------------------------------------------------------------------------------------------------------------

[Anchor to percentage](https://shopify.dev/docs/api/admin-graphql/latest/objects/appsubscriptiondiscountpercentage#field-AppSubscriptionDiscountPercentage.fields.percentage)percentage
