...
URL Source: https://shopify.dev/docs/storefronts/themes/best-practices/javascript-and-stylesheet-tags
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/best-practices/javascript-and-stylesheet-tags#Main)
...
[Anchor link to section titled "javascript"](https://shopify.dev/docs/storefronts/themes/best-practices/javascript-and-stylesheet-tags#javascript)
...
[Anchor link to section titled "Instance specific JavaScript"](https://shopify.dev/docs/storefronts/themes/best-practices/javascript-and-stylesheet-tags#instance-specific-javascript)
...
[Anchor link to section titled "stylesheet"](https://shopify.dev/docs/storefronts/themes/best-practices/javascript-and-stylesheet-tags#stylesheet)
...
The content from `{% stylesheet %}` tags across all sections, blocks and snippets is concatenated into a single `styles.css` file by Shopify, and then injected into the theme through the `content_for_header`[global Liquid object](https://shopify.dev/docs/api/liquid/objects/content_for_header).

### Instance specific styles

[Anchor link to section titled "Instance specific styles"](https://shopify.dev/docs/storefronts/themes/best-practices/javascript-and-stylesheet-tags#instance-specific-styles)
