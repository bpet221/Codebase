---
title: "Platform"
source: https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform
sections: Best practices > Performance
created: 2025-07-29 15:26:18
---

Title: The Shopify platform

URL Source: https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#Main)
...
[Anchor link to section titled "Shopify CDN"](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#shopify-cdn)
...
[Anchor link to section titled "Short delays for images in your store"](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#short-delays-for-images-in-your-store)
...
[Anchor link to section titled "CSS syntax to ensure automatic updates"](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#css-syntax-to-ensure-automatic-updates)
...
[Anchor link to section titled "Server-side rendering"](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#server-side-rendering)
...
[Anchor link to section titled "Minification"](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#minification)
...
[Anchor link to section titled "Speculation Rules"](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#speculation-rules)
...
[Anchor link to section titled "Polyfills"](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#polyfills)
...
[Anchor link to section titled "Pagination Limits"](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#pagination-limits)
...
Pagination above 25,000 items suggest a more suitable design can be found to help Buyers narrow down their search to a managable amount of items before paging through all resutls. If you are finding your self constrainted by this limitation [see how you can add filters to your shop](https://help.shopify.com/en/manual/online-store/search-and-discovery/filters).
...
*   [Server-side rendering](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#server-side-rendering)
*   [Minification](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#minification)
*   [Speculation Rules](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#speculation-rules)
*   [Polyfills](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#polyfills)
*   [Pagination Limits](https://shopify.dev/docs/storefronts/themes/best-practices/performance/platform#pagination-limits)
