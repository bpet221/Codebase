---
title: "Schema locale files"
source: https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files
sections: Key concepts > Locales
created: 2025-07-29 15:24:47
---

Title: Schema locale files

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#Main)
...
To learn which attributes can be translated, refer to [Content](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#content).

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#location)
...
[Anchor link to section titled "Schema"](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#schema)

Schema locale files need to follow a specific [naming structure](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#name-structure). They also follow a basic organizational structure:
...
[Anchor link to section titled "Name structure"](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#name-structure)
...
Additionally, you must designate a [default locale file](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#the-default-locale-file).

#### The default locale file

[Anchor link to section titled "The default locale file"](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#the-default-locale-file)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#content)
...
| `settings_schema.json` [Section schema](https://shopify.dev/docs/storefronts/themes/architecture/sections/section-schema) `block` | `name` |
| `select` | `group` |
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#usage)

When working with schema locale files, you should familiarize yourself with [referencing schema translations](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#reference-schema-translations).

### Reference schema translations

[Anchor link to section titled "Reference schema translations"](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#reference-schema-translations)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#location)
*   [Schema](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#schema)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#usage)
