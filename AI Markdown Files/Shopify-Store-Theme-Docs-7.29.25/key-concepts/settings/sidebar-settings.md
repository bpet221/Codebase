...
source: https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings
sections: Key concepts > Settings
created: 2025-07-29 15:24:13
---

Title: Sidebar settings

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#Main)
...
Sidebar settings are composed of [standard attributes](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#standard-attributes). The following are the types of sidebar settings:

*   [header](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#header)
*   [paragraph](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#paragraph)

#### Tip

If you want to add input settings, like a checkbox, then refer to [Input settings](https://shopify.dev/docs/storefronts/themes/architecture/settings/input-settings).

Standard attributes
-------------------

[Anchor link to section titled "Standard attributes"](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#standard-attributes)

The following are standard attributes across sidebar settings:

| Attribute | Description | Required |
| --- | --- | --- |
| `type` | The input setting type, which can be either [header](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#header) or [paragraph](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#paragraph). | Yes |
| `content` | The setting content, which will show in the theme editor. | Yes |

header
------

[Anchor link to section titled "header"](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#header)

A setting of type `header` outputs a header element to help you better organize your input settings. In addition to the [standard attributes](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#standard-attributes) of a sidebar setting, `header` type settings have the following attribute:
...
![Image 5: header setting](https://shopify.dev/assets/themes/header-setting-with-info.png)

paragraph
---------

[Anchor link to section titled "paragraph"](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#paragraph)
...
![Image 6: paragraph setting](https://shopify.dev/assets/themes/paragraph-setting.png)

Create links
------------

[Anchor link to section titled "Create links"](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#create-links)
...
![Image 7: link setting](https://shopify.dev/assets/themes/create_links_input.png)

### On this page

*   [Standard attributes](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#standard-attributes)
*   [header](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#header)
*   [paragraph](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#paragraph)
*   [Create links](https://shopify.dev/docs/storefronts/themes/architecture/settings/sidebar-settings#create-links)
