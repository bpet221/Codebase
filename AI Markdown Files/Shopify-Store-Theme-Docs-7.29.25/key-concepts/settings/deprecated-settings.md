...
source: https://shopify.dev/docs/storefronts/themes/architecture/settings/deprecated-settings
...
URL Source: https://shopify.dev/docs/storefronts/themes/architecture/settings/deprecated-settings
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/settings/deprecated-settings#Main)
...
[Anchor link to section titled "font"](https://shopify.dev/docs/storefronts/themes/architecture/settings/deprecated-settings#font)

The `font` setting has been replaced by the [font_picker](https://shopify.dev/docs/themes/architecture/settings/input-settings#font_picker) setting.
...
![Image 4: font setting](https://shopify.dev/assets/themes/ts-font.png)

snippet
-------

[Anchor link to section titled "snippet"](https://shopify.dev/docs/storefronts/themes/architecture/settings/deprecated-settings#snippet)

The `snippet` setting has been replaced by [sections](https://shopify.dev/docs/storefronts/themes/architecture/sections).
...
![Image 5: snippet settings](https://shopify.dev/assets/themes/ts-footer.png)

### On this page

*   [font](https://shopify.dev/docs/storefronts/themes/architecture/settings/deprecated-settings#font)
*   [snippet](https://shopify.dev/docs/storefronts/themes/architecture/settings/deprecated-settings#snippet)
