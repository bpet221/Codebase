---
title: "App blocks"
source: https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks
sections: Key concepts > Blocks
created: 2025-07-29 15:23:38
---

Title: App blocks for themes

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#Main)
...
When merchants choose to add the app to a new section, Shopify automatically wraps the app block in a [wrapper section](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#app-block-wrapper) called `Apps`. You can customize this wrapper section by your own `apps.liquid` section.

To add support for app blocks to your sections and theme blocks, you need take the following steps:

*   [Add support for app blocks to the schema](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#supporting-app-blocks)
*   [Render the block content](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#render-app-blocks)
*   [Ensure that you have valid section settings](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#app-blocks-and-section-settings)
...
[Anchor link to section titled "Supporting app blocks"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#supporting-app-blocks)
...
[Anchor link to section titled "Render app blocks"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#render-app-blocks)
...
[Anchor link to section titled "Render app blocks alongside section-defined blocks"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#render-app-blocks-alongside-section-defined-blocks)
...
[Anchor link to section titled "App blocks and section settings"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#app-blocks-and-section-settings)
...
[Anchor link to section titled "App block wrapper"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#app-block-wrapper)
...
[Anchor link to section titled "Shopify wrapper logic"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#shopify-wrapper-logic)
...
[Anchor link to section titled "Theme-provided apps.liquid section"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#theme-provided-apps-liquid-section)
...
[Anchor link to section titled "Theme-provided _blocks.liquid section"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#theme-provided-_blocks-liquid-section)
...
[Anchor link to section titled "Platform-generated apps.liquid section"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#platform-generated-apps-liquid-section)
...
[Anchor link to section titled "App Wrapper Examples"](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks#app-wrapper-examples)
