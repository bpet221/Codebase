...
source: https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json
sections: Key concepts > Config
created: 2025-07-29 15:24:44
---

Title: settings_schema.json

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#Main)
...
[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#location)
...
[Anchor link to section titled "Schema"](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#schema)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#usage)

When working with the `settings_schema.json` file, familiarize yourself with the following:

*   [setting types](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#setting-types)
*   [accessing settings](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#access-settings)
*   [adding theme metadata](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#add-theme-metadata)

### Setting types

[Anchor link to section titled "Setting types"](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#setting-types)
...
[Anchor link to section titled "Access settings"](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#access-settings)
...
[Anchor link to section titled "Add theme metadata"](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#add-theme-metadata)
...
![Image 3](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/theme-editor/theme-info-panel-highlighted-a706485d9f85e6e2481e8f3b72ccedc42c50b1fc1d83af5b3a4298bb2598613f.png)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#location)
*   [Schema](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#schema)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#usage)
