---
title: "page"
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/page
sections: Key concepts > Templates > Page
created: 2025-07-29 15:23:01
---

Title: page

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/page
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/page#Main)
...
![Image 4: An example of the page template in Dawn](https://shopify.dev/assets/themes/templates/page.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/page#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/page#content)

You can include the following in your page template or a section inside of the template:

*   [The page object](https://shopify.dev/docs/storefronts/themes/architecture/templates/page#the-page-object)

### The page object

[Anchor link to section titled "The page object"](https://shopify.dev/docs/storefronts/themes/architecture/templates/page#the-page-object)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/page#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/page#content)
