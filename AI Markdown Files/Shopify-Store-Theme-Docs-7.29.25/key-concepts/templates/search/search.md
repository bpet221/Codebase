---
title: "search"
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/search
sections: Key concepts > Templates > Search
created: 2025-07-29 15:23:01
---

Title: search

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/search
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#Main)
...
![Image 3: An example of the search template in Dawn](https://shopify.dev/assets/themes/templates/search.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#content)

You should include the following in your `search` template or a section inside of the template:

*   [The search object](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#the-search-object)
*   [The search form](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#the-search-form)
*   [The search results](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#the-search-results)

### The search object

[Anchor link to section titled "The search object"](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#the-search-object)

You can access the Liquid [`search` object](https://shopify.dev/docs/api/liquid/objects/search) to display the search details.

### The search form

[Anchor link to section titled "The search form"](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#the-search-form)
...
[Anchor link to section titled "The search results"](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#the-search-results)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#usage)

When working with the `search` template, you should familiarize yourself with [highlighting search terms](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#highlight-search-terms).
...
[Anchor link to section titled "Highlight search terms"](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#highlight-search-terms)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/search#usage)
