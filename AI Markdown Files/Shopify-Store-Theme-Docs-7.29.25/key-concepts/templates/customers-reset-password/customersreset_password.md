---
title: "customers/reset_password"
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password
sections: Key concepts > Templates > Customers Reset Password
created: 2025-07-29 15:22:30
---

Title: customers/reset_password

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password#Main)
...
![Image 3: An example of the customer reset password template in Dawn](https://shopify.dev/assets/themes/templates/customer-reset-password.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password#content)

You should include the [password reset form](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password#the-password-reset-form) in your `customers/account` template or a section inside of the template.
...
[Anchor link to section titled "The password reset form"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password#the-password-reset-form)

The password reset form can be added with the Liquid [`form` tag](https://shopify.dev/docs/api/liquid/tags/form#form-reset_customer_password) and accompanying `'reset_customer_password'` parameter. Within the form tag block, you need to include the following:
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password#usage)
...
1.   Fill out the [password recovery form](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-login#provide-a-forgot-your-password-option) on the login page.
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password#usage)
