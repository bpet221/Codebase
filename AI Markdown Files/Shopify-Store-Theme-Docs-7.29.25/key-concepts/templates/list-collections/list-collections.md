...
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections
sections: Key concepts > Templates > List Collections
created: 2025-07-29 15:22:30
---

Title: list-collections

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#Main)
...
![Image 3: An example of the list-collections template in Dawn](https://shopify.dev/assets/themes/templates/list-collections.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#content)

You can include the following in your list-collections template or a section inside of the template:

*   [The collections object](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#the-collections-object)

### The collections object

[Anchor link to section titled "The collections object"](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#the-collections-object)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#usage)

When working with the `list-collections` template, you should familiarize yourself with the following:

*   [Changing the order of collections](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#change-the-order-of-collections)
*   [Setting a fallback image for collection images](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#collection-image-fallback)
...
[Anchor link to section titled "Change the order of collections"](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#change-the-order-of-collections)
...
[Anchor link to section titled "Collection image fallback"](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#collection-image-fallback)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/list-collections#usage)
