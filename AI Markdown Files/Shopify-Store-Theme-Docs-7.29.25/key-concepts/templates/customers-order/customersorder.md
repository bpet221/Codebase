...
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order
sections: Key concepts > Templates > Customers Order
created: 2025-07-29 15:21:59
---

Title: customers/order

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order#Main)
...
Refer to the [customers/order template](https://github.com/Shopify/dawn/blob/main/templates/customers/order.json) and its [main section](https://github.com/Shopify/dawn/blob/main/sections/main-order.liquid) in Dawn for an example implementation.

![Image 4: An example of the customer order template in Dawn](https://shopify.dev/assets/themes/templates/customer-order.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order#content)

You should include the [order object](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order#the-order-object) in your `customers/account` template or a section inside of the template.
...
[Anchor link to section titled "The order object"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order#the-order-object)

You can access the [`order` object](https://shopify.dev/docs/api/liquid/objects/order) to display the details of the order.

### On this page

*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order#content)
