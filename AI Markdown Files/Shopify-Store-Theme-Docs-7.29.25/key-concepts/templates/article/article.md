---
title: "article"
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/article
sections: Key concepts > Templates > Article
created: 2025-07-29 15:21:30
---

Title: article

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/article
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#Main)
...
![Image 3: An example of the article template in Dawn](https://shopify.dev/assets/themes/templates/article.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#content)

You should include the following in your `article` template or a section inside of the template:

*   [The article object](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#the-article-object)
*   [The comment form](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#the-comment-form)

### The article object

[Anchor link to section titled "The article object"](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#the-article-object)
...
[Anchor link to section titled "The comment form"](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#the-comment-form)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#usage)

When working with the `article` template, you should familiarize yourself with [paginating article comments](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#paginate-article-comments).
...
[Anchor link to section titled "Paginate article comments"](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#paginate-article-comments)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/article#usage)
