---
title: "blog"
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/blog
sections: Key concepts > Templates > Blog
created: 2025-07-29 15:21:28
---

Title: blog

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/blog
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#Main)
...
![Image 3: An example of the blog template in Dawn](https://shopify.dev/assets/themes/templates/blog.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#content)

Your blog template should contain a section that includes the [`blog` object](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#the-blog-object).

### The blog object

[Anchor link to section titled "The blog object"](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#the-blog-object)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#usage)

When working with the `blog` template, you should familiarize yourself with [filtering articles by tag](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#filter-articles-by-tag).
...
[Anchor link to section titled "Filter articles by tag"](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#filter-articles-by-tag)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/blog#usage)
