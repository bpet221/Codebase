...
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register
sections: Key concepts > Templates > Customers Register
created: 2025-07-29 15:22:00
---

Title: customers/register

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#Main)
...
![Image 3: An example of the customer register template in Dawn](https://shopify.dev/assets/themes/templates/customer-register.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#content)

You should include the [customer register form](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#the-customer-register-form) in your `customers/register` template or a section inside of the template.
...
[Anchor link to section titled "The customer register form"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#the-customer-register-form)

The customer register form can be added with the Liquid [`form` tag](https://shopify.dev/docs/api/liquid/tags/form#form-create_customer) and accompanying `'create_customer'` parameter. Within the form tag block, you need to include the following:
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#usage)
...
[Anchor link to section titled "Redirect customers on account creation"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#redirect-customers-on-account-creation)

By default, when a customer creates an account, they're directed to the [home page](https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template). However, you can specify a page to direct customers to using the `return_to` parameter of the Liquid [form tag](https://shopify.dev/docs/api/liquid/tags/form#form-return_to).
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#usage)
