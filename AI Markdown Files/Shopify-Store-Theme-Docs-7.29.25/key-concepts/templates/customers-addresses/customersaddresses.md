...
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses
sections: Key concepts > Templates > Customers Addresses
created: 2025-07-29 15:22:00
---

Title: customers/addresses

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#Main)
...
![Image 3: An example of the customer addresses template in Dawn](https://shopify.dev/assets/themes/templates/customer-addresses.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#content)

You should include the following in your `customers/account` template or a section inside of the template:

*   [The customer object](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#the-customer-object)
*   [Standard form inputs](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#standard-form-inputs)

### The customer object

[Anchor link to section titled "The customer object"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#the-customer-object)
...
[Anchor link to section titled "Standard form inputs"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#standard-form-inputs)
...
If you want to limit your form to accept submissions for only the places that you ship to, then you can use [`country_option_tags`](https://shopify.dev/docs/api/liquid/objects#country_option_tags) to build your country selector.
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#usage)

When working with the `customers/account` template, you should familiarize yourself with the following:

*   [How to add a new address](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#add-a-new-address)
*   [How to edit an existing address](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#edit-an-existing-address)
*   [How to delete an address](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#delete-an-address)
...
[Anchor link to section titled "Add a new address"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#add-a-new-address)

You can allow customers to add a new address with the Liquid [`form` tag](https://shopify.dev/docs/api/liquid/tags/form#form-customer_address) and accompanying `'customer_address', customer.new_address` parameters:
...
Inside the form, you need to include the [standard form inputs](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#standard-form-inputs) for capturing the various address details.

### Edit an existing address

[Anchor link to section titled "Edit an existing address"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#edit-an-existing-address)

With each existing address, you should include a form to edit it. You can add this form with the Liquid [form tag](https://shopify.dev/docs/api/liquid/tags/form#form-customer_address) and accompanying `'customer_address', address` parameters:
...
[Anchor link to section titled "Delete an address"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#delete-an-address)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses#usage)
