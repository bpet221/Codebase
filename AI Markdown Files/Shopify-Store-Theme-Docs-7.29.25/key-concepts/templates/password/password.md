...
sections: Key concepts > Templates > Password
created: 2025-07-29 15:23:01
---

Title: password

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/password
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#Main)
...
Refer to the [password template](https://github.com/Shopify/dawn/blob/main/templates/password.json) and its sections in Dawn for an example implementation.

![Image 3: An example of the password template in Dawn](https://shopify.dev/assets/themes/templates/password.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#content)

You can include the following in your password template or a section inside of the template:

*   [A password message](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#the-password-message)
*   [The password form](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#the-password-form)
*   [The email sign-up form](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#the-email-sign-up-form)
...
[Anchor link to section titled "The password message"](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#the-password-message)

When password protection is enabled on a store, there's also the option to include a message. This message can be shown using the `password_message` attribute of the Liquid [`shop` object](https://shopify.dev/docs/api/liquid/objects/shop#shop-password_message):
...
[Anchor link to section titled "The password form"](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#the-password-form)

The password form can be added with the Liquid [`form` tag](https://shopify.dev/docs/api/liquid/tags/form#form-storefront_password) and accompanying `'storefront_password'` parameter. Within the form tag block, you need to include an `<input>` with the following attributes:
...
[Anchor link to section titled "The email sign-up form"](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#the-email-sign-up-form)

You can include an email sign-up form, to capture customer emails, with the Liquid [`form` tag](https://shopify.dev/docs/api/liquid/tags/form#form-customer) and accompanying `'customer'` parameter. Within the form tag block, you need to include the following:
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#usage)

If you're working on a [development store](https://shopify.dev/docs/storefronts/themes/tools/development-stores), then you can't show a custom password page on the store. A development store-specific password page is always displayed.
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/password#usage)
