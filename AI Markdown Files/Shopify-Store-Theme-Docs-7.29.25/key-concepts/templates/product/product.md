---
title: "product"
source: https://shopify.dev/docs/storefronts/themes/architecture/templates/product
sections: Key concepts > Templates > Product
created: 2025-07-29 15:23:03
---

Title: product

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/product
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#Main)
...
![Image 3: An example of the product template in Dawn](https://shopify.dev/assets/themes/templates/product.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#content)

You should include the following in your `product` template or a section inside of the template:

*   [The product object](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-product-object)
*   [The product form](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-product-form), with the following components: 
    *   [A variant selector](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-variant-selector)
    *   [A quantity input](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-quantity-input)
    *   [Accelerated checkout buttons](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#accelerated-checkout-buttons)
    *   [Input elements for line item properties](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#line-item-properties)

Optionally, you might want to show [product recommendations](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#show-product-recommendations) on the product page.
...
[Anchor link to section titled "The product object"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-product-object)
...
[Anchor link to section titled "The product form"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-product-form)
...
*   The [variant selector](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-variant-selector)
*   The [quantity input](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-quantity-input)
*   [Accelerated checkout buttons](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#accelerated-checkout-buttons)

#### The variant selector

[Anchor link to section titled "The variant selector"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-variant-selector)
...
[Anchor link to section titled "The quantity input"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-quantity-input)
...
[Anchor link to section titled "Accelerated checkout buttons"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#accelerated-checkout-buttons)
...
[Anchor link to section titled "Line item properties"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#line-item-properties)
...
These properties are captured through input elements with an attribute of `name="properties[property-name]"`, where `property-name` is the name of your custom property. Any property inputs need to be included inside the [product form](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-product-form):
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#usage)

When working with the `product` template, you should familiarize yourself with the following:

*   [The Cart AJAX API](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-cart-ajax-api)
*   [Showing product recommendations](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#show-product-recommendations)
...
[Anchor link to section titled "The Cart AJAX API"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#the-cart-ajax-api)
...
[Anchor link to section titled "Show product recommendations"](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#show-product-recommendations)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/product#usage)
