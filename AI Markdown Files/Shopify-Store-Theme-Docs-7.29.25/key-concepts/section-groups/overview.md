...
sections: Key concepts > Section Groups
created: 2025-07-29 15:23:07
---

Title: Section groups

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/section-groups
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#Main)
...
You can [add a reference to a section group](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#include-a-section-group-in-a-layout-file) in a [layout](https://shopify.dev/docs/storefronts/themes/architecture/layouts) file to add support for sections in areas that are controlled by the layout, such as the header or footer.
...
![Image 3: Templates control what's rendered on each type of page in a theme.](https://shopify.dev/assets/themes/architecture/section-group.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#location)
...
[Anchor link to section titled "Schema"](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#schema)
...
[Anchor link to section titled "Section data"](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#section-data)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#usage)
...
[Anchor link to section titled "Contextual section groups"](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#contextual-section-groups)
...
[Anchor link to section titled "Include a section group in a layout file"](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#include-a-section-group-in-a-layout-file)
...
[Anchor link to section titled "Static section and section group coexistence"](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#static-section-and-section-group-coexistence)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#location)
*   [Schema](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#schema)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/section-groups#usage)
