---
title: "Markets"
description: "Shopify theme documentation for markets"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/markets"
...
URL Source: https://shopify.dev/docs/storefronts/themes/markets
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/markets#Main)
...
To support this, Shopify has the[Geolocation app](https://help.shopify.com/en/manual/cross-border/geolocation), which detects a customer's location and enables them to choose a currency, a language, or both. Alternatively, you can [create country and language selectors](https://shopify.dev/docs/storefronts/themes/markets/multiple-currencies-languages)to enable customers to choose their preferred options.

Additionally, you can [adapt your theme content for different markets](https://help.shopify.com/en/manual/online-store/themes/customizing-themes/store-contextualization).
