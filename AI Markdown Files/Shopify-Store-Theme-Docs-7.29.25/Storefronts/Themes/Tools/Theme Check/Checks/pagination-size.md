...
description: "Shopify theme documentation for pagination size"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size"
...
URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#Main)
...
Ensures that objects are [paginated](https://shopify.dev/docs/api/liquid/tags/paginate) with performant sizes so that too many objects aren't loaded at once. This helps to keep response times low.

Examples
--------

[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#examples)

The following examples contain code snippets that either fail or pass this check.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#fail)

The following example includes a pagination size that leads to too many products on a single page, exceeding the [`max_size`](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#options) value:
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#pass)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#disabling-this-check)

This check is safe to [disable](https://shopify.dev/docs/storefronts/themes/tools/theme-check/configuration).

### On this page

*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#examples)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/pagination-size#disabling-this-check)
