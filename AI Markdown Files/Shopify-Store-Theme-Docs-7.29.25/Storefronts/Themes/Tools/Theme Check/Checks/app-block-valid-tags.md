---
title: "App Block Valid Tags"
description: "Shopify theme documentation for app block valid tags"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/app-block-valid-tags"
sections: ['Storefronts', 'Themes', 'Tools', 'Theme Check', 'Checks']
tags: ["shopify", "themes", "documentation"]
---

Title: AppBlockValidTags

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/app-block-valid-tags
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/app-block-valid-tags#Main)
...
Identifies forbidden Liquid tags in [theme app extension](https://shopify.dev/docs/apps/build/online-store/theme-app-extensions) app block and app embed block code.
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/app-block-valid-tags#disabling-this-check)

This check is enabled by default when you run the Shopify CLI 3.x [`build`](https://shopify.dev/docs/api/shopify-cli/app/app-build) command on an app that contains a theme app extension. Disabling this check isn't recommended.
