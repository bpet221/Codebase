...
description: "Shopify theme documentation for json syntax error"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error"
...
URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error#Main)
...
[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error#examples)

The following examples contain code snippets that either fail or pass this check.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error#pass)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error#disabling-this-check)
...
[Anchor link to section titled "Aliases"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error#aliases)
...
*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error#examples)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error#disabling-this-check)
*   [Aliases](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/json-syntax-error#aliases)
