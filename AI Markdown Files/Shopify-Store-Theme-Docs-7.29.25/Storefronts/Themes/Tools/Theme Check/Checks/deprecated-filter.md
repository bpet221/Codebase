...
description: "Shopify theme documentation for deprecated filter"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter"
sections: ['Storefronts', 'Themes', 'Tools', 'Theme Check', 'Checks']
tags: ["shopify", "themes", "documentation"]
---

Title: DeprecatedFilter

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#Main)
...
Discourages using [deprecated filters](https://shopify.dev/docs/api/liquid/filters/deprecated-filters) in themes.

Examples
--------

[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#examples)

The following examples contain code snippets that either fail or pass this check.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#pass)
...
[Anchor link to section titled "Auto-correction"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#auto-correction)

Theme Check can correct usage of the deprecated `img_url` filter using the `--auto-correct` flag. When the flag is specified, Theme Check automatically replaces instances of `img_url` with [`image_url`](https://shopify.dev/docs/api/liquid/filters/url-filters#image_url) where possible.

Options
-------

[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#disabling-this-check)

Disabling this check isn't recommended.

### On this page

*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#examples)
*   [Auto-correction](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#auto-correction)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-filter#disabling-this-check)
