...
description: "Shopify theme documentation for missing template"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template"
...
URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#Main)
...
[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#examples)

The following examples contain code snippets that either fail or pass this check.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#pass)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#options)
...
[Anchor link to section titled "ignore and ignore_missing"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#ignore-and-ignore_missing)
...
[Anchor link to section titled "Auto-correction"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#auto-correction)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#disabling-this-check)

Disabling this check isn't recommended.

### On this page

*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#examples)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#options)
*   [Auto-correction](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#auto-correction)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/missing-template#disabling-this-check)
