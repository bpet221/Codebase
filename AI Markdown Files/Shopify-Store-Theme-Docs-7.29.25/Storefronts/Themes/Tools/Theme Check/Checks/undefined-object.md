...
description: "Shopify theme documentation for undefined object"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object"
sections: ['Storefronts', 'Themes', 'Tools', 'Theme Check', 'Checks']
tags: ["shopify", "themes", "documentation"]
---

Title: UndefinedObject

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object#Main)
...
Identifies unknown variable references. Liquid variables must declared using `assign` tags, `capture` tags, or documented with `@param` inside of [LiquidDoc](https://shopify.dev/docs/storefronts/themes/tools/liquid-doc). Some Liquid variables exist by default in a global scope. See Liquid [objects](https://shopify.dev/docs/api/liquid/objects).

Examples
--------

[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object#examples)

The following examples contain code snippets that either fail or pass this check for different scenarios.

### ✓ Pass

[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object#pass)
...
[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object#fail)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object#disabling-this-check)

Disabling this check isn't recommended as it helps catch typos and potential runtime errors.

### On this page

*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object#examples)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/undefined-object#disabling-this-check)
