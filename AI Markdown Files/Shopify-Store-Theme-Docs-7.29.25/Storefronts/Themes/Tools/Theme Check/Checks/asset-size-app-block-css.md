---
title: "Asset Size App Block Css"
description: "Shopify theme documentation for asset size app block css"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css"
sections: ['Storefronts', 'Themes', 'Tools', 'Theme Check', 'Checks']
tags: ["shopify", "themes", "documentation"]
---

Title: AssetSizeAppBlockCSS

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css#Main)
...
Prevents [theme app extensions](https://shopify.dev/docs/apps/build/online-store/theme-app-extensions) from using CSS files larger than the configured [`threshold_in_bytes`](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css#options). Limiting the size of CSS files helps to improve the performance of your theme app extension.

Example
-------

[Anchor link to section titled "Example"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css#example)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css#options)
...
| `threshold_in_bytes` | The maximum allowed compressed size, in bytes, for a single CSS file. Reflects the [suggested limit](https://shopify.dev/docs/apps/build/online-store/theme-app-extensions/configuration#file-and-content-size-limits) for theme app extension CSS, and includes theme and remote stylesheets. |

Disabling this check
--------------------

[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css#disabling-this-check)
...
*   [Example](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css#example)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-app-block-css#disabling-this-check)
