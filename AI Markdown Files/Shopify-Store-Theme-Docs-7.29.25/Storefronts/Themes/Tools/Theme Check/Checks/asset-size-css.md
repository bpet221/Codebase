---
title: "Asset Size Css"
description: "Shopify theme documentation for asset size css"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css"
...
URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css#Main)
...
Prevents themes and theme app extensions from using CSS files larger than the configured [`threshold_in_bytes`](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css#options). Limiting the size of CSS files helps to improve the [performance](https://shopify.dev/docs/storefronts/themes/best-practices/performance) of your theme.

Example
-------

[Anchor link to section titled "Example"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css#example)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css#disabling-this-check)

This check is enabled by default when you run the Shopify CLI 3.x [`build`](https://shopify.dev/docs/api/shopify-cli/app/app-build) command on a theme app extension. This limit is not yet enforced, but disabling this check isn't recommended for theme app extensions.
...
*   [Example](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css#example)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/asset-size-css#disabling-this-check)
