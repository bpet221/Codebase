---
title: "Deprecate Bgsizes"
description: "Shopify theme documentation for deprecate bgsizes"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecate-bgsizes"
sections: ['Storefronts', 'Themes', 'Tools', 'Theme Check', 'Checks']
tags: ["shopify", "themes", "documentation"]
---

Title: DeprecateBgsizes

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecate-bgsizes
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecate-bgsizes#Main)
...
Discourages use of the [lazysizes bgset extension](https://github.com/aFarkas/lazysizes/tree/gh-pages/plugins/bgset) instead of the CSS `image-set` attribute to load responsive background images.
...
[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecate-bgsizes#examples)

The following examples contain code snippets that either fail or pass this check.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecate-bgsizes#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecate-bgsizes#pass)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecate-bgsizes#disabling-this-check)

This check is safe to [disable](https://shopify.dev/docs/storefronts/themes/tools/theme-check/configuration).

### On this page

*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecate-bgsizes#examples)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecate-bgsizes#disabling-this-check)
