---
title: "Commands"
description: "Shopify theme documentation for commands"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands"
sections: ['Storefronts', 'Themes', 'Tools', 'Theme Check']
tags: ["shopify", "themes", "documentation"]
---

Title: Theme Check commands

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands#Main)
...
[Anchor link to section titled "Requirements"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands#requirements)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands#usage)
...
[Anchor link to section titled "Flags"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands#flags)
...
*   [Requirements](https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands#requirements)
*   [Usage](https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands#usage)
