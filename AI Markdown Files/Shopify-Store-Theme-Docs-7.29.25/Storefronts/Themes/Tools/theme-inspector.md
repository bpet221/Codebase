...
description: "Shopify theme documentation for theme inspector"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-inspector"
sections: ['Storefronts', 'Themes', 'Tools']
tags: ["shopify", "themes", "documentation"]
---

Title: Shopify Theme Inspector for Chrome

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-inspector
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-inspector#Main)
...
[Anchor link to section titled "Install the Shopify Theme Inspector"](https://shopify.dev/docs/storefronts/themes/tools/theme-inspector#install-the-shopify-theme-inspector)
...
[Anchor link to section titled "Run the Shopify Theme Inspector"](https://shopify.dev/docs/storefronts/themes/tools/theme-inspector#run-the-shopify-theme-inspector)
...
*   [Install the Shopify Theme Inspector](https://shopify.dev/docs/storefronts/themes/tools/theme-inspector#install-the-shopify-theme-inspector)
*   [Run the Shopify Theme Inspector](https://shopify.dev/docs/storefronts/themes/tools/theme-inspector#run-the-shopify-theme-inspector)
