...
description: "Shopify theme documentation for language server"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/cli/language-server"
sections: ['Storefronts', 'Themes', 'Tools', 'Cli']
tags: ["shopify", "themes", "documentation"]
---

Title: Shopify Liquid Language Server

URL Source: https://shopify.dev/docs/storefronts/themes/tools/cli/language-server
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#Main)
...
The [Language Server Protocol](https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/) enables developers to provide code editing features to all code editors in a single codebase with no code editor-specific code.

Installation
------------

[Anchor link to section titled "Installation"](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#installation)

The Shopify Liquid Language Server is a [Shopify CLI](https://shopify.dev/docs/storefronts/themes/tools/cli/cli-2/commands) theme command.

Usage basics
------------

[Anchor link to section titled "Usage basics"](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#usage-basics)
...
[Anchor link to section titled "Features"](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#features)
...
[Anchor link to section titled "Editor integration"](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#editor-integration)
...
[Anchor link to section titled "Contributing to the Language Server"](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#contributing-to-the-language-server)
...
*   [Installation](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#installation)
*   [Usage basics](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#usage-basics)
*   [Features](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#features)
*   [Editor integration](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#editor-integration)
*   [Contributing to the Language Server](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server#contributing-to-the-language-server)
