---
title: "Theme Check"
description: "Shopify theme documentation for theme check"
date: "2025-07-29"
...
URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check#Main)
...
[Anchor link to section titled "Installation"](https://shopify.dev/docs/storefronts/themes/tools/theme-check#installation)
...
[Anchor link to section titled "Configuration"](https://shopify.dev/docs/storefronts/themes/tools/theme-check#configuration)

You can configure check options to override defaults, or enable or disable specific checks, or point to your own [custom checks](https://shopify.dev/docs/storefronts/themes/tools/theme-check#creating-your-own-checks). To learn more, refer to [Theme Check configuration](https://shopify.dev/docs/storefronts/themes/tools/theme-check/configuration).

Creating your own checks
------------------------

[Anchor link to section titled "Creating your own checks"](https://shopify.dev/docs/storefronts/themes/tools/theme-check#creating-your-own-checks)
...
[Anchor link to section titled "Using Theme Check in other editors"](https://shopify.dev/docs/storefronts/themes/tools/theme-check#using-theme-check-in-other-editors)
...
[Anchor link to section titled "Command reference"](https://shopify.dev/docs/storefronts/themes/tools/theme-check#command-reference)

[![Image 2](https://shopify.dev/assets/resource-cards/docs) ### Checks reference Learn what each check does, how to configure it, and when to disable it.](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks)

[![Image 3](https://shopify.dev/assets/resource-cards/docs) ### Command reference Review the Theme Check reference for commands.](https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands)

Contributing to Theme Check
---------------------------

[Anchor link to section titled "Contributing to Theme Check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check#contributing-to-theme-check)
...
*   [Installation](https://shopify.dev/docs/storefronts/themes/tools/theme-check#installation)
*   [Configuration](https://shopify.dev/docs/storefronts/themes/tools/theme-check#configuration)
*   [Creating your own checks](https://shopify.dev/docs/storefronts/themes/tools/theme-check#creating-your-own-checks)
*   [Using Theme Check in other editors](https://shopify.dev/docs/storefronts/themes/tools/theme-check#using-theme-check-in-other-editors)
*   [Command reference](https://shopify.dev/docs/storefronts/themes/tools/theme-check#command-reference)
*   [Contributing to Theme Check](https://shopify.dev/docs/storefronts/themes/tools/theme-check#contributing-to-theme-check)
