---
title: "Theme Access"
description: "Shopify theme documentation for theme access"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools/theme-access"
extraction_method: "jina_extended"
sections: ['Storefronts', 'Themes', 'Tools']
tags: ["shopify", "themes", "documentation"]
---

Title: Manage theme access

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-access
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-access#Main)
...
[Anchor link to section titled "How the Theme Access app works"](https://shopify.dev/docs/storefronts/themes/tools/theme-access#how-the-theme-access-app-works)
...
The Theme Access app was previously called the Theme Kit Access app. Passwords generated with either version of the app are interchangeable. For example, If you have a password that you use with Theme Kit, then you can reuse that password with Shopify CLI 3.x.

Install the Theme Access app
----------------------------

[Anchor link to section titled "Install the Theme Access app"](https://shopify.dev/docs/storefronts/themes/tools/theme-access#install-the-theme-access-app)
...
[Anchor link to section titled "Create a password"](https://shopify.dev/docs/storefronts/themes/tools/theme-access#create-a-password)
...
[Anchor link to section titled "Resend a password"](https://shopify.dev/docs/storefronts/themes/tools/theme-access#resend-a-password)
...
[Anchor link to section titled "Delete a password"](https://shopify.dev/docs/storefronts/themes/tools/theme-access#delete-a-password)
...
[Anchor link to section titled "Next steps"](https://shopify.dev/docs/storefronts/themes/tools/theme-access#next-steps)
...
*   [Requirements](https://shopify.dev/docs/storefronts/themes/tools/theme-access#requirements)
*   [How the Theme Access app works](https://shopify.dev/docs/storefronts/themes/tools/theme-access#how-the-theme-access-app-works)
*   [Install the Theme Access app](https://shopify.dev/docs/storefronts/themes/tools/theme-access#install-the-theme-access-app)
*   [Create a password](https://shopify.dev/docs/storefronts/themes/tools/theme-access#create-a-password)
*   [Resend a password](https://shopify.dev/docs/storefronts/themes/tools/theme-access#resend-a-password)
*   [Delete a password](https://shopify.dev/docs/storefronts/themes/tools/theme-access#delete-a-password)
*   [Next steps](https://shopify.dev/docs/storefronts/themes/tools/theme-access#next-steps)
