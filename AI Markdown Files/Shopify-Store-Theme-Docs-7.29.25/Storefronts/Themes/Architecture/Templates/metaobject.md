---
title: "Metaobject"
description: "Shopify theme documentation for metaobject"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/architecture/templates/metaobject"
sections: ['Storefronts', 'Themes', 'Architecture', 'Templates']
tags: ["shopify", "themes", "documentation"]
---

Title: Metaobject theme templates

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/metaobject
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/metaobject#Main)
...
`Metaobject` theme templates enable the rendering of [metaobject webpages](https://help.shopify.com//manual/custom-data/metaobjects/webpages) per metaobject definition. To create a metaobject template for an Online Store, you must enable the [onlineStore](https://shopify.dev/docs/apps/build/custom-data/metaobjects/use-metaobject-capabilities#make-your-metaobjects-render-web-pages-in-the-online-store) capability. You should enable the [renderable](https://shopify.dev/docs/apps/build/custom-data/metaobjects/use-metaobject-capabilities#render-metaobjects-as-web-pages) capability as well to enable SEO fields management.
...
![Image 4: An example of the Metaobject Pages template in Dawn](https://shopify.dev/assets/themes/templates/pages-for-metaobjects.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/metaobject#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/metaobject#content)

Any sections that are available for any template or section group are included in metaobject templates by default. You can access the Liquid [metaobject object](https://shopify.dev/docs/api/liquid/objects/metaobject) to display the metaobject fields.

### On this page

*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/metaobject#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/metaobject#content)
