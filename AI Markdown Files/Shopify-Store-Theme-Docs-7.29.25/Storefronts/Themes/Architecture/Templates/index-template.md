...
description: "Shopify theme documentation for index template"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template"
...
URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template#Main)
...
![Image 3: An example of the index template in Dawn](https://shopify.dev/assets/themes/templates/index.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template#location)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template#usage)

When working with the `index` template, you should familiarize yourself with the [differences between JSON and Liquid index templates](https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template#json-vs-liquid).

### JSON vs. Liquid

[Anchor link to section titled "JSON vs. Liquid"](https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template#json-vs-liquid)
...
*   JSON templates store their own data, which minimizes the amount of data in [settings_data.json](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-data-json) and improves the performance of the theme editor.

### On this page

*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template#location)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/index-template#usage)
