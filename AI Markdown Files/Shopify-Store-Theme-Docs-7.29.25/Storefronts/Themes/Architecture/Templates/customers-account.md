...
description: "Shopify theme documentation for customers account"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account"
...
URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#Main)
...
![Image 3: An example of the customers/account template in Dawn](https://shopify.dev/assets/themes/templates/customer-account.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#content)

You should include the [customer object](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#the-customer-object) in your `customers/account` template or a section inside of the template.

### The customer object

[Anchor link to section titled "The customer object"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#the-customer-object)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#usage)

When working with the `customers/account` template, you should familiarize yourself with the following:

*   [Showing the customer's orders](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#show-the-customer-s-orders)
*   [Showing the customer's default address](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#show-the-customer-s-default-address)
...
[Anchor link to section titled "Show the customer’s orders"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#show-the-customer-s-orders)
...
[Anchor link to section titled "Show the customer’s default address"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#show-the-customer-s-default-address)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account#usage)
