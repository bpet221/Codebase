---
title: "Customers Activate Account"
description: "Shopify theme documentation for customers activate account"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account"
sections: ['Storefronts', 'Themes', 'Architecture', 'Templates']
tags: ["shopify", "themes", "documentation"]
---

Title: customers/activate_account

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#Main)
...
![Image 3: An example of the customers/activate_account template in Dawn](https://shopify.dev/assets/themes/templates/customer-activate-account.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#content)

You should include the [customer account activation form](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#the-customer-account-activation-form) in your `customers/activate_account` template or a section inside of the template.
...
[Anchor link to section titled "The customer account activation form"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#the-customer-account-activation-form)

The customer account activation form can be added with the Liquid [`form` tag](https://shopify.dev/docs/api/liquid/tags/form#form-activate_customer_password) and accompanying `'activate_customer_password'` parameter. Within the form tag block, you need to include the following:
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#usage)

When working with the `customers/activate_account` template, you should familiarize yourself with [previewing the template](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#preview-the-template).

### Preview the template

[Anchor link to section titled "Preview the template"](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#preview-the-template)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account#usage)
