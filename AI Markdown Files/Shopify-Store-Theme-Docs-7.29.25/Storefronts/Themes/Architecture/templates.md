---
title: "Templates"
description: "Shopify theme documentation for templates"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/architecture/templates"
sections: ['Storefronts', 'Themes', 'Architecture']
tags: ["shopify", "themes", "documentation"]
---

Title: Templates

URL Source: https://shopify.dev/docs/storefronts/themes/architecture/templates
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/templates#Main)
...
![Image 3: Templates control what is rendered on each type of page in a theme.](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/architecture/template-c0bc9f9c1485a3760d6a2536a6455d14a15527cae5697aa97bc763ead8683e05.png)
...
[Anchor link to section titled "JSON vs. Liquid"](https://shopify.dev/docs/storefronts/themes/architecture/templates#json-vs-liquid)

There are two different file types you can use for a theme template: JSON and Liquid. These template file types can be used to build multiple [template types](https://shopify.dev/docs/storefronts/themes/architecture/templates#template-types), each of which represents a type of content in a merchant's online store.
...
[Anchor link to section titled "Choosing JSON vs Liquid"](https://shopify.dev/docs/storefronts/themes/architecture/templates#choosing-json-vs-liquid)
...
JSON templates provide more flexibility for merchants to add, remove, and reorder sections, including app sections. Additionally, they minimize the amount of data in [settings_data.json](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-data-json). Instead, data is stored directly in the template, which improves the performance of the theme editor.

Template types
--------------

[Anchor link to section titled "Template types"](https://shopify.dev/docs/storefronts/themes/architecture/templates#template-types)
...
| [customers/account](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-account) | Renders the customer account page, which provides an overview of the customer’s account. |
| [customers/activate_account](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-activate-account) | Renders the customer account activation page, which hosts the form for activating a customer account. |
| [customers/addresses](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-addresses) | Renders the customer addresses page, which allows customers to view and manage their current addresses, as well as add new ones. |
| [customers/login](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-login) | Renders the customer login page, which hosts the form for logging into a customer account. |
| [customers/order](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order) | Renders the customer order page, which displays the details of a customer’s past orders. |
| [customers/register](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register) | Renders the customer register page, which hosts the form for customer account creation. |
| [customers/reset_password](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-reset-password) | Renders the password reset page, which hosts the form to reset the password for a customer account. |
| [gift_card.liquid](https://shopify.dev/docs/storefronts/themes/architecture/templates/gift-card-liquid) | Renders the gift card page, which displays the gift card issued to a customer upon purchase. This must be a Liquid template. |
...
[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/templates#location)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/templates#content)
...
*   [JSON vs. Liquid](https://shopify.dev/docs/storefronts/themes/architecture/templates#json-vs-liquid)
*   [Template types](https://shopify.dev/docs/storefronts/themes/architecture/templates#template-types)
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/templates#location)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/templates#content)
