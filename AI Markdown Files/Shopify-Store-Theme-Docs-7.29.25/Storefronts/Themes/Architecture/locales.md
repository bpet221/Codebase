---
title: "Locales"
description: "Shopify theme documentation for locales"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/architecture/locales"
...
URL Source: https://shopify.dev/docs/storefronts/themes/architecture/locales
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/locales#Main)
...
[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/locales#location)
...
[Anchor link to section titled "Subtypes"](https://shopify.dev/docs/storefronts/themes/architecture/locales#subtypes)

There are two types of locale files:

| Type | Description |
| --- | --- |
| [Storefront](https://shopify.dev/docs/storefronts/themes/architecture/locales/storefront-locale-files) | Storefront locale files have a `.json` file extension, and control translations for storefront content. These translations can be edited by merchants through the [Shopify Language Editor](https://help.shopify.com/manual/online-store/themes/customizing-themes/language/change-wording#overview-of-the-language-editor). |
| [Schema](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files) | Schema locale files have a `.schema.json` file extension, and control translations for theme editor settings. |

Schema
------

[Anchor link to section titled "Schema"](https://shopify.dev/docs/storefronts/themes/architecture/locales#schema)

Locale files need to follow a specific [naming structure](https://shopify.dev/docs/storefronts/themes/architecture/locales#name-locale-files). They also follow a basic organizational structure:
...
[Anchor link to section titled "Name locale files"](https://shopify.dev/docs/storefronts/themes/architecture/locales#name-locale-files)
...
Additionally, you must designate a [default locale file](https://shopify.dev/docs/storefronts/themes/architecture/locales#the-default-locale-file) for each type.

#### The default locale file

[Anchor link to section titled "The default locale file"](https://shopify.dev/docs/storefronts/themes/architecture/locales#the-default-locale-file)
...
[Anchor link to section titled "Requirements and limitations"](https://shopify.dev/docs/storefronts/themes/architecture/locales#requirements-and-limitations)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/locales#usage)

When working with locale files, you should familiarize yourself with referencing locale files. The code for referencing locale files varies depending on whether you're referencing a [storefront locale file](https://shopify.dev/docs/storefronts/themes/architecture/locales/storefront-locale-files) or a [schema locale file](https://shopify.dev/docs/storefronts/themes/architecture/locales/schema-locale-files#reference-schema-translations).

### On this page

*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/locales#location)
*   [Subtypes](https://shopify.dev/docs/storefronts/themes/architecture/locales#subtypes)
*   [Schema](https://shopify.dev/docs/storefronts/themes/architecture/locales#schema)
*   [Requirements and limitations](https://shopify.dev/docs/storefronts/themes/architecture/locales#requirements-and-limitations)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/locales#usage)
