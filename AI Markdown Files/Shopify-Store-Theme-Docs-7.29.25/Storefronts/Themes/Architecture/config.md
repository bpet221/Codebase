---
title: "Config"
description: "Shopify theme documentation for config"
date: "2025-07-29"
...
URL Source: https://shopify.dev/docs/storefronts/themes/architecture/config
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/config#Main)
...
You can also create settings for [sections](https://shopify.dev/docs/storefronts/themes/architecture/sections/section-schema#settings) and [blocks](https://shopify.dev/docs/storefronts/themes/architecture/sections/section-schema#blocks). These settings are defined as part of the parent section or block object, and appear in the theme editor with the associated object.

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/config#location)
...
[Anchor link to section titled "Subtypes"](https://shopify.dev/docs/storefronts/themes/architecture/config#subtypes)

There are up to three config files, each with their own schema and content:

| Type | Description | Required |
| --- | --- | --- |
| **[settings_schema.json](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json)** | Controls the organization and content of the **Theme settings** area of the theme editor. | Yes |
| **[settings_data.json](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-data-json)** | Contains the saved values from the settings in `settings_schema.json`. | Yes |
| **[markets.json](https://shopify.dev/docs/storefronts/themes/architecture/config/markets-json)** | Sets the source of inheritance of market-specific theme customizations. | No |

Usage
-----

[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/config#usage)

When working with config files, you should familiarize yourself with the following:

*   [Setting types](https://shopify.dev/docs/storefronts/themes/architecture/config#setting-types)
*   [Accessing settings](https://shopify.dev/docs/storefronts/themes/architecture/config#access-settings)
*   [Theme metadata](https://shopify.dev/docs/storefronts/themes/architecture/config#theme-metadata)

### Setting types

[Anchor link to section titled "Setting types"](https://shopify.dev/docs/storefronts/themes/architecture/config#setting-types)
...
[Anchor link to section titled "Access settings"](https://shopify.dev/docs/storefronts/themes/architecture/config#access-settings)
...
[Anchor link to section titled "Theme metadata"](https://shopify.dev/docs/storefronts/themes/architecture/config#theme-metadata)

You can add theme metadata to the **Theme actions** menu of the theme editor. This includes information like the theme name and version, where to find theme documentation, and theme developer contact details. To learn how to include this information in your theme, refer to [Add theme metadata](https://shopify.dev/docs/storefronts/themes/architecture/config/settings-schema-json#add-theme-metadata).

### On this page

*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/config#location)
*   [Subtypes](https://shopify.dev/docs/storefronts/themes/architecture/config#subtypes)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/config#usage)
