---
title: "Blocks"
description: "Shopify theme documentation for blocks"
date: "2025-07-29"
...
URL Source: https://shopify.dev/docs/storefronts/themes/architecture/blocks
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/blocks#Main)
...
[Anchor link to section titled "Overview"](https://shopify.dev/docs/storefronts/themes/architecture/blocks#overview)
...
![Image 3: A theme block that contains multiple levels of nested theme blocks as children](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/architecture/nested-blocks-example-c0c734c1ee5144116cc95b4c8bb25339f6f5c9cc8f7935620eed70740a50d5ef.png)

Theme blocks can accept other nested blocks as children.

There are three types of blocks:

*   [Theme blocks](https://shopify.dev/docs/storefronts/themes/architecture/blocks/theme-blocks): Created as their own Liquid files in the `/blocks` folder, and re-usable across multiple sections with the theme.
*   [Section blocks](https://shopify.dev/docs/storefronts/themes/architecture/blocks/section-blocks): Created within a section's Liquid file and are limited to use within that section.
*   [App blocks](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks): Provided by apps installed on a merchant's shop.

Theme blocks
------------

[Anchor link to section titled "Theme blocks"](https://shopify.dev/docs/storefronts/themes/architecture/blocks#theme-blocks)
...
[Anchor link to section titled "Section blocks"](https://shopify.dev/docs/storefronts/themes/architecture/blocks#section-blocks)
...
[Anchor link to section titled "App blocks"](https://shopify.dev/docs/storefronts/themes/architecture/blocks#app-blocks)
...
[Anchor link to section titled "Theme blocks vs Snippets"](https://shopify.dev/docs/storefronts/themes/architecture/blocks#theme-blocks-vs-snippets)
...
[Anchor link to section titled "AI generated theme blocks"](https://shopify.dev/docs/storefronts/themes/architecture/blocks#ai-generated-theme-blocks)
...
*   [Overview](https://shopify.dev/docs/storefronts/themes/architecture/blocks#overview)
*   [Theme blocks](https://shopify.dev/docs/storefronts/themes/architecture/blocks#theme-blocks)
*   [Section blocks](https://shopify.dev/docs/storefronts/themes/architecture/blocks#section-blocks)
*   [App blocks](https://shopify.dev/docs/storefronts/themes/architecture/blocks#app-blocks)
*   [Theme blocks vs Snippets](https://shopify.dev/docs/storefronts/themes/architecture/blocks#theme-blocks-vs-snippets)
