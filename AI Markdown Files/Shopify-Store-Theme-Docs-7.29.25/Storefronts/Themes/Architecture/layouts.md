---
title: "Layouts"
description: "Shopify theme documentation for layouts"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/architecture/layouts"
...
URL Source: https://shopify.dev/docs/storefronts/themes/architecture/layouts
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/architecture/layouts#Main)
...
*   In Liquid templates, the layout that's used to render a page is specified using [the `layout` Liquid tag](https://shopify.dev/docs/api/liquid/tags/layout).

![Image 3: Diagram of theme architecture components with the layout highlighted.](https://shopify.dev/assets/themes/architecture/layout.png)

Location
--------

[Anchor link to section titled "Location"](https://shopify.dev/docs/storefronts/themes/architecture/layouts#location)
...
[Anchor link to section titled "Subtypes"](https://shopify.dev/docs/storefronts/themes/architecture/layouts#subtypes)
...
[Anchor link to section titled "Schema"](https://shopify.dev/docs/storefronts/themes/architecture/layouts#schema)
...
*   [content_for_header](https://shopify.dev/docs/storefronts/themes/architecture/layouts#content_for_header)
*   [content_for_layout](https://shopify.dev/docs/storefronts/themes/architecture/layouts#content_for_layout)
...
[Anchor link to section titled "Content"](https://shopify.dev/docs/storefronts/themes/architecture/layouts#content)
...
[Anchor link to section titled "content_for_header"](https://shopify.dev/docs/storefronts/themes/architecture/layouts#content_for_header)
...
[Anchor link to section titled "content_for_layout"](https://shopify.dev/docs/storefronts/themes/architecture/layouts#content_for_layout)
...
[Anchor link to section titled "Usage"](https://shopify.dev/docs/storefronts/themes/architecture/layouts#usage)

When working with layout files, you should familiarize yourself with the following concepts:

*   [Supporting template-specific CSS selectors](https://shopify.dev/docs/storefronts/themes/architecture/layouts#support-template-specific-css-selectors)
*   [Accessing and customizing checkout.liquid](https://shopify.dev/docs/storefronts/themes/architecture/layouts#access-and-customize-checkout-liquid)

### Support template-specific CSS selectors

[Anchor link to section titled "Support template-specific CSS selectors"](https://shopify.dev/docs/storefronts/themes/architecture/layouts#support-template-specific-css-selectors)
...
[Anchor link to section titled "Access and customize checkout.liquid"](https://shopify.dev/docs/storefronts/themes/architecture/layouts#access-and-customize-checkout-liquid)
...
*   [Location](https://shopify.dev/docs/storefronts/themes/architecture/layouts#location)
*   [Subtypes](https://shopify.dev/docs/storefronts/themes/architecture/layouts#subtypes)
*   [Schema](https://shopify.dev/docs/storefronts/themes/architecture/layouts#schema)
*   [Content](https://shopify.dev/docs/storefronts/themes/architecture/layouts#content)
*   [Usage](https://shopify.dev/docs/storefronts/themes/architecture/layouts#usage)
