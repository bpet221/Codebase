---
title: "Filtering"
description: "Shopify theme documentation for filtering"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/navigation-search/filtering"
...
URL Source: https://shopify.dev/docs/storefronts/themes/navigation-search/filtering
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/navigation-search/filtering#Main)
...
[Anchor link to section titled "Storefront filtering"](https://shopify.dev/docs/storefronts/themes/navigation-search/filtering#storefront-filtering)

[Storefront filtering](https://shopify.dev/docs/storefronts/themes/navigation-search/filtering/storefront-filtering) is the recommended method for filtering products. It allows merchants to easily create filter groups based on existing product data, like availability, price, variant options, and more. These filters can be applied to both collections and search results.

To learn more about how to support storefront filtering in your theme, refer to [Support storefront filtering](https://shopify.dev/docs/storefronts/themes/navigation-search/filtering/storefront-filtering/support-storefront-filtering).

You should also familiarize yourself with the [UX considerations](https://shopify.dev/docs/storefronts/themes/navigation-search/filtering/storefront-filtering/storefront-filtering-ux) for storefront filtering.

Tag filtering
-------------

[Anchor link to section titled "Tag filtering"](https://shopify.dev/docs/storefronts/themes/navigation-search/filtering#tag-filtering)
...
To learn more about how to use tag filtering, refer to [Filter collections by tag](https://shopify.dev/docs/storefronts/themes/navigation-search/filtering/tag-filtering).
