---
title: "Gift Cards"
description: "Shopify theme documentation for gift cards"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards"
extraction_method: "jina_extended"
sections: ['Storefronts', 'Themes', 'Product Merchandising']
tags: ["shopify", "themes", "documentation"]
---

Title: Add a gift card recipient form

URL Source: https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#Main)
...
[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#resources)
...
[Anchor link to section titled "Implementing the recipient form"](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#implementing-the-recipient-form)
...
[Anchor link to section titled "Create a form to collect recipient information"](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#create-a-form-to-collect-recipient-information)
...
[Anchor link to section titled "Add the recipient form to your product form"](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#add-the-recipient-form-to-your-product-form)
...
The recipient form validation doesn't support [accelerated checkout buttons](https://help.shopify.com/manual/online-store/accelerated-checkout). The form should be used only with the **Add to Cart** button.

Displaying the recipient properties in the cart
-----------------------------------------------

[Anchor link to section titled "Displaying the recipient properties in the cart"](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#displaying-the-recipient-properties-in-the-cart)
...
[Anchor link to section titled "Limitations"](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#limitations)
...
*   [Resources](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#resources)
*   [Implementing the recipient form](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#implementing-the-recipient-form)
*   [Create a form to collect recipient information](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#create-a-form-to-collect-recipient-information)
*   [Add the recipient form to your product form](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#add-the-recipient-form-to-your-product-form)
*   [Displaying the recipient properties in the cart](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#displaying-the-recipient-properties-in-the-cart)
*   [Limitations](https://shopify.dev/docs/storefronts/themes/product-merchandising/gift-cards#limitations)
