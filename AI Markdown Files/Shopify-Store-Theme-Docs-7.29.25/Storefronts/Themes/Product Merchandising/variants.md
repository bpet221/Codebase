---
title: "Variants"
description: "Shopify theme documentation for variants"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/product-merchandising/variants"
...
URL Source: https://shopify.dev/docs/storefronts/themes/product-merchandising/variants
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#Main)
...
[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#resources)
...
[Anchor link to section titled "Implementing product variants"](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#implementing-product-variants)

To support variants in your theme, you need to implement the following components:

*   [Variant deep link handling](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#variant-deep-link-handling): A variant can be linked to directly, so you should ensure that the product information is updated for the "selected" variant when a variant is referenced in a product link.
*   [Variant selectors](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#variant-selectors): You should build a variant selector to allow customers to easily browse the available variants of a product. Selecting a variant should update the page with variant-specific information.
...
[Anchor link to section titled "Variant deep link handling"](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#variant-deep-link-handling)
...
[Anchor link to section titled "Example"](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#example)
...
[Anchor link to section titled "Variant selectors"](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#variant-selectors)
...
*   [Resources](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#resources)
*   [Implementing product variants](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#implementing-product-variants)
*   [Variant deep link handling](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#variant-deep-link-handling)
*   [Variant selectors](https://shopify.dev/docs/storefronts/themes/product-merchandising/variants#variant-selectors)
