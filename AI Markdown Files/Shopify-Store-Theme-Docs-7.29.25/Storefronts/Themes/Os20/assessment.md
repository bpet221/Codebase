---
title: "Assessment"
description: "Shopify theme documentation for assessment"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/os20/assessment"
extraction_method: "jina_extended"
sections: ['Storefronts', 'Themes', 'Os20']
tags: ["shopify", "themes", "documentation"]
---

Title: Migration assessment

URL Source: https://shopify.dev/docs/storefronts/themes/os20/assessment
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/os20/assessment#Main)
...
*   **[Migrate a theme manually](https://shopify.dev/docs/storefronts/themes/os20/assessment)**: Add Online Store 2.0 functionality to a theme by converting a Liquid template into a JSON template, and moving any required Liquid code or HTML into sections that you can include in the new JSON template.
...
| **[Requires Online Store 2.0 features](https://shopify.dev/docs/storefronts/themes/os20/assessment#online-store-2-0-feature-requirements)** |
| Yes |  | ✓ | ✓ | ✓ |
| No | ✓ |  |  |  |
| **[Satisfied with the current theme](https://shopify.dev/docs/storefronts/themes/os20/assessment#satisfaction-with-the-current-theme)** |
| Yes |  |  | ✓ | ✓ |
| No |  | ✓ |  |  |
| **[Uses many apps and theme customizations](https://shopify.dev/docs/storefronts/themes/os20/assessment#apps-and-customizations)** |
| Yes |  |  |  | ✓ |
| No |  | ✓ | ✓ |  |
| **[Has a budget for migration](https://shopify.dev/docs/storefronts/themes/os20/assessment#budget)** |
| Yes |  | ✓ | ✓ | ✓ |
| No |  | Choose from [free themes by Shopify](https://themes.shopify.com/themes?price=free) | ✓ | ✓ |
| **[Comfortable with writing and editing code](https://shopify.dev/docs/storefronts/themes/os20/assessment#code-expertise)** |
| Yes |  | ✓ | ✓ | ✓ |
...
[Anchor link to section titled "Online Store 2.0 feature requirements"](https://shopify.dev/docs/storefronts/themes/os20/assessment#online-store-2-0-feature-requirements)
...
[Anchor link to section titled "Satisfaction with the current theme"](https://shopify.dev/docs/storefronts/themes/os20/assessment#satisfaction-with-the-current-theme)
...
*   If the current theme hasn't been upgraded to Online Store 2.0, then follow one of the methods below: 
    *   Upgrade the theme [manually](https://shopify.dev/docs/storefronts/themes/os20/assessment)
...
[Anchor link to section titled "Apps and customizations"](https://shopify.dev/docs/storefronts/themes/os20/assessment#apps-and-customizations)
...
If the theme was made specifically for you, or it is a heavily customized version of a free or paid theme, then it should be migrated [manually](https://shopify.dev/docs/storefronts/themes/os20/assessment). Consider the amount of time it will take to reinstall any required apps on your migrated themes.

Budget
------

[Anchor link to section titled "Budget"](https://shopify.dev/docs/storefronts/themes/os20/assessment#budget)
...
*   [Hire a Shopify Partner](https://www.shopify.com/partners/directory) to migrate the theme to Online Store 2.0 [manually](https://shopify.dev/docs/storefronts/themes/os20/assessment)
...
*   If you're comfortable with writing or editing code, then migrate the theme [manually](https://shopify.dev/docs/storefronts/themes/os20/assessment) at no cost

Code expertise
--------------

[Anchor link to section titled "Code expertise"](https://shopify.dev/docs/storefronts/themes/os20/assessment#code-expertise)

If you're comfortable with writing or editing code, then you can consider migrating your theme [manually](https://shopify.dev/docs/storefronts/themes/os20/assessment). You can migrate individual templates to take advantage of Online Store 2.0 features in specific parts of your theme, or you can migrate the entire theme by migrating all templates.
...
*   [Online Store 2.0 feature requirements](https://shopify.dev/docs/storefronts/themes/os20/assessment#online-store-2-0-feature-requirements)
*   [Satisfaction with the current theme](https://shopify.dev/docs/storefronts/themes/os20/assessment#satisfaction-with-the-current-theme)
*   [Apps and customizations](https://shopify.dev/docs/storefronts/themes/os20/assessment#apps-and-customizations)
*   [Budget](https://shopify.dev/docs/storefronts/themes/os20/assessment#budget)
*   [Code expertise](https://shopify.dev/docs/storefronts/themes/os20/assessment#code-expertise)
