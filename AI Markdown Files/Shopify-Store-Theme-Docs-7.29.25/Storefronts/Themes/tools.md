---
title: "Tools"
description: "Shopify theme documentation for tools"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/tools"
extraction_method: "jina_extended"
sections: ['Storefronts', 'Themes']
tags: ["shopify", "themes", "documentation"]
---

Title: Tools for building Shopify themes

URL Source: https://shopify.dev/docs/storefronts/themes/tools
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools#Main)
...
[Anchor link to section titled "Tools for building and editing themes"](https://shopify.dev/docs/storefronts/themes/tools#tools-for-building-and-editing-themes)

The following tools help you quickly scaffold, test, share, and develop Shopify themes.

[![Image 2](https://shopify.dev/assets/resource-cards/cli) ### Shopify CLI 3.x A powerful command-line tool for building Shopify themes, and exploring Liquid code in a REPL interface.](https://shopify.dev/docs/api/shopify-cli/theme)

[![Image 3](https://shopify.dev/assets/resource-cards/theme) ### Shopify Liquid VS Code extension Use the Shopify Liquid Visual Studio Code extension to improve your local development experience.](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode)

### Legacy tools

[Anchor link to section titled "Legacy tools"](https://shopify.dev/docs/storefronts/themes/tools#legacy-tools)

[![Image 4](https://shopify.dev/assets/resource-cards/cli) ### Shopify CLI 2.x The previous major version of Shopify CLI.](https://shopify.dev/docs/storefronts/themes/tools/cli/cli-2/commands)

[![Image 5](https://shopify.dev/assets/resource-cards/cli) ### Theme Kit A legacy command-line tool for building Shopify themes.](https://shopify.dev/docs/storefronts/themes/tools/theme-kit)

Web-based editors for themes
----------------------------

[Anchor link to section titled "Web-based editors for themes"](https://shopify.dev/docs/storefronts/themes/tools#web-based-editors-for-themes)
...
[![Image 6](https://shopify.dev/assets/resource-cards/theme) ### Admin theme editor An interactive editor that lets merchants customize their online store and theme.](https://shopify.dev/docs/storefronts/themes/tools/online-editor)

[![Image 7](https://shopify.dev/assets/resource-cards/cli) ### Admin code editor A code editor built into the Shopify admin.](https://shopify.dev/docs/storefronts/themes/tools/code-editor)

Access tools
------------

[Anchor link to section titled "Access tools"](https://shopify.dev/docs/storefronts/themes/tools#access-tools)

The following tools allow you to access Shopify infrastructure for testing, and help you to safely access merchant stores.

[![Image 8](https://shopify.dev/assets/resource-cards/build) ### Development stores A free Shopify account that you can use to build and test themes.](https://shopify.dev/docs/storefronts/themes/tools/development-stores)

[![Image 9](https://shopify.dev/assets/resource-cards/authentication) ### Collaborator accounts An account that lets you access and manage a merchant's store through the Partner Dashboard.](https://shopify.dev/docs/storefronts/themes/tools/collaborator-accounts)

[![Image 10](https://shopify.dev/assets/resource-cards/authentication) ### Theme Access app An app that grants programmatic access to themes in a particular store. Used with Shopify CLI and Theme Kit.](https://shopify.dev/docs/storefronts/themes/tools/theme-access)

Version control tools
---------------------

[Anchor link to section titled "Version control tools"](https://shopify.dev/docs/storefronts/themes/tools#version-control-tools)

The Shopify GitHub integration helps you to track and push changes to and from a theme in a Shopify store by using Git.

[![Image 11](https://shopify.dev/assets/resource-cards/github) ### Shopify GitHub integration Manage your Shopify theme code by using Git version control.](https://shopify.dev/docs/storefronts/themes/tools/github)

Testing tools
-------------

[Anchor link to section titled "Testing tools"](https://shopify.dev/docs/storefronts/themes/tools#testing-tools)

The following tools help you to optimize and detect errors in your theme code.

[![Image 12](https://shopify.dev/assets/resource-cards/build) ### Theme Check A command-line based linter for themes. Also offered as part of the Shopify Liquid Visual Studio Code extension.](https://shopify.dev/docs/storefronts/themes/tools/theme-check/configuration)

[![Image 13](https://shopify.dev/assets/resource-cards/theme) ### Liquid Prettier Plugin Use the Liquid Prettier Plugin to format your Liquid and HTML in a consistent style.](https://shopify.dev/docs/storefronts/themes/tools/liquid-prettier-plugin)

[![Image 14](https://shopify.dev/assets/resource-cards/build) ### Shopify Theme Inspector for Chrome Profile and debug your Liquid template performance with this extension for Chrome Developer Tools.](https://shopify.dev/docs/storefronts/themes/tools/theme-inspector)

[![Image 15](https://shopify.dev/assets/resource-cards/rest) ### Lighthouse CI Ensure that your theme is performant by using the Lighthouse CI GitHub Action.](https://shopify.dev/docs/storefronts/themes/tools/lighthouse-ci)

[![Image 16](https://shopify.dev/assets/resource-cards/cheatsheet) ### LiquidDoc Enable enhanced tooling features for Liquid snippets.](https://shopify.dev/docs/storefronts/themes/tools/liquid-doc)

Tools for learning Liquid
-------------------------

[Anchor link to section titled "Tools for learning Liquid"](https://shopify.dev/docs/storefronts/themes/tools#tools-for-learning-liquid)

The following tools help you to learn and write Liquid.

[![Image 17](https://shopify.dev/assets/resource-cards/theme) ### Imagery New Learn how to write image tags, and understand how images are dynamically transformed with Imagery.](https://cdn.shopify.com/)

### On this page

*   [Tools for building and editing themes](https://shopify.dev/docs/storefronts/themes/tools#tools-for-building-and-editing-themes)
*   [Web-based editors for themes](https://shopify.dev/docs/storefronts/themes/tools#web-based-editors-for-themes)
*   [Access tools](https://shopify.dev/docs/storefronts/themes/tools#access-tools)
*   [Version control tools](https://shopify.dev/docs/storefronts/themes/tools#version-control-tools)
*   [Testing tools](https://shopify.dev/docs/storefronts/themes/tools#testing-tools)
*   [Tools for learning Liquid](https://shopify.dev/docs/storefronts/themes/tools#tools-for-learning-liquid)
