---
title: "B2B"
description: "Shopify theme documentation for b2b"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b"
extraction_method: "jina_extended"
sections: ['Storefronts', 'Themes', 'Pricing Payments']
tags: ["shopify", "themes", "documentation"]
---

Title: Support B2B customers in your theme

URL Source: https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b#Main)
...
To help manage B2B transactions, merchants can create [companies](https://shopify.dev/docs/api/liquid/objects/company). A company can be associated with one or more [customers](https://shopify.dev/docs/api/liquid/objects/customer), and can have one or more [locations](https://shopify.dev/docs/api/liquid/objects/company_location). For an individual transaction, a B2B customer must select a location for the transaction to be associated with.
...
[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b#resources)
...
*   [`company_location`](https://shopify.dev/docs/api/liquid/objects/company_location)
*   [`customer.b2b?`](https://shopify.dev/docs/api/liquid/objects/customer#customer-b2b?)
*   [`customer.company_available_locations`](https://shopify.dev/docs/api/liquid/objects/customer#customer-company_available_locations)
*   [`customer.current_company`](https://shopify.dev/docs/api/liquid/objects/customer#customer-current_company)
*   [`customer.current_location`](https://shopify.dev/docs/api/liquid/objects/customer#customer-current_location)

Implementing a company location picker
--------------------------------------

[Anchor link to section titled "Implementing a company location picker"](https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b#implementing-a-company-location-picker)
...
[Anchor link to section titled "Show content based on company or location"](https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b#show-content-based-on-company-or-location)
...
[Anchor link to section titled "Show content to B2B customers only"](https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b#show-content-to-b2b-customers-only)
...
You can [adapt your theme content for your B2B customers](https://help.shopify.com//en/manual/online-store/themes/customizing-themes/store-contextualization) directly from the theme editor. Alternatively, you can use the Liquid [`customer.b2b?`](https://shopify.dev/docs/api/liquid/objects#customer-b2b?) property to render content for verified B2B customers. In this example, `customer.b2b?` is used to conditionally hide the product price:
...
*   [Resources](https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b#resources)
*   [Implementing a company location picker](https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b#implementing-a-company-location-picker)
*   [Show content based on company or location](https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b#show-content-based-on-company-or-location)
*   [Show content to B2B customers only](https://shopify.dev/docs/storefronts/themes/pricing-payments/b2b#show-content-to-b2b-customers-only)
