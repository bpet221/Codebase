...
description: "Shopify theme documentation for delivery fulfillment"
date: "2025-07-29"
source: "https://shopify.dev/docs/storefronts/themes/delivery-fulfillment"
...
URL Source: https://shopify.dev/docs/storefronts/themes/delivery-fulfillment
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/delivery-fulfillment#Main)
...
A big hurdle for merchants is getting customers to make a purchase, however once that purchase is made, they still need a way for the product to reach the customer. The most common method is shipping, however Shopify also provides merchants the option to offer products for local pickup.

As such, you can show the [pickup availability](https://shopify.dev/docs/storefronts/themes/delivery-fulfillment/pickup-availability) on product pages so customers can see whether this is an option for their desired product.
