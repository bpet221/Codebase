---
title: "Grouped view Bundle emails"
source: https://shopify.dev/docs/storefronts/themes/product-merchandising/bundles-emails
sections: Theme features > Bundles Emails
created: 2025-07-29 15:37:45
---

Title: Bundles grouped view emails

URL Source: https://shopify.dev/docs/storefronts/themes/product-merchandising/bundles-emails
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/product-merchandising/bundles-emails#Main)
...
![Image 4: Order confirmation email that lists a bundle of products ungrouped](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/product-merchandising/bundles/grouped-view-before-f80ebad52eabc8fdb00ae9bc7d3733a4ce8d686a98ba27d0c566140fc3345b3d.png)
In this image, the products in a Bundle are presented in a grouped view:

![Image 5: Order confirmation email that lists a bundle of products grouped](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/product-merchandising/bundles/grouped-view-after-101432836dff8954aa76145319a7699a3e130ae51d1f71d84bff31b07424538d.png)

Step 1: Querying for the `lineItemsGroup` data
----------------------------------------------

[Anchor link to section titled "Step 1: Querying for the lineItemsGroup data"](https://shopify.dev/docs/storefronts/themes/product-merchandising/bundles-emails#step-1-querying-for-the-lineitemsgroup-data)
...
[Anchor link to section titled "Step 2: Grouping Bundles"](https://shopify.dev/docs/storefronts/themes/product-merchandising/bundles-emails#step-2-grouping-bundles)
...
[Anchor link to section titled "Step 3: Calculating the bundle price"](https://shopify.dev/docs/storefronts/themes/product-merchandising/bundles-emails#step-3-calculating-the-bundle-price)
...
*   [Step 1: Querying for the `lineItemsGroup` data](https://shopify.dev/docs/storefronts/themes/product-merchandising/bundles-emails#step-1-querying-for-the-lineitemsgroup-data)
*   [Step 2: Grouping Bundles](https://shopify.dev/docs/storefronts/themes/product-merchandising/bundles-emails#step-2-grouping-bundles)
*   [Step 3: Calculating the bundle price](https://shopify.dev/docs/storefronts/themes/product-merchandising/bundles-emails#step-3-calculating-the-bundle-price)
