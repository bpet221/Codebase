---
title: "Explicit currency formatting"
source: https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting
sections: Theme features > Currency Formatting
created: 2025-07-29 15:38:52
---

Title: Explicit currency formatting

URL Source: https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#Main)

[![Image 4: shopify.dev](https://cdn.shopify.com/shopifycloud/shopify_dev/bundles/4fad754688bb9dbf6b7d91bd294fd7c00200db68aaf55f416ad2fb01850e48a9.svg)](https://shopify.dev/docs)
...
In this tutorial, you'll learn how to create a setting that lets merchants enable explicit currency formatting, and then apply it to price displays. You can also review [guidelines](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#guidelines-for-updating-price-displays) for price displays and currency formatting.

#### Note

Merchants can define the format of money filters [in the Shopify admin](https://help.shopify.com/manual/payments/currency-formatting).

Resources
---------

[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#resources)

To add explicit currency formatting to your theme, you'll use the following Liquid filters:

*   The [`money_with_currency`](https://shopify.dev/docs/api/liquid/filters/money_with_currency) filter
*   The [`money`](https://shopify.dev/docs/api/liquid/filters/money) filter

Implement explicit currency formatting
--------------------------------------

[Anchor link to section titled "Implement explicit currency formatting"](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#implement-explicit-currency-formatting)

To implement explicit currency formatting, you need to implement the following components:

*   [A currency code theme setting](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#create-a-currency-code-theme-setting): This setting enables merchants to choose whether the currency code is included in price displays.
*   [References to the theme setting in price displays](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#reference-the-theme-setting-in-price-displays): Reference the currency code theme setting to display the appropriate currency format in price displays.

### Create a currency code theme setting

[Anchor link to section titled "Create a currency code theme setting"](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#create-a-currency-code-theme-setting)
...
[Anchor link to section titled "Reference the theme setting in price displays"](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#reference-the-theme-setting-in-price-displays)
...
You shouldn't update all price displays to reference the currency code setting. To learn where you should and shouldn't use this setting in a theme, refer to [Guidelines for updating price displays](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#guidelines-for-updating-price-displays).

Your code should do the following:

1.   Check the value of the currency setting to determine whether currency codes are enabled.
2.   If currency codes are enabled, show the price with currency code by applying the [`money with currency`](https://shopify.dev/docs/api/liquid/filters/money_with_currency) filter to the price display.
3.   If currency codes aren't enabled, show the price without the currency code by applying the [`money`](https://shopify.dev/docs/api/liquid/filters/money) filter to the price display.
...
[Anchor link to section titled "Guidelines for updating price displays"](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#guidelines-for-updating-price-displays)

Most price displays should be updated to reference a [currency code theme setting](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#create-a-currency-code-theme-setting). However, there are some areas that should be hardcoded to provide the best customer experience or avoid repetition.

### Displays that should always use explicit currency formatting

[Anchor link to section titled "Displays that should always use explicit currency formatting"](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#displays-that-should-always-use-explicit-currency-formatting)
...
[Anchor link to section titled "Displays that shouldn't use explicit currency formatting"](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#displays-that-shouldnt-use-explicit-currency-formatting)
...
| --- | --- |
| Installment prices in an [installment banner](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments) | ![Image 5](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/currency-format/installment-prices-c4f6897aca69a64065b80f9b5c578e36518a4d00190c11e755687536dac81974.png) |
| Itemized prices in a cart or order | ![Image 6](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/currency-format/itemized-prices-8d2c15b7fe82596ee383be43ff58d0a36a8f754056fb1a690bf9adacf7cb953d.png) |
| [Unit prices](https://shopify.dev/docs/storefronts/themes/pricing-payments/unit-pricing) | ![Image 7](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/currency-format/unit-prices-a9d4ebd21f5cbb3eaa4128270622c50386542ebdad959a09b6b90526a6e332fe.png) |

### On this page

*   [Resources](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#resources)
*   [Implement explicit currency formatting](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#implement-explicit-currency-formatting)
*   [Guidelines for updating price displays](https://shopify.dev/docs/storefronts/themes/pricing-payments/currency-formatting#guidelines-for-updating-price-displays)
