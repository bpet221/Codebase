...
source: https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search
sections: Theme features > Search > Predictive Search
created: 2025-07-29 15:39:35
---

Title: Add predictive search to your theme

URL Source: https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#Main)

[![Image 3: shopify.dev](https://cdn.shopify.com/shopifycloud/shopify_dev/bundles/4fad754688bb9dbf6b7d91bd294fd7c00200db68aaf55f416ad2fb01850e48a9.svg)](https://shopify.dev/docs)
...
![Image 4: Example of search dropdown showing recommended products](https://shopify.dev/assets/themes/predictive-search-demo-838215f27371a0968df76ef98a8848a009f9c4e10409d65e42e20c51c17e6c45.png)

Predictive search supports suggestions for products, collections, queries, pages, and articles.

Before [implementing predictive search in your theme](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#implementing-predictive-search), it's important to be familiar with [how suggestions are generated](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#how-suggestions-are-generated), [current API limitations](https://shopify.dev/docs/api/ajax/reference/predictive-search#limitations), and the [UX guidelines](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search-ux).

How suggestions are generated
-----------------------------

[Anchor link to section titled "How suggestions are generated"](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#how-suggestions-are-generated)

The predictive search dropdown displays the following information when you enter a query.

![Image 5: Diagram of search dropdown](https://shopify.dev/assets/themes/PredictiveSearchDiagram3.png)

Legend for the diagram of the search dropdown| Point | Description |
| --- | --- |
...
[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#resources)
...
[Anchor link to section titled "Implementing predictive search"](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#implementing-predictive-search)

To support predictive search, you need to implement the following components:

*   [The main search](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#the-main-search): A search input for predictive search to apply to.
*   [The predictive search section](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#the-predictive-search-section]): A section to host the general predictive search display. This display is populated with the results of the predictive search using the `resources` attribute of the `predictive_search` object.
...
[Anchor link to section titled "The main search"](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#the-main-search)
...
[Anchor link to section titled "The predictive search section"](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#the-predictive-search-section)
...
This section is rendered with [the main search](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#the-main-search) using [the JavaScript function](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#the-javascript-function).
...
[Anchor link to section titled "The JavaScript function"](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#the-javascript-function)
...
*   [How suggestions are generated](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#how-suggestions-are-generated)
*   [Resources](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#resources)
*   [Implementing predictive search](https://shopify.dev/docs/storefronts/themes/navigation-search/search/predictive-search#implementing-predictive-search)
