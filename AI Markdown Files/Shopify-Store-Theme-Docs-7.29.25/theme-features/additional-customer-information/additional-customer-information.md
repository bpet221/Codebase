...
source: https://shopify.dev/docs/storefronts/themes/customer-engagement/additional-customer-information
sections: Theme features > Additional Customer Information
created: 2025-07-29 15:38:54
---

Title: Collect additional customer information

URL Source: https://shopify.dev/docs/storefronts/themes/customer-engagement/additional-customer-information
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/customer-engagement/additional-customer-information#Main)
...
You can collect additional information from customers when they create an account through [the customer register form](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register).

#### Note

You can't create new fields in the Shopify admin to host information, so any additional information is saved as a [customer note](https://help.shopify.com/manual/customers/manage-customers#edit-customer-profiles). The customer note isn't accessible through Liquid, but can be accessed through the [`Customer`](https://shopify.dev/docs/api/admin-graphql/latest/objects/Customer) object of the GraphQL Admin API.

This information can be collected with any [HTML input type](https://developer.mozilla.org/en-US/docs/Learn/Forms/HTML5_input_types), except for `file`. The input needs to have an attribute of `name="customer[note][Information title]"`, where `Information title` is the title of the information you're collecting. You can have more than one input for collecting a note entry.
