...
source: https://shopify.dev/docs/storefronts/themes/pricing-payments/installments
sections: Theme features > Installments
created: 2025-07-29 15:38:21
---

Title: Shop Pay Installments

URL Source: https://shopify.dev/docs/storefronts/themes/pricing-payments/installments
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#Main)
...
![Image 2: Shop Pay Installments banner on the product page](https://shopify.dev/assets/themes/pricing-payments/installments/spi-banner-product.png)![Image 3: Shop Pay Installments banner on the cart page](https://shopify.dev/assets/themes/pricing-payments/installments/spi-banner-cart.png)
![Image 4: Shop Pay Installments banner 'Learn more' pop-up](https://shopify.dev/assets/themes/pricing-payments/installments/spi-banner-pop-up-blur.png)

In this tutorial, you'll learn how to add a Shop Pay Installments banner to the following locations:

*   [The product form](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#add-the-banner-to-the-product-form)
*   [The cart form](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#add-the-banner-to-the-cart-form)

Requirements
------------

[Anchor link to section titled "Requirements"](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#requirements)
...
[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#resources)
...
[Anchor link to section titled "Implementing a Shop Pay Installments banner"](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#implementing-a-shop-pay-installments-banner)
...
[Anchor link to section titled "Add the banner to the product form"](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#add-the-banner-to-the-product-form)
...
[Anchor link to section titled "Add the banner to the cart form"](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#add-the-banner-to-the-cart-form)
...
[Anchor link to section titled "Updating the banner with cart total changes"](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#updating-the-banner-with-cart-total-changes)
...
*   [Requirements](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#requirements)
*   [Resources](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#resources)
*   [Implementing a Shop Pay Installments banner](https://shopify.dev/docs/storefronts/themes/pricing-payments/installments#implementing-a-shop-pay-installments-banner)
