...
source: https://shopify.dev/docs/storefronts/themes/trust-security/security-badges
sections: Theme features > Security Badges
created: 2025-07-29 15:40:36
---

Title: Security badges

URL Source: https://shopify.dev/docs/storefronts/themes/trust-security/security-badges
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/trust-security/security-badges#Main)
...
[![Image 5: Shopify secure badge](https://cdn.shopify.com/s/images/badges/shopify-secure-badge-white.svg)](https://www.shopify.com/security/pci-compliant?utm_medium=shop&utm_source=secure "This online store is secured by Shopify")[![Image 6: Shopify secure badge](https://cdn.shopify.com/s/images/badges/shopify-secure-badge-dark.svg)](https://www.shopify.com/security/pci-compliant?utm_medium=shop&utm_source=secure "This online store is secured by Shopify")

Add security badges to your theme
---------------------------------

[Anchor link to section titled "Add security badges to your theme"](https://shopify.dev/docs/storefronts/themes/trust-security/security-badges#add-security-badges-to-your-theme)
