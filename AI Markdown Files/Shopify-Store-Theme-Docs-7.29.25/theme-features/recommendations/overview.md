---
title: "Overview"
source: https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations
sections: Theme features > Recommendations
created: 2025-07-29 15:37:17
---

Title: Product recommendations

URL Source: https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations#Main)
...
*   **[Recommendation intents](https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations#recommendation-intents)**
*   **[How to track recommendations](https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations#track-recommendations)**
...
[Anchor link to section titled "Recommendation intents"](https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations#recommendation-intents)
...
*   **[Related products](https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations/related-products)**: Offer customers a mix of products that are similar to a product the customer is interacting with. An example is substitutable products that display in a **You might also like** section.

*   **[Complementary products](https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations/complementary-products)**: Offer customers products that are complementary to a product the customer is interacting with. An example is add-on products that display in a **Pair it with** section.
...
[Anchor link to section titled "Track recommendations"](https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations#track-recommendations)
...
*   [Recommendation intents](https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations#recommendation-intents)
*   [Track recommendations](https://shopify.dev/docs/storefronts/themes/product-merchandising/recommendations#track-recommendations)
