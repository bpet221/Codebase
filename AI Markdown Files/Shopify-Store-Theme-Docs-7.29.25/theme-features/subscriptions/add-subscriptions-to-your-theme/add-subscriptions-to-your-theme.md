---
title: "Add subscriptions to your theme"
source: https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme
sections: Theme features > Subscriptions > Add Subscriptions To Your Theme
created: 2025-07-29 15:38:16
---

Title: Add subscriptions to your theme

URL Source: https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#Main)
...
Refer to [Subscription UX guidelines](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/subscription-ux-guidelines) to review user experience considerations that might impact your implementation.

Requirements
------------

[Anchor link to section titled "Requirements"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#requirements)
...
[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#resources)
...
| Variants that have been added to a cart or are part of an order | * [cart](https://shopify.dev/docs/storefronts/themes/architecture/templates/cart) * [customers/order](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order) | [line_item](https://shopify.dev/docs/api/liquid/objects/line_item) |
...
[Anchor link to section titled "Implementing subscription displays"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#implementing-subscription-displays)

To support subscriptions in your theme, you need to implement the following components:

*   **[A selling plan selector on the product page](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-selling-plan-selector-on-the-product-page)**: This selector enables customers to select a selling plan.
*   **[JavaScript to update the selling plan](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#javascript-to-update-selling-plan-information)**: Use JavaScript to update the available selling plans when variants are selected, and update the hidden selling plan input as selling plan options are selected.
*   **[A selling plan display in the cart](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-selling-plan-display-in-the-cart)**: Indicate to customers when a selling plan has been applied to a line item. You can also implement a selling plan selector to give the option to add a new selling plan, or to remove or edit the current selling plan.
*   **[A checkout charge in the cart](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-checkout-charge-display-in-the-cart)**: Display a checkout charge that represents the amount that customers need to pay during checkout.
*   **[A selling plan display on the customer order pages](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#customer-order-selling-plan-display)**: Indicate to customers when a selling plan has been applied to a line item.

The selling plan selector on the product page
---------------------------------------------

[Anchor link to section titled "The selling plan selector on the product page"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-selling-plan-selector-on-the-product-page)
...
*   Save the product object so that it can be accessed in [JavaScript](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#javascript-to-update-selling-plan-information).

### Example

[Anchor link to section titled "Example"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#example)

The following example is showing an example on how you can show the selling plan group in your product form. Make sure to add the code inside your product form. The example is referring to the file `selling-plans-integration.js`, this file is covered on the [JavaScript](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#javascript-to-update-selling-plan-information) section. The following code is doing the following:
...
This example demonstrates how to integrate selling plans into your theme. We recommend customizing this integration to suit your specific needs. The following code can also be used as a [theme app block](https://shopify.dev/docs/storefronts/themes/architecture/blocks/app-blocks).
...
[Anchor link to section titled "JavaScript to update selling plan information"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#javascript-to-update-selling-plan-information)
...
[Anchor link to section titled "The selling plan display in the cart"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-selling-plan-display-in-the-cart)
...
[Anchor link to section titled "The selling plan selector"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-selling-plan-selector)
...
[Anchor link to section titled "The checkout charge display in the cart"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-checkout-charge-display-in-the-cart)
...
[Anchor link to section titled "Customer order selling plan display"](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#customer-order-selling-plan-display)
...
*   [Requirements](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#requirements)
*   [Resources](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#resources)
*   [Implementing subscription displays](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#implementing-subscription-displays)
*   [The selling plan selector on the product page](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-selling-plan-selector-on-the-product-page)
*   [JavaScript to update selling plan information](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#javascript-to-update-selling-plan-information)
*   [The selling plan display in the cart](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-selling-plan-display-in-the-cart)
*   [The checkout charge display in the cart](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#the-checkout-charge-display-in-the-cart)
*   [Customer order selling plan display](https://shopify.dev/docs/storefronts/themes/pricing-payments/subscriptions/add-subscriptions-to-your-theme#customer-order-selling-plan-display)
