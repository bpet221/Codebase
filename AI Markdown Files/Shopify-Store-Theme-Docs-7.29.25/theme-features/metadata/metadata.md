---
title: "Metadata"
source: https://shopify.dev/docs/storefronts/themes/seo/metadata
sections: Theme features > Metadata
created: 2025-07-29 15:40:05
---

Title: Add SEO metadata to your theme

URL Source: https://shopify.dev/docs/storefronts/themes/seo/metadata
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/seo/metadata#Main)
...
*   The [title tag](https://shopify.dev/docs/storefronts/themes/seo/metadata#the-title-tag)
*   The [meta description](https://shopify.dev/docs/storefronts/themes/seo/metadata#the-meta-description)
*   [Canonical URLs](https://shopify.dev/docs/storefronts/themes/seo/metadata#canonical-urls)
...
[Anchor link to section titled "The title tag"](https://shopify.dev/docs/storefronts/themes/seo/metadata#the-title-tag)

You can include a `<title>` element for search engines to read the page title from. The title for most pages can be set in the admin, and you can access this title with the Liquid [page_title object](https://shopify.dev/docs/api/liquid/objects/page_title).

### The meta description

[Anchor link to section titled "The meta description"](https://shopify.dev/docs/storefronts/themes/seo/metadata#the-meta-description)

You can include a `<meta>` element for search engines to read the page description from. The description for most pages can be set in the admin, and you can access this description with the Liquid [page_description object](https://shopify.dev/docs/api/liquid/objects/page_description).

### Canonical URLs

[Anchor link to section titled "Canonical URLs"](https://shopify.dev/docs/storefronts/themes/seo/metadata#canonical-urls)
