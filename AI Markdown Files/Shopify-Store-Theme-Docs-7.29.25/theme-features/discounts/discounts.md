---
title: "Discounts"
source: https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts
sections: Theme features > Discounts
created: 2025-07-29 15:37:48
---

Title: Discounts

URL Source: https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#Main)
...
![Image 5: Cart page with a shirt added to the cart. A discount applies directly to the shirt line item in the cart, while another discount applies to the cart as a whole.](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/pricing-payments/discounts/discounts-no-highlighting-8fc9ca5446b9cda28ecde55e36d056b275ef2991ad86478cef90c7800dcd71c2.png)

Requirements
------------

[Anchor link to section titled "Requirements"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#requirements)

You've created a [cart template](https://shopify.dev/docs/storefronts/themes/architecture/templates/cart) or a [customers/order template](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order).

Resources
---------

[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#resources)

To display discounts in your theme, you'll use the following:

*   [The `discount_application` object](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#the-discount_application-object)
*   [The `discount_allocation` object](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#the-discount_allocation-object)
*   [The `line_item` object](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#the-line_item-object)

### The `discount_application` object

[Anchor link to section titled "The discount_application object"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#the-discount_application-object)
...
*   For the [customers/order](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order) template: 
    *   [`order.discount_applications`](https://shopify.dev/docs/api/liquid/objects/order#order-discount_applications)
    *   [`order.cart_level_discount_applications`](https://shopify.dev/docs/api/liquid/objects/order#order-cart_level_discount_applications)
...
[Anchor link to section titled "The discount_allocation object"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#the-discount_allocation-object)
...
[Anchor link to section titled "The line_item object"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#the-line_item-object)
...
[Anchor link to section titled "Implementing discount displays"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#implementing-discount-displays)
...
*   [With individual line items](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#line-item-discounts)
*   [With the total summary](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#cart-discounts)

The examples in this tutorial use the [cart template](https://shopify.dev/docs/storefronts/themes/architecture/templates/cart). However, you can adapt these examples to add discounts to the [customers/order template](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-order) by using the [`order` object](https://shopify.dev/docs/api/liquid/objects/order) where the [`cart` object](https://shopify.dev/docs/api/liquid/objects/cart) is used.
...
[Anchor link to section titled "Line item discounts"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#line-item-discounts)
...
*   [The line item price](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#line-item-price)
*   [The line item discount](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#line-item-discounts)

### Line item price

[Anchor link to section titled "Line item price"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#line-item-price)
...
[Anchor link to section titled "Example"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#example)
...
![Image 6: Cart page with a shirt added to the cart. A discount applies directly to the shirt line item in the cart.](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/pricing-payments/discounts/line-item-discount-22566259c0df55db0be51515bd1fd14e54aa6a7f101f16c3bc0450b8a8c7c608.png)
#### Tip
...
[Anchor link to section titled "Cart discounts"](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#cart-discounts)
...
![Image 7: Cart page with a bottle of canola oil added to the cart. A 10% discount applies to the cart as a whole.](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/pricing-payments/discounts/cart-discount-976070fe43557d2a67faae566d3f8b08b66ad4c35ff1f0424e8cdb98db0c6a62.png)
#### Tip
...
*   [Requirements](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#requirements)
*   [Resources](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#resources)
*   [Implementing discount displays](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#implementing-discount-displays)
*   [Line item discounts](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#line-item-discounts)
*   [Cart discounts](https://shopify.dev/docs/storefronts/themes/pricing-payments/discounts#cart-discounts)
