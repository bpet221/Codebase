...
sections: Theme features > Email Consent
created: 2025-07-29 15:38:53
---

Title: Email consent

URL Source: https://shopify.dev/docs/storefronts/themes/customer-engagement/email-consent
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/customer-engagement/email-consent#Main)
...
*   [A newsletter sign-up form](https://shopify.dev/docs/storefronts/themes/customer-engagement/email-consent#newsletter-sign-up-form)
*   [A checkbox input in the customer register form](https://shopify.dev/docs/storefronts/themes/customer-engagement/email-consent#customer-registration-form-checkbox)

Newsletter sign-up form
-----------------------

[Anchor link to section titled "Newsletter sign-up form"](https://shopify.dev/docs/storefronts/themes/customer-engagement/email-consent#newsletter-sign-up-form)
...
[Anchor link to section titled "Customer registration form checkbox"](https://shopify.dev/docs/storefronts/themes/customer-engagement/email-consent#customer-registration-form-checkbox)

Inside the [customer register form](https://shopify.dev/docs/storefronts/themes/architecture/templates/customers-register#the-customer-register-form), you can include a checkbox to allow customers to consent email marketing. This requires the following inputs to be placed inside the form:
...
*   [Newsletter sign-up form](https://shopify.dev/docs/storefronts/themes/customer-engagement/email-consent#newsletter-sign-up-form)
*   [Customer registration form checkbox](https://shopify.dev/docs/storefronts/themes/customer-engagement/email-consent#customer-registration-form-checkbox)
