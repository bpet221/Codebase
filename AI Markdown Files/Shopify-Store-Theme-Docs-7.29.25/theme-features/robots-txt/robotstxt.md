...
sections: Theme features > Robots Txt
created: 2025-07-29 15:40:36
---

Title: Customize robots.txt

URL Source: https://shopify.dev/docs/storefronts/themes/seo/robots-txt
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#Main)
...
[Anchor link to section titled "Requirements"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#requirements)
...
[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#resources)
...
[Anchor link to section titled "Customize robots.txt.liquid"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#customize-robots-txt-liquid)

You can make the following customizations:

*   [Add a new rule to an existing group](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#add-a-new-rule-to-an-existing-group)
*   [Remove a rule from an existing group](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#remove-a-default-rule-from-an-existing-group)
*   [Add custom rules](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#add-custom-rules)
...
[Anchor link to section titled "Add a new rule to an existing group"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#add-a-new-rule-to-an-existing-group)
...
[Anchor link to section titled "Add host-specific rules"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#add-host-specific-rules)
...
[Anchor link to section titled "Remove a default rule from an existing group"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#remove-a-default-rule-from-an-existing-group)
...
[Anchor link to section titled "Add custom rules"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#add-custom-rules)
...
*   [Block certain crawlers](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#block-certain-crawlers)
*   [Allow certain crawlers](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#allow-certain-crawlers)
*   [Add extra sitemap URLs](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#add-extra-sitemap-urls)

#### Block certain crawlers

[Anchor link to section titled "Block certain crawlers"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#block-certain-crawlers)
...
[Anchor link to section titled "Allow certain crawlers"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#allow-certain-crawlers)
...
[Anchor link to section titled "Add extra sitemap URLs"](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#add-extra-sitemap-urls)
...
*   [Requirements](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#requirements)
*   [Resources](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#resources)
*   [Customize `robots.txt.liquid`](https://shopify.dev/docs/storefronts/themes/seo/robots-txt#customize-robots-txt-liquid)
