---
title: "Overview"
source: https://shopify.dev/docs/storefronts/themes/pricing-payments/preorder-tbyb
sections: Theme features > Preorder Tbyb
created: 2025-07-29 15:38:17
---

Title: Pre-orders and Try Before You Buy (TBYB)

URL Source: https://shopify.dev/docs/storefronts/themes/pricing-payments/preorder-tbyb
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/pricing-payments/preorder-tbyb#Main)
...
[Anchor link to section titled "How it works"](https://shopify.dev/docs/storefronts/themes/pricing-payments/preorder-tbyb#how-it-works)

To enable pre-orders, apps create [selling plan groups](https://shopify.dev/docs/api/liquid/objects/selling_plan_group), within which they create [selling plans](https://shopify.dev/docs/api/liquid/objects/selling_plan). These selling plans are linked to products and product variants. For example, a selling plan group called "Pre-order" can offer selling plans that enable the customer to choose the amount they pay at the time of purchase. Merchants can offer multiple optional selling plans to customers, or specify a required selling plan for a product, such as "pre-order-only" offers.

![Image 3: Product page with a pre-order option.](https://cdn.shopify.com/shopifycloud/shopify_dev/assets/themes/pre-order-1e4adf603fea9f95eb0314ca232c8b38c95f76bd509831b0a65a7398e8b2b502.png)

Implementing pre-orders and TBYB in a theme
-------------------------------------------

[Anchor link to section titled "Implementing pre-orders and TBYB in a theme"](https://shopify.dev/docs/storefronts/themes/pricing-payments/preorder-tbyb#implementing-pre-orders-and-tbyb-in-a-theme)
...
[![Image 4](https://shopify.dev/assets/resource-cards/docs) ### Add pre-orders and TBYB to your theme Learn more about how to integrate pre-orders and TBYB into your theme.](https://shopify.dev/docs/storefronts/themes/pricing-payments/preorder-tbyb/add-preorder-tbyb-to-your-theme)

[![Image 5](https://shopify.dev/assets/resource-cards/theme) ### Pre-orders and TBYB UX guidelines Learn how to build a pre-order or TBYB experience and style components in your theme.](https://shopify.dev/docs/storefronts/themes/pricing-payments/preorder-tbyb/preorder-tbyb-ux-guidelines)

### On this page

*   [How it works](https://shopify.dev/docs/storefronts/themes/pricing-payments/preorder-tbyb#how-it-works)
*   [Implementing pre-orders and TBYB in a theme](https://shopify.dev/docs/storefronts/themes/pricing-payments/preorder-tbyb#implementing-pre-orders-and-tbyb-in-a-theme)
