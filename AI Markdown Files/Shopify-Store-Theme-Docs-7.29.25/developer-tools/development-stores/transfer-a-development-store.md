---
title: "Transfer a development store"
source: https://shopify.dev/docs/storefronts/themes/tools/development-stores/transfer-development-stores
sections: Developer Tools > Development Stores
created: 2025-07-29 15:35:13
---

Title: Transfer a development store

URL Source: https://shopify.dev/docs/storefronts/themes/tools/development-stores/transfer-development-stores
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/development-stores/transfer-development-stores#Main)
...
[Development stores](https://shopify.dev/docs/storefronts/themes/tools/development-stores) can be used to build a store for a client, or to test your app while you’re building it.
...
[Anchor link to section titled "When to transfer a store"](https://shopify.dev/docs/storefronts/themes/tools/development-stores/transfer-development-stores#when-to-transfer-a-store)
...
*   The work on the store is not complete, but the store requires a feature that's available only on a paid Shopify plan. To learn more about what features aren't available for development stores, refer to [Features and limitations of development stores](https://shopify.dev/docs/storefronts/themes/tools/development-stores#features-and-limitations-of-development-stores).
...
[Anchor link to section titled "How to transfer a store to a merchant"](https://shopify.dev/docs/storefronts/themes/tools/development-stores/transfer-development-stores#how-to-transfer-a-store-to-a-merchant)

To learn more about how to transfer a development store to a merchant, refer to [the Shopify Help Center page on transferring ownership of a development store](https://help.shopify.com/partners/dashboard/managing-stores/hand-off-development-stores#transfer-ownership-of-a-development-store).

Transfer-disabled stores
------------------------

[Anchor link to section titled "Transfer-disabled stores"](https://shopify.dev/docs/storefronts/themes/tools/development-stores/transfer-development-stores#transfer-disabled-stores)
...
*   If you install a [custom app or a draft app](https://help.shopify.com/manual/apps/app-types) on a development store
*   If you enable [developer preview](https://shopify.dev/docs/api/developer-previews) for a development store
...
*   [When to transfer a store](https://shopify.dev/docs/storefronts/themes/tools/development-stores/transfer-development-stores#when-to-transfer-a-store)
*   [How to transfer a store to a merchant](https://shopify.dev/docs/storefronts/themes/tools/development-stores/transfer-development-stores#how-to-transfer-a-store-to-a-merchant)
*   [Transfer-disabled stores](https://shopify.dev/docs/storefronts/themes/tools/development-stores/transfer-development-stores#transfer-disabled-stores)
