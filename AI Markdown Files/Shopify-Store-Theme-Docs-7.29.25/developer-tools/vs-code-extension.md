...
source: https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode
sections: Developer Tools
created: 2025-07-29 15:26:49
---

Title: Shopify Liquid VS Code extension

URL Source: https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#Main)
...
[Anchor link to section titled "Installation"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#installation)
...
Install the Shopify Liquid extension in [VS Code for the Web](https://vscode.dev/) to enable intelligent code completion, syntax highlighting, and other features for working with themes directly in your browser.

Features
--------

[Anchor link to section titled "Features"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#features)
...
*   [Syntax highlighting](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#syntax-highlighting)
*   [Documentation on hover](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#documentation-on-hover)
*   [Liquid code completion and documentation](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#liquid-code-completion-and-documentation)
*   [Schema tag code completion](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#schema-tag-code-completion)
*   [JSON code completion](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#json-code-completion)
*   [HTML element renaming](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#html-element-renaming)
...
*   [Auto-closing pairs](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#auto-closing-pairs)
*   [Theme checks](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#theme-checks)
*   [Fixes](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#fixes)
*   [Suggestions](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#suggestions)

### Syntax highlighting

[Anchor link to section titled "Syntax highlighting"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#syntax-highlighting)

The Shopify Liquid VS Code extension offers syntax highlighting. The syntax highlighting grammar is [officially maintained by Shopify](https://github.com/shopify/liquid-tm-grammar) and is the same one that [GitHub uses](https://github.com/github-linguist/linguist) to highlight Liquid code.

### Documentation on hover

[Anchor link to section titled "Documentation on hover"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#documentation-on-hover)
...
[Anchor link to section titled "Liquid code completion and documentation"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#liquid-code-completion-and-documentation)
...
[Anchor link to section titled "Schema tag code completion"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#schema-tag-code-completion)

Valid elements of JSON schema tags are contextually completed:

### JSON code completion

[Anchor link to section titled "JSON code completion"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#json-code-completion)

Valid elements of the `config/settings_schema.json` tag are contextually completed:

### HTML element renaming

[Anchor link to section titled "HTML element renaming"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#html-element-renaming)
...
[Anchor link to section titled "Code formatting"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#code-formatting)

Code formatting is powered by the [Liquid Prettier plugin](https://shopify.dev/docs/storefronts/themes/tools/liquid-prettier-plugin) and can be applied in the following ways:

*   [Automatically on save](https://shopify.dev/docs/storefronts/themes/tools/liquid-prettier-plugin#the-shopify-liquid-extension)
...
[Anchor link to section titled "Code navigation"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#code-navigation)
...
[Anchor link to section titled "Auto-closing pairs"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#auto-closing-pairs)

The extension will close Liquid and HTML character pairs for you.

### Theme checks

[Anchor link to section titled "Theme checks"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#theme-checks)

![Image 3: Theme Check demo](https://shopify.dev/assets/themes/tools/theme-check.png)
...
[Anchor link to section titled "Fixes"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#fixes)
...
*   [Automatically on save](https://code.visualstudio.com/docs/languages/javascript#_code-actions-on-save)
...
[Anchor link to section titled "Suggestions"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#suggestions)
...
[Anchor link to section titled "Contributing to the VS Code extension"](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#contributing-to-the-vs-code-extension)
...
*   [Installation](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#installation)
*   [Features](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#features)
*   [Contributing to the VS Code extension](https://shopify.dev/docs/storefronts/themes/tools/shopify-liquid-vscode#contributing-to-the-vs-code-extension)
