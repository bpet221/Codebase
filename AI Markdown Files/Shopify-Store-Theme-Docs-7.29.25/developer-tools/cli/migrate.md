---
title: "Migrate"
source: https://shopify.dev/docs/storefronts/themes/tools/cli/migrate
sections: Developer Tools > Cli
created: 2025-07-29 15:28:23
---

Title: Migrate to Shopify CLI 3.x

URL Source: https://shopify.dev/docs/storefronts/themes/tools/cli/migrate
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#Main)
...
[Anchor link to section titled "Getting started"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#getting-started)

Refer to the following tutorials for details about creating or working on a Shopify theme using Shopify CLI:

[![Image 2](https://shopify.dev/assets/resource-cards/globe) ### Start building a theme Learn how to set up your theme development environment and create a new theme.](https://shopify.dev/docs/storefronts/themes/getting-started/create)

[![Image 3](https://shopify.dev/assets/resource-cards/theme) ### Customize an existing theme Learn how to set up your development environment to work on a theme in a Shopify store.](https://shopify.dev/docs/storefronts/themes/getting-started/customize)

Workflow changes
----------------

[Anchor link to section titled "Workflow changes"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#workflow-changes)
...
| View the organization you're currently logged into using `shopify whoami` | _No longer supported_ |
...
| Populate stores using `shopify populate [ products | draftorders | customers ]` | _No longer supported_ |
...
[Anchor link to section titled "Migrate to Shopify CLI 3.x"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#migrate-to-shopify-cli-3-x)

Follow the steps below to migrate your theme development environment to Shopify CLI 3.x.

### macOS and Homebrew

[Anchor link to section titled "macOS and Homebrew"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#macos-and-homebrew)
...
In addition to the requirements for Shopify CLI 2.x, Shopify CLI 3.x requires [Node.js](https://nodejs.org/en/download/) 18 or higher. . Homebrew installs Node.js for you when you upgrade to the latest version of Shopify CLI.
...
[Anchor link to section titled "Other"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#other)

#### Step 1: Install new requirements

[Anchor link to section titled "Step 1: Install new requirements"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#step-1-install-new-requirements)

In addition to the requirements for Shopify CLI 2.x, Shopify CLI 3.x requires [Node.js](https://nodejs.org/en/download/) 18 or higher. . If you use macOS, then Homebrew will install Node.js for you when you upgrade to the latest version of Shopify CLI.
...
[Anchor link to section titled "Step 2: Uninstall Shopify CLI 2.x"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#step-2-uninstall-shopify-cli-2-x)
...
If you want to keep both versions of Shopify CLI installed, then refer to [Using both Shopify CLI 2.x and 3.x](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#using-multiple-versions) to learn how to work with both versions in the same environment.
...
[Anchor link to section titled "Step 3: Install Shopify CLI 3.x"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#step-3-install-shopify-cli-3-x)
...
[Anchor link to section titled "Step 4: Verify the installation"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#step-4-verify-the-installation)
...
[Anchor link to section titled "Using both Shopify CLI 2.x and 3.x"](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#using-both-shopify-cli-2-x-and-3-x)
...
*   [Getting started](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#getting-started)
*   [Workflow changes](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#workflow-changes)
*   [Migrate to Shopify CLI 3.x](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#migrate-to-shopify-cli-3-x)
*   [Using both Shopify CLI 2.x and 3.x](https://shopify.dev/docs/storefronts/themes/tools/cli/migrate#using-both-shopify-cli-2-x-and-3-x)
