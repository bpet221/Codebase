---
title: "ParserBlockingJavaScript"
source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript
sections: Developer Tools > Theme Check > Checks
created: 2025-07-29 15:32:29
---

Title: ParserBlockingJavaScript

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript#Main)
...
Considering that JavaScript on Shopify themes [should always be used to progressively enhance the experience of the site](https://shopify.dev/docs/storefronts/themes/best-practices/performance#optimize-your-javascript), themes should never make use of parser-blocking script tags.

As a general rule, use `defer` if the order of execution matters, and use `async` if it doesn't.

Learn more about [improving your theme's performance](https://shopify.dev/docs/storefronts/themes/best-practices/performance).

Examples
--------

[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript#examples)

The following examples contain code snippets that either fail or pass this check.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript#pass)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript#disabling-this-check)

If you can't avoid violating the rule, you should disable the check using the [comment syntax](https://shopify.dev/docs/storefronts/themes/tools/theme-check/configuration#disable-checks-using-liquid-comments). This ensures that you intentionally disable the check for each instance.
...
*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript#examples)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/parser-blocking-javascript#disabling-this-check)
