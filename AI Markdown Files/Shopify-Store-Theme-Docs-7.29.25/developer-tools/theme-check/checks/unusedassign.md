---
title: "UnusedAssign"
source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign
...
URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign#Main)
...
[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign#examples)

The following examples contain code snippets that either fail or pass this check.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign#pass)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign#disabling-this-check)
...
*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign#examples)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/unused-assign#disabling-this-check)
