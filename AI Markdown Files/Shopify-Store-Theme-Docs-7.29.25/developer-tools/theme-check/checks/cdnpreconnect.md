---
title: "CdnPreconnect"
source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect
sections: Developer Tools > Theme Check > Checks
created: 2025-07-29 15:29:54
---

Title: CdnPreconnect

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#Main)
...
[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#examples)

The following examples contain code snippets that either fail or pass this check.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#pass)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#disabling-this-check)
...
[Anchor link to section titled "Resources"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#resources)

*   [Introduction to resource hints](https://performance.shopify.com/blogs/blog/introduction-to-resource-hints)

### On this page

*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#examples)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#disabling-this-check)
*   [Resources](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/cdn-preconnect#resources)
