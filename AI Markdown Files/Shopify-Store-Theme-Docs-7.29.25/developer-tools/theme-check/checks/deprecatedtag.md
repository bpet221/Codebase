---
title: "DeprecatedTag"
source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag
sections: Developer Tools > Theme Check > Checks
created: 2025-07-29 15:30:56
---

Title: DeprecatedTag

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#Main)
...
Discourages using [deprecated tags](https://shopify.dev/docs/api/liquid/tags/theme-tags) in themes. Deprecated tags have their own unique implementation within this check. For example the `include` tag is deprecated but is still used in themes. This check looks for the `include` tag and provides a message that it's deprecated.

Examples
--------

[Anchor link to section titled "Examples"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#examples)

The following examples contain code snippets that either fail or pass this check:

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#pass)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#disabling-this-check)
...
[Anchor link to section titled "Aliases"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#aliases)
...
*   [Examples](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#examples)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#disabling-this-check)
*   [Aliases](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/deprecated-tag#aliases)
