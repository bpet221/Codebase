...
source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks
sections: Developer Tools > Theme Check > Checks
created: 2025-07-29 15:34:39
---

Title: ValidLocalBlocks

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks#Main)
...
[Anchor link to section titled "Validation on local blocks"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks#validation-on-local-blocks)

This section covers validations for local blocks in sections and in theme blocks.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks#pass)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks#disabling-this-check)

Disabling this check isn't recommended.

### On this page

*   [Validation on local blocks](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks#validation-on-local-blocks)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-local-blocks#disabling-this-check)
