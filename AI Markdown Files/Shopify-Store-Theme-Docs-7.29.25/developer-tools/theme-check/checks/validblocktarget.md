...
source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target
sections: Developer Tools > Theme Check > Checks
created: 2025-07-29 15:34:03
---

Title: ValidBlockTarget

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#Main)
...
[Anchor link to section titled "Validation on block file existence"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#validation-on-block-file-existence)

This section describes the validations to ensure that block types reference valid files.

### ✗ Fail

[Anchor link to section titled "✗ Fail"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#fail)
...
[Anchor link to section titled "✓ Pass"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#pass)
...
[Anchor link to section titled "Validation on nested blocks"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#validation-on-nested-blocks)
...
[Anchor link to section titled "Options"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#options)
...
[Anchor link to section titled "Disabling this check"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#disabling-this-check)

Disabling this check isn't recommended.

### On this page

*   [Validation on block file existence](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#validation-on-block-file-existence)
*   [Validation on nested blocks](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#validation-on-nested-blocks)
*   [Options](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#options)
*   [Disabling this check](https://shopify.dev/docs/storefronts/themes/tools/theme-check/checks/valid-block-target#disabling-this-check)
