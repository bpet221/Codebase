---
title: "Migrate"
source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/migrate
sections: Developer Tools > Theme Check
created: 2025-07-29 15:28:53
---

Title: Migrate to Theme Check 2.x

URL Source: https://shopify.dev/docs/storefronts/themes/tools/theme-check/migrate
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/tools/theme-check/migrate#Main)
...
In January 2024, Theme Check 2.x was integrated into the [admin code editor](https://shopify.dev/docs/storefronts/themes/tools/online-editor), the [VS Code extension](https://shopify.dev/docs/storefronts/themes/tools/cli/language-server), and [Shopify CLI](https://shopify.dev/docs/storefronts/themes/tools/cli/cli-2/commands).
...
[Anchor link to section titled "CLI changes"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/migrate#cli-changes)
...
The decision to remove these options was made to simplify the API and reduce the noise on the CLI's `--help`. While this might require some users to create a subset of the config for performance-related checks, the new framework's ability to extend multiple configurations makes this a more efficient approach. For more details about flags, please refer to the [commands reference](https://shopify.dev/docs/storefronts/themes/tools/theme-check/commands).

Configuration changes
---------------------

[Anchor link to section titled "Configuration changes"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/migrate#configuration-changes)

In Theme Check 2.x, the `extends` option has been updated. It now supports values such as `theme-check:all`, `theme-check:recommended`, and `theme-check:theme-app-extension`, but also supports a list of configuration files and third-party modules. For more details, please refer to the [configuration file reference](https://shopify.dev/docs/storefronts/themes/tools/theme-check/configuration).

The `require` option no longer supports custom Ruby checks. If you need to create your own custom checks or use a third-party set of checks with Theme Check 2.x, refer to the [Creating your own checks](https://github.com/Shopify/theme-tools/blob/main/docs/theme-check-common/writing-your-own-check) guide.

Check compatibility table
-------------------------

[Anchor link to section titled "Check compatibility table"](https://shopify.dev/docs/storefronts/themes/tools/theme-check/migrate#check-compatibility-table)
...
*   [CLI changes](https://shopify.dev/docs/storefronts/themes/tools/theme-check/migrate#cli-changes)
*   [Configuration changes](https://shopify.dev/docs/storefronts/themes/tools/theme-check/migrate#configuration-changes)
*   [Check compatibility table](https://shopify.dev/docs/storefronts/themes/tools/theme-check/migrate#check-compatibility-table)
