...
source: https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business
sections: Getting started > Build Your Business
created: 2025-07-29 15:20:22
---

Title: Build your business

URL Source: https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#Main)
...
As a [Shopify Partner](https://help.shopify.com/en/partners/about), there are several ways that you can earn money when working with Shopify themes.

Distribute your theme
---------------------

[Anchor link to section titled "Distribute your theme"](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#distribute-your-theme)
...
*   By uploading your theme to a GitHub repository, and then [connecting a branch of the repository](https://shopify.dev/docs/storefronts/themes/tools/github) to a theme in the Shopify admin.
*   By pushing a theme to a store using [Shopify CLI](https://shopify.dev/docs/storefronts/themes/tools/cli/cli-2/commands).

### Submit your theme to the shopify theme store

[Anchor link to section titled "Submit your theme to the shopify theme store"](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#submit-your-theme-to-the-shopify-theme-store)

Consider submitting your theme to the [Shopify Theme Store](https://shopify.dev/docs/storefronts/themes/store). As a theme Partner, you can create themes for the Shopify Theme Store and reach an international audience of millions of entrepreneurs. Learn about the requirements for themes in the Shopify Theme Store, and how to submit your theme.

### Prepare to hand off your store to a client

[Anchor link to section titled "Prepare to hand off your store to a client"](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#prepare-to-hand-off-your-store-to-a-client)

If you're building your theme for a client, then review our [best practices for working with merchants](https://shopify.dev/docs/storefronts/themes/best-practices/merchant-stores).

Theme customization
-------------------

[Anchor link to section titled "Theme customization"](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#theme-customization)
...
You can apply to offer theme customization services through the [Shopify Partner Directory](https://help.shopify.com/partners/directory).

[Learn more about the Partner Directory](https://help.shopify.com/en/partners/directory).

Building bespoke themes and stores
----------------------------------

[Anchor link to section titled "Building bespoke themes and stores"](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#building-bespoke-themes-and-stores)
...
You can offer theme building as a service through the [Shopify Partner Directory](https://help.shopify.com/partners/directory). You can charge your clients a fee that you both agree upon to build their theme.

If you're building a theme for a client who is moving to Shopify for the first time, then you can use a development store to build their store and build or customize their theme. After you [hand off the store](https://shopify.dev/docs/storefronts/themes/best-practices/merchant-stores) to the merchant, you receive a [recurring commission](https://help.shopify.com/partners/how-to-earn#development-store-referrals).

[Learn more about building stores for merchants](https://help.shopify.com/partners/building-stores-for-merchants).

Building for the Shopify Theme Store
------------------------------------

[Anchor link to section titled "Building for the Shopify Theme Store"](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#building-for-the-shopify-theme-store)

The [Shopify Theme Store](https://shopify.dev/docs/storefronts/themes/store) is one of the first stops in a merchant’s journey to launching their online store. As a Partner, you can create themes for the Shopify Theme Store and reach an international audience of millions of entrepreneurs.
...
[Learn more about submitting a theme to the Shopify Theme Store](https://shopify.dev/docs/storefronts/themes/store).

Building apps that integrate with themes
----------------------------------------

[Anchor link to section titled "Building apps that integrate with themes"](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#building-apps-that-integrate-with-themes)

As an app developer, you can build an app that extends the functionality of a merchant's theme. You can build a custom app for a specific client, or submit an app to the [Shopify App Store](https://shopify.dev/docs/apps/launch/app-store-review).

[Learn more about building apps that integrate with themes](https://shopify.dev/docs/apps/build/online-store).

### On this page

*   [Distribute your theme](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#distribute-your-theme)
*   [Theme customization](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#theme-customization)
*   [Building bespoke themes and stores](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#building-bespoke-themes-and-stores)
*   [Building for the Shopify Theme Store](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#building-for-the-shopify-theme-store)
*   [Building apps that integrate with themes](https://shopify.dev/docs/storefronts/themes/getting-started/build-your-business#building-apps-that-integrate-with-themes)
