---
title: "Removing a theme"
source: https://shopify.dev/docs/storefronts/themes/store/success/remove-theme
sections: Sell themes > Success > Remove Theme
created: 2025-07-29 15:42:10
---

Title: Removing your theme from the Shopify Theme Store

URL Source: https://shopify.dev/docs/storefronts/themes/store/success/remove-theme
...
[Skip to main content](https://shopify.dev/docs/storefronts/themes/store/success/remove-theme#Main)
...
[Anchor link to section titled "Should I remove a theme?"](https://shopify.dev/docs/storefronts/themes/store/success/remove-theme#should-i-remove-a-theme)
...
If your reason for removing a theme is related to poor sales, then explore ways to [improve your theme’s success](https://shopify.dev/docs/storefronts/themes/store/success).

Removing a theme
----------------

[Anchor link to section titled "Removing a theme"](https://shopify.dev/docs/storefronts/themes/store/success/remove-theme#removing-a-theme)
...
[Anchor link to section titled "Previous theme removals or inactive themes"](https://shopify.dev/docs/storefronts/themes/store/success/remove-theme#previous-theme-removals-or-inactive-themes)
...
*   [Should I remove a theme?](https://shopify.dev/docs/storefronts/themes/store/success/remove-theme#should-i-remove-a-theme)
*   [Removing a theme](https://shopify.dev/docs/storefronts/themes/store/success/remove-theme#removing-a-theme)
*   [Previous theme removals or inactive themes](https://shopify.dev/docs/storefronts/themes/store/success/remove-theme#previous-theme-removals-or-inactive-themes)
