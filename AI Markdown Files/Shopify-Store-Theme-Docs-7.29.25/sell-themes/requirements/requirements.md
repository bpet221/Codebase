...
sections: Sell themes > Requirements
created: 2025-07-29 15:41:10
---

Title: Theme store requirements

URL Source: https://shopify.dev/docs/storefronts/themes/store/requirements
...
*   [1. Theme Store exclusivity](https://shopify.dev/docs/storefronts/themes/store/requirements#1-theme-store-exclusivity)
*   [2. Uniqueness from other themes](https://shopify.dev/docs/storefronts/themes/store/requirements#2-uniqueness-from-other-themes)
*   [3. Theme design and UX](https://shopify.dev/docs/storefronts/themes/store/requirements#3-theme-design-and-ux)
*   [4. Features](https://shopify.dev/docs/storefronts/themes/store/requirements#4-features)
*   [5. Templates, sections, and blocks](https://shopify.dev/docs/storefronts/themes/store/requirements#5-templates-sections-and-blocks)
*   [6. Lighthouse performance and accessibility](https://shopify.dev/docs/storefronts/themes/store/requirements#6-lighthouse-performance-and-accessibility)
*   [7. Pages](https://shopify.dev/docs/storefronts/themes/store/requirements#7-pages)
*   [8. Consistency and functionality](https://shopify.dev/docs/storefronts/themes/store/requirements#8-consistency-and-functionality)
*   [9. Browser compatibility](https://shopify.dev/docs/storefronts/themes/store/requirements#9-browser-compatibility)
*   [10. Assets](https://shopify.dev/docs/storefronts/themes/store/requirements#10-assets)
*   [11. Search engine optimization (SEO)](https://shopify.dev/docs/storefronts/themes/store/requirements#11-search-engine-optimization-seo)
*   [12. Accessibility](https://shopify.dev/docs/storefronts/themes/store/requirements#12-accessibility)
*   [13. Social media](https://shopify.dev/docs/storefronts/themes/store/requirements#13-social-media)
*   [14. Settings](https://shopify.dev/docs/storefronts/themes/store/requirements#14-settings)
*   [15. Font picker](https://shopify.dev/docs/storefronts/themes/store/requirements#15-font-picker)
*   [16. Color system](https://shopify.dev/docs/storefronts/themes/store/requirements#16-color-system)
*   [17. Responsive images](https://shopify.dev/docs/storefronts/themes/store/requirements#17-responsive-images)
*   [18. Naming themes and theme presets](https://shopify.dev/docs/storefronts/themes/store/requirements#18-naming-themes-and-theme-presets)
*   [19. Theme versions and release notes](https://shopify.dev/docs/storefronts/themes/store/requirements#19-theme-versions-and-release-notes)
*   [20. Demo stores](https://shopify.dev/docs/storefronts/themes/store/requirements#20-demo-stores)
*   [21. Documentation and contact forms](https://shopify.dev/docs/storefronts/themes/store/requirements#21-documentation-and-contact-forms)
*   [22. Supporting your theme](https://shopify.dev/docs/storefronts/themes/store/requirements#22-supporting-your-theme)
...
[Anchor link to section titled "1. Theme Store exclusivity"](https://shopify.dev/docs/storefronts/themes/store/requirements#1-theme-store-exclusivity)
...
[Anchor link to section titled "2. Uniqueness from other themes"](https://shopify.dev/docs/storefronts/themes/store/requirements#2-uniqueness-from-other-themes)

Your theme must be substantively different from other themes that are already listed on the [Shopify Theme Store](https://themes.shopify.com/) (including your own). You must make meaningful changes and innovations to the design and functionality of the theme. Below are some cues that we look for:
...
[Anchor link to section titled "3. Theme design and UX"](https://shopify.dev/docs/storefronts/themes/store/requirements#3-theme-design-and-ux)
...
[Anchor link to section titled "Visual design and art direction"](https://shopify.dev/docs/storefronts/themes/store/requirements#visual-design-and-art-direction)

- [x]

**Unique and intentional design:** Your theme clearly stands apart, does not closely resemble existing themes in the theme store, and clearly targets a specific merchant type or industry with a thoughtful, deliberate visual style.
...
[Anchor link to section titled "Layout"](https://shopify.dev/docs/storefronts/themes/store/requirements#layout)
...
[Anchor link to section titled "Consistency"](https://shopify.dev/docs/storefronts/themes/store/requirements#consistency)
...
[Anchor link to section titled "Customer shopping experience"](https://shopify.dev/docs/storefronts/themes/store/requirements#customer-shopping-experience)
...
**Frictionless shopping interactions:**TThe shopping experience is smooth, easy, and completely frustration-free. All key customer actions—such as choosing product options, adding to cart, editing cart items, and moving to checkout—are clear, intuitive, and immediately responsive.

### Demo store experience

[Anchor link to section titled "Demo store experience"](https://shopify.dev/docs/storefronts/themes/store/requirements#demo-store-experience)
...
[Anchor link to section titled "4. Features"](https://shopify.dev/docs/storefronts/themes/store/requirements#4-features)
...
**Follow on Shop** - Add a **Follow on Shop button** using the [login_button](https://shopify.dev/docs/api/liquid/filters/login_button) Liquid filter to enable a customer to follow a store in the Shop app.
...
[Anchor link to section titled "5. Templates, sections, and blocks"](https://shopify.dev/docs/storefronts/themes/store/requirements#5-templates-sections-and-blocks)
...
[Anchor link to section titled "Template support requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#template-support-requirements)
...
[Anchor link to section titled "Section support requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#section-support-requirements)
...
[Anchor link to section titled "Block and app block support requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#block-and-app-block-support-requirements)
...
[Anchor link to section titled "6. Lighthouse performance and accessibility"](https://shopify.dev/docs/storefronts/themes/store/requirements#6-lighthouse-performance-and-accessibility)
...
[Anchor link to section titled "Lighthouse performance and accessibility requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#lighthouse-performance-and-accessibility-requirements)
...
[Anchor link to section titled "Testing the performance of your theme"](https://shopify.dev/docs/storefronts/themes/store/requirements#testing-the-performance-of-your-theme)
...
[Anchor link to section titled "Testing the accessibility of your theme"](https://shopify.dev/docs/storefronts/themes/store/requirements#testing-the-accessibility-of-your-theme)
...
[Anchor link to section titled "7. Pages"](https://shopify.dev/docs/storefronts/themes/store/requirements#7-pages)
...
[Anchor link to section titled "Layout page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#layout-page-requirements)
...
[Anchor link to section titled "Product page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#product-page-requirements)
...
[Anchor link to section titled "Collection page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#collection-page-requirements)
...
[Anchor link to section titled "Collection List page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#collection-list-page-requirements)
...
[Anchor link to section titled "Cart page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#cart-page-requirements)
...
[Anchor link to section titled "Page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#page-requirements)
...
[Anchor link to section titled "Blog page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#blog-page-requirements)
...
[Anchor link to section titled "Article page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#article-page-requirements)
...
[Anchor link to section titled "Search page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#search-page-requirements)
...
[Anchor link to section titled "404 page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#404-page-requirements)
...
[Anchor link to section titled "Gift Card page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#gift-card-page-requirements)
...
[Anchor link to section titled "Customer page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#customer-page-requirements)
...
[Anchor link to section titled "Password page requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#password-page-requirements)
...
[Anchor link to section titled "8. Consistency and functionality"](https://shopify.dev/docs/storefronts/themes/store/requirements#8-consistency-and-functionality)
...
[Anchor link to section titled "9. Browser compatibility"](https://shopify.dev/docs/storefronts/themes/store/requirements#9-browser-compatibility)
...
[Anchor link to section titled "Desktop browser requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#desktop-browser-requirements)
...
[Anchor link to section titled "Mobile browser requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#mobile-browser-requirements)
...
[Anchor link to section titled "Webviews and other application requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#webviews-and-other-application-requirements)
...
[Anchor link to section titled "10. Assets"](https://shopify.dev/docs/storefronts/themes/store/requirements#10-assets)
...
[Anchor link to section titled "11. Search engine optimization (SEO)"](https://shopify.dev/docs/storefronts/themes/store/requirements#11-search-engine-optimization-seo)
...
[Anchor link to section titled "12. Accessibility"](https://shopify.dev/docs/storefronts/themes/store/requirements#12-accessibility)
...
[Anchor link to section titled "13. Social media"](https://shopify.dev/docs/storefronts/themes/store/requirements#13-social-media)
...
[Anchor link to section titled "14. Settings"](https://shopify.dev/docs/storefronts/themes/store/requirements#14-settings)
...
[Anchor link to section titled "Basic requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#basic-requirements)

- [x]

All theme settings must adhere to the [text style](https://shopify.dev/docs/storefronts/themes/store/requirements#text-style-requirements) and [terminology](https://shopify.dev/docs/storefronts/themes/store/requirements#terminology-requirements) requirements.
...
[Anchor link to section titled "Theme editor event requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#theme-editor-event-requirements)
...
[Anchor link to section titled "Text style requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#text-style-requirements)
...
[Anchor link to section titled "Terminology requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#terminology-requirements)
...
[Anchor link to section titled "Section name guidelines"](https://shopify.dev/docs/storefronts/themes/store/requirements#section-name-guidelines)
...
![Image 1: Section example](https://shopify.dev/assets/themes/store/dawn-section-c77bba1af5d9ed109c085f51d78c5d0311b07f9b1ce4a20fbaca05cca52a2546.png)
...
[Anchor link to section titled "Suggested section names"](https://shopify.dev/docs/storefronts/themes/store/requirements#suggested-section-names)
...
[Anchor link to section titled "Section preset guidelines"](https://shopify.dev/docs/storefronts/themes/store/requirements#section-preset-guidelines)

Section presets are predefined configurations of sections that merchants start with when adding content.

![Image 2: Section preset example](https://shopify.dev/assets/themes/store/dawn-preset-1b2c035e1cbe2d1ed8218f19ca3bf0aa4df77be9e27f9ff00b1a987e53d3e191.png)
...
[Anchor link to section titled "Content placeholders"](https://shopify.dev/docs/storefronts/themes/store/requirements#content-placeholders)
...
[Anchor link to section titled "15. Font picker"](https://shopify.dev/docs/storefronts/themes/store/requirements#15-font-picker)
...
All fonts must use the setting type [font_picker](https://shopify.dev/docs/themes/architecture/settings/input-settings#font_picker).
...
[Anchor link to section titled "16. Color system"](https://shopify.dev/docs/storefronts/themes/store/requirements#16-color-system)
...
[Anchor link to section titled "17. Responsive images"](https://shopify.dev/docs/storefronts/themes/store/requirements#17-responsive-images)
...
[Anchor link to section titled "18. Naming themes and theme presets"](https://shopify.dev/docs/storefronts/themes/store/requirements#18-naming-themes-and-theme-presets)
...
[Anchor link to section titled "Theme and preset naming requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#theme-and-preset-naming-requirements)
...
[Anchor link to section titled "Theme and preset name guidelines"](https://shopify.dev/docs/storefronts/themes/store/requirements#theme-and-preset-name-guidelines)
...
[Anchor link to section titled "Increasing clarity and discoverability"](https://shopify.dev/docs/storefronts/themes/store/requirements#increasing-clarity-and-discoverability)
...
[Anchor link to section titled "Adding presets to your theme zip submission"](https://shopify.dev/docs/storefronts/themes/store/requirements#adding-presets-to-your-theme-zip-submission)
...
You can optionally include preset-specific [section groups](https://shopify.dev/docs/storefronts/themes/architecture/section-groups) under a `/sections` folder under your preset listing folders. To learn more about how theme zips should be structured, refer to the [themes architecture documentation](https://shopify.dev/docs/storefronts/themes/architecture).

For a more detailed example of how to structure presets in your theme zip, refer to this [best practices page](https://shopify.dev/docs/storefronts/themes/store/success/updates#best-practices-on-structuring-your-theme-zip).

19. Theme versions and release notes
------------------------------------

[Anchor link to section titled "19. Theme versions and release notes"](https://shopify.dev/docs/storefronts/themes/store/requirements#19-theme-versions-and-release-notes)
...
[Anchor link to section titled "20. Demo stores"](https://shopify.dev/docs/storefronts/themes/store/requirements#20-demo-stores)
...
To build your demo store, you can use a Shopify [development store](https://shopify.dev/docs/storefronts/themes/tools/development-stores) free of charge.
...
[Anchor link to section titled "Demo store requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#demo-store-requirements)
...
[Anchor link to section titled "Demo store recommendations"](https://shopify.dev/docs/storefronts/themes/store/requirements#demo-store-recommendations)
...
[Anchor link to section titled "21. Documentation and contact forms"](https://shopify.dev/docs/storefronts/themes/store/requirements#21-documentation-and-contact-forms)
...
[Anchor link to section titled "Documentation and contact form requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#documentation-and-contact-form-requirements)
...
[Anchor link to section titled "Merchant-facing theme documentation"](https://shopify.dev/docs/storefronts/themes/store/requirements#merchant-facing-theme-documentation)
...
[Anchor link to section titled "Clear support policy"](https://shopify.dev/docs/storefronts/themes/store/requirements#clear-support-policy)
...
[Anchor link to section titled "Clarity on custom two-column MDX tutorials"](https://shopify.dev/docs/storefronts/themes/store/requirements#clarity-on-custom-two-column-mdx-tutorials)
...
[Anchor link to section titled "Contact forms"](https://shopify.dev/docs/storefronts/themes/store/requirements#contact-forms)
...
[Anchor link to section titled "22. Supporting your theme"](https://shopify.dev/docs/storefronts/themes/store/requirements#22-supporting-your-theme)
...
Merchant support requests are submitted through your [contact form](https://shopify.dev/docs/storefronts/themes/store/requirements#contact-forms), which you should link to from the Shopify Theme Store and your theme documentation.

### Merchant support requirements

[Anchor link to section titled "Merchant support requirements"](https://shopify.dev/docs/storefronts/themes/store/requirements#merchant-support-requirements)

- [x] You must assist merchants with their theme-related questions.

- [x] You must reply to support requests from merchants within two business days.

- [x] If there is a technical issue with your theme, such as a broken layout, a dead link, or a logical error, then you're responsible for fixing the issue in a timely manner.

- [x] You must fix critical bugs immediately or your theme may be temporarily removed from the Theme Store.

#### Tips for improving the merchant installation experience

[Anchor link to section titled "Tips for improving the merchant installation experience"](https://shopify.dev/docs/storefronts/themes/store/requirements#tips-for-improving-the-merchant-installation-experience)
...
[Anchor link to section titled "Estimating the support workload"](https://shopify.dev/docs/storefronts/themes/store/requirements#estimating-the-support-workload)
